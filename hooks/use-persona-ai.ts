/**
 * usePersonaAi — Persona-specific facade over the shared generation
 * listener. See ``use-scenario-ai.ts`` for the canonical rationale.
 *
 * Persona.tsx itself consumes ``useSharedGenerationListener`` directly;
 * this shim exists for the Personas list view which uses the older
 * facade shape.
 */
"use client";
