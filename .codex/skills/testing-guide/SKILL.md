...
- Infrastructure tests: `server/tests/integration/infra/v5/[resource]/`
- E2E tests: `server/tests/e2e/`
- No client-side unit tests.

Write integration tests per endpoint in:
`server/tests/integration/api/v5/[resource]/test_[operation].py`
...
make test
make test-cov
make test server/tests/integration/api/v5/personas/test_create.py
```
