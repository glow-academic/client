...
ARTIFACTS = ['agent', 'auth', 'chat', 'cohort', 'department', 'document', 'eval', 'field', 'grade', 'key', 'message', 'model', 'parameter', 'persona', 'profile', 'provider', 'rubric', 'run', 'scenario', 'setting', 'simulation', 'tool']
