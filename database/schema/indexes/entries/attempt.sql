...
-- Name: attempt_conversation_completions_entry_conversation_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX attempt_conversation_completions_entry_conversation_id_idx ON public.attempt_conversation_completions_entry USING btree (conversation_id);


--

-- Name: attempt_conversation_completions_entry_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX attempt_conversation_completions_entry_created_at_idx ON public.attempt_conversation_completions_entry USING btree (created_at);
...
CREATE INDEX attempt_conversations_entry_chat_id_idx ON public.attempt_conversations_entry USING btree (chat_id);


--

-- Name: attempt_conversations_entry_created_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
-- Name: idx_attempt_conversation_completions_entry_call_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_attempt_conversation_completions_entry_call_id ON public.attempt_conversation_completions_entry USING btree (call_id);
...
CREATE INDEX idx_attempt_responses_entry_chat_id ON public.attempt_responses_entry USING btree (chat_id);


--

-- Name: idx_attempt_responses_entry_generated; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_attempt_responses_entry_generated ON public.attempt_responses_entry USING btree (generated);


--

-- Name: idx_attempt_responses_entry_mcp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_attempt_responses_entry_mcp ON public.attempt_responses_entry USING btree (mcp);
