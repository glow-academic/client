...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'document_drafts_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS document_drafts_mv CASCADE;
...
CREATE UNIQUE INDEX document_drafts_mv_pk ON document_drafts_mv (draft_id);

REFRESH MATERIALIZED VIEW document_drafts_mv;
