...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'parameter_drafts_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS parameter_drafts_mv CASCADE;

CREATE MATERIALIZED VIEW parameter_drafts_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX parameter_drafts_mv_pk ON parameter_drafts_mv (draft_id);

REFRESH MATERIALIZED VIEW parameter_drafts_mv;
