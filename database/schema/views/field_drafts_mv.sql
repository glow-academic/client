...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'field_drafts_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS field_drafts_mv CASCADE;
...
CREATE UNIQUE INDEX field_drafts_mv_pk ON field_drafts_mv (draft_id);

REFRESH MATERIALIZED VIEW field_drafts_mv;
