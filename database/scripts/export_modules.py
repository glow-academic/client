...
async def export_resources(conn: asyncpg.Connection) -> None:
    ...
    resource_files: list[tuple[str, str, list[str]]] = [
        ...
        ("08-domains", "domains", ["domains_resource"]),
        ("09-args", "args", ["args_resource", "args_outputs_resource"]),
        ("10-request-limits", "request-limits", ["request_limits_resource"]),
        ("11-voices", "voices", ["voices_resource"]),
        ("12-reasoning-levels", "reasoning-levels", ["reasoning_levels_resource"]),
        (
