...
async def export_resources(conn: asyncpg.Connection) -> None:
    ...
    resource_files: list[tuple[str, str, list[str]]] = [
        ...
        ("12-request-limits", "request-limits", ["request_limits_resource"]),
        ("13-voices", "voices", ["voices_resource"]),
        ("14-reasoning-levels", "reasoning-levels", ["reasoning_levels_resource"]),
        (
