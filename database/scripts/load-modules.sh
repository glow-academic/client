...
# --- Modules 02-10 (profiles, providers, models, agents, auth, evals, systems)
# Generated by: python -m database.seeds.runner --modules
combined_seed="$modules_dir/modules-02-10-seed.sql"
if [[ -f "$combined_seed" ]]; then
  echo "Loading modules-02-10-seed.sql (profiles, providers, models, agents, auth, evals, systems) ..."
