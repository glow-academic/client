...
INSERT INTO public.agents_resource (created_at, active, generated, mcp, id, name, description, department_ids, temperature, reasoning, tool_ids, quality, voices, model_id, prompt_id, instruction_ids) VALUES ('2026-02-22T00:20:46.593734+00:00', true, false, false, '019c82b8-5d9d-710d-ae51-3080db0b7b55', 'Home', 'Navigation and recommendation agent for home page overview', '{}', 0, 'none', '{}', NULL, '{}', '019bb25e-e5ff-76f6-90d4-830670bb5d82', '019c82b8-5d9d-7046-81b8-1bb8eb191ffe', '{019c82b8-5d9d-7092-983c-d8ccd6a89b8c}') ON CONFLICT (id) DO NOTHING;
