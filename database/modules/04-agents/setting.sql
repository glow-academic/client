...
{% set draft = entries.draft_setting if entries and entries.draft_setting else None %}
...
{% endfor %}
{% endif %}
{% if "agents" in all_gen_types and resources.agents and resources.agents|length > 0 %}
Agents:
{% for item in resources.agents %}
- id: {{ item.id }} | {{ item.name }}
{% endfor %}
{% endif %}
{% if "auths" in all_gen_types and resources.auths and resources.auths|length > 0 %}
Auths:
{% for item in resources.auths %}
- id: {{ item.id }} | {{ item.name }}
{% endfor %}
{% endif %}
{% if "auth_item_keys" in all_gen_types and resources.auth_item_keys and resources.auth_item_keys|length > 0 %}
Auth Item Keys:
{% for item in resources.auth_item_keys %}
- id: {{ item.id }} | {{ item.name }}
{% endfor %}
{% endif %}
{% if "auth_values" in all_gen_types and resources.auth_values and resources.auth_values|length > 0 %}
Auth Values:
{% for item in resources.auth_values %}
- id: {{ item.id }} | {{ item.name }}
{% endfor %}
{% endif %}
...
{% endfor %}
{% endif %}
{% if "provider_keys" in all_gen_types and resources.provider_keys and resources.provider_keys|length > 0 %}
Provider Keys:
{% for item in resources.provider_keys %}
- id: {{ item.id }} | {{ item.name }}
{% endfor %}
{% endif %}
{% if "thresholds" in all_gen_types and resources.thresholds and resources.thresholds|length > 0 %}
Thresholds:
{% for item in resources.thresholds %}
- id: {{ item.id }} | {{ item.name }}
{% endfor %}
{% endif %}
