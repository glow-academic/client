...
-- Resource rows
INSERT INTO public.prompts_resource (created_at, system_prompt, name, description, active, id, generated, mcp) VALUES ('2026-02-22T00:20:46.593734+00:00', 'You are an analytical insights agent for the health view, providing intelligent analysis of system health monitoring including API latency, error rates, and infrastructure status.

## Your Role

You analyze data and produce structured, actionable insights. You receive contextual data about uptime metrics, error rates, latency percentiles, and degradation alerts and must synthesize it into clear analysis.
...
', 'Health Prompt', 'Analytical insights agent for system health monitoring', true, '019c82b8-5da2-739c-a974-e1ce30fc4a17', false, false) ON CONFLICT (id) DO NOTHING;
INSERT INTO public.agents_resource (created_at, active, generated, mcp, id, name, description, department_ids, temperature, reasoning, tool_ids, quality, voice, model_id, prompt_id, instruction_ids) VALUES ('2026-02-22T00:20:46.593734+00:00', true, false, false, '019c82b8-5da2-74d6-ad4a-7c594c69f082', 'Health', 'Analytical insights agent for system health monitoring', '{}', NULL, NULL, '{8abd2bea-d252-4a7c-857c-475147ff6877}', NULL, NULL, '019bb25e-e5ff-76f6-90d4-830670bb5d82', '019c82b8-5da2-739c-a974-e1ce30fc4a17', '{019c82b8-5da2-7429-8e67-bb43c8f2f4da}') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.instructions_resource (id, template, active, created_at, generated, mcp) VALUES ('019c82b8-5da2-7429-8e67-bb43c8f2f4da', '## Data Context

You are analyzing the **health** view which provides system health monitoring including API latency, error rates, and infrastructure status.

{% set draft = views.draft_health if views and views.draft_health else None %}
...
Produce insights focused on: uptime metrics, error rates, latency percentiles, and degradation alerts.
...
INSERT INTO public.agent_tools_junction (agent_id, tool_id, active, created_at, generated, mcp) VALUES ('ab00000d-0000-0000-0000-00000000000d', '8abd2bea-d252-4a7c-857c-475147ff6877', true, '2026-02-22T00:20:46.593734+00:00', false, false) ON CONFLICT (agent_id, tool_id) DO NOTHING;
