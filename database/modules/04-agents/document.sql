...
INSERT INTO public.tools_resource (created_at, active, generated, mcp, id, name, description, resource, entry, artifact, createable, args_ids) VALUES ('2026-01-13T23:48:20.098044+00:00', true, false, false, '019bebc4-d436-7bcc-b38a-2799877eb259', 'create_html', 'Generate the Jinja template HTML for the document.', NULL, NULL, NULL, true, '{}') ON CONFLICT (id) DO NOTHING;
