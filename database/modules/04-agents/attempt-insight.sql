...
INSERT INTO public.agent_descriptions_junction (agent_id, descriptions_id, created_at, generated, mcp, active) VALUES ('018f0005-0001-7000-8000-000000000001', '018f0005-0005-7000-8000-000000000001', '2026-02-23T17:47:02.459307+00:00', false, false, true) ON CONFLICT (agent_id, descriptions_id) DO NOTHING;
-- agent_flags_junction
INSERT INTO public.agent_flags_junction (agent_id, flags_id, created_at, generated, mcp, active) VALUES ('018f0005-0001-7000-8000-000000000001', '019be334-bfc4-76ac-80d3-c8ba7618bc7a', '2026-02-23T17:47:02.459307+00:00', false, false, true) ON CONFLICT (agent_id, flags_id) DO NOTHING;
-- agent_names_junction
INSERT INTO public.agent_names_junction (agent_id, names_id, created_at, generated, mcp, active) VALUES ('018f0005-0001-7000-8000-000000000001', '018f0005-0002-7000-8000-000000000001', '2026-02-23T17:36:15.969225+00:00', false, false, true) ON CONFLICT (agent_id, names_id) DO NOTHING;

-- agents_resource (denormalized row for generation pipeline)
INSERT INTO public.agents_resource (created_at, active, generated, mcp, id, name, description, department_ids, temperature, reasoning, tool_ids, quality, voices, model_id, prompt_id, instruction_ids) VALUES ('2026-02-23T17:47:02.459307+00:00', true, false, false, '018f0005-0006-7000-8000-000000000001', 'Attempt Insight', 'AI agent for generating analytical insights about individual training attempts including performance, conversation quality, and skill development', '{}', 0, 'none', '{}', NULL, '{}', '019bb25e-e5ff-76f6-90d4-830670bb5d82', '018f0005-0003-7000-8000-000000000001', '{018f0005-0004-7000-8000-000000000001}') ON CONFLICT (id) DO NOTHING;
-- agent_agents_junction
