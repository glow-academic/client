...
{% if entries.pricing_insights is defined and entries.pricing_insights and entries.pricing_insights|length > 0 %}
The following insights were previously generated:
{% for insight in entries.pricing_insights %}
- {{ insight.content }}
{% endfor %}
{% else %}
...
INSERT INTO public.agent_tools_junction (agent_id, tool_id, active, created_at, generated, mcp) VALUES ('ab00000c-0000-0000-0000-00000000000c', '018f0002-0001-7000-8000-000000000009', true, '2026-02-23T17:36:15.969225+00:00', false, false) ON CONFLICT (agent_id, tool_id) DO NOTHING;
