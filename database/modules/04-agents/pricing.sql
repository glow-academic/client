...
{% if artifacts.pricing.get.entries.insights is defined and artifacts.pricing.get.entries.insights and artifacts.pricing.get.entries.insights|length > 0 %}
The following insights were previously generated:
{% for insight in artifacts.pricing.get.entries.insights %}
- {{ insight.content }}
{% endfor %}
{% else %}
...
{% if artifacts.pricing.get.entries.runs is defined and artifacts.pricing.get.entries.runs %}
### Runs
{{ artifacts.pricing.get.entries.runs | tojson }}
{% endif %}
...
INSERT INTO public.agent_descriptions_junction (agent_id, descriptions_id, created_at, generated, mcp, active) VALUES ('ab00000c-0000-0000-0000-00000000000c', '019c82b8-5da1-7bcc-973e-99c531dc1a2a', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (agent_id, descriptions_id) DO NOTHING;
-- agent_flags_junction
INSERT INTO public.agent_flags_junction (agent_id, flags_id, created_at, generated, mcp, active) VALUES ('ab00000c-0000-0000-0000-00000000000c', '019be334-bfc4-76ac-80d3-c8ba7618bc7a', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (agent_id, flags_id) DO NOTHING;
-- agent_names_junction
INSERT INTO public.agent_names_junction (agent_id, names_id, created_at, generated, mcp, active) VALUES ('ab00000c-0000-0000-0000-00000000000c', '019c82b8-5da1-7b75-a0b2-8c4697ac76d1', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (agent_id, names_id) DO NOTHING;
-- agent_tools_junction
INSERT INTO public.agent_tools_junction (agent_id, tools_id, active, created_at, generated, mcp) VALUES ('ab00000c-0000-0000-0000-00000000000c', '019522a0-0020-7000-8000-000000000005', true, '2026-02-24T11:27:01.778199+00:00', false, false) ON CONFLICT (agent_id, tools_id) DO NOTHING;
