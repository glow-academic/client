...
-- Resource rows
INSERT INTO public.prompts_resource (created_at, system_prompt, name, description, active, id, generated, mcp) VALUES ('2026-02-22T00:20:46.593734+00:00', 'You are an analytical insights agent for the dashboard view, providing intelligent analysis of high-level organizational dashboard with KPIs, trends, and departmental breakdowns.

## Your Role

You analyze data and produce structured, actionable insights. You receive contextual data about key performance indicators, usage trends, department comparisons, and executive summaries and must synthesize it into clear analysis.
...
', 'Dashboard Prompt', 'Analytical insights agent for high-level organizational KPIs and trends', true, '019c82b8-5d9e-74ad-b6c3-6902661c88c7', false, false) ON CONFLICT (id) DO NOTHING;
INSERT INTO public.agents_resource (created_at, active, generated, mcp, id, name, description, department_ids, temperature, reasoning, tool_ids, quality, voice, model_id, prompt_id, instruction_ids) VALUES ('2026-02-22T00:20:46.593734+00:00', true, false, false, '019c82b8-5d9e-75d2-9cf7-e0f91bb0fb38', NULL, NULL, '{}', NULL, NULL, '{8abd2bea-d252-4a7c-857c-475147ff6877}', NULL, NULL, '019bb25e-e5ff-76f6-90d4-830670bb5d82', '019c82b8-5d9e-74ad-b6c3-6902661c88c7', '{019c82b8-5d9e-7511-a124-6b571e673d57}') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.instructions_resource (id, template, active, created_at, generated, mcp) VALUES ('019c82b8-5d9e-7511-a124-6b571e673d57', '## Data Context

You are analyzing the **dashboard** view which provides high-level organizational dashboard with KPIs, trends, and departmental breakdowns.

{% set draft = views.draft_dashboard if views and views.draft_dashboard else None %}
...
Produce insights focused on: key performance indicators, usage trends, department comparisons, and executive summaries.
...
INSERT INTO public.agent_tools_junction (agent_id, tool_id, active, created_at, generated, mcp) VALUES ('ab000007-0000-0000-0000-000000000007', '8abd2bea-d252-4a7c-857c-475147ff6877', true, '2026-02-22T00:20:46.593734+00:00', false, false) ON CONFLICT (agent_id, tool_id) DO NOTHING;
