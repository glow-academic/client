...
SELECT 'ab000008-0000-0000-0000-000000000008', ar.model_id, true, '2026-02-22T00:20:46.593734+00:00', false, false
FROM public.agents_resource ar
WHERE ar.id = '019c82b8-5d9f-71af-a2ac-3bfc3d189410'
...
SELECT 'ab000008-0000-0000-0000-000000000008', rlr.id, true, '2026-02-22T00:20:46.593734+00:00', false, false
FROM public.agents_resource ar
...
SELECT 'ab000008-0000-0000-0000-000000000008', tlr.id, true, '2026-02-22T00:20:46.593734+00:00', false, false
FROM public.agents_resource ar
...
SELECT DISTINCT 'ab000008-0000-0000-0000-000000000008'::uuid, vr.id, true, '2026-02-22T00:20:46.593734+00:00'::timestamptz, false, false
FROM public.agents_resource ar
...
INSERT INTO public.agent_descriptions_junction (agent_id, descriptions_id, created_at, generated, mcp, active) VALUES ('ab000008-0000-0000-0000-000000000008', '019c82b8-5d9f-72f2-9205-d1b904c0b54b', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (agent_id, descriptions_id) DO NOTHING;
-- agent_flags_junction
INSERT INTO public.agent_flags_junction (agent_id, flags_id, created_at, generated, mcp, active) VALUES ('ab000008-0000-0000-0000-000000000008', '019be334-bfc4-76ac-80d3-c8ba7618bc7a', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (agent_id, flags_id) DO NOTHING;
-- agent_names_junction
INSERT INTO public.agent_names_junction (agent_id, names_id, created_at, generated, mcp, active) VALUES ('ab000008-0000-0000-0000-000000000008', '019c82b8-5d9f-7291-b2f2-8f25be112477', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (agent_id, names_id) DO NOTHING;
-- agent_tools_junction
INSERT INTO public.agent_tools_junction (agent_id, tools_id, active, created_at, generated, mcp) VALUES ('ab000008-0000-0000-0000-000000000008', '019522a0-0020-7000-8000-000000000007', true, '2026-02-24T11:27:01.778199+00:00', false, false) ON CONFLICT (agent_id, tools_id) DO NOTHING;
