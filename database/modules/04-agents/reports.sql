...
INSERT INTO public.agents_resource (created_at, active, generated, mcp, id, name, description, department_ids, temperature, reasoning, tool_ids, quality, voice, model_id, prompt_id, instruction_ids) VALUES ('2026-02-22T00:20:46.593734+00:00', true, false, false, '019c82b8-5d9f-71af-a2ac-3bfc3d189410', 'Reports', 'Analytical insights agent for detailed training outcome reports', '{}', NULL, NULL, '{8abd2bea-d252-4a7c-857c-475147ff6877}', NULL, NULL, '019bb25e-e5ff-76f6-90d4-830670bb5d82', '019c82b8-5d9f-708d-8b0e-d00022ff16c0', '{019c82b8-5d9f-70f2-875e-b435dcc24083}') ON CONFLICT (id) DO NOTHING;
...
{% if entries.reports_insights is defined and entries.reports_insights and entries.reports_insights|length > 0 %}
The following insights were previously generated:
{% for insight in entries.reports_insights %}
- {{ insight.content }}
{% endfor %}
{% else %}
...
INSERT INTO public.agent_tools_junction (agent_id, tool_id, active, created_at, generated, mcp) VALUES ('ab000008-0000-0000-0000-000000000008', '018f0002-0001-7000-8000-00000000000b', true, '2026-02-23T17:36:15.969225+00:00', false, false) ON CONFLICT (agent_id, tool_id) DO NOTHING;
