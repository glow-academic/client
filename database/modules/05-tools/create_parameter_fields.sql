...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('019bf207-ca52-70cc-ae3c-a5ca44d6d5e9', '2026-01-24T22:02:35.441799+00:00', false, false, true, 'create_parameter_fields', 'Create a parameter field resource for linking general parameter fields to scenarios', '{}', false, '{019c06a8-2afd-75f5-bc5e-84761794a3d6,019c06a8-2afd-7619-95b4-0c0252b8e5ee}', '{019c48f5-89d8-76c3-a4f8-56bad0f21043,019c48f5-89d9-7414-a395-bd6c07cbf197}') ON CONFLICT (id) DO NOTHING;
