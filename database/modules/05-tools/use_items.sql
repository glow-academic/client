...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('5e11556a-3a07-4dc2-8fb2-a6efeac86c88', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_items', 'Use an existing item by its ID', '{}', false, '{b71b58f0-1f02-46a4-8299-1dd4c799738d}', '{7468279e-aa34-46a4-829f-3e39f875eaca}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('594e5538-e564-48bd-b1d7-e68170bd004a', 'df188f80-b6c5-46bc-b945-df1a40318de5', false, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
