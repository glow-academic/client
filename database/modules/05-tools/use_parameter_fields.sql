...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c06a8-2af6-7609-9bc5-2782eb639be2', '2026-01-28T22:10:10.283595+00:00', false, false, true, 'use_parameter_fields', 'Use an existing parameter field resource instead of creating a new one', '{}', false, '{019c06a8-2afd-75d2-b632-0b14d929ce51}', '{80914706-baaa-47a1-bf0d-b9d169964343}', 'parameter_fields', NULL) ON CONFLICT (id) DO NOTHING;
