...
INSERT INTO public.args_outputs_resource (id, args_id, name, template, created_at, active, generated, mcp) VALUES ('019bbf87-096b-74ae-a967-e642fef0a546', '019bbf87-091f-781f-adab-974beb4f0386', 'id', '{{ simulation_id }}', '2026-01-14T18:39:46.732086+00:00', true, false, false) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019bebc4-d436-7cb0-a120-7762b81276c3', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_scenario_positions', 'Create a new scenario position resource to set ordering of scenarios within simulations', '{}', 'create', '{019bbf87-091e-78ff-aac4-e106cd6af4e1,019bbf87-091f-781f-adab-974beb4f0386,019bbf87-091f-7380-834d-0e0eb6b97d0c}', '{019bbf87-096b-734d-b031-69ff82f593a4,019bbf87-0965-751e-bf8d-1f0c7563f20b,019bbf87-096b-74ae-a967-e642fef0a546}', '{scenario_positions}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('019bb544-12d5-7ea5-9c7b-0d6082a02d61', '019bbabc-5a32-79b3-8fa1-ddb6a2056a31', '2026-01-13T02:51:36.016365+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_resources_junction
INSERT INTO public.tool_resources_junction (tool_id, resources_id, active, created_at, generated, mcp) VALUES ('019bb544-12d5-7ea5-9c7b-0d6082a02d61', '019bbeb4-5114-79ea-bfe0-901d3d172d9c', true, '2026-01-13T02:51:36.016365+00:00', false, false) ON CONFLICT (tool_id, resources_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('019bb544-12d5-7ea5-9c7b-0d6082a02d61', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-01-13T02:51:36.016365+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('019bb544-12d5-7ea5-9c7b-0d6082a02d61', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('019bb544-12d5-7ea5-9c7b-0d6082a02d61', '019bbabc-5a32-791a-8eee-2372b2ca5924', '2026-01-13T02:51:36.016365+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
