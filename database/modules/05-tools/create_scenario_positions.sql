...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('019bebc4-d436-7cb0-a120-7762b81276c3', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_scenario_positions', 'Create a new scenario position resource to set ordering of scenarios within simulations', '{}', false, '{019bbf87-091e-78ff-aac4-e106cd6af4e1,019bbf87-091f-781f-adab-974beb4f0386,019bbf87-091f-7380-834d-0e0eb6b97d0c}', '{019bbf87-096b-734d-b031-69ff82f593a4,019bbf87-0965-751e-bf8d-1f0c7563f20b,019bbf87-096b-74ae-a967-e642fef0a546}') ON CONFLICT (id) DO NOTHING;
