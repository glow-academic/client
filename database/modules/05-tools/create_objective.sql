...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019bebc4-d436-7b8b-8443-f82efdfd5790', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_objective', 'Create a learning objective for this scenario. Objectives should be specific, measurable, relate to pedagogical skills or subject matter knowledge, and be achievable within a single chat interaction. Call this tool multiple times to create multiple objectives.', '{}', true, '{019bbf87-091e-7778-8b79-b9c01c9861cd}', '{019bbf87-0966-77df-9c22-cee11b4f4d31}', 'objectives', NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('019b6ba0-df00-79f5-9e03-1e507b91adfd', 'df188f80-b6c5-46bc-b945-df1a40318de5', true, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
