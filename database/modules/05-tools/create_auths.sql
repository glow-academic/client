...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('e3abe747-7f2d-4f59-992d-4dcfed8d8664', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_auths', 'Create a new auth binding for settings', '{}', 'create', '{019c4f27-1773-7e98-80e4-c94c03867ee0}', '{}', '{}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('0eb5b1be-fc65-4a0e-95d4-799d0242efb3', '019c82b8-5d89-72cb-8638-7242c6689a92', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('0eb5b1be-fc65-4a0e-95d4-799d0242efb3', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('0eb5b1be-fc65-4a0e-95d4-799d0242efb3', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('0eb5b1be-fc65-4a0e-95d4-799d0242efb3', '019c82b8-5d89-723c-bdd2-5e1abc8c8fdd', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
