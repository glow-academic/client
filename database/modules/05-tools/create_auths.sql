...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('e3abe747-7f2d-4f59-992d-4dcfed8d8664', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_auths', 'Create a new auth binding for settings', '{}', true, '{019c4f27-1773-7e98-80e4-c94c03867ee0}', '{}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
