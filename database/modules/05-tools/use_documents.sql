...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019c0a2d-fc35-7eb7-8bc4-4a4d9578918d', '2026-01-29T14:35:11.795021+00:00', false, false, true, 'use_documents', 'Use an existing document resource instead of creating a new one', '{}', false, '{019c0a2d-fc3b-7713-bd61-06feccddfcc8}', '{fe4a69ea-eb46-41db-a4c2-1b0d3fc23490}', 'documents', NULL, NULL) ON CONFLICT (id) DO NOTHING;
