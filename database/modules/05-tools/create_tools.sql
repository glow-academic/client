...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('d9247def-16e8-4fff-b27e-a8af318a5dd9', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_tools', 'Create a new tool binding', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
