...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019bebc4-d436-7b79-9a9b-f4ca94396178', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'end_conversation', 'End the conversation. This tool signals that the conversation should be terminated.', '{}', false, '{019bbf87-091e-76bb-aea5-9b1811fde09d}', '{019bbf87-0969-7918-baff-8a6aea670506}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('019b484d-9837-760c-aa73-2421c6d107c0', 'df188f80-b6c5-46bc-b945-df1a40318de5', false, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
