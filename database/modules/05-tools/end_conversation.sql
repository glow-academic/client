...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019bebc4-d436-7b79-9a9b-f4ca94396178', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'end_conversation', 'End the conversation. This tool signals that the conversation should be terminated.', '{}', false, '{019bbf87-091e-76bb-aea5-9b1811fde09d}', '{019bbf87-0969-7918-baff-8a6aea670506}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
