...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('e00113cf-8fb3-4823-872f-5856a8075447', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_auth_item_keys', 'Use an existing auth item key by its ID', '{}', false, '{3ba72256-8cc0-4559-8811-113e5e95c1a5}', '{3103c655-93a9-45c1-81f7-536ccca275e5}', NULL) ON CONFLICT (id) DO NOTHING;
