...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019bebc4-d436-7c7f-a1f3-9bc8a7bc70ba', '2026-01-17T17:58:56.053417+00:00', false, false, true, 'create_times', 'Create a new times resource', '{}', true, '{019bbf87-091e-7fe7-be5c-f809786ca7ff,019bbf87-091f-7380-834d-0e0eb6b97d0c}', '{019bbf87-096a-7997-80ef-78cc7a63cb2b,019bbf87-096b-734d-b031-69ff82f593a4}', 'scenario_time_limits') ON CONFLICT (id) DO NOTHING;
