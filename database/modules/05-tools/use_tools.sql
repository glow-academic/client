...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('a24eefa2-fe75-4619-ae36-7eb1ea8ba4aa', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_tools', 'Use an existing tool by its ID', '{}', false, '{3286d1b9-376e-4e30-8c34-1906b5913233}', '{a547ad83-09e7-4580-aaf9-110cbd31cea3}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
