...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('a9275dc8-75e1-42c9-8fd7-ab5bdee1189b', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_uploads', 'Use an existing upload by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
