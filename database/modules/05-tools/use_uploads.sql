...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('a9275dc8-75e1-42c9-8fd7-ab5bdee1189b', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_uploads', 'Use an existing upload by its ID', '{}', false, '{13772ecb-3e4a-4fba-b9e1-2b038401e5ca}', '{8599b585-8015-4681-8a63-295bc77f6794}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
