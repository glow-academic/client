...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019c0a2d-fc36-756e-b50e-a5987eb4f0d5', '2026-01-29T14:35:11.795021+00:00', false, false, true, 'use_personas', 'Use an existing persona resource instead of creating a new one', '{}', false, '{019c0a2d-fc3b-7e62-bcb0-75124c777dcd}', '{86ad0489-0a8c-4e2f-b8a0-c2db397a23de}', 'personas', NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_resources_junction (tool_id, resource_id, active, created_at, generated, mcp) VALUES ('019c0a2d-fc3a-7c3c-a778-ee25cbb23ea2', '019bbeb4-5112-745f-9ae9-c8e64ca14d91', true, '2026-02-12T01:05:03.953545+00:00', false, false) ON CONFLICT (tool_id, resource_id) DO NOTHING;
-- tool_flags_junction
