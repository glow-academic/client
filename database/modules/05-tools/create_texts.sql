...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('aa93008d-9bcd-4594-a41c-9f003f6f1b33', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_texts', 'Create a new text resource', '{}', true, '{6ae76642-b24e-4e7b-a4e0-e51b8d214ff7}', '{7e11b681-9d8e-406d-93bd-a46f5555ceef}', NULL) ON CONFLICT (id) DO NOTHING;
