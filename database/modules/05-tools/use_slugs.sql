...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('d07bff92-18d9-4b75-a8d2-deefb5a0616c', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_slugs', 'Use an existing slug by its ID', '{}', false, '{4b6d2687-4c4e-4e54-ae8f-e1c4c13bd9a6}', '{a7e46b34-9852-4b9d-bece-3b544eb5404b}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
