...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019bebc4-d436-7c01-b86b-9483883762a6', '2026-01-17T17:58:56.073128+00:00', false, false, true, 'create_descriptions', 'Create a new descriptions resource', '{}', true, '{019bbf87-091e-7373-8a48-37437e3ffde1}', '{019bbf87-0964-7ddd-9ac0-ca38f131c8b8}', 'descriptions', NULL, NULL) ON CONFLICT (id) DO NOTHING;
