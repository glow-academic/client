...
-- Resource rows
INSERT INTO public.args_resource (id, name, description, field_type, required, default_value, created_at, active, generated, mcp) VALUES ('33b35bd7-b496-4e2d-b1f4-80c16d28bf18', 'domain_id', '', 'string', true, '', '2026-02-21T22:16:39.602906+00:00', true, false, false) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.args_outputs_resource (id, args_id, name, template, created_at, active, generated, mcp) VALUES ('e526507f-2782-4394-b796-529e57b1f44c', '33b35bd7-b496-4e2d-b1f4-80c16d28bf18', 'id', '{{ domain_id }}', '2026-02-21T22:16:39.604747+00:00', true, false, false) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('a85ffddf-b68f-4117-aab8-5888b3020fb1', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_domains', 'Use an existing domain by its ID', '{}', false, '{33b35bd7-b496-4e2d-b1f4-80c16d28bf18}', '{e526507f-2782-4394-b796-529e57b1f44c}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('22f98ee6-b613-4ce1-aefb-145616e52bb8', '019be334-bfc6-74fb-be11-ea6b522945bb', true, '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('22f98ee6-b613-4ce1-aefb-145616e52bb8', 'df188f80-b6c5-46bc-b945-df1a40318de5', false, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
...
-- tool_tools_junction
INSERT INTO public.tool_tools_junction (tool_id, tools_id, active, created_at, generated, mcp) VALUES ('22f98ee6-b613-4ce1-aefb-145616e52bb8', 'a85ffddf-b68f-4117-aab8-5888b3020fb1', true, '2026-02-21T22:16:39.608062+00:00', false, false) ON CONFLICT (tool_id, tools_id) DO NOTHING;
