...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019bebc4-d436-7b96-b622-c512f3a418da', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_video', 'Create a video for this scenario. The video should visually represent the scenario described in the problem statement. Include details about the setting, characters, and key actions.', '{}', true, '{019bbf87-091e-73a9-b24d-e7ab977a5273,019bbf87-091e-7373-8a48-37437e3ffde1,019bbf87-091e-79c6-9b3e-d5b2865e3956}', '{019bbf87-0964-77cd-ab26-d467f04ec130,019bbf87-096c-7c49-8340-67b41f71b130,019bbf87-0964-7ddd-9ac0-ca38f131c8b8}', 'videos', NULL, NULL) ON CONFLICT (id) DO NOTHING;
