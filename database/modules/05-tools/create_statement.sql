...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019bebc4-d436-7b81-9555-1d88249b6d78', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_statement', 'Create the problem statement for this scenario. The statement should be 1-2 sentences and subtly demonstrate the student''s persona without stating it directly.', '{}', true, '{019bbf87-091e-73a9-b24d-e7ab977a5273,019bbf87-091e-7971-b066-945bf89e4bbf}', '{019bbf87-0964-77cd-ab26-d467f04ec130,019bbf87-0966-74cb-9170-23849b47d719}', 'problem_statements', NULL) ON CONFLICT (id) DO NOTHING;
