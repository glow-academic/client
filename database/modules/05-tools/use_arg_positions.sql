...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('56263d13-2025-498c-9632-87300a83b5cc', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_arg_positions', 'Use an existing arg position by its ID', '{}', false, '{ce1cf75b-cd9a-4c00-a352-1092ec80dae3}', '{f6cb8f3a-553f-4eb1-82a3-79e847e28530}', NULL) ON CONFLICT (id) DO NOTHING;
