...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('019c4f27-1781-78eb-922b-095e42cb9438', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_providers', 'Use an existing provider resource instead of creating a new one', '{}', false, '{019bbf87-091f-7713-8183-d5f81f342c75}', '{}') ON CONFLICT (id) DO NOTHING;
