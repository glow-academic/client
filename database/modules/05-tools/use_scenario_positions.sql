...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019c0cd8-ad73-781f-a3aa-1f1049dd213c', '2026-01-30T03:00:52.718855+00:00', false, false, true, 'use_scenario_positions', 'Use an existing scenario position configuration instead of creating a new one', '{}', false, '{019c0cd8-ad78-7a5d-a14b-81019cf711ba}', '{5dae5401-6bec-40ff-9cdc-8bfdd02576be}', 'scenario_positions', NULL, NULL) ON CONFLICT (id) DO NOTHING;
