...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019c0a2d-fc36-7997-bdca-92935994cb93', '2026-01-29T14:35:11.795021+00:00', false, false, true, 'use_options', 'Use an existing option resource instead of creating a new one', '{}', false, '{019bbf87-091e-784e-8a7c-562ef0c4725d}', '{d33ca9ba-69d3-49ce-884b-05995e1b95e5}', 'options', NULL, NULL) ON CONFLICT (id) DO NOTHING;
