...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c4f27-1785-74f4-92c1-b909e5b7a7af', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_thresholds', 'Use an existing threshold resource instead of creating a new one', '{}', false, '{019c4f27-1785-79cc-ab77-07debbfadcad}', '{a0000515-0009-0000-0000-000000000001}', 'thresholds', NULL) ON CONFLICT (id) DO NOTHING;
