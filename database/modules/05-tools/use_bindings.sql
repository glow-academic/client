...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('37ea0108-e0aa-4d2e-b514-f1a8d2d976aa', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_bindings', 'Use an existing binding by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
