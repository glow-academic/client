...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('45902714-adea-43d4-8068-42a1913f6a45', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_simulation_positions', 'Use an existing simulation position by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
