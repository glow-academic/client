...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('45902714-adea-43d4-8068-42a1913f6a45', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_simulation_positions', 'Use an existing simulation position by its ID', '{}', false, '{73daa13b-c37a-42dc-8d55-368bc5a629af}', '{01c567f0-8fec-4522-84f0-85fe8bc9eaeb}', 'simulation_positions') ON CONFLICT (id) DO NOTHING;
