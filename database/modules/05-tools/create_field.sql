...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019bebc4-d436-7b73-a506-0b196bce4ada', '2026-01-17T17:57:40.566652+00:00', false, false, true, 'create_field', 'Classify files as part of a specific parameter item. Provide a list of file numbers (as strings) that should be classified as the specified parameter item.', '{}', 'create', '{019bbf87-091e-7940-9825-c757e353ed6d}', '{019bbf87-0965-77e7-8ab0-e35555bc6b29}', '{fields}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('019b484d-9837-75a6-97f2-6cd03cb2bf7c', '019bbabc-5a2e-7cc1-94c7-8ef9ee428408', '2025-12-22T23:03:23.445951+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_resources_junction
INSERT INTO public.tool_resources_junction (tool_id, resources_id, active, created_at, generated, mcp) VALUES ('019b484d-9837-75a6-97f2-6cd03cb2bf7c', '019bbeb4-510d-7790-bb69-2e3f34e2d23b', true, '2025-12-22T23:03:23.445951+00:00', false, false) ON CONFLICT (tool_id, resources_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('019b484d-9837-75a6-97f2-6cd03cb2bf7c', '019be334-bfc6-74fb-be11-ea6b522945bb', '2025-12-22T23:03:23.445951+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('019b484d-9837-75a6-97f2-6cd03cb2bf7c', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('019b484d-9837-75a6-97f2-6cd03cb2bf7c', '019bbabc-5a2e-7bc1-89a0-a01bd5175324', '2025-12-22T23:03:23.445951+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
