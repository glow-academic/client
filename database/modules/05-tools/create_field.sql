...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('019bebc4-d436-7b73-a506-0b196bce4ada', '2026-01-17T17:57:40.566652+00:00', false, false, true, 'create_field', 'Classify files as part of a specific parameter item. Provide a list of file numbers (as strings) that should be classified as the specified parameter item.', '{}', false, '{019bbf87-091e-7940-9825-c757e353ed6d}', '{019bbf87-0965-77e7-8ab0-e35555bc6b29}') ON CONFLICT (id) DO NOTHING;
