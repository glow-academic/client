...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('88115f24-f7ca-45cd-a431-ef9b381a96d0', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_run_positions', 'Use an existing run position by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
