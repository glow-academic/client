...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('88115f24-f7ca-45cd-a431-ef9b381a96d0', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_run_positions', 'Use an existing run position by its ID', '{}', false, '{3f8275d5-da10-4351-bae9-465313516649}', '{a55dbf53-b737-406e-a338-ea1aef26096a}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('6321ad07-a435-4a43-9158-f313cad3d4aa', '019be334-bfc6-74fb-be11-ea6b522945bb', true, '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('6321ad07-a435-4a43-9158-f313cad3d4aa', 'df188f80-b6c5-46bc-b945-df1a40318de5', false, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
