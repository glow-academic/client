...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019bebc4-d436-7c75-ad20-e10da932e60b', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_thresholds', 'Create a new thresholds resource', '{}', true, '{019bbf87-091e-78ff-aac4-e106cd6af4e1}', '{019bbf87-0965-751e-bf8d-1f0c7563f20b}', 'thresholds', NULL) ON CONFLICT (id) DO NOTHING;
