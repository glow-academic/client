...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('a52e42b8-ecdc-4836-861a-e82007220ec5', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_conditional_parameters', 'Use an existing conditional parameter by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
