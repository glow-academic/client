...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019c4f27-1784-7127-9b62-b1b57aac5b54', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_settings', 'Use an existing setting resource instead of creating a new one', '{}', false, '{019c4f27-1784-733f-a6b0-29152236cd21}', '{a0000515-0008-0000-0000-000000000001}', 'settings', NULL, NULL) ON CONFLICT (id) DO NOTHING;
