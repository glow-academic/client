...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019bebc4-d436-7b8d-adb8-3b17bafdda99', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_image', 'Create an image for this scenario. The image will be saved and linked to the scenario after generation completes.', '{}', true, '{019bbf87-091e-7373-8a48-37437e3ffde1,019bbf87-091e-73a9-b24d-e7ab977a5273}', '{019bbf87-0964-77cd-ab26-d467f04ec130,019bbf87-0964-7ddd-9ac0-ca38f131c8b8}', 'images', NULL) ON CONFLICT (id) DO NOTHING;
