...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019bebc4-d436-7ba3-9c29-c24f308f6e56', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_hint', 'Create a strategic hint for the GTA. This is one of multiple hints that should be distinct and focused on different aspects of helping the student (e.g., content explanation, emotional support, pedagogical approach). Call this tool multiple times to create multiple hints.', '{}', 'create', '{019bbf87-091e-7a33-aa90-781a6dc10b10,019bbf87-091e-72cb-b3b5-5e90e16254b2}', '{019bbf87-096a-76f9-8b4d-4516886a1626,019bbf87-0965-7d8c-b246-dd3411515aca}', '{}'::text[], '{hints}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_entries_junction (tool_id, entries_id, active, created_at, generated, mcp) VALUES ('019c16d8-a123-7040-9a24-0fed772143a1', '10215b8d-6e4b-48da-9041-a94e439f3f9a', true, '2026-02-19T14:14:23.735268+00:00', false, false) ON CONFLICT (tool_id, entries_id) DO NOTHING;
-- tool_descriptions_junction
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('019c16d8-a123-7040-9a24-0fed772143a1', '019c16d8-a123-735a-97bb-02658124651d', '2026-02-01T01:37:01.720364+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('019c16d8-a123-7040-9a24-0fed772143a1', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-02-01T01:37:01.720364+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('019c16d8-a123-7040-9a24-0fed772143a1', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('019c16d8-a123-7040-9a24-0fed772143a1', '019bbabc-5a2e-7db7-a230-390bd0ff9a90', '2026-02-01T01:37:01.720364+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
