...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019bebc4-d436-7ba3-9c29-c24f308f6e56', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_hint', 'Create a strategic hint for the GTA. This is one of multiple hints that should be distinct and focused on different aspects of helping the student (e.g., content explanation, emotional support, pedagogical approach). Call this tool multiple times to create multiple hints.', '{}', true, '{019bbf87-091e-7a33-aa90-781a6dc10b10,019bbf87-091e-72cb-b3b5-5e90e16254b2}', '{019bbf87-096a-76f9-8b4d-4516886a1626,019bbf87-0965-7d8c-b246-dd3411515aca}', NULL, 'hints') ON CONFLICT (id) DO NOTHING;
