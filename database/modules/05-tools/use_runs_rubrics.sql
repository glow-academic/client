...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('4264ba54-2e31-4a1c-ab6b-605b2c63e759', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_runs_rubrics', 'Use an existing run-rubric binding by its ID', '{}', false, '{9d73b780-9cfd-421a-92e4-a29b2feb26e8}', '{f7fb9958-f74c-492a-ad8e-6e2a4b37f3bb}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
