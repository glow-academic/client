...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('019bebc4-d436-7b60-9f57-f7c03f636fac', '2026-01-17T17:57:40.541181+00:00', false, false, true, 'create_content', 'Make a persona speak by calling this tool with the persona name and message. The persona name must match one of the available personas (case-insensitive matching is supported).', '{}', false, '{019bbf87-091e-7a33-aa90-781a6dc10b10,019bbf87-091e-768f-9c96-37941363873a,019c0a2d-fc3b-7e62-bcb0-75124c777dcd}', '{019bbf87-096a-76f9-8b4d-4516886a1626,019bbf87-0966-7327-b2a1-f5fbde584a12,019c26f6-fecc-7f2a-a62f-d5fe00b4837e}') ON CONFLICT (id) DO NOTHING;
