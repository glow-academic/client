...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('1b746440-0408-4df2-8130-87eacd6b05af', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_texts', 'Use an existing text by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
