...
INSERT INTO public.args_outputs_resource (id, args_id, name, template, created_at, active, generated, mcp) VALUES ('019bbf87-0968-7995-8f2b-285611270c53', '019bbf87-091e-784e-8a7c-562ef0c4725d', 'option_id', '{{ option_id }}', '2026-01-06T15:55:22.226036+00:00', true, false, false) ON CONFLICT (id) DO NOTHING;
INSERT INTO public.args_outputs_resource (id, args_id, name, template, created_at, active, generated, mcp) VALUES ('019bbf87-0968-7a39-8b5d-8ab0e285f6f6', '019bbf87-091e-786e-bbff-3e50b51a7cd1', 'question_id', '{{ question_id }}', '2026-01-06T15:55:22.226036+00:00', true, false, false) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019bebc4-d436-7bd9-a072-6590e24dbc21', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_response', 'Create a response linking a question to an option. Responses represent user selections in quizzes.', '{}', 'create', '{019bbf87-091e-784e-8a7c-562ef0c4725d,019bbf87-091e-786e-bbff-3e50b51a7cd1}', '{019bbf87-0968-7995-8f2b-285611270c53,019bbf87-0968-7a39-8b5d-8ab0e285f6f6}', '{}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('019b916f-f5c8-7e4e-8412-3e3fb1a9ce5c', '019bbabc-5a2f-78e7-b6f3-3662dd69cf19', '2026-01-06T03:53:12.392779+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('019b916f-f5c8-7e4e-8412-3e3fb1a9ce5c', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-01-06T03:53:12.392779+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('019b916f-f5c8-7e4e-8412-3e3fb1a9ce5c', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('019b916f-f5c8-7e4e-8412-3e3fb1a9ce5c', '019bbabc-5a2f-7858-8b1a-51d774212a65', '2026-01-06T03:53:12.392779+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
