...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c0cd8-ad73-7b6f-b393-86ceeddd1beb', '2026-01-30T03:00:52.718855+00:00', false, false, true, 'use_scenario_time_limits', 'Use an existing scenario time limit configuration instead of creating a new one', '{}', false, '{019c0cd8-ad78-7ab6-8d92-f0cdef967fd8}', '{550fdadd-cdfb-4f81-8b63-fea58d068c1b}', 'scenario_time_limits', NULL) ON CONFLICT (id) DO NOTHING;
