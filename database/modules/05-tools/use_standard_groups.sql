...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('d0e82950-8f92-46b9-90d6-0fdbeaebc9bb', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_standard_groups', 'Use an existing standard group by its ID', '{}', false, '{19c46603-8edc-4af6-823b-6fb7b3bf46b9}', '{9432a763-d34a-418c-b126-f847a8e93f1b}', NULL) ON CONFLICT (id) DO NOTHING;
