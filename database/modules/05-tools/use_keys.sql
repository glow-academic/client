...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('5133b52b-e5ee-4f08-a9e0-f5b459ab8bea', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_keys', 'Use an existing key by its ID', '{}', false, '{019bbf87-091f-77de-b8e9-1160c499a3e7}', '{019bbf87-0969-7d40-b671-1bdfae5c96af}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('f5e25ca4-de7b-4e3c-ab51-340962f246a5', 'df188f80-b6c5-46bc-b945-df1a40318de5', false, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
