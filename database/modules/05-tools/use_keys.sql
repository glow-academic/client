...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('5133b52b-e5ee-4f08-a9e0-f5b459ab8bea', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_keys', 'Use an existing key by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
