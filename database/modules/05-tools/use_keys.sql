...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('5133b52b-e5ee-4f08-a9e0-f5b459ab8bea', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_keys', 'Use an existing key by its ID', '{}', false, '{019bbf87-091f-77de-b8e9-1160c499a3e7}', '{019bbf87-0969-7d40-b671-1bdfae5c96af}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
