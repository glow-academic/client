...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019523a0-0020-7000-8000-000000000003', '2026-02-24T13:16:34.035984+00:00', false, false, true, 'get_cohort', 'Re-fetch cohort configuration context with fresh data.', '{}', false, '{019521a0-0001-7000-8000-000000000003,019524a0-0001-7000-8000-000000000020,019524a0-0001-7000-8000-000000000021,019524a0-0001-7000-8000-000000000022,019524a0-0001-7000-8000-000000000023}', '{}', NULL, NULL, 'cohort') ON CONFLICT (id) DO NOTHING;
