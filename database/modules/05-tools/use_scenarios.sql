...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019c0cd8-ad73-72dd-8a41-ea5b247384db', '2026-01-30T03:00:52.718855+00:00', false, false, true, 'use_scenarios', 'Use an existing scenario resource instead of creating a new one', '{}', 'link', '{019bbf87-091f-7380-834d-0e0eb6b97d0c}', '{1974e228-f025-490a-a974-6d2bf9b8ef44}', '{scenarios}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_resources_junction (tool_id, resources_id, active, created_at, generated, mcp) VALUES ('019c0cd8-ad75-7d9c-a481-f29ca2da6fd0', '019bbeb4-5114-7d6f-b639-917c2d4e0b9b', true, '2026-02-12T01:05:03.953545+00:00', false, false) ON CONFLICT (tool_id, resources_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('019c0cd8-ad75-7d9c-a481-f29ca2da6fd0', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-01-31T02:04:17.083661+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('019c0cd8-ad75-7d9c-a481-f29ca2da6fd0', '019d0000-0001-7000-8000-000000000003', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('019c0cd8-ad75-7d9c-a481-f29ca2da6fd0', '019c0cd8-ad75-7f4e-acf1-b8d5ce99fd48', '2026-01-30T03:00:52.718855+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
