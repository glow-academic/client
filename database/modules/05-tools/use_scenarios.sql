...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('019c0cd8-ad73-72dd-8a41-ea5b247384db', '2026-01-30T03:00:52.718855+00:00', false, false, true, 'use_scenarios', 'Use an existing scenario resource instead of creating a new one', '{}', false, '{019bbf87-091f-7380-834d-0e0eb6b97d0c}', '{1974e228-f025-490a-a974-6d2bf9b8ef44}') ON CONFLICT (id) DO NOTHING;
