...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('98194c0a-97af-4bf8-8c30-12a87bfbacb2', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_fields', 'Create a new field binding', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
