...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('8160a858-1a05-4171-b079-ed96706861e9', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_bindings', 'Create a new entry type binding', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
