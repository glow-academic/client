...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('8160a858-1a05-4171-b079-ed96706861e9', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_bindings', 'Create a new entry type binding', '{}', true, '{93c83b76-e662-48a6-a26e-93a52f249508}', '{1026f7f2-44a5-4bb5-bf0d-f2929a07563a}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('8e33597b-3b00-4b10-bfe4-a038471eb91a', 'df188f80-b6c5-46bc-b945-df1a40318de5', true, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
