...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('b64a7415-bfaf-42cf-8737-f0dcc4ce39b6', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_provider_keys', 'Use an existing provider key by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
