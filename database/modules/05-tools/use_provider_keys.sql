...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('b64a7415-bfaf-42cf-8737-f0dcc4ce39b6', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_provider_keys', 'Use an existing provider key by its ID', '{}', false, '{606e39cb-6382-4dd1-850a-f23bbd6ac7d5}', '{75ef8fc7-80ab-4648-9c10-cb115e7583c2}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('516a3f3d-2a75-4cb9-9f57-ed95d63bd32f', '019be334-bfc6-74fb-be11-ea6b522945bb', true, '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('516a3f3d-2a75-4cb9-9f57-ed95d63bd32f', 'df188f80-b6c5-46bc-b945-df1a40318de5', false, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
