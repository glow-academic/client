...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019c0a2d-fc36-785a-9b6d-02eca12bb6e6', '2026-01-29T14:35:11.795021+00:00', false, false, true, 'use_objectives', 'Use an existing objective resource instead of creating a new one', '{}', false, '{019c0a2d-fc3b-7ed3-9540-bc9f25fd77fc}', '{fd340494-667f-46da-8437-d1062b446449}', 'objectives', NULL, NULL) ON CONFLICT (id) DO NOTHING;
