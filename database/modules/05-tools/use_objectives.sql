...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019c0a2d-fc36-785a-9b6d-02eca12bb6e6', '2026-01-29T14:35:11.795021+00:00', false, false, true, 'use_objectives', 'Use an existing objective resource instead of creating a new one', '{}', 'link', '{019c0a2d-fc3b-7ed3-9540-bc9f25fd77fc}', '{fd340494-667f-46da-8437-d1062b446449}', '{objectives}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_resources_junction (tool_id, resources_id, active, created_at, generated, mcp) VALUES ('019c0a2d-fc3a-7f3c-b722-c1d9f679bb89', '019bbeb4-5112-708a-806d-7d695f766105', true, '2026-02-12T01:05:03.953545+00:00', false, false) ON CONFLICT (tool_id, resources_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('019c0a2d-fc3a-7f3c-b722-c1d9f679bb89', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-01-31T02:04:17.083661+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('019c0a2d-fc3a-7f3c-b722-c1d9f679bb89', '019d0000-0001-7000-8000-000000000003', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('019c0a2d-fc3a-7f3c-b722-c1d9f679bb89', '019c0a2d-fc3a-7f6c-bfeb-e4d8fe48b7f7', '2026-01-29T14:35:11.795021+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
