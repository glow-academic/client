...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('b6f5bfc5-65ee-4ee4-afab-25b2a528c6ac', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_scenario_personas', 'Use an existing scenario-persona binding by its ID', '{}', false, '{a92290bc-f250-4419-a42d-f1c4a75bde4d}', '{98af36dc-6d1f-49e4-8469-5b027d13c1bc}', 'scenario_personas', NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('1390af29-8586-487a-91c4-7b34f02d00d7', 'df188f80-b6c5-46bc-b945-df1a40318de5', false, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
