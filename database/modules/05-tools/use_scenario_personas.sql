...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('b6f5bfc5-65ee-4ee4-afab-25b2a528c6ac', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_scenario_personas', 'Use an existing scenario-persona binding by its ID', '{}', 'link', '{a92290bc-f250-4419-a42d-f1c4a75bde4d}', '{98af36dc-6d1f-49e4-8469-5b027d13c1bc}', '{scenario_personas}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('1390af29-8586-487a-91c4-7b34f02d00d7', '019c82b8-5d8c-7211-9348-490bffb0557a', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_resources_junction
INSERT INTO public.tool_resources_junction (tool_id, resources_id, active, created_at, generated, mcp) VALUES ('1390af29-8586-487a-91c4-7b34f02d00d7', '019c4f61-51dd-733a-baea-c994866d65c0', true, '2026-02-23T14:09:37.222956+00:00', false, false) ON CONFLICT (tool_id, resources_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('1390af29-8586-487a-91c4-7b34f02d00d7', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('1390af29-8586-487a-91c4-7b34f02d00d7', '019d0000-0001-7000-8000-000000000003', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('1390af29-8586-487a-91c4-7b34f02d00d7', '019c82b8-5d8c-718f-ab14-123e17653677', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
