...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('753f699e-f1dc-4fd9-8701-a69f26d0c110', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_problem_statements', 'Create a new problem statement resource', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
