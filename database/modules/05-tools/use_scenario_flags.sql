...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('019c0cd8-ad73-7621-b92d-91764faa013e', '2026-01-30T03:00:52.718855+00:00', false, false, true, 'use_scenario_flags', 'Use an existing scenario flag configuration instead of creating a new one', '{}', false, '{019c0cd8-ad78-744b-9c53-a823ab2682be}', '{44ab4560-1387-47dd-84f6-79dce5859a72}') ON CONFLICT (id) DO NOTHING;
