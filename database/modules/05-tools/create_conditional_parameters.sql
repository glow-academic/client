...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('f3aeb0a8-1ca0-4dc7-9f8d-61b4f8537d43', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_conditional_parameters', 'Create a conditional parameter binding', '{}', true, '{019bbf87-091f-73fa-8792-299a4c6e4bc0}', '{019bbf87-096c-7e02-bf85-9e4044aaf175}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
