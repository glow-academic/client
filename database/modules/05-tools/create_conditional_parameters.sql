...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('f3aeb0a8-1ca0-4dc7-9f8d-61b4f8537d43', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_conditional_parameters', 'Create a conditional parameter binding', '{}', 'create', '{019bbf87-091f-73fa-8792-299a4c6e4bc0}', '{019bbf87-096c-7e02-bf85-9e4044aaf175}', '{}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('56171eeb-1c3e-429d-a163-5b625fa78a2c', '019c82b8-5d85-7ff0-9aae-58aa55e4f87a', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('56171eeb-1c3e-429d-a163-5b625fa78a2c', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('56171eeb-1c3e-429d-a163-5b625fa78a2c', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('56171eeb-1c3e-429d-a163-5b625fa78a2c', '019bbabc-5a32-7c4f-b08a-816e421efcc3', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
