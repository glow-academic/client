...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019522a0-0020-7000-8000-00000000000a', '2026-02-24T11:27:01.778199+00:00', false, false, true, 'get_home', 'Re-fetch home context with optional history filters.', '{}', false, '{019522a0-0001-7000-8000-000000000001,019522a0-0001-7000-8000-000000000002,019522a0-0001-7000-8000-000000000003,019522a0-0001-7000-8000-000000000004,019522a0-0001-7000-8000-000000000005,019522a0-0001-7000-8000-000000000006,019522a0-0001-7000-8000-000000000007,019522a0-0001-7000-8000-000000000008}', '{}', NULL, NULL, 'home') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_artifacts_junction (tool_id, artifact_id, active, generated, mcp, created_at) VALUES ('019522a0-0010-7000-8000-00000000000a', '019c8d5a-6426-7cd5-86df-0a7fb1beafac', true, false, false, '2026-02-24T11:27:01.778199+00:00') ON CONFLICT (tool_id, artifact_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, name_id, created_at, generated, mcp, active) VALUES ('019522a0-0010-7000-8000-00000000000a', '019522a0-0030-7000-8000-00000000000a', '2026-02-24T11:27:01.778199+00:00', false, false, true) ON CONFLICT (tool_id, name_id) DO NOTHING;
-- tool_tools_junction
