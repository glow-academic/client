...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('52bd3f2d-8a5f-4a90-940a-a334975adc2a', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_videos', 'Create a new video resource', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
