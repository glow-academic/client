...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019c0cd8-ad73-7a10-805f-28e22f591d29', '2026-01-30T03:00:52.718855+00:00', false, false, true, 'use_scenario_rubrics', 'Use an existing scenario rubric assignment instead of creating a new one', '{}', 'link', '{019c0cd8-ad78-7a8f-a152-23252169ffea}', '{efe913ef-fddd-4906-8a50-f46b5658b81e}', '{scenario_rubrics}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_resources_junction (tool_id, resources_id, active, created_at, generated, mcp) VALUES ('019c0cd8-ad77-73c2-b9c0-2795004879ee', '019c4f27-1789-755a-ae00-6c38abda1503', true, '2026-02-12T00:01:27.881501+00:00', false, false) ON CONFLICT (tool_id, resources_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('019c0cd8-ad77-73c2-b9c0-2795004879ee', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-01-31T02:04:17.083661+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('019c0cd8-ad77-73c2-b9c0-2795004879ee', '019d0000-0001-7000-8000-000000000003', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('019c0cd8-ad77-73c2-b9c0-2795004879ee', '019c0cd8-ad77-741f-8f04-35bc6f1bc17e', '2026-01-30T03:00:52.718855+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
