...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c0cd8-ad73-7a10-805f-28e22f591d29', '2026-01-30T03:00:52.718855+00:00', false, false, true, 'use_scenario_rubrics', 'Use an existing scenario rubric assignment instead of creating a new one', '{}', false, '{019c0cd8-ad78-7a8f-a152-23252169ffea}', '{efe913ef-fddd-4906-8a50-f46b5658b81e}', 'scenario_rubrics', NULL) ON CONFLICT (id) DO NOTHING;
