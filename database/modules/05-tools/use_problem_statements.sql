...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019c0a2d-fc36-7c0c-80c1-098a75897197', '2026-01-29T14:35:11.795021+00:00', false, false, true, 'use_problem_statements', 'Use an existing problem statement resource instead of creating a new one', '{}', false, '{019c0a2d-fc3b-7f11-89b0-3ed69b5c6760}', '{78849cf4-d4a2-4ada-85b0-64f5522f1fe3}', 'problem_statements') ON CONFLICT (id) DO NOTHING;
