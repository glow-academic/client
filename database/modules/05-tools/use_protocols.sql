...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('ee01c972-7196-4fdd-ad4d-a55a41523396', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_protocols', 'Use an existing protocol by its ID', '{}', false, '{6af5cbea-a239-4bb4-a064-36df3118f364}', '{6983fab6-a059-4cf6-af2a-6a18b51663f9}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
