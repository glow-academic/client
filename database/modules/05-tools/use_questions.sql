...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c0a2d-fc36-7ace-adde-c1e47bc14a89', '2026-01-29T14:35:11.795021+00:00', false, false, true, 'use_questions', 'Use an existing question resource instead of creating a new one', '{}', false, '{019bbf87-091e-786e-bbff-3e50b51a7cd1}', '{0e366f8e-b831-4ecf-bc12-e29bdd9375e3}', 'questions', NULL) ON CONFLICT (id) DO NOTHING;
