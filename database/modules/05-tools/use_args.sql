...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('f41134ae-290f-4105-b439-1cd01a94c4e3', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_args', 'Use an existing arg by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
