...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('f41134ae-290f-4105-b439-1cd01a94c4e3', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_args', 'Use an existing arg by its ID', '{}', 'link', '{f17f51a9-ef9b-4f85-87f8-4bb6feb83fe1}', '{a18aba5b-765f-4caf-832e-9bd9552d76f3}', '{}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('ef45a500-ed4c-45fc-a7d1-adac65e8c554', '019c82b8-5d8c-74a5-9c8b-668417a48b2e', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('ef45a500-ed4c-45fc-a7d1-adac65e8c554', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('ef45a500-ed4c-45fc-a7d1-adac65e8c554', '019d0000-0001-7000-8000-000000000003', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('ef45a500-ed4c-45fc-a7d1-adac65e8c554', '019c82b8-5d8c-7425-ab25-14e2eb3e8f43', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
