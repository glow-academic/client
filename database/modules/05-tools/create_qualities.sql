...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019bebc4-d436-7cf0-9617-f44d4e7a6d71', '2026-01-17T17:57:40.647526+00:00', false, false, true, 'create_qualities', 'Create a new qualities resource', '{}', 'create', '{019bbf87-091f-754c-898b-d84a77ff7109,019bbf87-091f-741e-9750-ffa018c4a030}', '{019bbf87-096d-7363-8bfb-2816be51eddd,019bbf87-0965-723f-9fa6-99aaa445f4fc}', '{qualities}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('019bbdce-8407-78da-ba4b-34de4d253d09', '019bbdce-8407-7b8d-afdc-42fd4a3b935c', '2026-01-14T18:39:46.667548+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_resources_junction
INSERT INTO public.tool_resources_junction (tool_id, resources_id, active, created_at, generated, mcp) VALUES ('019bbdce-8407-78da-ba4b-34de4d253d09', '019bbeb4-5113-7474-82ad-730fbdf768cc', true, '2026-01-14T22:50:46.919286+00:00', false, false) ON CONFLICT (tool_id, resources_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('019bbdce-8407-78da-ba4b-34de4d253d09', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-01-14T18:39:46.667548+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('019bbdce-8407-78da-ba4b-34de4d253d09', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('019bbdce-8407-78da-ba4b-34de4d253d09', '019bbdce-8407-793e-8532-3de81e0e8bb6', '2026-01-14T18:39:46.667548+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
