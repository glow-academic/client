...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019bebc4-d436-7cf0-9617-f44d4e7a6d71', '2026-01-17T17:57:40.647526+00:00', false, false, true, 'create_qualities', 'Create a new qualities resource', '{}', true, '{019bbf87-091f-754c-898b-d84a77ff7109,019bbf87-091f-741e-9750-ffa018c4a030}', '{019bbf87-096d-7363-8bfb-2816be51eddd,019bbf87-0965-723f-9fa6-99aaa445f4fc}', 'qualities', NULL) ON CONFLICT (id) DO NOTHING;
