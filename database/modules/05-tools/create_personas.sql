...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019bebc4-d436-7c46-a65d-2b9f3dc7776d', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_personas', 'Create a new personas resource', '{}', true, '{019bbf87-091e-7940-9825-c757e353ed6d}', '{019bbf87-0965-77e7-8ab0-e35555bc6b29}', 'personas', NULL) ON CONFLICT (id) DO NOTHING;
