...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019bebc4-d436-7ce4-83f1-2299dc3bbd35', '2026-01-17T17:57:40.647526+00:00', false, false, true, 'create_modalities', 'Create a new modalities resource', '{}', true, '{019bbf87-091f-757c-916a-3921398ab373,019bbf87-091f-741e-9750-ffa018c4a030}', '{019bbf87-0969-7b09-902c-3f48e2fbff16,019bbf87-0965-723f-9fa6-99aaa445f4fc}', 'modalities') ON CONFLICT (id) DO NOTHING;
