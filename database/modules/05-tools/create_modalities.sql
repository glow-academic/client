...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019bebc4-d436-7ce4-83f1-2299dc3bbd35', '2026-01-17T17:57:40.647526+00:00', false, false, true, 'create_modalities', 'Create a new modalities resource', '{}', true, '{019bbf87-091f-757c-916a-3921398ab373,019bbf87-091f-741e-9750-ffa018c4a030}', '{019bbf87-0969-7b09-902c-3f48e2fbff16,019bbf87-0965-723f-9fa6-99aaa445f4fc}', 'modalities', NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('019bbdce-8405-7075-a5fd-c72fc1d9d836', 'df188f80-b6c5-46bc-b945-df1a40318de5', true, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
