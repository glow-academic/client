...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019bebc4-d436-78e3-ae05-f12509f43557', '2026-01-17T17:57:40.542955+00:00', false, false, true, 'create_template', 'Create a dynamic document using a template. The template schema defines the required fields and their types. This tool accepts template-specific arguments based on the template schema.', '{}', true, '{019bbf87-091e-73a9-b24d-e7ab977a5273}', '{019bbf87-0964-77cd-ab26-d467f04ec130}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
