...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('0dde45ed-a56e-44e6-bbbc-ed4314a40558', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_auth_values', 'Create a new auth value setting', '{}', true, '{019bbf87-091e-78ff-aac4-e106cd6af4e1}', '{019bbf87-0965-751e-bf8d-1f0c7563f20b}', NULL) ON CONFLICT (id) DO NOTHING;
