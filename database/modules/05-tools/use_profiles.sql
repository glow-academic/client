...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c4f27-1780-7b67-ae67-f94f42caef57', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_profiles', 'Use an existing profile resource instead of creating a new one', '{}', false, '{019c4f27-1781-7589-8927-6eb5ddfb1472}', '{8eff5cb8-809f-486e-b3a5-9580f22a3934}', 'profiles', NULL) ON CONFLICT (id) DO NOTHING;
