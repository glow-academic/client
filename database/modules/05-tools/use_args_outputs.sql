...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('1faeefb9-77ee-4a64-9a35-55a9cba2c12c', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_args_outputs', 'Use an existing args output by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
