...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('1faeefb9-77ee-4a64-9a35-55a9cba2c12c', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_args_outputs', 'Use an existing args output by its ID', '{}', 'link', '{16bbeddb-ffcc-4ca9-8b78-7febd1fa5131}', '{7b814c3c-f9e5-4fdc-8955-27193d488106}', '{}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('a0c17ebd-38dd-47a2-a0be-cc60dd0b267f', '019c82b8-5d8c-7658-90e4-f00e30afd5ae', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('a0c17ebd-38dd-47a2-a0be-cc60dd0b267f', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('a0c17ebd-38dd-47a2-a0be-cc60dd0b267f', '019d0000-0001-7000-8000-000000000003', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('a0c17ebd-38dd-47a2-a0be-cc60dd0b267f', '019c82b8-5d8c-75cd-9631-3645ef73d41b', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
