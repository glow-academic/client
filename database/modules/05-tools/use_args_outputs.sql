...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('1faeefb9-77ee-4a64-9a35-55a9cba2c12c', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_args_outputs', 'Use an existing args output by its ID', '{}', false, '{16bbeddb-ffcc-4ca9-8b78-7febd1fa5131}', '{7b814c3c-f9e5-4fdc-8955-27193d488106}', NULL) ON CONFLICT (id) DO NOTHING;
