...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('eb52f323-b454-48c8-8385-69fad8f8388b', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_emails', 'Use an existing email by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
