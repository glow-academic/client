...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('eb52f323-b454-48c8-8385-69fad8f8388b', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_emails', 'Use an existing email by its ID', '{}', false, '{e1e8afa3-68fa-479c-afd8-7a087ec5ab2d}', '{0f859f29-a9b8-4266-8d9b-1f4a4f28bd41}', NULL) ON CONFLICT (id) DO NOTHING;
