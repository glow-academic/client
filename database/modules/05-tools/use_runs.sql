...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019c4f27-1783-7c26-b0a1-3103c94891b6', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_runs', 'Use an existing run resource instead of creating a new one', '{}', false, '{019bbf87-091f-76bc-b6e2-a34bca37f12d}', '{}', 'runs') ON CONFLICT (id) DO NOTHING;
