...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('019c4f27-177d-7066-8f89-2089560e5d4f', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_modalities', 'Use an existing modality resource instead of creating a new one', '{}', false, '{019c4f27-177f-7318-8e65-b129bfb42f86}', '{}') ON CONFLICT (id) DO NOTHING;
