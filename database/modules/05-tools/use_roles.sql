...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('4f07ae5c-a08c-4dee-a8f8-60f20dbf96e2', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_roles', 'Use an existing role by its ID', '{}', false, '{b92e7dbb-06f5-495d-b4e6-b9c5fbaf999a}', '{ef8befff-9306-453d-b960-fed06e2294f5}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
