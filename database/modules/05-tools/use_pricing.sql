...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('9eea4ffa-2482-498b-9651-1d8549da8b09', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_pricing', 'Use an existing pricing entry by its ID', '{}', false, '{958ce490-97b2-4ef1-99cf-f4f70042d5dd}', '{bf95d193-eb09-415d-b126-7affae495a6e}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('f91de42f-f451-4902-b241-a8492cf2e92f', 'df188f80-b6c5-46bc-b945-df1a40318de5', false, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
