...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('71082313-23e6-428e-a32f-86ea85aad6bb', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_scenario_time_limits', 'Create a scenario time limit', '{}', 'create', '{543d8ecf-24a6-42c1-a5bf-780934e4efeb}', '{bb1f8aab-759b-4ba9-9abf-4ccfe6f6ccc8}', '{scenario_time_limits}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('6856a90b-03b9-4dbf-b858-8877217ba428', '019c82b8-5d89-7844-9eb8-c00144d45f2b', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_resources_junction
INSERT INTO public.tool_resources_junction (tool_id, resources_id, active, created_at, generated, mcp) VALUES ('6856a90b-03b9-4dbf-b858-8877217ba428', '019c4f27-1788-77d1-80c2-d5f6a884ea5e', true, '2026-02-23T14:09:37.222956+00:00', false, false) ON CONFLICT (tool_id, resources_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('6856a90b-03b9-4dbf-b858-8877217ba428', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('6856a90b-03b9-4dbf-b858-8877217ba428', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('6856a90b-03b9-4dbf-b858-8877217ba428', '019c82b8-5d89-77bb-9b30-a944022e65d9', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
