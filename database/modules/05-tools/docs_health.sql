-- Module: docs_health
-- Category: tool
-- Description: docs_health MCP tool
-- ============================================================


-- Resource rows
INSERT INTO public.args_resource (id, name, description, field_type, required, default_value, created_at, active, generated, mcp) VALUES ('019521e4-0006-7000-8000-000000000001', 'entity_id', 'Optional health UUID for entity-specific documentation', 'string', false, '', '2026-02-24T01:53:57.278464+00:00', true, false, false) ON CONFLICT (id) DO NOTHING;
INSERT INTO public.names_resource (id, name, created_at, active, generated, mcp) VALUES ('019521e4-0035-7000-8000-000000000001', 'docs_health', '2026-02-24T01:53:57.278464+00:00', true, false, false) ON CONFLICT (id) DO NOTHING;
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019521e4-0025-7000-8000-000000000001', '2026-02-24T01:53:57.278464+00:00', false, false, true, 'docs_health', 'Get comprehensive health documentation including schema, permissions, API routing, and page metadata. Optionally provide an entity_id to include entity-specific context.', '{}', 'docs', '{019521e4-0006-7000-8000-000000000001}', '{}', '{}'::text[], '{}'::text[], '{health}'::text[]) ON CONFLICT (id) DO NOTHING;

-- Artifact
-- tool_artifact
INSERT INTO public.tool_artifact (id, created_at, updated_at, generated, mcp) VALUES ('019521e4-0015-7000-8000-000000000001', '2026-02-24T01:53:57.278464+00:00', '2026-02-24T01:53:57.278464+00:00', false, false) ON CONFLICT (id) DO NOTHING;
