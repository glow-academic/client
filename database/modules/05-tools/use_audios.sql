...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019c4f27-1771-7483-98db-9dc94290bd6f', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_audios', 'Use an existing audio resource instead of creating a new one', '{}', false, '{019c4f27-1772-72ea-ba7e-dae7eac3a314}', '{a0000515-0001-0000-0000-000000000001}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
