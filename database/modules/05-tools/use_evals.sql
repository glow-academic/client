...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('019c4f27-1776-7306-ba10-a21149cd2d02', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_evals', 'Use an existing eval resource instead of creating a new one', '{}', false, '{019bbf87-091f-7621-82c2-3fba8dc1a434}', '{}') ON CONFLICT (id) DO NOTHING;
