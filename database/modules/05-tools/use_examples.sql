...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019c06a8-2af5-747f-a440-a2a60dd205e1', '2026-01-28T22:10:10.283595+00:00', false, false, true, 'use_examples', 'Use an existing example resource instead of creating a new one', '{}', false, '{019c06a8-2afd-7507-b94b-e23a4f7629cb}', '{dda071e7-f216-436c-90ce-2ab8023e0322}', 'examples', NULL, NULL) ON CONFLICT (id) DO NOTHING;
