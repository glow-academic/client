...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c4f27-177b-7617-a58c-86ec6b464e38', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_groups', 'Use an existing group resource instead of creating a new one', '{}', false, '{019bbf87-091f-7642-aa72-3507ef41149c}', '{019bbf87-0966-7aee-96c7-e5f169218818}', 'groups', NULL) ON CONFLICT (id) DO NOTHING;
