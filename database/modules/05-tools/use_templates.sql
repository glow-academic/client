...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c0a2d-fc36-7d3c-ac2c-a2108a6c55de', '2026-01-29T14:35:11.795021+00:00', false, false, true, 'use_templates', 'Use an existing template resource instead of creating a new one', '{}', false, '{019bbf87-091e-7cb7-91f8-df30e243b6e4}', '{4ab492c3-52b5-4cd3-940c-06611d307d23,019bbf87-0966-7df6-bc74-45c69b1d866f}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
