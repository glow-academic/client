...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019bebc4-d436-7cbe-a7bf-4b364674f3e0', '2026-01-17T17:57:40.632192+00:00', false, false, true, 'create_request_limits', 'Create a new request limit resource', '{}', true, '{019bbf87-091f-73d5-a8ad-732972c98ac4}', '{019bbf87-096b-7282-bdf7-f2c69c7c928c}', 'request_limits') ON CONFLICT (id) DO NOTHING;
