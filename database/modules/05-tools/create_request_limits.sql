...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019bebc4-d436-7cbe-a7bf-4b364674f3e0', '2026-01-17T17:57:40.632192+00:00', false, false, true, 'create_request_limits', 'Create a new request limit resource', '{}', true, '{019bbf87-091f-73d5-a8ad-732972c98ac4}', '{019bbf87-096b-7282-bdf7-f2c69c7c928c}', 'request_limits', NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_resources_junction (tool_id, resource_id, active, created_at, generated, mcp) VALUES ('019bb553-e74c-7cb6-8868-d9bace1610dd', '019bbeb4-5113-7921-8e56-c68491eeb0ff', true, '2026-01-13T03:08:53.448220+00:00', false, false) ON CONFLICT (tool_id, resource_id) DO NOTHING;
-- tool_flags_junction
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('019bb553-e74c-7cb6-8868-d9bace1610dd', 'df188f80-b6c5-46bc-b945-df1a40318de5', true, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
