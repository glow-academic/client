...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019523a0-0020-7000-8000-000000000002', '2026-02-24T13:16:34.035984+00:00', false, false, true, 'get_simulation', 'Re-fetch simulation configuration context with fresh data.', '{}', false, '{019524a0-0001-7000-8000-000000000010,019524a0-0001-7000-8000-000000000011}', '{}', NULL, NULL, 'simulation') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_artifacts_junction (tool_id, artifact_id, active, generated, mcp, created_at) VALUES ('019523a0-0010-7000-8000-000000000002', '019c8d5a-6426-7bac-94b4-cfe788bd85b7', true, false, false, '2026-02-24T13:16:34.035984+00:00') ON CONFLICT (tool_id, artifact_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, name_id, created_at, generated, mcp, active) VALUES ('019523a0-0010-7000-8000-000000000002', '019523a0-0030-7000-8000-000000000002', '2026-02-24T13:16:34.035984+00:00', false, false, true) ON CONFLICT (tool_id, name_id) DO NOTHING;
-- tool_tools_junction
