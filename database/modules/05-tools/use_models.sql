...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c4f27-177f-7762-8c20-a2210565a69b', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_models', 'Use an existing model resource instead of creating a new one', '{}', false, '{019c4f27-1780-7818-b7e2-5022488af925}', '{a0000515-0006-0000-0000-000000000001}', 'models', NULL) ON CONFLICT (id) DO NOTHING;
