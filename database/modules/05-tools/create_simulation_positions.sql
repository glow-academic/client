...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019bebc4-d436-7d28-8f22-23d852477486', '2026-01-19T21:43:11.312843+00:00', false, false, true, 'create_simulation_positions', 'Create a new simulation position resource to set ordering of simulations within cohorts', '{}', 'create', '{019bbf87-091f-781f-adab-974beb4f0386,019bbf87-091e-78ff-aac4-e106cd6af4e1}', '{019bbf87-0965-751e-bf8d-1f0c7563f20b,019bbf87-096b-74ae-a967-e642fef0a546,019c48f6-4a52-73c5-9e33-08bdb39628b8}', '{simulation_positions}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('019bd836-3ae3-71a0-990d-b5c0fa015cd0', '019bd836-3ae4-7267-af9c-380b1cebb553', '2026-01-19T21:43:11.312843+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_resources_junction
INSERT INTO public.tool_resources_junction (tool_id, resources_id, active, created_at, generated, mcp) VALUES ('019bd836-3ae3-71a0-990d-b5c0fa015cd0', '019bd836-3ae2-703b-9d67-f64fab2b69d0', true, '2026-01-19T21:43:11.312843+00:00', false, false) ON CONFLICT (tool_id, resources_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('019bd836-3ae3-71a0-990d-b5c0fa015cd0', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-01-19T21:43:11.312843+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('019bd836-3ae3-71a0-990d-b5c0fa015cd0', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('019bd836-3ae3-71a0-990d-b5c0fa015cd0', '019bd836-3ae3-73c8-901f-24564dff13a4', '2026-01-19T21:43:11.312843+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
