...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019c4f27-1784-7c83-a971-06d5405753dd', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_temperature_levels', 'Use an existing temperature level resource instead of creating a new one', '{}', false, '{019bbf87-091f-748d-877c-acad536b0f97}', '{}', 'temperature_levels') ON CONFLICT (id) DO NOTHING;
