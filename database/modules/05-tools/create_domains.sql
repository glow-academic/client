...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('63fedfa6-778e-45e6-adc4-e7d5469ccd75', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_domains', 'Create a new domain binding', '{}', true, '{3cd1fed8-bd05-4de7-a17c-bd1417e20310}', '{a76929e0-1b9d-4cea-8e9a-9036eeb1b400}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('9a4a6f93-e3b2-40fb-9058-1fc1c823ce5b', 'df188f80-b6c5-46bc-b945-df1a40318de5', true, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
