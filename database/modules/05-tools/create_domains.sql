...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('63fedfa6-778e-45e6-adc4-e7d5469ccd75', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_domains', 'Create a new domain binding', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
