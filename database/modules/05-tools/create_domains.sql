...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('63fedfa6-778e-45e6-adc4-e7d5469ccd75', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_domains', 'Create a new domain binding', '{}', true, '{3cd1fed8-bd05-4de7-a17c-bd1417e20310}', '{a76929e0-1b9d-4cea-8e9a-9036eeb1b400}', NULL) ON CONFLICT (id) DO NOTHING;
