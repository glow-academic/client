...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('018a62dc-6b3d-4b5f-95a1-e9809a17efd3', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_auth_item_keys', 'Create a new auth item key', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
