...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('018a62dc-6b3d-4b5f-95a1-e9809a17efd3', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_auth_item_keys', 'Create a new auth item key', '{}', true, '{998763c1-8fe5-4422-81ba-59eb8bb46192}', '{e0814298-ee37-4ea9-ac03-a9490357fe3b}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
