...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('99022425-d75d-40f1-9886-cba63505a99e', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_endpoints', 'Use an existing endpoint by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
