...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('99022425-d75d-40f1-9886-cba63505a99e', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_endpoints', 'Use an existing endpoint by its ID', '{}', false, '{c4416a36-58e3-429a-810d-3a2c5a45d955}', '{065c41fe-713c-465e-b8ea-0bb5c5063314}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
