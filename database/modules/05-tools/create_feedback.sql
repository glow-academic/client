...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019bebc4-d436-7ba4-963e-758c7971447d', '2026-01-17T17:58:56.053417+00:00', false, false, true, 'create_feedback', 'Create a grade for the conversation on a specific standard group. Score should be an integer from 1-5 based on the rubric criteria. Provide brief feedback explaining the score with specific examples.', '{}', 'create', '{019c16d8-a123-7f0c-8e49-144fd344a1e3,019c16d8-a123-7f65-ace0-006c414bed9c,019c16d8-a123-7f93-b0ed-eccc63b7067c}', '{019c24ff-49ec-7d9d-94b3-4935c374ee23,019c24ff-49ed-72ca-b5bf-2e3e55e3844d,019c24ff-49ed-752a-b110-0827ea43d37c}', '{}'::text[], '{feedbacks}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_entries_junction (tool_id, entries_id, active, created_at, generated, mcp) VALUES ('019c16d8-a126-715d-9699-0140b7afddad', 'a0647fd3-bedd-4e72-8d96-4c7e76e9e602', true, '2026-02-19T14:14:23.735542+00:00', false, false) ON CONFLICT (tool_id, entries_id) DO NOTHING;
-- tool_descriptions_junction
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('019c16d8-a126-715d-9699-0140b7afddad', '019c16d8-a126-7433-8d42-692180a7ea4a', '2026-02-01T01:37:01.720364+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('019c16d8-a126-715d-9699-0140b7afddad', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-02-01T01:37:01.720364+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('019c16d8-a126-715d-9699-0140b7afddad', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('019c16d8-a126-715d-9699-0140b7afddad', '019bbabc-5a2e-79b9-85e5-ef4376a017e1', '2026-02-01T01:37:01.720364+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
