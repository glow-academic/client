...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019bebc4-d436-7ba4-963e-758c7971447d', '2026-01-17T17:58:56.053417+00:00', false, false, true, 'create_feedback', 'Create a grade for the conversation on a specific standard group. Score should be an integer from 1-5 based on the rubric criteria. Provide brief feedback explaining the score with specific examples.', '{}', true, '{019c16d8-a123-7f0c-8e49-144fd344a1e3,019c16d8-a123-7f65-ace0-006c414bed9c,019c16d8-a123-7f93-b0ed-eccc63b7067c}', '{019c24ff-49ec-7d9d-94b3-4935c374ee23,019c24ff-49ed-72ca-b5bf-2e3e55e3844d,019c24ff-49ed-752a-b110-0827ea43d37c}', NULL) ON CONFLICT (id) DO NOTHING;
