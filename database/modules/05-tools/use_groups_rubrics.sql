...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('eb7d2884-cc40-4d92-bed8-b23f604c0f0c', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_groups_rubrics', 'Use an existing group-rubric binding by its ID', '{}', false, '{626de89a-072f-4bb4-87b3-8176f3165870}', '{bbe4a7c6-1414-42f7-904d-d9e83d72f32d}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('42fa4cc2-348b-435c-a5b2-fb2d045af785', 'df188f80-b6c5-46bc-b945-df1a40318de5', false, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
