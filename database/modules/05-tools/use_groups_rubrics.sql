...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('eb7d2884-cc40-4d92-bed8-b23f604c0f0c', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_groups_rubrics', 'Use an existing group-rubric binding by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
