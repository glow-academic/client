...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019bebc4-d436-7be1-9553-b722c5a74848', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_auth', 'Create a new auth resource', '{}', true, '{019bbf87-091f-7106-807a-8c15887af9be,019bbf87-091f-70e7-bb38-3aec3e65c691,019bbf87-091f-7127-8a0f-e0ff158f148f}', '{}', 'auths') ON CONFLICT (id) DO NOTHING;
