...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('e234b7b3-fd49-4179-9a96-ea5c355bf919', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_standards', 'Use an existing standard by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
