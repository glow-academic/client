...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable) VALUES ('019c4f27-1782-706e-bc20-dc534c81ebda', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_qualities', 'Use an existing quality resource instead of creating a new one', '{}', false) ON CONFLICT (id) DO NOTHING;
