...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019c4f27-1782-706e-bc20-dc534c81ebda', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_qualities', 'Use an existing quality resource instead of creating a new one', '{}', false, '{019c4f27-1782-74f3-923b-6563265324d3}', '{a0000515-0007-0000-0000-000000000001}', 'qualities', NULL, NULL) ON CONFLICT (id) DO NOTHING;
