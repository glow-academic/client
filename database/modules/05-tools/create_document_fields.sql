...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019bf207-ca51-72c1-b1ca-e06fd2334952', '2026-01-24T22:02:35.441799+00:00', false, false, true, 'create_document_fields', 'Create a document field resource for linking document-type parameter fields to scenarios', '{}', true, '{}', '{}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
