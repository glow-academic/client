...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('b8d2fd18-ee1b-4564-b6f4-bbac30a9cbfc', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_prompts', 'Use an existing prompt by its ID', '{}', false, '{9fa45ea4-efee-41b0-85e6-52e7a3ff3e4d}', '{f8453079-705d-4b16-9c03-2b15fcdd4a02}', NULL) ON CONFLICT (id) DO NOTHING;
