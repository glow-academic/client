...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('b8d2fd18-ee1b-4564-b6f4-bbac30a9cbfc', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_prompts', 'Use an existing prompt by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
