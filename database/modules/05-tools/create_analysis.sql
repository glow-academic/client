...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019bebc4-d436-7bbb-bd65-5f158fd12e4d', '2026-01-17T17:58:56.053417+00:00', false, false, true, 'create_analysis', 'Create an analysis of audio messages from the conversation. Specify which messages (by their numbers in the conversation history) you want to analyze and what aspects you want to evaluate.', '{}', true, '{019c16d8-a123-7fb0-9fdb-a7ad98e9ee96,019c16d8-a123-7fd8-8a2d-9bc685609689}', '{019c24ff-49ef-7df9-a09c-cb548d564fff,019c24ff-49ef-7f77-bea7-67c82142ea36}', NULL, 'analyses', NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_bindings_junction (tool_id, binding_id, active, created_at, generated, mcp) VALUES ('019c16d8-a126-7a29-8df7-fe06f8483301', 'e70170b4-4d36-4061-9de6-8d622725236f', true, '2026-02-19T14:14:23.735785+00:00', false, false) ON CONFLICT (tool_id, binding_id) DO NOTHING;
