...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('019bebc4-d436-7bd2-b670-e4c1b24b1a9c', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_options', 'Create options for questions. Options can be reused across multiple questions.', '{}', false, '{019bbf87-091e-77b5-92b4-feb05ac43179,019bbf87-091e-7799-8255-23920ae8e5d4}', '{019bbf87-0969-730a-a621-2bf047d7f1ac,019bbf87-0969-73a6-b096-1b124b50944a}') ON CONFLICT (id) DO NOTHING;
