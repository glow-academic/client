...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019bebc4-d436-7bd2-b670-e4c1b24b1a9c', '2026-01-13T23:48:20.098044+00:00', false, false, true, 'create_options', 'Create options for questions. Options can be reused across multiple questions.', '{}', true, '{019bbf87-091e-77b5-92b4-feb05ac43179,019bbf87-091e-7799-8255-23920ae8e5d4}', '{019bbf87-0969-730a-a621-2bf047d7f1ac,019bbf87-0969-73a6-b096-1b124b50944a}', 'options', NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('019b914c-a3ea-713a-887e-99bcbfb9559a', 'df188f80-b6c5-46bc-b945-df1a40318de5', true, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
