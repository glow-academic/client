...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('451a9536-b994-47ab-8663-1a7757735505', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_group_positions', 'Use an existing group position by its ID', '{}', false, '{69c8f9fe-eb30-461a-bc68-890dfc16d1bc}', '{5e0a68b8-05e8-4046-a91c-36047ae8ed9b}', NULL) ON CONFLICT (id) DO NOTHING;
