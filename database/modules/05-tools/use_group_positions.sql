...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('451a9536-b994-47ab-8663-1a7757735505', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_group_positions', 'Use an existing group position by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
