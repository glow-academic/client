...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019522a0-0020-7000-8000-000000000009', '2026-02-24T11:27:01.778199+00:00', false, false, true, 'get_group', 'Re-fetch group analytics context with fresh data.', '{}', false, '{}', '{}', NULL, NULL, 'group') ON CONFLICT (id) DO NOTHING;
