...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019c0a2d-fc36-7e78-9083-05afa0c8e4d8', '2026-01-29T14:35:11.795021+00:00', false, false, true, 'use_videos', 'Use an existing video resource instead of creating a new one', '{}', false, '{019c0a2d-fc3b-7f40-aa9e-df41c3b68717}', '{e4789a8b-5de9-4f7b-99cf-cc1c9ec96d32}', 'videos') ON CONFLICT (id) DO NOTHING;
