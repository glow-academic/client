...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('019c0a2d-fc36-7e78-9083-05afa0c8e4d8', '2026-01-29T14:35:11.795021+00:00', false, false, true, 'use_videos', 'Use an existing video resource instead of creating a new one', '{}', false, '{019c0a2d-fc3b-7f40-aa9e-df41c3b68717}', '{e4789a8b-5de9-4f7b-99cf-cc1c9ec96d32}', 'videos', NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_domains_junction (tool_id, domain_id, active, created_at, generated, mcp) VALUES ('019c0a2d-fc3b-7066-913e-5aaf3fa11bd9', '019bbeb4-5117-741b-aa3c-9c953d7554f9', true, '2026-02-12T01:05:03.953545+00:00', false, false) ON CONFLICT (tool_id, domain_id) DO NOTHING;
-- tool_flags_junction
