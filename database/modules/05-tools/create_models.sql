...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019bebc4-d436-7c2e-af8f-40ed4aa3edaf', '2026-01-17T17:57:40.643852+00:00', false, false, true, 'create_models', 'Create a new models resource', '{}', true, '{019bbf87-091e-7940-9825-c757e353ed6d,019bbf87-091e-78ff-aac4-e106cd6af4e1}', '{019bbf87-0965-77e7-8ab0-e35555bc6b29,019bbf87-0965-751e-bf8d-1f0c7563f20b}', 'models') ON CONFLICT (id) DO NOTHING;
