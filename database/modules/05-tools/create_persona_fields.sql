...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019bf207-ca4b-7fcd-8c58-15d372105878', '2026-01-24T22:02:35.441799+00:00', false, false, true, 'create_persona_fields', 'Create a persona field resource for linking persona-type parameter fields to scenarios', '{}', true, '{}', '{}', NULL) ON CONFLICT (id) DO NOTHING;
