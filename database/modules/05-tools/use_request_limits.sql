...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('611f8ec9-1863-402d-8c7a-88329f5721bb', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_request_limits', 'Use an existing request limit by its ID', '{}', false, '{fcfa0aec-a9a8-484e-bcb2-d3fcbe851fba}', '{f48e6687-8360-4bc0-ba1e-064738901dc6}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('8c851e97-fd25-4d48-94cb-c28f353d2703', 'df188f80-b6c5-46bc-b945-df1a40318de5', false, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
