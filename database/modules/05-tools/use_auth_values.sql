...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('e149e3fe-bd77-4b58-b15f-d796c1dee9e1', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_auth_values', 'Use an existing auth value by its ID', '{}', false, '{8d791c32-d854-4ab9-b690-a62e75fb699f}', '{74695e49-c809-404c-b08c-edb5943ba550}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_flags_junction (tool_id, flag_id, value, created_at, generated, mcp, active) VALUES ('77c54043-a722-48a1-a7b7-9695621fa4a5', 'df188f80-b6c5-46bc-b945-df1a40318de5', false, '2026-02-22T12:36:03.817884+00:00', false, false, true) ON CONFLICT (tool_id, flag_id) DO NOTHING;
-- tool_names_junction
