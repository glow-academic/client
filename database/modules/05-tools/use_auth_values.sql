...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('e149e3fe-bd77-4b58-b15f-d796c1dee9e1', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_auth_values', 'Use an existing auth value by its ID', '{}', false, '{8d791c32-d854-4ab9-b690-a62e75fb699f}', '{74695e49-c809-404c-b08c-edb5943ba550}', NULL) ON CONFLICT (id) DO NOTHING;
