...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('e149e3fe-bd77-4b58-b15f-d796c1dee9e1', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_auth_values', 'Use an existing auth value by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
