...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable) VALUES ('019c4f61-51df-7230-a045-e517cb1c9127', '2026-02-12T01:05:03.953545+00:00', false, false, true, 'create_arg_positions', 'Create arg position records for tool args', '{}', true) ON CONFLICT (id) DO NOTHING;
