...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry, artifact) VALUES ('093e0e28-1bd1-49a3-8464-c6322ddac802', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_runs_rubrics', 'Create a run-rubric binding', '{}', true, '{019bbf87-091f-731c-a2f6-8ffc74d94378,019bbf87-091f-76bc-b6e2-a34bca37f12d}', '{019bbf87-0966-7034-9f1e-9aa5955a38aa,019bbf87-0967-72eb-9d83-366f75833a50}', NULL, NULL, NULL) ON CONFLICT (id) DO NOTHING;
