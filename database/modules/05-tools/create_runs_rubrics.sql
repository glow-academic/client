...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('093e0e28-1bd1-49a3-8464-c6322ddac802', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_runs_rubrics', 'Create a run-rubric binding', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
