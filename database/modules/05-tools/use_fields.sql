...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('019c4f27-1778-7a54-b3bb-1574ff2c0357', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_fields', 'Use an existing field resource instead of creating a new one', '{}', false, '{019c4f27-1779-7eb3-a4bc-57320ecfad6b}', '{}', 'fields') ON CONFLICT (id) DO NOTHING;
