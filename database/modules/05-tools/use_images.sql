...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('019c0a2d-fc36-770a-b18d-af61cdf0f908', '2026-01-29T14:35:11.795021+00:00', false, false, true, 'use_images', 'Use an existing image resource instead of creating a new one', '{}', false, '{019c0a2d-fc3b-7e9a-b0a1-485413199ea7}', '{513fb867-9ca5-4f33-a4dc-c071f1090d4e}') ON CONFLICT (id) DO NOTHING;
