...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('019bebc4-d436-7c96-b29a-80cc1f4d73b1', '2026-01-17T17:57:40.627996+00:00', false, false, true, 'create_protocols', 'Create a new protocol', '{}', 'create', '{019bbf87-091e-78ff-aac4-e106cd6af4e1}', '{019bbf87-0965-751e-bf8d-1f0c7563f20b}', '{protocols}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('019ba034-3316-767a-a5de-ba418c62676c', '019bbabc-5a32-734a-8e28-618edc0c51e2', '2026-01-09T00:42:14.163715+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_resources_junction
INSERT INTO public.tool_resources_junction (tool_id, resources_id, active, created_at, generated, mcp) VALUES ('019ba034-3316-767a-a5de-ba418c62676c', '019bbeb4-5112-7eee-9fad-3bd63f172a5c', true, '2026-01-09T00:42:14.163715+00:00', false, false) ON CONFLICT (tool_id, resources_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('019ba034-3316-767a-a5de-ba418c62676c', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-01-09T00:42:14.163715+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('019ba034-3316-767a-a5de-ba418c62676c', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('019ba034-3316-767a-a5de-ba418c62676c', '019bbabc-5a32-72b5-803c-5115bb8e3496', '2026-01-09T00:42:14.163715+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
