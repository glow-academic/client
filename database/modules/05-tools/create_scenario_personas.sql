...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('9a1122c5-f078-4eae-ae6a-1ce90068d8f2', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_scenario_personas', 'Create a scenario-persona binding', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
