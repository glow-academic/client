...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('209cfad1-69b5-40be-a980-406888376306', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_voices', 'Use an existing voice by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
