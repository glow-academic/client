...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c4f27-1758-7c66-af1b-4c6c05170ccb', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_agents', 'Use an existing agent resource instead of creating a new one', '{}', false, '{019bbf87-091f-7363-a53b-59c0c5d9656b}', '{}', 'agents', NULL) ON CONFLICT (id) DO NOTHING;
