...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c4f27-1758-7c66-af1b-4c6c05170ccb', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_agents', 'Use an existing agent resource instead of creating a new one', '{}', false, '{019bbf87-091f-7363-a53b-59c0c5d9656b}', '{019bbf87-0966-7185-b960-c6c580ea7096}', 'agents', NULL) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_domains_junction (tool_id, domain_id, active, created_at, generated, mcp) VALUES ('019c4f27-1759-7168-8b7d-783e21c0946f', '019bbeb4-5109-7671-b1cc-ed9a018d7c13', true, '2026-02-12T00:01:27.881501+00:00', false, false) ON CONFLICT (tool_id, domain_id) DO NOTHING;
-- tool_flags_junction
