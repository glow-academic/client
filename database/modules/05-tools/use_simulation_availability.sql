...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids) VALUES ('35d3af95-db6a-430b-bc78-2fd51c5ff45c', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'use_simulation_availability', 'Use an existing simulation availability by its ID', '{}', false, '{}', '{}') ON CONFLICT (id) DO NOTHING;
