...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource, entry) VALUES ('019c4f27-1773-786b-bdec-19c9c969bde5', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_auths', 'Use an existing auth resource instead of creating a new one', '{}', false, '{019c4f27-1773-7e98-80e4-c94c03867ee0}', '{}', 'auths', NULL) ON CONFLICT (id) DO NOTHING;
