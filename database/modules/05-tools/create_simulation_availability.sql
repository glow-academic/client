...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable, args_ids, args_output_ids, resource) VALUES ('eebab06c-460f-45d8-94ca-64cfa9d7e20c', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_simulation_availability', 'Create a simulation availability setting', '{}', true, '{}', '{}', 'simulation_availability') ON CONFLICT (id) DO NOTHING;
