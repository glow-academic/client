...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, operation, args_ids, args_output_ids, resources, entries, artifacts) VALUES ('eebab06c-460f-45d8-94ca-64cfa9d7e20c', '2026-02-21T22:16:39.608062+00:00', false, false, true, 'create_simulation_availability', 'Create a simulation availability setting', '{}', 'create', '{a8be5da6-d2f0-4c53-98b6-bab0b076c974}', '{5f423266-490c-41dc-9bfd-aa68ac37887e}', '{simulation_availability}'::text[], '{}'::text[], '{}'::text[]) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.tool_descriptions_junction (tool_id, descriptions_id, created_at, generated, mcp, active) VALUES ('f595ec06-41a3-49d8-8999-b6ee39034ba4', '019c82b8-5d88-7be6-b02f-4e60fb234c81', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, descriptions_id) DO NOTHING;
-- tool_resources_junction
INSERT INTO public.tool_resources_junction (tool_id, resources_id, active, created_at, generated, mcp) VALUES ('f595ec06-41a3-49d8-8999-b6ee39034ba4', '9f42547f-1e25-49ba-97dc-8b85e1398666', true, '2026-02-23T14:09:37.222956+00:00', false, false) ON CONFLICT (tool_id, resources_id) DO NOTHING;
-- tool_flags_junction
INSERT INTO public.tool_flags_junction (tool_id, flags_id, created_at, generated, mcp, active) VALUES ('f595ec06-41a3-49d8-8999-b6ee39034ba4', '019be334-bfc6-74fb-be11-ea6b522945bb', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, flags_id) DO NOTHING;
-- tool_operations_junction
INSERT INTO public.tool_operations_junction (tool_id, operations_id, created_at, active, generated, mcp) VALUES ('f595ec06-41a3-49d8-8999-b6ee39034ba4', '019d0000-0001-7000-8000-000000000002', '2026-02-27T00:00:00.000000+00:00', true, false, false) ON CONFLICT (tool_id, operations_id) DO NOTHING;
-- tool_names_junction
INSERT INTO public.tool_names_junction (tool_id, names_id, created_at, generated, mcp, active) VALUES ('f595ec06-41a3-49d8-8999-b6ee39034ba4', '019c82b8-5d88-7b4e-b8a4-592b8ba9e236', '2026-02-22T00:20:46.593734+00:00', false, false, true) ON CONFLICT (tool_id, names_id) DO NOTHING;
-- tool_tools_junction
