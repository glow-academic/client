...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable) VALUES ('019c4f27-1782-77f6-8e39-d193b8240237', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_reasoning_levels', 'Use an existing reasoning level resource instead of creating a new one', '{}', false) ON CONFLICT (id) DO NOTHING;
