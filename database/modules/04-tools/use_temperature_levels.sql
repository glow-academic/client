...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable) VALUES ('019c4f27-1784-7c83-a971-06d5405753dd', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_temperature_levels', 'Use an existing temperature level resource instead of creating a new one', '{}', false) ON CONFLICT (id) DO NOTHING;
