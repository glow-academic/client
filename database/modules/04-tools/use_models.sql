...
INSERT INTO public.tools_resource (id, created_at, generated, mcp, active, name, description, department_ids, createable) VALUES ('019c4f27-177f-7762-8c20-a2210565a69b', '2026-02-12T00:01:27.881501+00:00', false, false, true, 'use_models', 'Use an existing model resource instead of creating a new one', '{}', false) ON CONFLICT (id) DO NOTHING;
