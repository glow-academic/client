...
INSERT INTO public.documents_resource (created_at, active, generated, mcp, id, name, description, department_ids, upload_id, text_id, image_ids) VALUES ('2025-12-06T02:59:23.893847+00:00', true, false, false, '019bb25e-e619-782f-8894-e5d20003dbee', 'Policy Template', 'Template document for policy', '{}', NULL, '258ee632-aa7a-4fb5-b9a8-fd4a4635f283', '{}') ON CONFLICT (id) DO NOTHING;
