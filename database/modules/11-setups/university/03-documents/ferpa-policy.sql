...
INSERT INTO public.documents_resource (created_at, active, generated, mcp, id, name, description, department_ids, upload_id, text_id, image_ids) VALUES ('2025-12-12T13:44:32.428979+00:00', true, false, false, '019bb25e-e619-7831-a70a-a7fb065a1999', 'FERPA Policy', 'Family Educational Rights and Privacy Act (FERPA) policy document', '{}', '019bcc94-efb5-7ac7-a390-938a31051739', NULL, '{}') ON CONFLICT (id) DO NOTHING;
