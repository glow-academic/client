...
INSERT INTO public.documents_resource (created_at, active, generated, mcp, id, name, description, department_ids, upload_id, text_id, image_ids) VALUES ('2025-12-12T13:44:32.428979+00:00', true, false, false, '019bb25e-e619-7834-9cb3-66671ca36a7d', 'Academic Integrity Policy', 'Academic integrity and honor code policy document', '{}', '019bcc94-efb5-7af4-a7d9-558119025039', NULL, '{}') ON CONFLICT (id) DO NOTHING;
