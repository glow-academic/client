...
INSERT INTO public.documents_resource (created_at, active, generated, mcp, id, name, description, department_ids, upload_id, text_id, html, image_ids) VALUES ('2025-12-06T02:59:23.893847+00:00', true, false, false, '019bb25e-e619-781f-9283-8bae433caa45', 'Midterm Template', 'Template document for midterm', '{}', NULL, '019c29d6-005c-7205-8dea-be2ddf4258ef', true, '{}') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.document_texts_junction (document_id, texts_id, active, created_at) VALUES ('019b3be4-324b-73ee-afba-5103618244d8', '019c29d6-005c-7205-8dea-be2ddf4258ef', true, '2026-02-13T20:01:39.050938+00:00') ON CONFLICT (document_id, texts_id) DO NOTHING;
