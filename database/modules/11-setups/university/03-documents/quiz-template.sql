...
INSERT INTO public.documents_resource (created_at, active, generated, mcp, id, name, description, department_ids, upload_id, text_id, image_ids) VALUES ('2025-12-06T02:59:23.893847+00:00', true, false, false, '019bb25e-e619-781b-8652-f6e38264e233', 'Quiz Template', 'Template document for quiz', '{}', NULL, '019c29d6-005c-714c-81db-6998e1e7ef95', '{}') ON CONFLICT (id) DO NOTHING;
