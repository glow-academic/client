-- Module: Passive Scenario
-- Category: scenario
-- Description: Passive Scenario scenario
-- ============================================================
...
INSERT INTO public.scenarios_resource (created_at, active, generated, mcp, id, name, description, is_root, problem_statement_enabled, objectives_enabled, video_enabled, images_enabled, questions_enabled, department_ids, persona_ids, parameter_ids, parent_id) VALUES ('2025-08-12T12:52:09.879666+00:00', true, false, false, '019bb25e-e61d-7f2b-90fe-0ddfddd5d737', 'Passive Scenario', 'Practice scenario featuring a passive or hesitant student persona.', true, true, true, false, false, false, '{}', '{019bb25e-e60c-734d-ac5b-d849214dd5ac}', '{}', '019bb25e-e61d-7f2b-90fe-0ddfddd5d737') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.scenario_parameters_junction (active, created_at, parameter_id, scenario_id, generated, mcp, type) VALUES (true, '2025-12-07T20:44:58.167108+00:00', '019bb25e-e621-700f-b494-72649843abfc', '019b3be4-3c3a-78e8-bf18-b56c48c37352', false, false, 'direct') ON CONFLICT (scenario_id, parameter_id) DO NOTHING;
INSERT INTO public.scenario_parameters_junction (active, created_at, parameter_id, scenario_id, generated, mcp, type) VALUES (true, '2025-12-07T20:44:58.167108+00:00', '019bb25e-e621-7023-a8a1-e0f52a01224d', '019b3be4-3c3a-78e8-bf18-b56c48c37352', false, false, 'direct') ON CONFLICT (scenario_id, parameter_id) DO NOTHING;
INSERT INTO public.scenario_parameters_junction (active, created_at, parameter_id, scenario_id, generated, mcp, type) VALUES (true, '2025-12-07T20:44:58.167108+00:00', '019bb25e-e621-7014-938e-88976a9c0f43', '019b3be4-3c3a-78e8-bf18-b56c48c37352', false, false, 'direct') ON CONFLICT (scenario_id, parameter_id) DO NOTHING;
INSERT INTO public.scenario_parameters_junction (active, created_at, parameter_id, scenario_id, generated, mcp, type) VALUES (true, '2025-12-07T20:44:58.167108+00:00', '019bb25e-e621-701f-86f5-ee5cdc68a584', '019b3be4-3c3a-78e8-bf18-b56c48c37352', false, false, 'direct') ON CONFLICT (scenario_id, parameter_id) DO NOTHING;
