...
INSERT INTO public.scenarios_resource (created_at, active, generated, mcp, id, name, description, is_root, problem_statement_enabled, objectives_enabled, video_enabled, images_enabled, questions_enabled, department_ids, persona_ids, parameter_ids, parent_id) VALUES ('2025-08-12T12:52:09.879666+00:00', true, false, false, '019bb25e-e61d-7efa-8819-7dcb0cf829f8', 'General Scenario', 'General purpose scenario for flexible practice across various situations.', true, true, true, false, true, false, '{}', '{}', '{}', '019bb25e-e61d-7efa-8819-7dcb0cf829f8') ON CONFLICT (id) DO NOTHING;
