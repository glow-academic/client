...
INSERT INTO public.scenarios_resource (created_at, active, generated, mcp, id, name, description, is_root, problem_statement_enabled, objectives_enabled, video_enabled, images_enabled, questions_enabled, department_ids, persona_ids, parameter_ids, parent_id) VALUES ('2025-08-12T12:52:09.879666+00:00', true, false, false, '019bb25e-e61d-7f22-b0ce-2f8bd6f51c97', 'Happy Scenario', 'Practice scenario featuring a cheerful and positive student persona.', true, true, true, false, false, false, '{}', '{019bb25e-e60c-72c3-8812-953686ef2201}', '{}', '019bb25e-e61d-7f22-b0ce-2f8bd6f51c97') ON CONFLICT (id) DO NOTHING;
