...
-- Resource rows
INSERT INTO public.cohorts_resource (created_at, active, generated, mcp, id, name, description, department_ids, simulation_ids, profile_ids, profile_persona_ids, simulation_position_ids, simulation_availability_ids) VALUES ('2026-02-02T20:23:35.540414+00:00', true, false, false, '019bb25e-e605-7500-8000-000000000001', 'Practice Cohort', '', '{}', '{019bb25e-e62c-78a4-a556-64cb01be3d92,019bb25e-e62c-789f-add0-0e4d307e952c,019bb25e-e62c-7899-81e2-c49cae2dbc50,019bb25e-e62c-78ae-9b5d-fa21cbd364d4,019bb25e-e62c-78b0-9cc1-39f25f8db3ef,019bb25e-e62c-7894-b18e-ddd3518cec67}', '{}', '{}', '{}', '{}') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.cohort_cohorts_junction (cohort_id, cohorts_id, active, created_at, generated, mcp) VALUES ('019b3be4-3243-7690-8000-000000000001', '019bb25e-e605-7500-8000-000000000001', true, '2026-02-02T20:23:35.540414+00:00', false, false) ON CONFLICT (cohort_id, cohorts_id) DO NOTHING;
