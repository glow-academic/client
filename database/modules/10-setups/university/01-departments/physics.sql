...
-- Resource rows
INSERT INTO public.departments_resource (created_at, active, generated, mcp, id, group_id, name, description, department_ids, setting_ids) VALUES ('2025-10-31T16:50:58.307484+00:00', true, false, false, '019bb25e-e624-745f-85ac-d4c79657d7e1', '019ba0cd-761c-7b67-8336-2cb0a8ea3874', 'Physics', 'PHYS', '{}', '{}') ON CONFLICT (id) DO NOTHING;
