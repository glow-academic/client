...
INSERT INTO public.settings_resource (created_at, active, generated, mcp, id, name, description, department_ids, agent_ids, provider_key_ids, auth_ids) VALUES ('2025-12-12T13:26:55.664826+00:00', true, false, false, '019bb25e-e615-7963-be87-7904de26729c', 'Purdue Chem Settings', 'Department-specific settings for Purdue Chem', '{}', '{}', '{}', '{019bb25e-e5e2-73eb-9313-57d774b30875,019bb25e-e5e2-74c2-aaf3-42c5403f26f9}') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.department_settings_junction (active, created_at, department_id, settings_id, generated, mcp) VALUES (true, '2025-12-12T13:26:55.664826+00:00', '019b3be4-3247-7d5e-a958-5b9fb4e2725b', '019bb25e-e615-7963-be87-7904de26729c', false, false) ON CONFLICT (department_id, settings_id) DO NOTHING;
