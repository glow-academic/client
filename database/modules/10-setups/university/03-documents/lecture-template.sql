...
INSERT INTO public.documents_resource (created_at, active, generated, mcp, id, name, description, department_ids, upload_id, text_id) VALUES ('2025-12-06T02:59:23.893847+00:00', true, false, false, '019bb25e-e619-7825-b171-9c36d4d56c4a', 'Lecture Template', 'Template document for lecture', '{}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
