...
INSERT INTO public.documents_resource (created_at, active, generated, mcp, id, name, description, department_ids, upload_id, text_id) VALUES ('2025-12-06T02:59:23.893847+00:00', true, false, false, '019bb25e-e619-7810-bc6e-9640cb15e1cf', 'Homework Template', 'Template document for homework', '{}', NULL, NULL) ON CONFLICT (id) DO NOTHING;
