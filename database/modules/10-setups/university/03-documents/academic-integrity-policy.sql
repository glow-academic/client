...
INSERT INTO public.documents_resource (created_at, active, generated, mcp, id, name, description, department_ids, upload_id, text_id) VALUES ('2025-12-12T13:44:32.428979+00:00', true, false, false, '019bb25e-e619-7834-9cb3-66671ca36a7d', 'Academic Integrity Policy', 'Academic integrity and honor code policy document', '{}', '019b3be4-3cf0-7032-a0e9-fd8b56aa4565', NULL) ON CONFLICT (id) DO NOTHING;
