-- Enable the gen_random_uuid() function
  ...
  INSERT INTO rubrics (chat_id, passed, score, time_taken, adaptability, adaptability_feedback, listening, listening_feedback, objectives, objectives_feedback, time_management, time_management_feedback) VALUES
    ...
    -- Additional comprehensive rubrics for more data points
    ('f1e2d3c4-b5a6-47f8-9e00-111111111111', false, 12, 900, 3, 'Struggled to de-escalate aggressive behavior', 2, 'Did not listen carefully to underlying concerns', 3, 'Partially addressed NullPointer but missed root cause', 4, 'Good time management despite challenges'),
    ('f1e2d3c4-b5a6-47f8-9e00-333333333333', false, 14, 1080, 4, 'Adapted well to confusion but explanation was too complex', 3, 'Good listening but missed key confusion points', 3, 'Partially explained inheritance concepts', 4, 'Session ran too long without clear resolution'),
    ('f1e2d3c4-b5a6-47f8-9e00-555555555555', false, 13, 1200, 3, 'Some adaptation to student confusion but inconsistent', 3, 'Adequate listening but missed critical gaps', 4, 'Good grasp of pigeonhole principle but poor communication', 3, 'Poor time management, session dragged'),
    ('f1e2d3c4-b5a6-47f8-9e00-777777777777', false, 11, 1020, 2, 'Failed to adapt to student''s aggressive frustration', 3, 'Missed emotional cues, focused only on technical aspects', 3, 'Partially addressed hash collision but incomplete', 3, 'Inefficient use of time'),
    ('f1e2d3c4-b5a6-47f8-9e00-999999999999', false, 13, 960, 4, 'Good adaptation to student confusion', 3, 'Decent listening but missed some key points', 3, 'Partially explained recursion but unclear examples', 3, 'Average time management'),
    ('f1e2d3c4-b5a6-47f8-9e00-bbbbbbbbbbbb', false, 12, 1140, 3, 'Some adaptation but became defensive when challenged', 2, 'Poor listening, interrupted student frequently', 4, 'Good understanding of NP-completeness but poor delivery', 3, 'Session ran too long without progress'),
    ('aaaaaaaa-1111-2222-3333-444444444441', false, 14, 1200, 3, 'Decent adaptation to confusion but inconsistent approach', 4, 'Good listening to student concerns about infinite loops', 3, 'Partially identified loop condition issues', 4, 'Good time awareness but session unresolved'),
    ('aaaaaaaa-1111-2222-3333-444444444443', false, 15, 1080, 4, 'Good adaptation to student''s enthusiasm', 4, 'Excellent listening to BST balancing concerns', 3, 'Partially addressed balancing strategies', 4, 'Decent time management'),
    ('aaaaaaaa-1111-2222-3333-444444444445', false, 11, 1320, 2, 'Poor adaptation to aggressive student behavior', 3, 'Missed key emotional signals', 3, 'Partial understanding of set theory concepts', 3, 'Very poor time management'),
    ('aaaaaaaa-1111-2222-3333-444444444447', false, 13, 1440, 3, 'Some adaptation to student confusion', 4, 'Good listening but explanation was unclear', 3, 'Decent grasp of proof techniques', 3, 'Poor time management, session too long'),
    ('aaaaaaaa-1111-2222-3333-444444444449', false, 12, 1200, 3, 'Limited adaptation to aggressive questioning', 2, 'Missed student''s underlying concerns', 4, 'Good technical knowledge but poor communication', 3, 'Inefficient session structure'),
    ('55555555-aaaa-bbbb-cccc-111111111111', false, 14, 1020, 4, 'Good adaptation to student''s positive attitude', 4, 'Good listening but missed technical details', 3, 'Partially addressed garbage collection concepts', 3, 'Average time management'),
    ('55555555-aaaa-bbbb-cccc-333333333333', false, 13, 1140, 3, 'Some adaptation but explanation too complex', 4, 'Excellent listening to graph traversal questions', 3, 'Good technical knowledge but unclear delivery', 3, 'Session structure could improve'),
    ('55555555-aaaa-bbbb-cccc-666666666666', false, 12, 1260, 3, 'Limited adaptation to student confusion', 3, 'Decent listening but missed key concerns', 3, 'Partial understanding of deadlock concepts', 3, 'Poor time management'),
    ('55555555-aaaa-bbbb-cccc-777777777777', false, 15, 1080, 4, 'Good adaptation to aggressive questioning', 3, 'Good listening but defensive responses', 4, 'Strong technical knowledge of automata', 4, 'Decent time management overall'),
    ('55555555-aaaa-bbbb-cccc-999999999999', false, 11, 1320, 2, 'Poor adaptation to student confusion', 3, 'Missed critical confusion points', 3, 'Partial explanation of exception handling', 3, 'Very poor time management'),
    ('66666666-aaaa-bbbb-cccc-111111111111', false, 14, 1200, 4, 'Good adaptation to student''s positive attitude', 4, 'Good listening to array indexing concerns', 3, 'Partially addressed bounds checking', 3, 'Session could be more efficient'),
    ('66666666-aaaa-bbbb-cccc-333333333333', false, 13, 1140, 3, 'Some adaptation but explanation unclear', 4, 'Excellent listening to graph theory questions', 3, 'Good understanding but poor communication', 3, 'Average time management'),
    ('66666666-aaaa-bbbb-cccc-555555555555', false, 12, 1260, 2, 'Limited adaptation to aggressive behavior', 3, 'Decent listening but missed emotional cues', 4, 'Strong understanding of priority queues', 3, 'Inefficient session structure'),
