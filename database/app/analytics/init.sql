...
INSERT INTO components (id, name, description, file_name, layout, stat, default_component) VALUES
  ...
  ('595e7002-360b-afce-83bd-3164dfc7a203', 'Active Cohorts', 'Analytics component for active cohorts', 'ActiveCohorts.tsx', '{}', true, false),
  ('71c51fa2-e117-853b-4da5-2de4ee328c7d', 'Average Score', 'Analytics component for average score', 'AverageScore.tsx', '{}', true, false),
  ('25c97e74-2e60-efeb-0277-b57c7ce720e1', 'Completion Rate', 'Analytics component for completion rate', 'CompletionRate.tsx', '{}', true, false),
  ('7b058d9e-2968-3e69-4ff7-8bc7a13e5cfc', 'Need Support', 'Analytics component for need support', 'NeedSupport.tsx', '{}', true, false),
  ('32aae137-f974-5b45-60eb-6b9b2eca6433', 'Pass Rate', 'Analytics component for pass rate', 'PassRate.tsx', '{}', true, false),
  ('c3bebe15-6231-0b14-704a-67545389be60', 'Total Sessions', 'Analytics component for total sessions', 'TotalSessions.tsx', '{}', true, false),
  ('e412e43b-468c-489c-f262-1607bc64dc43', 'Total Tas', 'Analytics component for total tas', 'TotalTas.tsx', '{}', true, false),
  ('71724c23-ef68-189d-94b3-8ed2c8ffded3', 'Training Hours', 'Analytics component for training hours', 'TrainingHours.tsx', '{}', true, false),
  ('654ffdaa-be1f-8f87-c2ac-5a11b7076c8f', 'Training Sessions', 'Analytics component for training sessions', 'TrainingSessions.tsx', '{}', true, false),
  ('bab2e342-c823-2e94-a85a-816d9cb78bd2', 'Performance By Personality', 'Analytics component for performance by personality', 'PerformanceByPersonality.tsx', '{}', false, false),
  ('a7e8e793-011f-b291-eec4-a74232db4491', 'Performance Trends', 'Analytics component for performance trends', 'PerformanceTrends.tsx', '{}', false, false),
  ('c2940e17-d668-43e3-ad76-9abf53d5b21f', 'Session Activity', 'Analytics component for session activity', 'SessionActivity.tsx', '{}', false, false),
  ('2a27f6d4-e6a9-f2fd-d691-7de103d7c443', 'Class Performance', 'Analytics component for class performance', 'ClassPerformance.tsx', '{}', false, false),
  ('ce392c42-3858-091d-cd39-3fc69bca92c2', 'Skill Breakdown', 'Analytics component for skill breakdown', 'SkillBreakdown.tsx', '{}', false, false),
  ('e5fd9fa5-5da1-7262-f40a-c2300888e1ad', 'Training Insights', 'Analytics component for training insights', 'TrainingInsights.tsx', '{}', false, false);
