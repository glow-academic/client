...
INSERT INTO components (id, name, description, file_name, layout, stat, default_component) VALUES
  ...
  ('bab2e342-c823-2e94-a85a-816d9cb78bd2', 'Performance By Personality', 'Analytics component for performance by personality', 'PerformanceByPersonality.tsx', '{"props":{"color":"blue","defaultTimeRange":"30d","chartType":"bar","title":"Performance by Personality","showTimeSelector":true},"metadata":{"color":{"type":"select","options":["blue","green","purple","orange","teal","red","emerald","indigo"],"multiple":false},"defaultTimeRange":{"type":"select","options":["7d","14d","30d","60d","90d"],"multiple":false},"chartType":{"type":"select","options":["bar"],"multiple":false},"title":{"type":"string"},"showTimeSelector":{"type":"boolean"}}}', false, false),
  ('a7e8e793-011f-b291-eec4-a74232db4491', 'Performance Trends', 'Analytics component for performance trends', 'PerformanceTrends.tsx', '{"props":{"color":"blue","defaultTimeRange":"30d","chartType":"area","title":"Performance Trends","showTimeSelector":true},"metadata":{"color":{"type":"select","options":["blue","green","purple","orange","teal","red","emerald","indigo"],"multiple":false},"defaultTimeRange":{"type":"select","options":["7d","30d","90d"],"multiple":false},"chartType":{"type":"select","options":["area","line"],"multiple":false},"title":{"type":"string"},"showTimeSelector":{"type":"boolean"}}}', false, false),
  ('c2940e17-d668-43e3-ad76-9abf53d5b21f', 'Session Activity', 'Analytics component for session activity', 'SessionActivity.tsx', '{"props":{"color":"blue","defaultTimeRange":"24h","chartType":"bar","title":"Session Activity","showTimeSelector":true},"metadata":{"color":{"type":"select","options":["blue","green","purple","orange","teal","red","emerald","indigo"],"multiple":false},"defaultTimeRange":{"type":"select","options":["1h","12h","24h","1d","3d","7d","14d","30d"],"multiple":false},"chartType":{"type":"select","options":["bar"],"multiple":false},"title":{"type":"string"},"showTimeSelector":{"type":"boolean"}}}', false, false),
  ('c48dc235-023a-838d-680a-ff19b075ec44', 'Cohort Performance', 'Analytics component for cohort performance', 'CohortPerformance.tsx', '{"props":{"className":"","color":"blue","maxItems":5,"title":"Cohort Performance","layout":"vertical"},"metadata":{"className":{"type":"string"},"color":{"type":"select","options":["blue","green","purple","orange","teal","red","emerald","indigo"],"multiple":false},"maxItems":{"type":"number"},"title":{"type":"string"},"layout":{"type":"select","options":["vertical","horizontal"],"multiple":false}}}', false, false),
...
INSERT INTO dashboards (
  ...
  ARRAY['c48dc235-023a-838d-680a-ff19b075ec44', 'ce392c42-3858-091d-cd39-3fc69bca92c2', 'e5fd9fa5-5da1-7262-f40a-c2300888e1ad']::UUID[],
