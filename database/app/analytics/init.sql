...
INSERT INTO components (id, name, description, file_name, layout, default_component) VALUES
  ('49990ffa-5698-bd91-b379-6703a8cf4835', 'Cohort Completion', 'Analytics component for cohort completion', 'CohortCompletion.tsx', '{"className":""}', false),
  ('d8e58a90-32e7-0b43-447c-fda790891cee', 'Scenario Data', 'Analytics component for scenario data', 'ScenarioData.tsx', '{"className":""}', false),
  ('6b8684a8-cd06-6f6a-9a53-d57ad527041b', 'Simulation Performance', 'Analytics component for simulation performance', 'SimulationPerformance.tsx', '{"className":""}', false),
  ('2e3380af-e6a2-6080-ceee-1c91b65121c4', 'Skill Growth', 'Analytics component for skill growth', 'SkillGrowth.tsx', '{"className":""}', false),
  ('595e7002-360b-afce-83bd-3164dfc7a203', 'Active Cohorts', 'Analytics component for active cohorts', 'ActiveCohorts.tsx', '{}', false),
  ('71c51fa2-e117-853b-4da5-2de4ee328c7d', 'Average Score', 'Analytics component for average score', 'AverageScore.tsx', '{}', false),
  ('25c97e74-2e60-efeb-0277-b57c7ce720e1', 'Completion Rate', 'Analytics component for completion rate', 'CompletionRate.tsx', '{}', false),
  ('7b058d9e-2968-3e69-4ff7-8bc7a13e5cfc', 'Need Support', 'Analytics component for need support', 'NeedSupport.tsx', '{}', false),
  ('32aae137-f974-5b45-60eb-6b9b2eca6433', 'Pass Rate', 'Analytics component for pass rate', 'PassRate.tsx', '{}', false),
  ('c3bebe15-6231-0b14-704a-67545389be60', 'Total Sessions', 'Analytics component for total sessions', 'TotalSessions.tsx', '{}', false),
