...
INSERT INTO parameters (id, name, description, numerical) VALUES
  ('11111111-1111-1111-1111-111111111111', 'Crowdedness', 'The number of students in the room', TRUE),
  ('22222222-2222-2222-2222-222222222222', 'Intensity', 'The intensity of the student', TRUE),
  ('33333333-3333-3333-3333-333333333333', 'Location', 'The location of the student', FALSE),
  ('44444444-4444-4444-4444-444444444444', 'Time', 'The time of the student', FALSE),
  ('55555555-5555-5555-5555-555555555555', 'Document', 'The document of the student', FALSE);
  ('66666666-6666-6666-6666-666666666666', 'Class', 'The class of the student', FALSE);

-- crowdedness
INSERT INTO parameter_items (id, name, description, value, parameter_id) VALUES
  ('11111111-1111-1111-1111-111111111111', 'Crowdedness (1)', 'The relative number of students in the room', '1', '11111111-1111-1111-1111-111111111111'),
  ('22222222-2222-2222-2222-222222222222', 'Crowdedness (2)', 'The relative number of students in the room', '2', '11111111-1111-1111-1111-111111111111'),
  ('33333333-3333-3333-3333-333333333333', 'Crowdedness (3)', 'The relative number of students in the room', '3', '11111111-1111-1111-1111-111111111111'),
  ('44444444-4444-4444-4444-444444444444', 'Crowdedness (4)', 'The relative number of students in the room', '4', '11111111-1111-1111-1111-111111111111'),
  ('55555555-5555-5555-5555-555555555555', 'Crowdedness (5)', 'The relative number of students in the room', '5', '11111111-1111-1111-1111-111111111111'),
  ('66666666-6666-6666-6666-666666666666', 'Crowdedness (6)', 'The relative number of students in the room', '6', '11111111-1111-1111-1111-111111111111'),
...
-- intensity
INSERT INTO parameter_items (id, name, description, value, parameter_id) VALUES
  ('77777777-7777-7777-7777-777777777777', 'Intensity (1)', 'The relative intensity of the student', '1', '22222222-2222-2222-2222-222222222222'),
  ('88888888-8888-8888-8888-888888888888', 'Intensity (2)', 'The relative intensity of the student', '2', '22222222-2222-2222-2222-222222222222'),
  ('99999999-9999-9999-9999-999999999999', 'Intensity (3)', 'The relative intensity of the student', '3', '22222222-2222-2222-2222-222222222222'),
  ('10101010-1010-1010-1010-101010101010', 'Intensity (4)', 'The relative intensity of the student', '4', '22222222-2222-2222-2222-222222222222'),
  ('11111111-1111-1111-1111-111111111111', 'Intensity (5)', 'The relative intensity of the student', '5', '22222222-2222-2222-2222-222222222222'),
  ('12121212-1212-1212-1212-121212121212', 'Intensity (6)', 'The relative intensity of the student', '6', '22222222-2222-2222-2222-222222222222'),
  ('13131313-1313-1313-1313-131313131313', 'Intensity (7)', 'The relative intensity of the student', '7', '22222222-2222-2222-2222-222222222222'),
  ('14141414-1414-1414-1414-141414141414', 'Intensity (8)', 'The relative intensity of the student', '8', '22222222-2222-2222-2222-222222222222'),
  ('15151515-1515-1515-1515-151515151515', 'Intensity (9)', 'The relative intensity of the student', '9', '22222222-2222-2222-2222-222222222222'),
  ('16161616-1616-1616-1616-161616161616', 'Intensity (10)', 'The relative intensity of the student', '10', '22222222-2222-2222-2222-222222222222'),

-- location
INSERT INTO parameter_items (id, name, description, value, parameter_id) VALUES
  ('77777777-7777-7777-7777-777777777777', 'Lawson Computer Science Building', 'An open, collaborative space in the Lawson building with high foot traffic.', 'Lawson', '33333333-3333-3333-3333-333333333333'),
  ('88888888-8888-8888-8888-888888888888', 'Felix Haas Hall', 'A quiet, focused study environment in the lower level of the HAAS building.', 'HAAS', '33333333-3333-3333-3333-333333333333'),
  ('99999999-9999-9999-9999-999999999999', 'Data Science and Artificial Intelligence Building', 'A specialized tech-focused lab environment in the basement of the Data Science/AI building.', 'DSAI', '33333333-3333-3333-3333-333333333333')

-- class
INSERT INTO parameter_items (id, name, description, value, parameter_id) VALUES
  ('11111111-1111-1111-1111-111111111111', 'CS 180', 'Problem solving and algorithms, implementation of algorithms in a high level programming language, conditionals, the iterative approach and debugging, collections of data, searching and sorting, solving problems by decomposition, the object-oriented approach, subclasses of existing classes, handling exceptions that occur when the program is running, graphical user interfaces (GUIs), data stored in files, abstract data types, a glimpse at topics from other CS courses.', '44444444-1111-1111-1111-111111111111'),
  ('22222222-2222-2222-2222-222222222222', 'CS 182', 'Logic and proofs; sets, functions, relations, sequences and summations; number representations; counting; fundamentals of the analysis of algorithms; graphs and trees; proof techniques; recursion; Boolean logic; finite state machines; pushdown automata; computability and undecidability.', '55555555-2222-2222-2222-222222222222'),
  ('33333333-3333-3333-3333-333333333333', 'CS 251', 'Running time analysis of algorithms and their implementations, one-dimensional data structures, trees, heaps, additional sorting algorithms, binary search trees, hash tables, graphs, directed graphs, weighted graph algorithms, additional topics.', '66666666-3333-3333-3333-333333333333'),
  ('44444444-4444-4444-4444-444444444444', 'CS 381', 'Techniques for analyzing the time and space requirements of algorithms. Application of these techniques to sorting, searching, pattern-matching, graph problems, and other selected problems. Brief introduction to the intractable (NP-hard) problems.', '77777777-4444-4444-4444-444444444444'),
  ('55555555-5555-5555-5555-555555555555', 'CS 422', 'Network protocols, socket programming, network security, distributed systems, and network performance analysis. Covers TCP/IP, HTTP, DNS, and other networking fundamentals.', '88888888-5555-5555-5555-555555555555'),
  ('66666666-6666-6666-6666-666666666666', 'CS 373', 'Introduction to machine learning algorithms, neural networks, feature engineering, model evaluation, and practical applications. Covers supervised and unsupervised learning techniques.', '99999999-6666-6666-6666-666666666666');
...
INSERT INTO scenarios (id, name, description, persona_id, practice_scenario, default_scenario) VALUES
...
INSERT INTO scenarios (id, name, description, persona_id, class_id, crowdedness, intensity, location_id, time_id, document_ids, default_scenario) VALUES
