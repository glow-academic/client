...
('22222222-bbbb-bbbb-bbbb-222222222222', 'gpt-5', 'GPT-5 is OpenAI''s latest language model with advanced reasoning and multimodal capabilities.', '11111111-aaaa-aaaa-aaaa-111111111111', 1.25, 10.00),
('44444444-dddd-dddd-dddd-444444444444', 'gpt-5-mini', 'GPT-5 Mini is a faster, more efficient version of GPT-5 optimized for speed and cost.', '11111111-aaaa-aaaa-aaaa-111111111111', 0.25, 2.00),
('55555555-eeee-eeee-eeee-555555555555', 'gpt-5-nano', 'GPT-5 Nano is the smallest and fastest GPT-5 variant, ideal for real-time applications.', '11111111-aaaa-aaaa-aaaa-111111111111', 0.05, 0.40),
