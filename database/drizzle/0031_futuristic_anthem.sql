...
CREATE TABLE "parameter_item_departments" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "parameter_item_departments_pkey" PRIMARY KEY("parameter_item_id","department_id")
);
--> statement-breakpoint
...
CREATE TABLE "prompt_departments" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "prompt_departments_pkey" PRIMARY KEY("prompt_id","department_id")
);
--> statement-breakpoint
...
DROP TABLE "parameter_departments" CASCADE;--> statement-breakpoint
ALTER TABLE "parameters" ADD COLUMN "document_parameter" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "scenarios" ADD COLUMN "hints_enabled" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "scenarios" ADD COLUMN "objectives_enabled" boolean DEFAULT true NOT NULL;--> statement-breakpoint
ALTER TABLE "scenarios" ADD COLUMN "image_input_enabled" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "scenarios" ADD COLUMN "input_guardrail_enabled" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "scenarios" ADD COLUMN "output_guardrail_enabled" boolean DEFAULT false NOT NULL;--> statement-breakpoint
...
ALTER TABLE "parameter_item_departments" ADD CONSTRAINT "parameter_item_departments_parameter_item_id_fkey" FOREIGN KEY ("parameter_item_id") REFERENCES "public"."parameter_items"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "parameter_item_departments" ADD CONSTRAINT "parameter_item_departments_department_id_fkey" FOREIGN KEY ("department_id") REFERENCES "public"."departments"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "profile_activity" ADD CONSTRAINT "profile_activity_profile_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "prompt_departments" ADD CONSTRAINT "prompt_departments_prompt_id_fkey" FOREIGN KEY ("prompt_id") REFERENCES "public"."prompts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "prompt_departments" ADD CONSTRAINT "prompt_departments_department_id_fkey" FOREIGN KEY ("department_id") REFERENCES "public"."departments"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "agent_prompts_agent_id_active_idx" ON "agent_prompts" USING btree ("agent_id" bool_ops,"active" uuid_ops);--> statement-breakpoint
...
CREATE INDEX "parameter_item_departments_department_id_idx" ON "parameter_item_departments" USING btree ("department_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "parameter_item_departments_parameter_item_id_idx" ON "parameter_item_departments" USING btree ("parameter_item_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "persona_prompts_persona_id_active_idx" ON "persona_prompts" USING btree ("persona_id" bool_ops,"active" uuid_ops);--> statement-breakpoint
...
CREATE INDEX "profile_activity_created_at_idx" ON "profile_activity" USING btree ("created_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "profile_activity_profile_id_idx" ON "profile_activity" USING btree ("profile_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "profile_activity_profile_id_last_active_idx" ON "profile_activity" USING btree ("profile_id" timestamptz_ops,"last_active" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "prompt_departments_department_id_idx" ON "prompt_departments" USING btree ("department_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "prompt_departments_prompt_id_idx" ON "prompt_departments" USING btree ("prompt_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "prompts_created_at_idx" ON "prompts" USING btree ("created_at" timestamptz_ops);--> statement-breakpoint
ALTER TABLE "agents" DROP COLUMN "system_prompt";--> statement-breakpoint
ALTER TABLE "personas" DROP COLUMN "system_prompt";--> statement-breakpoint
ALTER TABLE "simulations" DROP COLUMN "output_guardrail_active";--> statement-breakpoint
ALTER TABLE "simulations" DROP COLUMN "input_guardrail_active";--> statement-breakpoint
ALTER TABLE "simulations" DROP COLUMN "image_input_active";--> statement-breakpoint
ALTER TABLE "simulations" DROP COLUMN "hints_enabled";--> statement-breakpoint
ALTER TABLE "simulations" DROP COLUMN "objectives_enabled";--> statement-breakpoint
