...
export const departments = pgTable("departments", {
	...
	inputGuardrailAgentId: uuid("input_guardrail_agent_id").notNull(),
	outputGuardrailAgentId: uuid("output_guardrail_agent_id").notNull(),
	hintAgentId: uuid("hint_agent_id").notNull(),
});
...
export const scenarios = pgTable("scenarios", {
	...
	name: text().notNull(),
	description: text().notNull(),
	objectives: text().array().default([""]).notNull(),
	personaId: uuid("persona_id"),
