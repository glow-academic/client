...
import { profiles, assistantChats, simulationAttempts, simulationChats, scenarios, assistantMessages, assistantToolCalls, dashboards, schedules, events, classes, documents, agents, simulationMessages, simulationSketches, simulations, rubrics, simulationChatGrades, topics, standardGroups, standards, models, simulationChatFeedbacks, users } from "./schema";
