...
\restrict Sn5eI4E3RAVJUEtdsS7D6ADGpZZcWw4GFY8kNFfbIrfeXEeWtGv1pIGtYds726R
...
--
-- Name: analysis_grades; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.analysis_grades (
...
--
-- Name: analysis_grades analysis_grades_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.analysis_grades
    ADD CONSTRAINT analysis_grades_pkey PRIMARY KEY (analysis_id, grade_id);
...
--
-- Name: analysis_grades_analysis_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX analysis_grades_analysis_id_idx ON public.analysis_grades USING btree (analysis_id);


--
-- Name: analysis_grades_grade_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX analysis_grades_grade_id_idx ON public.analysis_grades USING btree (grade_id);
...
--
-- Name: analysis_grades analysis_grades_analysis_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.analysis_grades
    ADD CONSTRAINT analysis_grades_analysis_id_fkey FOREIGN KEY (analysis_id) REFERENCES public.analyses(id) ON DELETE CASCADE;


--
-- Name: analysis_grades analysis_grades_grade_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.analysis_grades
    ADD CONSTRAINT analysis_grades_grade_id_fkey FOREIGN KEY (grade_id) REFERENCES public.grades(id) ON DELETE CASCADE;
...
\unrestrict Sn5eI4E3RAVJUEtdsS7D6ADGpZZcWw4GFY8kNFfbIrfeXEeWtGv1pIGtYds726R
