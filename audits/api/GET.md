...
Reference: `server/app/routes/v5/api/main/persona/get.py`
...
Reference: `server/app/routes/v5/api/main/persona/get.py:140-253`
...
Reference: `server/app/routes/v5/api/auth/profile.py`, `server/app/routes/v5/api/main/persona/get.py:146-159`
...
Reference: `server/app/routes/v5/api/main/persona/get.py:226-248`
...
Reference: `server/app/routes/v5/permissions.py`, `server/app/routes/v5/api/main/persona/get.py`
...
Reference: `server/app/routes/v5/api/main/persona/get.py:344-580`
...
Reference: `server/app/routes/v5/api/main/persona/get.py:671-685`, `permissions.py:394-402`
...
Reference: `server/app/routes/v5/api/main/persona/types.py:225-268`
...
Reference: `server/app/routes/v5/api/main/persona/get.py`, `types.py`
...
Reference: `server/app/routes/v5/api/main/persona/types.py:185-196`
...
Reference: `server/app/routes/v5/api/main/persona/get.py:806-894`
...
Reference: `server/app/routes/v5/api/main/persona/get.py:1013-1090`
...
Reference: `server/app/routes/v5/socket/artifacts/persona/generate.py:92-527`
...
Reference: `server/app/routes/v5/socket/artifacts/persona/generate.py:411-436`
...
Reference: `server/app/routes/v5/socket/artifacts/persona/complete.py:36-174`
...
```bash
grep -rl "domain_ids\|domain_id\|agent_type" server/app/routes/v5/api/main/*/types.py | while read f; do
...
```bash
for artifact_dir in server/app/routes/v5/socket/artifacts/*/; do
  artifact=$(basename "$artifact_dir")
...
```bash
grep -n "class.*WebsocketResources" server/app/routes/v5/api/main/*/types.py | while read line; do
...
2. **The persona artifact is the gold standard.** All patterns reference `server/app/routes/v5/api/main/persona/`.
