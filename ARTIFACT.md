...
- [API v5 Standards](server/app/routes/v5/STANDARDS.md) - API endpoint standards
- [WebSocket v5 Standards](server/app/routes/v5/socket/STANDARDS.md) - WebSocket event standards
