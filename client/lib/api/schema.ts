  ...
  schemas: {
    ...
    AgentsListResponse: {
      ...
      model_mapping: {
        [
          key: string
        ]: components["schemas"]["app__utils__schema__ModelMappingItem"];
      };
      /** Department Mapping */
      department_mapping: {
        [
    ...
    ChatData: {
      ...
      video?:
        | components["schemas"]["app__api__v3__attempts__full__VideoItem"]
        | null;
    ...
    DashboardBundleResponse: {
      ...
      parameter_mapping: {
        [
          key: string
        ]: components["schemas"]["app__utils__schema__ParameterMappingItem"];
      };
    ...
    HomeOverviewResponse: {
      ...
      standard_groups_mapping: {
        [
          key: string
        ]: components["schemas"]["app__utils__schema__StandardGroupMappingItem"];
      };
      /** Standards Mapping */
      standards_mapping: {
    ...
    RunFullResponse: {
      ...
      simulation?:
        | components["schemas"]["app__api__v3__attempts__full__SimulationItem"]
        | null;
      /**
       * Attemptprofiles
       * @default []
    ...
    app__api__v3__videos__detail__VideoDetailResponse: {
      ...
      problem_statement_mapping: {
        [
          key: string
        ]: components["schemas"]["app__api__v3__videos__detail__ProblemStatementInfo"];
      };
      /** Objective Ids */
      objective_ids: string[];
      /** Objective Mapping */
    ...
    app__api__v3__videos__new__VideoDetailResponse: {
      ...
      problem_statement_mapping: {
        [
          key: string
        ]: components["schemas"]["app__api__v3__videos__new__ProblemStatementInfo"];
      };
      /** Objective Ids */
      objective_ids: string[];
      /** Objective Mapping */
