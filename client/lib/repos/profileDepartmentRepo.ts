...
export const ProfileDepartmentCreateSchema =
  createInsertSchema(profileDepartments);
export const ProfileDepartmentUpdateSchema =
  ProfileDepartmentCreateSchema.partial();
...
export const profileDepartmentRepo = {
  ...
  async list() {
    ...
    return db
      ...
      .orderBy(profileDepartments.createdAt);
  },
  ...
  async update(_id: unknown, _patch: ProfileDepartmentUpdate) {
  ...
  async listByProfile(profileId: string) {
    ...
    return db
      .select()
      .from(profileDepartments)
      .where(eq(profileDepartments.profileId, profileId));
  },
  ...
  async listByProfiles(profileIds: string[]) {
    ...
    return db
      .select()
      .from(profileDepartments)
      .where(inArray(profileDepartments.profileId, profileIds));
  },
  ...
  async listByDepartment(departmentId: string) {
    ...
    return db
      .select()
      .from(profileDepartments)
      .where(eq(profileDepartments.departmentId, departmentId));
  },
  ...
  async listByDepartments(departmentIds: string[]) {
    ...
    return db
      .select()
      .from(profileDepartments)
      .where(inArray(profileDepartments.departmentId, departmentIds));
  },
};
