...
export async function POST(req: Request) {
  ...
  return handle(
    async () => {
      ...
      const res = await fetch(`${base}/analytics/home`, {
        method: "POST",
    ...
    (e: unknown) =>
      log.error("api.analytics.home.failed", {
        message: "Failed to fetch home analytics",
        context: { route: "/api/analytics/home", body: json },
        error: e,
      })
  );
}
