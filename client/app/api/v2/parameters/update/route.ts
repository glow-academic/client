...
export async function POST(req: NextRequest) {
  try {
    ...
    const request = UpdateParameterRequestSchema.parse(body);

    const response = await fetch(`${getApiBase()}/api/v2/parameters/update`, {
      method: "POST",
      headers: {
    ...
    log.error("parameters.v2.update.error", {
