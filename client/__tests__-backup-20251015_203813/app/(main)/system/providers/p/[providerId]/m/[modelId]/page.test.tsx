...
// ——————————————————————————————————————————
import ModelEditPage from "@/app/(main)/system/providers/p/[providerId]/m/[modelId]/page";

// ✨ Import comprehensive mock data from our centralized mock system
import "@/mocks/api";

// Mock the ModelEdit component
vi.mock("@/components/system/providers/ModelEdit", () => ({
  default: ({
    modelId,
    providerId,
  }: {
...
vi.mock(
  "@/app/(main)/system/providers/p/[providerId]/m/[modelId]/page",
  () => ({
    default: ({}: {
 ...
 * Path: (main)/system/providers/p/[providerId]/m/[modelId]/page.tsx
 *
 * Features detected:
 * - Default export: true
