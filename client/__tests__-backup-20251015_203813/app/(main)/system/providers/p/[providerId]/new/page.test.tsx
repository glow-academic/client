...
// ——————————————————————————————————————————
import NewModelPage from "@/app/(main)/system/providers/p/[providerId]/new/page";

// ✨ Import comprehensive mock data from our centralized mock system
import "@/mocks/api";

// Mock the NewModel component
vi.mock("@/components/system/providers/NewModel", () => ({
...
describe("NewModelPage", () => {
  ...
  describe("basic render smoke-test", () => {
    it("renders without crashing", async () => {
      ...
      await act(async () => {
        render(<NewModelPage params={mockParams} />);
      });
 ...
 * Path: (main)/system/providers/p/[providerId]/new/page.tsx
 *
 * Features detected:
 * - Default export: true
