...
// ——————————————————————————————————————————
import ProviderEditPage from "@/app/(main)/system/providers/p/[providerId]/page";

// ✨ Import comprehensive mock data from our centralized mock system
import "@/mocks/api";

// Mock the ProviderEdit component
vi.mock("@/components/system/providers/ProviderEdit", () => ({
...
vi.mock("@/app/(main)/system/providers/p/[providerId]/page", () => ({
 ...
 * Path: (main)/system/providers/p/[providerId]/page.tsx
 *
 * Features detected:
 * - Default export: true
