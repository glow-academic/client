...
describe('Rubrics', () => {
  ...
  describe('Rendering', () => {
    it('should render without crashing', () => {
      ...
      expect(screen.getByText('Manage your evaluation rubrics and create new assessment criteria')).toBeInTheDocument();
    });

    it('should render create button', () => {
      renderWithProviders(<Rubrics />);
      
      expect(screen.getByRole('button', { name: /create new rubric/i })).toBeInTheDocument();
    });
  ...
  describe('User Interactions', () => {
      ...
      const { getAllRubrics } = await import('@/utils/queries/rubrics/get-all-rubrics');
    ...
    it('should handle delete confirmation dialog', async () => {
      ...
      const deleteButton = deleteButtons.find(button => button.querySelector('svg')); // Delete button with icon
  ...
  describe('API Integration', () => {
    ...
    it('should handle empty state', async () => {
      ...
      expect(screen.getByText('Create your first evaluation rubric to define assessment criteria')).toBeInTheDocument();
    });
  });
