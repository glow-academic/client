...
const mockProps: PersonasDataTableToolbarProps = {
  table: {} as unknown as Table<{ name: string; id: string; createdAt: string; updatedAt: string; description: string; systemPrompt: string; temperature: number; defaultPersona: boolean; color: string; modelId: string | null; reasoning: "low" | ... 2 more ... | null; }>,
  scenarioOptions: [],
  reasoningOptions: [],
  modelOptions: [],
  temperatureOptions: [],
