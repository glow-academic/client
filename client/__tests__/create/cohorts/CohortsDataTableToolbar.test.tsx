...
// ——————————————————————————————————————————
import { CohortsDataTableToolbar, CohortsDataTableToolbarProps } from '@/components/create/cohorts/CohortsDataTableToolbar';
...
const mockProps: CohortsDataTableToolbarProps = {
  table: {} as unknown as Table<{ id: string; createdAt: string; updatedAt: string; title: string; description: string | null; active: boolean; profileIds: string[]; defaultCohort: boolean; }>,
  profileOptions: [],
  simulationOptions: [],
  classOptions: [],
};
