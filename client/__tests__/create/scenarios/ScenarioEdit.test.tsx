...
describe('ScenarioEdit', () => {
  ...
  describe('User Interactions', () => {
    it('should handle form submissions', async () => {
      const { getScenario } = await import('@/utils/queries/scenarios/get-scenario');
      const { updateScenario } = await import('@/utils/mutations/scenarios/update-scenario');
      ...
      const nameInput = screen.getByLabelText(/scenario name/i);
      const submitButton = screen.getByRole('button', { name: /update scenario/i });
  ...
  describe('Edge Cases', () => {
    it('should handle scenario data population', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByDisplayValue('Original Scenario')).toBeInTheDocument();
