...
// ——————————————————————————————————————————
import { TourProvider, useTour, TourContextState } from '@/contexts/tour-context';
 ...
 * - Named exports: TourProvider, useTour, TourContextState
 * - Has props: true
 * - Props interface: TourProviderProps
 * - Client component: true
 * - Uses hooks: useCallback, useContext, useEffect, useMemo, useReducer, useRef, useProfile, useRouter, useTour
 * - Uses router: true
 * - Has API calls: false
