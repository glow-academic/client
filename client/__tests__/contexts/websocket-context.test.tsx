...
// ——————————————————————————————————————————
import { WebSocketProvider, WebSocketContextType, useWebSocket } from '@/contexts/websocket-context';
...
describe('websocket-context', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      render(<websocketcontext {...mockProps} />);
 ...
 * - Named exports: WebSocketProvider, WebSocketContextType, useWebSocket
 * - Has props: true
 * - Props interface: WebSocketProviderProps
