...
const mockProps: StaffEditProps = {
  ...
  // hideDelete: false, /* optional */
  // hideBack: false, /* optional */
  // redirectOnSuccess: false, /* optional */
  // canToggleDefault: false, /* optional */
};
// ------------------------------------------------------------------
describe('StaffEdit', () => {
 ...
 * - Uses hooks: useProfile, useEffectiveProfile, useDeleteProfile, useProfileSimple, useUpdateProfileSimple, useRouter, useCallback, useEffect, useState, useStaffEditBusinessLogic
 * - Uses router: true
 * - Has API calls: false
