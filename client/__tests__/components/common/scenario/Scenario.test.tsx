 ...
 * - Uses hooks: useRouter, useEffect, useMemo, useState, useDepartments, useProfile, useCreateScenario, useGenerateScenarioAI, useRandomizeScenario, useScenarioDetail, useScenarioDetailDefault, useUpdateScenario
 * - Uses router: true
 * - Has API calls: false
