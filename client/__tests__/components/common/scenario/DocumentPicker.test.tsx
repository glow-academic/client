...
// ——————————————————————————————————————————
import { DocumentPicker, DocumentMappingItem, DocumentPickerProps } from '@/components/common/scenario/DocumentPicker';



// ------------------------------------------------------------------
// Minimal props factory – edit values as needed
const mockProps: DocumentPickerProps<unknown> = {
  mapping: {},
  validIds: [],
  selectedIds: [],
  onSelect: vi.fn(),
 ...
 * - Named exports: DocumentPicker, DocumentMappingItem, DocumentPickerProps
 * - Has props: true
 * - Props interface: DocumentPickerProps
