...
// ——————————————————————————————————————————
import Parameter, { ParameterProps } from '@/components/common/parameter/Parameter';
 ...
 * - Uses hooks: useRouter, useEffect, useMemo, useState, useDepartments, useProfile, useCreateParameter, useParameterDetail, useParameterDetailDefault, useUpdateParameter
 * - Uses router: true
 * - Has API calls: false
