 ...
 * - Uses hooks: useEffect, useMemo, useState, useDepartments, useProfile, useCreateSimulation, useCreateSimulationV2, useSimulationDetail, useSimulationDetailDefault, useUpdateSimulation, useUpdateSimulationV2, useRouter
 * - Uses router: true
 * - Has API calls: false
