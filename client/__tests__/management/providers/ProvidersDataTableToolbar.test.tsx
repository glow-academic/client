...
// ——————————————————————————————————————————
import { ProvidersDataTableToolbar, ProvidersDataTableToolbarProps } from '@/components/management/providers/ProvidersDataTableToolbar';
...
const mockProps: ProvidersDataTableToolbarProps = {
  table: {} as unknown as Table<{ name: string; id: string; createdAt: string; updatedAt: string; description: string; providerId: string; active: boolean; }>,
  providerOptions: [],
  customModelOptions: [],
  statusOptions: [],
};
 ...
 * Path: management/providers/ProvidersDataTableToolbar.tsx
 * 
 * Features detected:
