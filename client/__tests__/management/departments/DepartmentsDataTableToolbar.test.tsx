...
// ——————————————————————————————————————————
import { DepartmentsDataTableToolbar, DepartmentsDataTableToolbarProps } from '@/components/management/departments/DepartmentsDataTableToolbar';
...
const mockProps: DepartmentsDataTableToolbarProps = {
  table: {} as unknown as Table<{ name: string; id: string; createdAt: string; updatedAt: string; departmentCode: string; description: string; profileIds: string[]; }>,
...
describe('DepartmentsDataTableToolbar', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<DepartmentsDataTableToolbar {...mockProps} />);
