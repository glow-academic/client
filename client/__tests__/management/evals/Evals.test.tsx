...
const mockEvals = [
  ...
  },
  {
    ...
    scenarioIds: ['scenario-1', 'scenario-2', 'scenario-3', 'scenario-4', 'scenario-5'],
...
describe('Evals', () => {
  ...
  describe('Rendering', () => {
    it('should render without crashing', async () => {
      ...
      expect(screen.getByText('Manage your evaluation configurations and run assessments')).toBeInTheDocument();
    });
    ...
    it('should display evaluation details correctly', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('Student Assessment 1')).toBeInTheDocument();
        expect(screen.getByText('Basic student evaluation for math concepts')).toBeInTheDocument();
    ...
    it('should have correct accessibility attributes', async () => {
      ...
      await waitFor(() => {
        const createButton = screen.getByRole('button', { name: /create new evaluation/i });
  ...
  describe('User Interactions', () => {
    ...
    it('should show info toast when run button is clicked', async () => {
      ...
      expect(toast.info).toHaveBeenCalledWith('Evaluation run functionality coming soon!');
    });
    ...
    it('should open delete dialog when delete button is clicked', async () => {
      ...
      expect(screen.getByText(/This will permanently delete the evaluation "Student Assessment 1"/)).toBeInTheDocument();
    });
    ...
    it('should delete evaluation when delete is confirmed', async () => {
      ...
      await waitFor(() => {
        ...
        expect(toast.success).toHaveBeenCalledWith('Evaluation deleted successfully');
      });
    });
    ...
    it('should navigate to create evaluation from empty state', async () => {
      ...
      const createButton = screen.getByRole('button', { name: /create your first evaluation/i });
      await user.click(createButton);
  ...
  describe('Edge Cases', () => {
    it('should handle evaluations without descriptions', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.queryByText('Basic student evaluation for math concepts')).not.toBeInTheDocument();
      });
    });
