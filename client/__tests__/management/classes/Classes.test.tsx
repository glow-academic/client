...
vi.mock('@/utils/queries/classes/get-all-classes', () => ({
  getAllClasses: vi.fn(() => Promise.resolve([
    { id: '1', name: 'CS 180', classCode: 'CS180', year: 2024, term: 'fall', description: 'Programming Fundamentals', createdAt: new Date().toISOString() },
    { id: '2', name: 'CS 182', classCode: 'CS182', year: 2024, term: 'fall', description: 'Data Structures', createdAt: new Date().toISOString() },
  ])),
}));
...
vi.mock('@/utils/queries/rubrics/get-all-rubrics', () => ({
  getAllRubrics: vi.fn(() => Promise.resolve([
    { id: '1', name: 'Teaching Assistant Evaluation Rubric', description: 'Test', points: 100, passPoints: 70, createdAt: new Date().toISOString() },
  ])),
}));

vi.mock('@/utils/queries/standard_groups/get-standard-groups-by-rubrics', () => ({
  getStandardGroupsByRubrics: vi.fn(() => Promise.resolve([
    { id: '1', name: 'Communication Skills', shortName: 'Active Listening', rubricId: '1', points: 25, passPoints: 18 },
    { id: '2', name: 'Problem Solving', shortName: 'Content Mastery', rubricId: '1', points: 25, passPoints: 18 },
  ])),
}));
...
vi.mock('@/utils/queries/simulation_chats/get-simulation-chats-by-attempts', () => ({
  getSimulationChatsByAttempts: vi.fn(() => Promise.resolve([
    { id: '1', attemptId: '1', scenarioId: '1', completed: true, title: 'Chat 1', createdAt: new Date().toISOString() },
    { id: '2', attemptId: '2', scenarioId: '2', completed: false, title: 'Chat 2', createdAt: new Date().toISOString() },
  ])),
}));
...
vi.mock('@/utils/queries/simulation_chat_grades/get-simulation-chat-grades-by-simulationchats', () => ({
  getSimulationChatGradesBySimulationChats: vi.fn(() => Promise.resolve([
    { id: '1', simulationChatId: '1', score: 85, passed: true, timeTaken: 300, rubricId: '1', createdAt: new Date().toISOString() },
    { id: '2', simulationChatId: '2', score: 72, passed: true, timeTaken: 450, rubricId: '1', createdAt: new Date().toISOString() },
  ])),
}));
...
vi.mock('@/utils/queries/simulation_chat_feedbacks/get-simulation-chat-feedbacks-by-simulationchatgrades', () => ({
  getSimulationChatFeedbacksBySimulationChatGrades: vi.fn(() => Promise.resolve([
    ...
    { id: '3', simulationChatGradeId: '2', standardId: '3', total: 3, feedback: 'Needs improvement' },
  ])),
}));
