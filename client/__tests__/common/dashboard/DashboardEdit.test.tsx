...
const DEFAULT_OVERRIDES = {
  queries: {
    getAllComponents: /* TODO */ [],
    getAllDashboards: /* TODO */ [],
    getProfilesByUser: /* TODO */ [],
  },
  mutations: {
    updateComponent: /* TODO */ {},
    createDashboard: /* TODO */ {},
    updateDashboard: /* TODO */ {},
  },
};
/* ------------------------------------------------------------------ */
 ...
 * - Uses hooks: useQuery, useQueryClient, useSession, useCallback, useEffect, useMemo, useState, userId, user, userProfile, usedComponentIds
 * - Uses router: false
 * - Has API calls: true
