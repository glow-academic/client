...
// ——————————————————————————————————————————
import LeaderboardTable from '@/components/common/class/LeaderboardTable';



// ------------------------------------------------------------------
// Minimal props factory – edit values as needed
import type { LeaderboardTableProps } from '@/components/common/class/LeaderboardTable';
 ...
 * Path: common/class/LeaderboardTable.tsx
 * 
 * Features detected:
 * - Default export: true
 * - Named exports: None
