...
vi.mock('@/components/ui/breadcrumb', () => ({
  ...
  BreadcrumbLink: ({ children, onClick, className }: { children: React.ReactNode; onClick?: () => void; className?: string }) => (
    <button data-testid="breadcrumb-link" onClick={onClick} className={className}>{children}</button>
  ),
...
describe('NavigationBreadcrumbs', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render with props', () => {
      render(<NavigationBreadcrumbs breadcrumbs={mockBreadcrumbs} onSectionChange={mockOnSectionChange} />);
    ...
    it('should render with right content', () => {
      ...
      render(<NavigationBreadcrumbs breadcrumbs={mockBreadcrumbs} rightContent={rightContent} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle missing or invalid props', () => {
      ...
      render(<NavigationBreadcrumbs breadcrumbs={breadcrumbsWithoutSections} onSectionChange={mockOnSectionChange} />);
      expect(screen.getByText('Home')).toBeInTheDocument();
      expect(screen.getByText('Analytics')).toBeInTheDocument();
    });
    ...
    it('should render only right content when no breadcrumbs and right content provided', () => {
      const rightContent = <button data-testid="right-content">Action</button>;
      render(<NavigationBreadcrumbs breadcrumbs={[]} rightContent={rightContent} />);
