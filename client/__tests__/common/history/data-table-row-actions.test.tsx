...
describe("DataTableRowActions", () => {
  ...
  describe("Rendering", () => {
    it("should render without crashing", () => {
      render(<DataTableRowActions id="test-id" completed={false} />);
    ...
    it("should render Continue button for incomplete chats in showChats mode", () => {
      render(
        <DataTableRowActions id="test-id" completed={false} showChats={true} />,
      );
    ...
    it("should render View button for completed chats in showChats mode", () => {
      render(
        <DataTableRowActions id="test-id" completed={true} showChats={true} />,
      );
  ...
  describe("Link Navigation", () => {
    ...
    it("should link to chat page for completed chats", () => {
      render(
        <DataTableRowActions id="chat-789" completed={true} showChats={true} />,
      );
    ...
    it("should handle different id formats", () => {
      ...
      testIds.forEach((id) => {
        const { unmount } = render(
          <DataTableRowActions id={id} completed={false} />,
        );
  ...
  describe("Edge Cases", () => {
    it("should handle empty id gracefully", () => {
      render(<DataTableRowActions id="" completed={false} />);
