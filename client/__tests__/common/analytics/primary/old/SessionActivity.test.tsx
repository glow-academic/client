...
// ——————————————————————————————————————————
import SessionActivity, { SessionActivityProps } from '@/components/common/analytics/primary/old/SessionActivity';
...
describe('SessionActivity', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<SessionActivity {...mockProps} />);
 ...
 * Path: common/analytics/primary/old/SessionActivity.tsx
 * 
 * Features detected:
 * - Default export: true
