...
// ——————————————————————————————————————————
import PerformanceByPersonality, { PerformanceByPersonalityProps } from '@/components/common/analytics/primary/old/PerformanceByPersonality';
...
describe('PerformanceByPersonality', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<PerformanceByPersonality {...mockProps} />);
 ...
 * Path: common/analytics/primary/old/PerformanceByPersonality.tsx
 * 
 * Features detected:
 * - Default export: true
