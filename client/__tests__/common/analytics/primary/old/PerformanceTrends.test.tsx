...
// ——————————————————————————————————————————
import PerformanceTrends, { PerformanceTrendsProps } from '@/components/common/analytics/primary/old/PerformanceTrends';
...
describe('PerformanceTrends', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<PerformanceTrends {...mockProps} />);
 ...
 * Path: common/analytics/primary/old/PerformanceTrends.tsx
 * 
 * Features detected:
 * - Default export: true
