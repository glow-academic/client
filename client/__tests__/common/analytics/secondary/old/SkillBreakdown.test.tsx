...
// ——————————————————————————————————————————
import SkillBreakdown, { SkillBreakdownProps } from '@/components/common/analytics/secondary/old/SkillBreakdown';
...
describe('SkillBreakdown', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<SkillBreakdown {...mockProps} />);
 ...
 * Path: common/analytics/secondary/old/SkillBreakdown.tsx
 * 
 * Features detected:
 * - Default export: true
 ...
 * 
 * Basic rendering:
 * render(<SkillBreakdown {...mockProps} />);
