...
// ——————————————————————————————————————————
import TrainingInsights, { TrainingInsightsProps } from '@/components/common/analytics/secondary/old/TrainingInsights';
 ...
 * Path: common/analytics/secondary/old/TrainingInsights.tsx
 * 
 * Features detected:
 * - Default export: true
