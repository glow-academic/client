...
// ——————————————————————————————————————————
import CohortPerformance, { CohortPerformanceProps } from '@/components/common/analytics/secondary/old/CohortPerformance';
 ...
 * Path: common/analytics/secondary/old/CohortPerformance.tsx
 * 
 * Features detected:
 * - Default export: true
