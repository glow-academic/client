...
// ——————————————————————————————————————————
import PassRate, { PassRateProps } from '@/components/common/analytics/header/old/PassRate';
...
describe('PassRate', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<PassRate {...mockProps} />);
 ...
 * Path: common/analytics/header/old/PassRate.tsx
 * 
 * Features detected:
 * - Default export: true
 * - Named exports: PassRateProps
 * - Has props: true
 * - Props interface: PassRateProps
