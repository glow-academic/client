...
// ——————————————————————————————————————————
import TotalTas, { TotalTasProps } from '@/components/common/analytics/header/old/TotalTas';
...
describe('TotalTas', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<TotalTas {...mockProps} />);
 ...
 * Path: common/analytics/header/old/TotalTas.tsx
 * 
 * Features detected:
 * - Default export: true
