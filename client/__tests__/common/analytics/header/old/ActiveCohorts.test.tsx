...
// ——————————————————————————————————————————
import ActiveCohorts, { ActiveCohortsProps } from '@/components/common/analytics/header/old/ActiveCohorts';
...
describe('ActiveCohorts', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<ActiveCohorts {...mockProps} />);
 ...
 * Path: common/analytics/header/old/ActiveCohorts.tsx
 * 
 * Features detected:
 * - Default export: true
