...
// ——————————————————————————————————————————
import CompletionRate, { CompletionRateProps } from '@/components/common/analytics/header/old/CompletionRate';
...
describe('CompletionRate', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<CompletionRate {...mockProps} />);
    ...
    it.skip('should render with props', () => {
      ...
      // Props interface: CompletionRateProps
 ...
 * Path: common/analytics/header/old/CompletionRate.tsx
 * 
 * Features detected:
 * - Default export: true
 * - Named exports: CompletionRateProps
 * - Has props: true
 * - Props interface: CompletionRateProps
 ...
 * 
 * Basic rendering:
 * render(<CompletionRate {...mockProps} />);
