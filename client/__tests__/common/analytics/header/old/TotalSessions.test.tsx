...
// ——————————————————————————————————————————
import TotalSessions, { TotalSessionsProps } from '@/components/common/analytics/header/old/TotalSessions';
...
describe('TotalSessions', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<TotalSessions {...mockProps} />);
 ...
 * Path: common/analytics/header/old/TotalSessions.tsx
 * 
 * Features detected:
 * - Default export: true
