...
// ——————————————————————————————————————————
import NeedSupport, { NeedSupportProps } from '@/components/common/analytics/header/old/NeedSupport';
...
describe('NeedSupport', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<NeedSupport {...mockProps} />);
 ...
 * Path: common/analytics/header/old/NeedSupport.tsx
 * 
 * Features detected:
 * - Default export: true
