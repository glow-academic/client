...
// ——————————————————————————————————————————
import TrainingHours, { TrainingHoursProps } from '@/components/common/analytics/header/old/TrainingHours';
...
describe('TrainingHours', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<TrainingHours {...mockProps} />);
 ...
 * Path: common/analytics/header/old/TrainingHours.tsx
 * 
 * Features detected:
 * - Default export: true
 * - Named exports: TrainingHoursProps
 * - Has props: true
 * - Props interface: TrainingHoursProps
