...
// ——————————————————————————————————————————
import SimulationCompositionPicker from '@/components/common/analytics/footer/SimulationCompositionPicker';



// ------------------------------------------------------------------
// Minimal props factory – edit values as needed
import type { SimulationCompositionPickerProps } from '@/components/common/analytics/footer/SimulationCompositionPicker';
