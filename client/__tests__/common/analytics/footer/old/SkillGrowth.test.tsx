...
// ——————————————————————————————————————————
import SkillGrowth, { SkillGrowthProps } from '@/components/common/analytics/footer/old/SkillGrowth';
...
describe('SkillGrowth', () => {
  ...
  describe('basic render smoke-test', () => {
    it('renders without crashing', async () => {
      ...
      renderWithMocks(<SkillGrowth {...mockProps} />);
 ...
 * Path: common/analytics/footer/old/SkillGrowth.tsx
 * 
 * Features detected:
 * - Default export: true
