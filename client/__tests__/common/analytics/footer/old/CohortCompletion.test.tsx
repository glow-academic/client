...
// ——————————————————————————————————————————
import CohortCompletion, { CohortCompletionProps } from '@/components/common/analytics/footer/old/CohortCompletion';
 ...
 * Path: common/analytics/footer/old/CohortCompletion.tsx
 * 
 * Features detected:
 * - Default export: true
