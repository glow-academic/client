...
// ——————————————————————————————————————————
import SimulationPerformance, { SimulationPerformanceProps } from '@/components/common/analytics/footer/old/SimulationPerformance';
 ...
 * Path: common/analytics/footer/old/SimulationPerformance.tsx
 * 
 * Features detected:
 * - Default export: true
