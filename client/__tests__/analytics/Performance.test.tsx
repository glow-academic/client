...
vi.mock('@/utils/queries/simulations/get-all-simulations', () => ({
  getAllSimulations: vi.fn(() => Promise.resolve([
...
vi.mock('@/utils/queries/rubrics/get-all-rubrics', () => ({
  getAllRubrics: vi.fn(() => Promise.resolve([
    { id: '1', name: 'Teaching Assistant Evaluation Rubric', description: 'Test', points: 100, passPoints: 70 },
    { id: '2', name: 'AI Student Performance Evaluation Rubric', description: 'Test', points: 100, passPoints: 70 },
    { id: '3', name: 'Unused Rubric', description: 'Test', points: 100, passPoints: 70 },
  ])),
}));
...
vi.mock('@/utils/queries/simulation_chats/get-simulation-chats-by-attempts', () => ({
  getSimulationChatsByAttempts: vi.fn(() => Promise.resolve([
    ...
    { id: '2', attemptId: '2', scenarioId: '2', completed: false, title: 'Chat 2' },
  ])),
}));
