...
describe("ClassEdit", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should display loading state while fetching class data", () => {
      vi.mocked(getClass).mockImplementation(() => new Promise(() => {})); // Never resolves
    ...
    it("should populate form fields with class data when loaded", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByDisplayValue("Introduction to Mathematics")
        ).toBeInTheDocument();
      });
    });
  ...
  describe("API Integration", () => {
    ...
    it("should handle error states", async () => {
      vi.mocked(getClass).mockRejectedValue(new Error("API Error"));
  ...
  describe("Edge Cases", () => {
    it("should handle edge cases gracefully", async () => {
      ...
      vi.mocked(getClass).mockResolvedValue(minimalClass);
    ...
    it("should handle missing class data fields", async () => {
      ...
      vi.mocked(getClass).mockResolvedValue(incompleteClass);
    ...
    it("should handle network errors gracefully", async () => {
      vi.mocked(getClass).mockRejectedValue(new Error("Network error"));
