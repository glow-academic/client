...
export const simulationAttempts = pgTable(
  ...
  (table) => [
    ...
    index("simulation_attempts_id_profile_archived_idx").using(
      "btree",
      table.id.asc().nullsLast().op("uuid_ops"),
      table.profileId.asc().nullsLast().op("uuid_ops"),
      table.archived.asc().nullsLast().op("uuid_ops"),
      table.infiniteMode.asc().nullsLast().op("uuid_ops"),
    ),
    index("simulation_attempts_profile_sim_idx").using(
      "btree",
      table.profileId.asc().nullsLast().op("uuid_ops"),
...
export const simulationChatCrowdsourcedFeedbacks = pgTable(
...
export const simulationCrowdsourcedMessages = pgTable(
