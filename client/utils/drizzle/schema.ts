import { pgTable, serial, text, jsonb, timestamp, foreignKey, uuid, integer, boolean, varchar, bigint, primaryKey, pgSequence, pgEnum } from "drizzle-orm/pg-core"
...
export const drizzleMigrationsIdSeq = pgSequence("__drizzle_migrations_id_seq", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const drizzleMigrationsIdSeq1 = pgSequence("__drizzle_migrations_id_seq1", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const drizzleMigrationsIdSeq2 = pgSequence("__drizzle_migrations_id_seq2", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const drizzleMigrationsIdSeq3 = pgSequence("__drizzle_migrations_id_seq3", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
export const drizzleMigrationsIdSeq4 = pgSequence("__drizzle_migrations_id_seq4", {  startWith: "1", increment: "1", minValue: "1", maxValue: "2147483647", cache: "1", cycle: false })
...
export const events = pgTable("events", {
	...
	scheduleId: uuid("schedule_id").notNull()}, (table) => [
	foreignKey({
...
export const evals = pgTable("evals", {
	...
	maxParallelRuns: integer("max_parallel_runs").notNull()}, (table) => [
	foreignKey({
...
export const simulationAttempts = pgTable("simulation_attempts", {
	...
	simulationId: uuid("simulation_id").notNull()}, (table) => [
	foreignKey({
...
export const standards = pgTable("standards", {
	...
	description: text().notNull(),
	points: integer().notNull(),
	standardGroupId: uuid("standard_group_id").notNull()}, (table) => [
	foreignKey({
