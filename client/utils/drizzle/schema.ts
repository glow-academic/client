...
export const evalMessageType = pgEnum("eval_message_type", [
  "query",
  "response",
]);
...
export const evals = pgTable(
  "evals",
  {
    ...
    startOnCreation: boolean("start_on_creation").default(true).notNull(),
  },
  (table) => [
    foreignKey({
...
export const dashboards = pgTable(
  "dashboards",
  {
    ...
    headerComponentIds: uuid("header_component_ids")
      .array()
      .default(["RAY"])
      .notNull(),
    primaryComponentIds: uuid("primary_component_ids")
      .array()
      .default(["RAY"])
      .notNull(),
    secondaryComponentIds: uuid("secondary_component_ids")
      .array()
      .default(["RAY"])
      .notNull(),
    footerComponentIds: uuid("footer_component_ids")
      .array()
      .default(["RAY"])
      .notNull(),
...
export const evalChatGrades = pgTable(
  "eval_chat_grades",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    createdAt: timestamp("created_at", { withTimezone: true, mode: "string" })
...
export const evalChatFeedbacks = pgTable(
  "eval_chat_feedbacks",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    createdAt: timestamp("created_at", { withTimezone: true, mode: "string" })
...
export const evalChats = pgTable(
  "eval_chats",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    createdAt: timestamp("created_at", { withTimezone: true, mode: "string" })
...
export const evalMessages = pgTable(
  "eval_messages",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    createdAt: timestamp("created_at", { withTimezone: true, mode: "string" })
