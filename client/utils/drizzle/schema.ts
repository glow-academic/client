import { pgTable, serial, varchar, timestamp, text, foreignKey, uuid, integer, boolean, doublePrecision, bigint, index, jsonb, real, primaryKey, uniqueIndex, pgView, pgMaterializedView, numeric, pgEnum } from "drizzle-orm/pg-core"
