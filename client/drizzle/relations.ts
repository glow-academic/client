...
export const standardGroupsRelations = relations(
  standardGroups,
  ({ one, many }) => ({
    rubric: one(rubrics, {
...
export const simulationAttemptsRelations = relations(
  simulationAttempts,
  ({ one, many }) => ({
    user: one(users, {
...
export const simulationChatsRelations = relations(
  simulationChats,
  ({ one, many }) => ({
...
export const simulationMessagesRelations = relations(
  simulationMessages,
  ({ one }) => ({
...
export const simulationChatGradesRelations = relations(
  simulationChatGrades,
  ({ one, many }) => ({
    rubric: one(rubrics, {
...
export const simulationChatFeedbacksRelations = relations(
  simulationChatFeedbacks,
  ({ one }) => ({
...
export const evalChatGradesRelations = relations(
  evalChatGrades,
  ({ one, many }) => ({
    rubric: one(rubrics, {
...
export const evalChatFeedbacksRelations = relations(
  evalChatFeedbacks,
  ({ one }) => ({
    standard: one(standards, {
