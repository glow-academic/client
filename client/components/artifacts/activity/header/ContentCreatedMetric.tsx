...
export interface EmulationsMetricProps {
  emulationsCount: number;
}

export default function EmulationsMetric({
  emulationsCount,
}: EmulationsMetricProps) {
  return (
    <Card className="bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 border-accent/30 h-full flex flex-col">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-sm font-medium">Emulations</CardTitle>
