...
import { CrowdsourcedRubricFeedbackData } from "@/hooks/use-crowdsourced-rubric-feedback-columns";
import { FeedbackDataTableToolbar } from "./FeedbackDataTableToolbar";

export interface CrowdsourcedRubricFeedbackDataTableProps {
  columns: ColumnDef<CrowdsourcedRubricFeedbackData>[];
  data: CrowdsourcedRubricFeedbackData[];
  isRefreshing: boolean;
  onRefresh: () => void;
}

export function CrowdsourcedRubricFeedbackDataTable({
  columns,
  data,
  isRefreshing,
  onRefresh,
