...
import { CrowdsourcedMessageData } from "@/hooks/use-crowdsourced-message-columns";
import { FeedbackDataTableToolbar } from "./FeedbackDataTableToolbar";

export interface CrowdsourcedMessagesDataTableProps {
  columns: ColumnDef<CrowdsourcedMessageData>[];
  data: CrowdsourcedMessageData[];
  isRefreshing: boolean;
  onRefresh: () => void;
}

export function CrowdsourcedMessagesDataTable({
  columns,
  data,
  isRefreshing,
  onRefresh,
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                ...
                >
                  No crowdsourced messages found.
                </TableCell>
              </TableRow>
            )}
          </TableBody>
