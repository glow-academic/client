...
function PersonaComponent({
  ...
  const [aiFormData, setAiFormData] = useState<{
    ...
    name_resource: {
      id: "019b995c-8e99-7857-8f01-4de8ad620b37",
      name: "Happy",
      generated: true,
    },
    description_resource: {
      id: "019b995c-8e96-7712-8abb-da48b93ef8c4",
      description: "Provides uplifting feedback and cheerful responses.",
      generated: true,
    },
    color_resource: {
      id: "019b995b-52f6-773e-9996-4bb11ef1e435",
      name: "Green",
    ...
    icon_resource: {
      id: "019b995b-52f7-7529-a5a1-36d3e463f24d",
      name: "SmilePlus",
    ...
    example_resources: [
      {
        id: "019b3be4-3253-7e6b-8ea0-093bbda66064",
        example: "I'm excited to learn more",
        idx: 0,
        generated: true,
      },
      {
        id: "019b3be4-3253-7e60-b44b-28075571088e",
        example: "That sounds great!",
        idx: 1,
        generated: true,
      },
      {
        id: "019b3be4-3253-7e6c-ae25-231dd20f6a97",
        example: "This is really helpful!",
        idx: 2,
        generated: true,
      },
    ],
    parameter_field_resources: [
      {
        id: "019bb25e-e5f8-7dda-b5c5-45f0ba4336bd",
        field_id: "019bb25e-e5f8-7dda-b5c5-45f0ba4336bd",
        parameter_id: "019bb25e-e621-702e-a7ba-81fd751a9c61",
        name: "happy",
        description: "Provides uplifting feedback and cheerful responses",
        generated: true,
    ...
    // Flag resource - "Active" flag to mark persona as active
    flag_resource: {
      id: "019be334-bfc3-7998-9dcf-a00d3d137da5",
      name: "Active",
      description:
        "Controls whether this persona is available for use in scenarios",
      icon: "Power",
      generated: true,
    },
    // Parameter resources - "Persona Type" parameter
    parameter_resources: [
      {
        parameter_id: "019bb25e-e621-702b-8d5d-5bfb7ed4af04",
        name: "Persona Type",
