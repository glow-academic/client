...
export default function Markdown({
    ...
    return (
        <div className="latex-container"> {/* Consider renaming this class if it's no longer just for "Latex" */}
            <ReactMarkdown
                remarkPlugins={[
                    RemarkMathPlugin,
                    remarkGfm,
                ...
                components={{
                    ...
                    thead: ({ children }) => <thead className="prose-thead">{children}</thead>,
                    tbody: ({ children }) => <tbody className="prose-tbody">{children}</tbody>,
            ...
            <style jsx global>{`
                ...
                .math-wrapper { /* If you wrap math content manually */
                    display: inline-block;
                    white-space: nowrap;
                }
