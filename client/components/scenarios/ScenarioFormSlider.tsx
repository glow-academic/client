/**
 * ScenarioFormSlider.tsx
 * Used to pick a value for a certain item as part of the scenario form
...
export interface ScenarioFormSliderProps {
...
export function ScenarioFormSlider({
  leftContent,
  rightContent,
  defaultValue,
  label = "Temperature",
