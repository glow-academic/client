    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-h-[400px] overflow-y-auto py-2 px-2">
        ...
        {filteredGroups.map((group) => {
          const isEditingName =
            editingId === group.id && editingField === "name";
          const isEditingDescription =
            editingId === group.id && editingField === "description";
                ...
                >
                  <Input
                    ...
                    onBlur={() => {
                      ...
                      if (
                        editingValue.name?.trim() &&
                        editingValue.name.trim() !== group.name
                      ) {
                        handleSaveEdit(group.id, "name");
                      } else {
                        handleCancelEdit();
