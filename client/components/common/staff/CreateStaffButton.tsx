...
export function CreateStaffButton({
  ...
  // Determine which button to show based on context
  // If scoped (cohort/department pages), show "Search Existing"
  // If not scoped (staff.tsx page), show "CSV Import"
  const showSearchButton = isScoped && searchStaffAction;
  const showCSVButton = !isScoped && processCSVAction;
