/**
 * CohortSimulationSection.tsx
 * Reusable simulation configuration section component for individual simulations in cohorts
 */
"use client";
...
export interface CohortSimulationSectionProps {
  // Data
  simulationId: string;
  ...
  // Callbacks
  onActiveToggle: (simulationId: string, active: boolean) => void;
  onMoveUp: (simulationId: string) => void;
  onMoveDown: (simulationId: string) => void;
...
export function CohortSimulationSection({
  simulationId,
  simulationName,
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        onActiveToggle(simulationId, checked)
                      }
                      disabled={readonly}
                    />
                  </div>
                  <p className="text-xs text-muted-foreground pl-6">
                    Enable or disable this simulation
                  </p>
                </div>
              </CardContent>
            </AccordionContent>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  size="icon"
                  className="h-8 w-8"
                  onClick={() => onMoveDown(simulationId)}
                  disabled={!canMoveDown || readonly}
                >
                  <ArrowDown className="h-3.5 w-3.5" />
                </Button>
