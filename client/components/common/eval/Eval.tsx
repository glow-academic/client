...
export default function Eval({
    ...
    const updateMutation = useMutation({
        mutationFn: ({ id, data }: { id: string; data: any }) => updateEval(id, data),
        onSuccess: () => {
    ...
    useEffect(() => {
        if (isEditMode && evalData) {
            setFormData({
                ...
                scenarioIds: evalData.scenarioIds?.filter((id: string) => id !== "RAY") || [],
                ...
                rubricIds: evalData.rubricIds?.filter((id: string) => id !== "RAY") || [],
            });
        }
    }, [isEditMode, evalData]);

    const handleInputChange = (field: keyof EvalFormData, value: string | number | string[] | null) => {
    ...
    const addItem = (field: "scenarioIds" | "agentIds" | "rubricIds", itemId: string) => {
    ...
    const removeItem = (field: "scenarioIds" | "agentIds" | "rubricIds", itemId: string) => {
        setFormData(prev => ({
            ...prev,
    ...
    const randomizeOrder = (field: "scenarioIds" | "agentIds" | "rubricIds") => {
        ...
        toast.success(`${field === "scenarioIds" ? "Scenarios" : field === "agentIds" ? "Agents" : "Rubrics"} randomized!`);
    };
    ...
    const handleDrop = (e: React.DragEvent, targetItemId: string, field: "scenarioIds" | "agentIds" | "rubricIds") => {
        e.preventDefault();
        ...
        <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value: "student" | "ta") => handleInputChange("evalType", value)}
                                >
                                    <SelectTrigger>
                                        <SelectValue />
                                    </SelectTrigger>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => handleInputChange("maxTurns", parseInt(e.target.value) || 1)}
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => handleInputChange("numParallelRuns", parseInt(e.target.value) || 1)}
                                    className={errors.numParallelRuns ? "border-destructive" : ""}
                                />
                                {errors.numParallelRuns && (
                                    <p className="text-sm text-destructive">{errors.numParallelRuns}</p>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value: string) => handleInputChange("baseAgentId", value)}
                                >
                                    <SelectTrigger className={errors.baseAgentId ? "border-destructive" : ""}>
                                ...
                                {errors.baseAgentId && (
                                    <p className="text-sm text-destructive">{errors.baseAgentId}</p>
                                )}
                            </div>
                        </div>
                    </CardContent>
                ...
                <Card>
                    ...
                    <CardContent>
                        {errors.scenarioIds && (
                            <p className="text-sm text-destructive mb-4">{errors.scenarioIds}</p>
                        )}
                        ...
                        {formData.scenarioIds.length === 0 ? (
                            <div className="flex items-center justify-center h-32 text-center text-muted-foreground border border-dashed rounded-md">
                                <div>
                                    ...
                                    <p className="text-sm">Add scenarios to define evaluation contexts</p>
                                </div>
                            </div>
                        ) : (
                                            ...
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    <Button
                                                        ...
                                                        variant="outline"
                                                        size="sm"
                                                        onClick={() => removeItem("scenarioIds", scenarioId)}
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        {agents
                                            .filter((agent: Agent) => !formData.agentIds.includes(agent.id) && agent.id !== formData.baseAgentId)
                                            .map((agent: Agent) => (
                                                <SelectItem key={agent.id} value={agent.id}>
                                                    {agent.name}
                                                </SelectItem>
                ...
                <Card>
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        {rubrics
                                            .filter((rubric: Rubric) => !formData.rubricIds.includes(rubric.id))
                                            .map((rubric: Rubric) => (
                    ...
                    <CardContent>
                        {errors.rubricIds && (
                            <p className="text-sm text-destructive mb-4">{errors.rubricIds}</p>
                        )}
                        ...
                        {formData.rubricIds.length === 0 ? (
                            <div className="flex items-center justify-center h-32 text-center text-muted-foreground border border-dashed rounded-md">
                                <div>
                                    ...
                                    <p className="text-sm">Add rubrics to define evaluation criteria</p>
                                </div>
                            </div>
                        ) : (
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {formData.rubricIds.map((rubricId, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <h4 className="font-medium text-sm mb-1">{rubric.name}</h4>
