/**
 * components/admin/agents-content.tsx
...
import { deleteAgent } from "@/utils/mutations/delete-agent";
...
export function AgentsContent() {
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      const result = await deleteAgent(deleteItem.id);
            ...
            <CardHeader>
              <div className="flex justify-between items-start">
                ...
                <div className="flex gap-2 items-center">
                  <Badge variant="outline">Magnitude: {agent.threshold}%</Badge>
