...
export default function Chats() {
    const { columns, data, isLoading, userOptions, classOptions } = useTaskColumns();
            ...
            >
                ...
                <CardFooter className="text-xs text-muted-foreground flex justify-between">
                    ...
                    <span className={profileMetrics.shuffle.score >= 17 ? 'text-green-600 font-medium' : 'text-amber-600'}>
                        {profileMetrics.shuffle.score >= 17 ? 'PASS' : `${profileMetrics.shuffle.progress}% to pass`}
                    </span>
                </CardFooter>
            </Card>
            ...
            >
                ...
                <CardFooter className="text-xs text-muted-foreground flex justify-between">
                    ...
                    <span className={profileMetrics.aggressive.score >= 17 ? 'text-green-600 font-medium' : 'text-amber-600'}>
                        {profileMetrics.aggressive.score >= 17 ? 'PASS' : `${profileMetrics.aggressive.progress}% to pass`}
                    </span>
                </CardFooter>
            </Card>
            ...
            >
                ...
                <CardFooter className="text-xs text-muted-foreground flex justify-between">
                    ...
                    <span className={profileMetrics.happy.score >= 17 ? 'text-green-600 font-medium' : 'text-amber-600'}>
                        {profileMetrics.happy.score >= 17 ? 'PASS' : `${profileMetrics.happy.progress}% to pass`}
                    </span>
                </CardFooter>
            </Card>
            ...
            >
                ...
                <CardFooter className="text-xs text-muted-foreground flex justify-between">
                    ...
                    <span className={profileMetrics.confused.score >= 17 ? 'text-green-600 font-medium' : 'text-amber-600'}>
                        {profileMetrics.confused.score >= 17 ? 'PASS' : `${profileMetrics.confused.progress}% to pass`}
                    </span>
                </CardFooter>
            </Card>
        </div>
