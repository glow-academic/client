/**
 * SettingsAuthMethodsSection.tsx
 * Card-based selection for authentication methods
...
export interface SettingsAuthMethodsSectionProps {
  authMethods: AuthMethod[];
  onAuthMethodClick: (authId: string) => void;
...
export function SettingsAuthMethodsSection({
  authMethods,
  onAuthMethodClick,
  stepStatus,
  stepTitle,
  ...
  stepNumber,
  isReadonly,
}: SettingsAuthMethodsSectionProps) {
  const [searchTerm, setSearchTerm] = useState("");

  const filteredAuthMethods = useMemo(() => {
    if (!searchTerm.trim()) return authMethods;
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    onAuthMethodClick(auth.auth_id);
                  }}
                  disabled={isReadonly}
                  className={cn(
