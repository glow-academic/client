/**
 * SettingsBrandColorsSection.tsx
 * Brand colors section with individual cards for each color picker
 */
"use client";
...
interface BrandColorCardProps {
  label: string;
  fieldName: "primary_color" | "accent";
  value: string;
  originalValue: string;
  onColorChange: (fieldName: "primary_color" | "accent", value: string) => void;
  onReset: () => void;
...
export const BrandColorCard = forwardRef<HTMLDivElement, BrandColorCardProps>(
  (
    {
      label,
      fieldName,
...
BrandColorCard.displayName = "BrandColorCard";
...
export interface SettingsBrandColorsSectionProps {
  colors: BrandColors;
...
export function SettingsBrandColorsSection({
  colors,
  originalColors,
  onColorChange,
  onResetColor,
  ...
  isReadonly,
  cardRefs,
}: SettingsBrandColorsSectionProps) {
  return (
    <div className="space-y-6">
      {/* Individual Brand Color Cards */}
      <BrandColorCard
        ref={cardRefs?.primaryColorRef}
        label="Primary Color"
        fieldName="primary_color"
        value={colors.primary_color}
        originalValue={originalColors.primary_color}
        onColorChange={onColorChange}
        onReset={() => onResetColor("primary_color")}
      ...
      <BrandColorCard
        ref={cardRefs?.accentRef}
        label="Accent"
        fieldName="accent"
        value={colors.accent}
        originalValue={originalColors.accent}
        onColorChange={onColorChange}
        onReset={() => onResetColor("accent")}
        stepStatus={stepStatus}
