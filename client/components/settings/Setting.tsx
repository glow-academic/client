...
function SettingComponent({
  ...
  // Set generation capability when setting data is loaded
  useEffect(() => {
    if (settingData?.general_agent_id) {
      setGenerationCapability({
        artifactType: "setting",
        canGenerate: true,
        agentId: settingData.general_agent_id,
      });
    } else {
      setGenerationCapability({
        artifactType: "setting",
  ...
  }, [settingData?.general_agent_id, handleOpenStepCardModal]);
