/**
 * SettingsSidebarColorsSection.tsx
 * Sidebar colors section with individual cards for each color picker
 */
"use client";
...
interface SidebarColorCardProps {
  label: string;
  fieldName: "sidebar_background" | "sidebar_primary";
  value: string;
  originalValue: string;
  onColorChange: (fieldName: "sidebar_background" | "sidebar_primary", value: string) => void;
  onReset: () => void;
...
export const SidebarColorCard = forwardRef<HTMLDivElement, SidebarColorCardProps>(
  (
    {
      label,
      fieldName,
...
SidebarColorCard.displayName = "SidebarColorCard";
...
export interface SettingsSidebarColorsSectionProps {
...
export function SettingsSidebarColorsSection({
  colors,
  originalColors,
  onColorChange,
  onResetColor,
  ...
  isReadonly,
  cardRefs,
}: SettingsSidebarColorsSectionProps) {
  return (
    <div className="space-y-6">
      {/* Individual Sidebar Color Cards */}
      <SidebarColorCard
        ref={cardRefs?.sidebarBackgroundRef}
        label="Sidebar Background"
        fieldName="sidebar_background"
        value={colors.sidebar_background}
        originalValue={originalColors.sidebar_background}
        onColorChange={onColorChange}
        onReset={() => onResetColor("sidebar_background")}
      ...
      <SidebarColorCard
        ref={cardRefs?.sidebarPrimaryRef}
        label="Sidebar Primary"
        fieldName="sidebar_primary"
        value={colors.sidebar_primary}
        originalValue={originalColors.sidebar_primary}
        onColorChange={onColorChange}
        onReset={() => onResetColor("sidebar_primary")}
        stepStatus={stepStatus}
