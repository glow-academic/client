/**
 * SettingsLayoutColorsSection.tsx
 * Layout colors section with individual cards for each color picker
 */
"use client";
...
interface LayoutColorCardProps {
  label: string;
  fieldName: "background" | "surface";
  value: string;
  originalValue: string;
  onColorChange: (fieldName: "background" | "surface", value: string) => void;
  onReset: () => void;
...
export const LayoutColorCard = forwardRef<HTMLDivElement, LayoutColorCardProps>(
  (
    {
      label,
      fieldName,
...
export interface SettingsLayoutColorsSectionProps {
  colors: LayoutColors;
...
export function SettingsLayoutColorsSection({
  colors,
  originalColors,
  onColorChange,
  onResetColor,
  ...
  isReadonly,
  cardRefs,
}: SettingsLayoutColorsSectionProps) {
  return (
    <div className="space-y-6">
      {/* Individual Layout Color Cards */}
      <LayoutColorCard
        ref={cardRefs?.backgroundRef}
        label="Background"
        fieldName="background"
        value={colors.background}
        originalValue={originalColors.background}
        onColorChange={onColorChange}
        onReset={() => onResetColor("background")}
      ...
      <LayoutColorCard
        ...
        originalValue={originalColors.surface}
        onColorChange={onColorChange}
        onReset={() => onResetColor("surface")}
        stepStatus={stepStatus}
