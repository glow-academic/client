...
export default function DocumentKPI({
  ...
  const displayColor = isMounted ? chartColor : chartColorFallbacks.chart3;
  ...
  const gradientStyle = useMemo(() => {
    const color = displayColor || chartColorFallbacks.chart3;
    return {
    ...
    <>
      ...
      >
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <FileText className="h-4 w-4" style={{ color: displayColor }} />
        </CardHeader>
