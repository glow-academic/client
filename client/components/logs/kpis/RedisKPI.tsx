/**
 * RedisKPI.tsx
 * Health KPI component for Redis service.
 */
"use client";
...
export interface RedisKPIProps {
  ok: boolean;
  latency_ms: number;
  error: string;
  trend: TrendData[];
...
export default function RedisKPI({
  ok,
  latency_ms,
  error,
  trend,
  ...
  const chartColor = chartColors[1]; // chart-2
  ...
  const displayColor = isMounted ? chartColor : chartColorFallbacks.chart2;
  ...
  const gradientStyle = useMemo(() => {
    const color = displayColor || chartColorFallbacks.chart2;
    return {
    ...
    <>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-4xl">
          <DialogHeader>
            <DialogTitle>Redis Health Trend</DialogTitle>
            <DialogDescription hidden>
              This chart shows Redis health metrics over time.
            </DialogDescription>
          </DialogHeader>
