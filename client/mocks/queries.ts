...
vi.mock('@/utils/queries/app_logs/get-app-log', () => ({
  getAppLog: vi.fn(() => mockSchema.app_logs?.[0] || null),
}));
...
vi.mock('@/utils/queries/eval_chat_feedbacks/get-all-eval-chat-feedbacks', () => ({
...
vi.mock('@/utils/queries/eval_chat_feedbacks/get-eval-chat-feedback', () => ({
  getEvalChatFeedback: vi.fn(() => mockSchema.eval_chat_feedbacks?.[0] || null),
}));
vi.mock('@/utils/queries/eval_chat_feedbacks/get-eval-chat-feedbacks-by-evalchatgrade', () => ({
  getEvalChatFeedbacksByEvalchatgrade: vi.fn(() => mockSchema.eval_chat_feedbacks || []),
}));
vi.mock('@/utils/queries/eval_chat_feedbacks/get-eval-chat-feedbacks-by-evalchatgrades', () => ({
  getEvalChatFeedbacksByEvalchatgrades: vi.fn(() => mockSchema.eval_chat_feedbacks || []),
}));
vi.mock('@/utils/queries/eval_chat_feedbacks/get-eval-chat-feedbacks-by-standard', () => ({
  getEvalChatFeedbacksByStandard: vi.fn(() => mockSchema.eval_chat_feedbacks || []),
}));
vi.mock('@/utils/queries/eval_chat_feedbacks/get-eval-chat-feedbacks-by-standards', () => ({
  getEvalChatFeedbacksByStandards: vi.fn(() => mockSchema.eval_chat_feedbacks || []),
}));
...
vi.mock('@/utils/queries/eval_chat_grades/get-eval-chat-grade', () => ({
  getEvalChatGrade: vi.fn(() => mockSchema.eval_chat_grades?.[0] || null),
}));
vi.mock('@/utils/queries/eval_chat_grades/get-eval-chat-grades-by-evalchat', () => ({
  getEvalChatGradesByEvalchat: vi.fn(() => mockSchema.eval_chat_grades || []),
}));
vi.mock('@/utils/queries/eval_chat_grades/get-eval-chat-grades-by-evalchats', () => ({
  getEvalChatGradesByEvalchats: vi.fn(() => mockSchema.eval_chat_grades || []),
}));
vi.mock('@/utils/queries/eval_chat_grades/get-eval-chat-grades-by-rubric', () => ({
  getEvalChatGradesByRubric: vi.fn(() => mockSchema.eval_chat_grades || []),
}));
vi.mock('@/utils/queries/eval_chat_grades/get-eval-chat-grades-by-rubrics', () => ({
  getEvalChatGradesByRubrics: vi.fn(() => mockSchema.eval_chat_grades || []),
}));
...
vi.mock('@/utils/queries/eval_chats/get-eval-chat', () => ({
  getEvalChat: vi.fn(() => mockSchema.eval_chats?.[0] || null),
}));
vi.mock('@/utils/queries/eval_chats/get-eval-chats-by-evalrun', () => ({
  getEvalChatsByEvalrun: vi.fn(() => mockSchema.eval_chats || []),
}));
vi.mock('@/utils/queries/eval_chats/get-eval-chats-by-evalruns', () => ({
  getEvalChatsByEvalruns: vi.fn(() => mockSchema.eval_chats || []),
}));
vi.mock('@/utils/queries/eval_chats/get-eval-chats-by-scenario', () => ({
  getEvalChatsByScenario: vi.fn(() => mockSchema.eval_chats || []),
}));
vi.mock('@/utils/queries/eval_chats/get-eval-chats-by-scenarios', () => ({
  getEvalChatsByScenarios: vi.fn(() => mockSchema.eval_chats || []),
}));
...
vi.mock('@/utils/queries/eval_messages/get-eval-message', () => ({
  getEvalMessage: vi.fn(() => mockSchema.eval_messages?.[0] || null),
}));
vi.mock('@/utils/queries/eval_messages/get-eval-messages-by-chat', () => ({
  getEvalMessagesByChat: vi.fn(() => mockSchema.eval_messages || []),
}));
vi.mock('@/utils/queries/eval_messages/get-eval-messages-by-chats', () => ({
  getEvalMessagesByChats: vi.fn(() => mockSchema.eval_messages || []),
}));
...
vi.mock('@/utils/queries/simulation_attempts/get-simulation-attempt', () => ({
  getSimulationAttempt: vi.fn(() => mockSchema.simulation_attempts?.[0] || null),
}));
vi.mock('@/utils/queries/simulation_attempts/get-simulation-attempts-by-profile', () => ({
  getSimulationAttemptsByProfile: vi.fn(() => mockSchema.simulation_attempts || []),
}));
vi.mock('@/utils/queries/simulation_attempts/get-simulation-attempts-by-profiles', () => ({
  getSimulationAttemptsByProfiles: vi.fn(() => mockSchema.simulation_attempts || []),
}));
vi.mock('@/utils/queries/simulation_attempts/get-simulation-attempts-by-simulation', () => ({
  getSimulationAttemptsBySimulation: vi.fn(() => mockSchema.simulation_attempts || []),
}));
vi.mock('@/utils/queries/simulation_attempts/get-simulation-attempts-by-simulations', () => ({
  getSimulationAttemptsBySimulations: vi.fn(() => mockSchema.simulation_attempts || []),
}));
...
vi.mock('@/utils/queries/simulation_chat_feedbacks/get-simulation-chat-feedback', () => ({
  getSimulationChatFeedback: vi.fn(() => mockSchema.simulation_chat_feedbacks?.[0] || null),
}));
vi.mock('@/utils/queries/simulation_chat_feedbacks/get-simulation-chat-feedbacks-by-simulationchatgrade', () => ({
  getSimulationChatFeedbacksBySimulationchatgrade: vi.fn(() => mockSchema.simulation_chat_feedbacks || []),
}));
vi.mock('@/utils/queries/simulation_chat_feedbacks/get-simulation-chat-feedbacks-by-simulationchatgrades', () => ({
  getSimulationChatFeedbacksBySimulationchatgrades: vi.fn(() => mockSchema.simulation_chat_feedbacks || []),
}));
vi.mock('@/utils/queries/simulation_chat_feedbacks/get-simulation-chat-feedbacks-by-standard', () => ({
  getSimulationChatFeedbacksByStandard: vi.fn(() => mockSchema.simulation_chat_feedbacks || []),
}));
vi.mock('@/utils/queries/simulation_chat_feedbacks/get-simulation-chat-feedbacks-by-standards', () => ({
  getSimulationChatFeedbacksByStandards: vi.fn(() => mockSchema.simulation_chat_feedbacks || []),
}));
...
vi.mock('@/utils/queries/simulation_chat_grades/get-simulation-chat-grade', () => ({
  getSimulationChatGrade: vi.fn(() => mockSchema.simulation_chat_grades?.[0] || null),
}));
vi.mock('@/utils/queries/simulation_chat_grades/get-simulation-chat-grades-by-rubric', () => ({
  getSimulationChatGradesByRubric: vi.fn(() => mockSchema.simulation_chat_grades || []),
}));
vi.mock('@/utils/queries/simulation_chat_grades/get-simulation-chat-grades-by-rubrics', () => ({
  getSimulationChatGradesByRubrics: vi.fn(() => mockSchema.simulation_chat_grades || []),
}));
vi.mock('@/utils/queries/simulation_chat_grades/get-simulation-chat-grades-by-simulationchat', () => ({
  getSimulationChatGradesBySimulationchat: vi.fn(() => mockSchema.simulation_chat_grades || []),
}));
vi.mock('@/utils/queries/simulation_chat_grades/get-simulation-chat-grades-by-simulationchats', () => ({
  getSimulationChatGradesBySimulationchats: vi.fn(() => mockSchema.simulation_chat_grades || []),
}));
...
vi.mock('@/utils/queries/simulation_chats/get-simulation-chat', () => ({
  getSimulationChat: vi.fn(() => mockSchema.simulation_chats?.[0] || null),
}));
vi.mock('@/utils/queries/simulation_chats/get-simulation-chats-by-attempt', () => ({
  getSimulationChatsByAttempt: vi.fn(() => mockSchema.simulation_chats || []),
}));
vi.mock('@/utils/queries/simulation_chats/get-simulation-chats-by-attempts', () => ({
  getSimulationChatsByAttempts: vi.fn(() => mockSchema.simulation_chats || []),
}));
vi.mock('@/utils/queries/simulation_chats/get-simulation-chats-by-scenario', () => ({
  getSimulationChatsByScenario: vi.fn(() => mockSchema.simulation_chats || []),
}));
vi.mock('@/utils/queries/simulation_chats/get-simulation-chats-by-scenarios', () => ({
  getSimulationChatsByScenarios: vi.fn(() => mockSchema.simulation_chats || []),
}));
...
vi.mock('@/utils/queries/simulation_messages/get-simulation-message', () => ({
  getSimulationMessage: vi.fn(() => mockSchema.simulation_messages?.[0] || null),
}));
vi.mock('@/utils/queries/simulation_messages/get-simulation-messages-by-chat', () => ({
  getSimulationMessagesByChat: vi.fn(() => mockSchema.simulation_messages || []),
}));
vi.mock('@/utils/queries/simulation_messages/get-simulation-messages-by-chats', () => ({
  getSimulationMessagesByChats: vi.fn(() => mockSchema.simulation_messages || []),
}));
...
vi.mock('@/utils/queries/standard_groups/get-standard-group', () => ({
  getStandardGroup: vi.fn(() => mockSchema.standard_groups?.[0] || null),
}));
vi.mock('@/utils/queries/standard_groups/get-standard-groups-by-rubric', () => ({
  getStandardGroupsByRubric: vi.fn(() => mockSchema.standard_groups || []),
}));
vi.mock('@/utils/queries/standard_groups/get-standard-groups-by-rubrics', () => ({
  getStandardGroupsByRubrics: vi.fn(() => mockSchema.standard_groups || []),
}));
