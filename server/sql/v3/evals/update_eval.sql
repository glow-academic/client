-- Update eval with optional model_runs changes
-- Parameters: $1=eval_id, $2=name, $3=description, $4=rubric_id, $5=model_run_ids (uuid[] | NULL - if provided, replaces all)
-- Returns: eval_id
...
-- If model_run_ids provided, replace all existing links
remove_existing_links AS (
    DELETE FROM eval_model_runs
