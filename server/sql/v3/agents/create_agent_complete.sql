...
-- Parameters: $1=name, $2=description, $3=model_id, $4=active, $5=role, $6=prompt_id (nullable), $7=system_prompt (nullable), $8=department_ids (nullable text array), $9=profile_id (uuid)
WITH new_agent AS (
