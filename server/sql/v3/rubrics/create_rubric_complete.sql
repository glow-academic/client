...
-- Parameters: $1=name, $2=description (nullable), $3=active, $4=points, $5=passPoints, $6=department_ids (nullable text array), $7=standard_groups (JSONB array), $8=profile_id (uuid)
-- Returns: rubric_id
WITH new_rubric AS (
    INSERT INTO rubrics (
        name,
