...
-- Parameters: $1=name, $2=description, $3=active, $4=simulation_parameter, $5=document_parameter, $6=persona_parameter, $7=scenario_parameter, $8=video_parameter, $9=parameter_level_department_ids (text array, nullable), $10=field_connections_json (jsonb array), $11=profile_id (uuid)
