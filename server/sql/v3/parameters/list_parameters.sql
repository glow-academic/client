...
GROUP BY p.id, p.name, p.description,  p.active, p.updated_at, pidd.department_ids, pic.num_items, 
         ps.scenario_ids, spd.scenario_ids, pd.document_ids, pasl.active_scenario_count, pasl_all.total_scenario_links, psi.sample_items, up.role, up.actor_name, sm.mapping, dmd.mapping, docmd.mapping
HAVING 
