"""
Tests for app.infra.v4.websocket.find_chat_by_socket
"""
...
from app.infra.v4.websocket.find_chat_by_socket import find_chat_by_socket
...
class TestFind_Chat_By_Socket:
    ...
    async def test_find_chat_by_socket_success(self) -> None:
        ...
        with patch(
            "app.infra.v4.websocket.find_chat_by_socket.get_redis_client",
