...
class TestDBLogHandler:
    ...
    @pytest.mark.asyncio
    async def test_db_log_handler_write_to_db(self, db: asyncpg.Connection) -> None:
    ...
    @pytest.mark.asyncio
    async def test_db_log_handler_extra_data(self, db: asyncpg.Connection) -> None:
    ...
    @pytest.mark.asyncio
    async def test_db_log_handler_exception_info(self, db: asyncpg.Connection) -> None:
