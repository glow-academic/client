"""E2E tests covering scenario delete confirmation and cancellation."""
...
def test_scenario_delete_cancel_then_confirm(page: Page, base_url: str) -> None:
    """Ensure delete dialog cancel preserves scenario and confirm removes it."""
    scenario_name, scenario_id = create_scenario_via_ui(
        page,
        base_url,
        name=generate_unique_scenario_name("Deletable Scenario"),
        problem_statement="Scenario targeted for delete E2E test.",
    )
    ...
    dialog = page.get_by_test_id("dialog-delete-scenario")
