"""E2E skeleton: Profile artifact lifecycle (/management/profiles).
...
def test_profiles_lifecycle(page: Page, base_url: str) -> None:
    """Profiles lifecycle: list → search → detail → edit → verify."""
