...
def _resolve_profile_ids(
    ...
    *,
    profile_id: str,
    effective_profile_id: str | None,
    pathname: str = "/analytics/dashboard",
) -> tuple[str, str]:
...
def wait_for_dashboard_load(page: Page) -> None:
    """Wait for dashboard page to fully load with data."""
...
def verify_dashboard_ssr(page: Page) -> None:
    """Verify dashboard page SSR rendering."""
    ...
    # Note: More detailed error checking can be added if needed
