"""Shared helpers for pricing E2E tests."""
...
def _resolve_profile_ids(
    ...
    *,
    profile_id: str,
    effective_profile_id: Optional[str],
    pathname: str = "/analytics/pricing",
) -> tuple[str, str]:
...
def wait_for_pricing_load(page: Page) -> None:
    """Wait for pricing page to fully load with data."""
...
def verify_pricing_ssr(page: Page) -> None:
    """Verify pricing page SSR rendering."""
