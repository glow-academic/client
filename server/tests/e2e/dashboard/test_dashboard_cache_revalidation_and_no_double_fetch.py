...
from server.tests.e2e.dashboard.helpers import fetch_dashboard_data, wait_for_dashboard_load
...
def test_dashboard_no_double_fetch(page: Page, base_url: str) -> None:
    ...
    dashboard_counter, stop_counter = _set_request_counter(
        page, "/api/v3/dashboard"
    )
