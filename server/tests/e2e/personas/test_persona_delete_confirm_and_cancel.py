"""E2E tests covering persona delete confirmation and cancellation."""
...
def test_persona_delete_cancel_then_confirm(page: Page, base_url: str) -> None:
    """Ensure delete dialog cancel preserves persona and confirm removes it."""
    persona_name, persona_id = create_persona_via_ui(
        page,
        base_url,
        name=generate_unique_persona_name("Deletable Persona"),
        description="Persona targeted for delete E2E test.",
        prompt="Persona to be deleted via UI.",
    )
    ...
    dialog = page.get_by_test_id("dialog-delete-persona")
    ...
    expect(persona_card).to_have_count(0)
