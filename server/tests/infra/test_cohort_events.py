...
from app.routes.v5.api.main.cohort.events import (
...
def test_get_cohort_event_config_maps_domain_event_and_entity_scope() -> None:
    ...
    assert config.domain_events == ("artifacts.cohort.viewed",)
...
def test_drafts_cohort_event_config_is_collection_scoped() -> None:
    ...
    assert config.domain_events == ("artifacts.cohort.drafts.viewed",)
