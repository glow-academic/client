...
from app.routes.v5.api.main.model.events import (
    MODEL_EVENT_CONFIGS,
...
def test_get_model_event_config_maps_domain_event_and_entity_scope() -> None:
    ...
    assert config.domain_events == ("artifacts.model.viewed",)
...
def test_drafts_model_event_config_is_collection_scoped() -> None:
    ...
    assert config.domain_events == ("artifacts.model.drafts.viewed",)
