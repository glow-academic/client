"""
Tests for app.mcp.tools.lookup.scenario_overview
"""
...
@patch("app.mcp.tools.lookup.scenario_overview.get_session")
class TestScenario_Overview:
    ...
    def test_scenario_overview_success(self, mock_get_session):
        ...
        mock_scenario = MockScenario(
            scenario_id,
            "Conflict Resolution",
            "Handle difficult employee situation",
    ...
    def test_scenario_overview_no_persona(self, mock_get_session):
        ...
        scenario_id = uuid.uuid4()
        mock_scenario = MockScenario(
            scenario_id, "No Persona Scenario", "A scenario without persona"
        )
    ...
    def test_scenario_overview_with_simulations(self, mock_get_session):
        ...
        mock_simulation = MockSimulation(
            simulation_id, "Test Simulation", scenario_ids=[scenario_id]
        )
    ...
    def test_scenario_overview_default_scenario(self, mock_get_session):
        ...
        scenario_id = uuid.uuid4()
        mock_scenario = MockScenario(
            scenario_id, "Default Scenario", "A default scenario", default_scenario=True
        )
    ...
    def test_scenario_overview_null_timestamps(self, mock_get_session):
        ...
        scenario_id = uuid.uuid4()
        mock_scenario = MockScenario(
            scenario_id, "Null Timestamp Scenario", "A scenario with null timestamps"
        )
    ...
    def test_scenario_overview_simulation_details(self, mock_get_session):
        ...
        mock_scenario = MockScenario(
            scenario_id, "Multi-Sim Scenario", "A scenario with multiple simulations"
        )
        mock_simulation1 = MockSimulation(
            simulation1_id, "Simulation 1", True, 30, [scenario_id]
        )
        mock_simulation2 = MockSimulation(
            simulation2_id, "Simulation 2", False, 45, [scenario_id]
        )
