...
class TestRunGenericAgent:
    ...
    @pytest.mark.asyncio
    async def test_run_generic_agent_simulation_success(
        self, mock_session, sample_simulation_chat
    ):
    ...
    @pytest.mark.asyncio
    async def test_run_generic_agent_simulation_error(
        self, mock_session, sample_simulation_chat
    ):
...
class TestAgentTypeHandling:
    ...
    def test_unknown_agent_type(self, mock_get_gemini):
        ...
        )  # Should fall back to agent_prompt
