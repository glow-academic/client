...
class TestGet_Document:
    ...
    def test_get_document_success(self, client, test_session, mocker):
        ...
        FileResponse.assert_called_once_with(
...
class TestFinalize_Upload:
    ...
    def test_finalize_regular_upload_success(
        self, client, test_session, temp_tus_uploads
    ):
...
class TestDelete_Document:
    ...
    def test_delete_document_success(self, client, test_session, mocker):
        ...
        test_session.add(
            Documents(
                id=doc_id, name="test.pdf", file_path=f"{doc_id}.pdf", class_id=class_id
            )
        )
        test_session.commit()
