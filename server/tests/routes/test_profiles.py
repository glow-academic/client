...
def mock_chats():
    ...
    return [
        MagicMock(id="chat-1", attempt_id="attempt-1", scenario_id="scenario-1", completed=True),
        MagicMock(id="chat-2", attempt_id="attempt-2", scenario_id="scenario-2", completed=True),
    ]
...
def mock_standard_groups():
    ...
    return [
        MagicMock(id="group-1", name="Communication", short_name="Comm", rubric_id="rubric-1"),
        MagicMock(id="group-2", name="Technical Skills", short_name="Tech", rubric_id="rubric-1"),
    ]
...
def mock_standards():
    ...
    return [
        MagicMock(id="standard-1", name="Listening", standard_group_id="group-1", points=10),
        MagicMock(id="standard-2", name="Problem Solving", standard_group_id="group-2", points=10),
    ]
...
class TestGet_Report:
    ...
    def test_get_report_success_all_options(
        ...
        mock_session.exec.side_effect = [
            ...
            MagicMock(one_or_none=lambda: mock_scenarios[0]),  # Scenario query for performance
            MagicMock(one_or_none=lambda: mock_agents[0]),  # Agent query for performance
            MagicMock(one_or_none=lambda: mock_scenarios[1]),  # Scenario query for performance
            MagicMock(one_or_none=lambda: mock_agents[1]),  # Agent query for performance
            MagicMock(one_or_none=lambda: mock_scenarios[0]),  # Scenario query for agent descriptions
            MagicMock(one_or_none=lambda: mock_scenarios[1]),  # Scenario query for agent descriptions
        ]
