"""Integration tests for image_generate WebSocket event."""
...
from app.socket.v4.agents.image.generate import image_generate
...
async def test_image_generate_success(
    ...
    """Test successful image_generate event."""
    # Arrange
    ...
    # Act
    await image_generate(sid, data)

    # Assert - verify handler completes
    # AI generation uses mocked Runner
    error_events = mock_sio.get_events("images_generate_error")
