"""Integration tests for simulation_generate WebSocket event."""
...
from app.socket.v4.agents.simulation.generate import simulation_generate

pytestmark = pytest.mark.asyncio


async def test_simulation_generate_success(
    db: asyncpg.Connection, mock_sio: MockSocketIO, mock_internal_sio: MockInternalBus
) -> None:
    """Test successful simulation_generate event."""
    # Arrange
    ...
    # Act
    await simulation_generate(sid, data)

    # Assert - verify handler completes
    # AI generation uses mocked Runner
    error_events = mock_sio.get_events("simulations_generate_error")
