"""Integration tests for video_regenerate WebSocket event."""
...
from app.socket.v4.agents.video.regenerate import video_regenerate

pytestmark = pytest.mark.asyncio


async def test_video_regenerate_success(
    db: asyncpg.Connection, mock_sio: MockSocketIO, mock_internal_sio: MockInternalBus
) -> None:
    """Test successful video_regenerate event."""
    # Arrange
    ...
    # Act
    await video_regenerate(sid, data)

    # Assert - verify handler completes
    # AI generation uses mocked Runner
    error_events = mock_sio.get_events("videos_regenerate_error")
