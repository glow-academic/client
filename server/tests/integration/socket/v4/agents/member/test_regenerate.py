"""Integration tests for member_regenerate WebSocket event."""
...
from app.socket.v4.agents.member.regenerate import member_regenerate

pytestmark = pytest.mark.asyncio


async def test_member_regenerate_success(
    db: asyncpg.Connection, mock_sio: MockSocketIO, mock_internal_sio: MockInternalBus
) -> None:
    """Test successful member_regenerate event."""
    # Arrange
    ...
    # Act
    await member_regenerate(sid, data)

    # Assert - verify handler completes
    # AI generation uses mocked Runner
    error_events = mock_sio.get_events("members_regenerate_error")
