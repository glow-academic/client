"""Integration tests for grade_generate WebSocket event."""
...
from app.socket.v4.agents.grade.generate import grade_generate

pytestmark = pytest.mark.asyncio


async def test_grade_generate_success(
    db: asyncpg.Connection, mock_sio: MockSocketIO, mock_internal_sio: MockInternalBus
) -> None:
    """Test successful grade_generate event."""
    # Arrange
    ...
    # Act
    await grade_generate(sid, data)

    # Assert - verify handler completes
    # AI generation uses mocked Runner
    error_events = mock_sio.get_events("grades_generate_error")
