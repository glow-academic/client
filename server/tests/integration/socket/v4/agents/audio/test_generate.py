"""Integration tests for audio_generate WebSocket event."""
...
from app.socket.v4.agents.audio.generate import audio_generate

pytestmark = pytest.mark.asyncio


async def test_audio_generate_success(
    db: asyncpg.Connection, mock_sio: MockSocketIO, mock_internal_sio: MockInternalBus
) -> None:
    """Test successful audio_generate event."""
    # Arrange
    ...
    # Act
    await audio_generate(sid, data)

    # Assert - verify handler completes
    # AI generation uses mocked Runner
    error_events = mock_sio.get_events("audios_generate_error")
