"""Integration tests for classify_generate WebSocket event."""
...
from app.socket.v4.agents.classify.generate import classify_generate

pytestmark = pytest.mark.asyncio


async def test_classify_generate_success(
    db: asyncpg.Connection, mock_sio: MockSocketIO, mock_internal_sio: MockInternalBus
) -> None:
    """Test successful classify_generate event."""
    # Arrange
    ...
    # Act
    await classify_generate(sid, data)

    # Assert - verify handler completes
    # AI generation uses mocked Runner
    error_events = mock_sio.get_events("classifys_generate_error")
