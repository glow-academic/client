"""Integration tests for voice_generate WebSocket event."""
...
from app.socket.v4.agents.voice.generate import voice_generate

pytestmark = pytest.mark.asyncio


async def test_voice_generate_success(
    db: asyncpg.Connection, mock_sio: MockSocketIO, mock_internal_sio: MockInternalBus
) -> None:
    """Test successful voice_generate event."""
    # Arrange
    ...
    # Act
    await voice_generate(sid, data)

    # Assert - verify handler completes
    # AI generation uses mocked Runner
    error_events = mock_sio.get_events("voices_generate_error")
