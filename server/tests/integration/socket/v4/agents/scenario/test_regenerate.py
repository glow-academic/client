"""Integration tests for scenario_regenerate WebSocket event."""
...
from app.socket.v4.agents.scenario.regenerate import scenario_regenerate

pytestmark = pytest.mark.asyncio


async def test_scenario_regenerate_success(
    db: asyncpg.Connection, mock_sio: MockSocketIO, mock_internal_sio: MockInternalBus
) -> None:
    """Test successful scenario_regenerate event."""
    # Arrange
    ...
    # Act
    await scenario_regenerate(sid, data)

    # Assert - verify handler completes
    # AI generation uses mocked Runner
    error_events = mock_sio.get_events("scenarios_regenerate_error")
