"""Integration tests for app.infra.v4.error.log_and_raise_error."""

import pytest
from fastapi import HTTPException
from utils.sql_helper import load_sql

from app.infra.v4.error.log_and_raise_error import log_and_raise_error
...
class TestLogAndRaiseError:
    ...
    def test_log_and_raise_error_with_sql_query(self) -> None:
        ...
        route_path = "/api/v4/test"
        operation = "test_operation"
        # Use a simple SQL file for testing - create one if needed
        sql_query = "SELECT 1"
