"""Route tests for PATCH /api/v4/artifacts/rubrics/draft endpoint."""
...
async def test_patch_rubric_draft_create(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
    """Test creating a new rubric draft."""
    ...
    response = await client.patch(
        ...
        json={
            "patch": {"name": "Draft Rubric", "description": "Draft description"},
            "expected_version": 0,
            "input_draft_id": None,
        },
    )
...
async def test_patch_rubric_draft_update(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
    """Test updating an existing rubric draft."""
    await get_superadmin_alias(db)
...
async def test_patch_rubric_draft_version_mismatch(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
