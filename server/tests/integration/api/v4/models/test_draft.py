"""Route tests for PATCH /api/v4/artifacts/models/draft endpoint."""
...
async def test_patch_model_draft_create(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
    """Test creating a new model draft."""
    ...
    response = await client.patch(
        ...
        json={
            "patch": {"name": "Draft Model", "description": "Draft description"},
            "expected_version": 0,
            "input_draft_id": None,
        },
    )
