"""Route tests for POST /api/v4/keys/list endpoint."""
...
async def test_list_keys_empty(
    ...
    # Note: We can't delete all keys using SQL file easily, so we'll just test the endpoint
    # In a real scenario, we'd create a SQL file for deleting all keys if needed
