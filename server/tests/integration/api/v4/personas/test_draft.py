"""Route tests for PATCH /api/v4/artifacts/personas/draft endpoint."""
...
async def test_patch_persona_draft_create(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
    """Test creating a new persona draft."""
    ...
    response = await client.patch(
        ...
        json={
            "patch": {"name": "Draft Persona", "description": "Draft description"},
            "expected_version": 0,
            "input_draft_id": None,
        },
    )
...
async def test_patch_persona_draft_update(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
    """Test updating an existing persona draft."""
    await get_superadmin_alias(db)
...
async def test_patch_persona_draft_version_mismatch(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
