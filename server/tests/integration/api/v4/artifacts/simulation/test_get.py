...
class TestSimulationGetNew:
    """Tests for POST /api/v4/artifacts/simulations/get with no simulation_id (new mode)."""
...
class TestSimulationGetExisting:
    """Tests for POST /api/v4/artifacts/simulations/get with existing simulation_id."""
