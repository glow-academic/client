...
async def test_patch_document_draft_create(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
    """Test creating a new document draft."""
...
async def test_patch_document_draft_update(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
    """Test updating an existing document draft."""
    await get_superadmin_alias(db)
...
async def test_patch_document_draft_version_mismatch(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
