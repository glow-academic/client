"""Route tests for POST /api/v3/agents/detail-default endpoint."""
...
async def test_get_agent_detail_default(
...
async def test_get_agent_detail_default_includes_models(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
