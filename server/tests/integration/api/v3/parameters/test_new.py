"""Route tests for POST /api/v3/parameters/new endpoint."""
...
async def test_get_parameter_new_not_found(
    client: httpx.AsyncClient, db: asyncpg.Connection, disable_cache: None
) -> None:
    """Test parameter new raises error when no default parameter exists.
