"""Tests for create_attempt_grade."""
...
from app.tools.v5.entries.attempt_grade.get import get_attempt_grades
from app.tools.v5.entries.attempt_grade.refresh import refresh_attempt_grade
...
async def _attempt_grade(conn, profile_id, **overrides):
    ...
    result = await create_attempt_grade(conn, **defaults)
    return result
