...
class TestSimulationSaveCreate:
    """Tests for POST /api/v5/artifacts/simulations/save (create mode)."""
...
class TestSimulationSaveUpdate:
    """Tests for POST /api/v5/artifacts/simulations/save (update mode)."""
...
class TestSimulationSaveErrors:
    """Tests for POST /api/v5/artifacts/simulations/save error cases."""
