...
class TestSettingGetNew:
    """Tests for GET /api/v5/artifacts/settings/get with no setting_id (new mode)."""
...
class TestSettingGetExisting:
    """Tests for GET /api/v5/artifacts/settings/get with existing setting_id."""
...
class TestSettingGetErrors:
    """Tests for GET /api/v5/artifacts/settings/get error cases."""
