...
class TestSettingSaveCreate:
    """Tests for POST /api/v5/artifacts/settings/save (create mode)."""
...
class TestSettingSaveUpdate:
    """Tests for POST /api/v5/artifacts/settings/save (update mode)."""
...
class TestSettingSaveErrors:
    """Tests for POST /api/v5/artifacts/settings/save error cases."""
