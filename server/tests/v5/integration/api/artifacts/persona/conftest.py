"""Shared fixtures for persona artifact integration tests.
...
async def seed_persona_data() -> None:
    """Seed test data needed by persona artifact tests.
...
async def db(seed_persona_data: None) -> AsyncGenerator[asyncpg.Connection, None]:
