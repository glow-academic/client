...
class TestPersonaGetNew:
    """Tests for POST /api/v5/artifacts/personas/get with no persona_id (new mode)."""
...
class TestPersonaGetExisting:
    """Tests for POST /api/v5/artifacts/personas/get with existing persona_id."""
...
class TestPersonaGetErrors:
    """Tests for POST /api/v5/artifacts/personas/get error cases."""
