...
class TestPersonaSaveCreate:
    """Tests for POST /api/v5/artifacts/personas/save (create mode)."""
...
class TestPersonaSaveUpdate:
    """Tests for POST /api/v5/artifacts/personas/save (update mode)."""
...
class TestPersonaSaveErrors:
    """Tests for POST /api/v5/artifacts/personas/save error cases."""
