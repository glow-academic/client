...
class TestScenarioSaveCreate:
    """Tests for POST /api/v5/artifacts/scenarios/save (create mode)."""
...
class TestScenarioSaveUpdate:
    """Tests for POST /api/v5/artifacts/scenarios/save (update mode)."""
...
class TestScenarioSaveErrors:
    """Tests for POST /api/v5/artifacts/scenarios/save error cases."""
