"""Integration tests for artifact scenario draft endpoint."""
...
class TestScenarioDraft:
    """Tests for PATCH /api/v5/artifacts/scenarios/draft endpoint."""
...
class TestScenarioDraftErrors:
    """Tests for PATCH /api/v5/artifacts/scenarios/draft error cases."""
