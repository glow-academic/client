...
class TestCohortSaveCreate:
    """Tests for POST /api/v5/artifacts/cohorts/save (create mode)."""
...
class TestCohortSaveUpdate:
    """Tests for POST /api/v5/artifacts/cohorts/save (update mode)."""
...
class TestCohortSaveErrors:
    """Tests for POST /api/v5/artifacts/cohorts/save error cases."""
