...
from app.v5.api.resources.agents.search import search_agents_internal
...
class TestSearchAgents:
    """Tests for POST /api/v5/resources/agents/search endpoint."""

    async def test_search_agents_returns_items(self, client: httpx.AsyncClient) -> None:
