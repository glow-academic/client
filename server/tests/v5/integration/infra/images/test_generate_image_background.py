"""Integration tests for app.v5.infra.images.generate_image_background."""

import pytest

from app.v5.infra.images.generate_image_background import generate_image_background
