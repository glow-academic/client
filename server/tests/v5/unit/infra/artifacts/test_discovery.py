...
from app.v5.infra.artifacts.discovery import (
...
class TestGetResourceSqlFunctionName:
    ...
    async def test_finds_singular_function(self):
        ...
        with patch(
            "app.v5.infra.artifacts.discovery.load_sql",
            return_value="CREATE FUNCTION...",
        ):
            with patch(
                "app.v5.infra.artifacts.discovery._detect_function_in_sql",
    ...
    async def test_template_extraction(self):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    "app.v5.infra.artifacts.discovery.get_resource_schema_fields",
                    return_value=[
                        {
                            "name": "content",
                            "field_type": "string",
