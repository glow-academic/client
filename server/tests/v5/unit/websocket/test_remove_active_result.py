"""
Tests for app.v5.infra.websocket.remove_active_result
"""
...
from app.v5.infra.websocket.remove_active_result import remove_active_result
...
class TestRemove_Active_Result:
    ...
    async def test_remove_active_result_success(self) -> None:
        ...
        # Act
        with patch(
            "app.v5.infra.websocket.remove_active_result.get_active_results_dict",
