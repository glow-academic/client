"""
Tests for app.v5.infra.websocket.remove_active_run
"""
...
from app.v5.infra.websocket.remove_active_run import remove_active_run  # type: ignore
...
class TestRemove_Active_Run:
    ...
    async def test_remove_active_run_success(self) -> None:
        ...
        # Act
        with patch(
            "app.v5.infra.websocket.remove_active_run.get_redis_client",
