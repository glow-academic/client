"""
Tests for app.v5.infra.websocket.cancel_active_run
"""
...
class TestCancel_Active_Run:
    ...
    async def test_cancel_active_run_success(self) -> None:
        ...
        with (
            patch(
                "app.v5.infra.websocket.cancel_active_run.get_redis_client",
                return_value=mock_redis,
            ),
            patch(
                "app.v5.infra.websocket.cancel_active_run.get_active_run",
                return_value=run_id,
            ),
        ):
