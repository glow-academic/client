"""
Tests for app.v5.infra.websocket.is_guest_socket
"""
...
class TestIs_Guest_Socket:
    ...
    async def test_is_guest_socket_true(self) -> None:
        ...
        with patch(
            "app.v5.infra.websocket.is_guest_socket.get_redis_client",
    ...
    async def test_is_guest_socket_no_redis(self) -> None:
        ...
        with patch(
            "app.v5.infra.websocket.is_guest_socket.get_redis_client", return_value=None
        ):
            result = await is_guest_socket(socket_id)
