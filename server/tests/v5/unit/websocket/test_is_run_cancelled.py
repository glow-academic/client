"""
Tests for app.v5.infra.websocket.is_run_cancelled
"""
...
from app.v5.infra.websocket.is_run_cancelled import is_run_cancelled
...
class TestIs_Run_Cancelled:
    ...
    async def test_is_run_cancelled_true(self) -> None:
        ...
        # Act
        with patch(
            "app.v5.infra.websocket.is_run_cancelled.get_redis_client",
