"""
Tests for app.v5.infra.websocket.store_active_events
"""
...
from app.v5.infra.websocket.store_active_events import store_active_events
...
class TestStore_Active_Events:
    ...
    async def test_store_active_events_success(self) -> None:
        ...
        # Act
        with patch(
            "app.v5.infra.websocket.store_active_events.get_active_results_dict",
