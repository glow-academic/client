"""
Tests for app.v5.infra.websocket.get_active_run
"""
...
from app.v5.infra.websocket.get_active_run import get_active_run
...
class TestGet_Active_Run:
    ...
    async def test_get_active_run_success(self) -> None:
        ...
        # Act
        with patch(
            "app.v5.infra.websocket.get_active_run.get_redis_client",
    ...
    async def test_get_active_run_no_redis(self) -> None:
        ...
        # Act
        with patch(
            "app.v5.infra.websocket.get_active_run.get_redis_client", return_value=None
        ):
            result = await get_active_run(chat_id)
