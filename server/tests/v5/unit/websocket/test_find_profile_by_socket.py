"""
Tests for app.v5.infra.websocket.find_profile_by_socket
"""
...
class TestFind_Profile_By_Socket:
    ...
    async def test_find_profile_by_socket_success(self) -> None:
        ...
        with (
            patch(
                "app.v5.infra.websocket.find_profile_by_socket.get_redis_client",
                return_value=mock_redis,
            ),
            patch(
                "app.v5.infra.websocket.find_profile_by_socket.get_socket_owner_dict",
