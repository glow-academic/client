"""
Tests for app.v5.infra.websocket.remove_socket_owner
"""
...
class TestRemove_Socket_Owner:
    ...
    async def test_remove_socket_owner_success(self) -> None:
        ...
        with (
            patch(
                "app.v5.infra.websocket.remove_socket_owner.get_redis_client",
                return_value=mock_redis,
            ),
            patch(
                "app.v5.infra.websocket.remove_socket_owner.get_socket_owner_dict",
