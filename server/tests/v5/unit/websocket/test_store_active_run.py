"""
Tests for app.v5.infra.websocket.store_active_run
"""
...
from app.v5.infra.websocket.store_active_run import store_active_run
...
class TestStore_Active_Run:
    ...
    async def test_store_active_run_success(self) -> None:
        ...
        # Act
        with patch(
            "app.v5.infra.websocket.store_active_run.set_active_run"
