"""
Tests for app.v5.infra.websocket.set_active_run
"""
...
class TestSet_Active_Run:
    ...
    async def test_set_active_run_success(self) -> None:
        ...
        # Act
        with patch(
            "app.v5.infra.websocket.set_active_run.get_redis_client",
    ...
    async def test_set_active_run_no_redis(self) -> None:
        ...
        # Act
        with patch(
            "app.v5.infra.websocket.set_active_run.get_redis_client", return_value=None
        ):
            await set_active_run(chat_id, run_id)
