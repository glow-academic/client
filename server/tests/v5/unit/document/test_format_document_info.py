...
class TestFormat_Document_Info:
    ...
    def test_format_document_info_empty_list(self) -> None:
        ...
        from app.v5.infra.documents.format_document_info import format_document_info
    ...
    def test_format_document_info_text_file(
        ...
        # Mock UPLOAD_FOLDER
        monkeypatch.setattr(
            "app.v5.infra.documents.format_document_info.UPLOAD_FOLDER", tmp_path
        )
    ...
    def test_format_document_info_pdf(
        ...
        with (
            ...
            patch(
                "app.v5.infra.documents.format_document_info.pdf_pages_to_image_data_urls",
                return_value=[],
            ),
        ):
            result = format_document_info(documents, show_images=False)
