...
CREATE OR REPLACE FUNCTION api_patch_auth_draft_v4(
    ...
    protocol_ids uuid[] DEFAULT NULL,
    slug_ids uuid[] DEFAULT NULL,
...
BEGIN
    ...
    IF input_draft_id IS NOT NULL THEN
        ...
        IF v_draft_id IS NOT NULL THEN
            ...
            DELETE FROM protocols_drafts_connection WHERE protocols_drafts_connection.draft_id = v_draft_id;
            DELETE FROM slugs_drafts_connection WHERE slugs_drafts_connection.draft_id = v_draft_id;
