-- Reports overview query - profile-specific view_metrics_entry
...
BEGIN
    FOR r IN 
        ...
        FROM pg_proc 
        WHERE proname = 'api_get_reports_overview_v4'
          AND pronamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'public')
    LOOP
        EXECUTE format('DROP FUNCTION IF EXISTS api_get_reports_overview_v4(%s)', r.sig);
    END LOOP;
END $$;
...
BEGIN
    LOOP
        ...
        FOR r IN 
            SELECT typname 
            FROM pg_type 
            WHERE typname LIKE 'q_reports_overview_v4_%'
...
CREATE TYPE types.q_reports_overview_v4_trend_data AS (
    date text,
    value float,
    count int
);
...
CREATE TYPE types.q_reports_overview_v4_data_point AS (
    profile_id text,
    date text,
    value float,
    attempt_id text,
...
CREATE TYPE types.q_reports_overview_v4_metric_response AS (
    has_data boolean,
    method text,
    current_value int,
    status text,
    ...
    value_field text,
    key_field text,
    trend_data types.q_reports_overview_v4_trend_data[],
    data_points types.q_reports_overview_v4_data_point[]
);

-- Header view_metrics_entry (10 view_metrics_entry)
CREATE TYPE types.q_reports_overview_v4_header_metrics AS (
    average_score types.q_reports_overview_v4_metric_response,
    completion_percentage types.q_reports_overview_v4_metric_response,
    first_attempt_pass_rate types.q_reports_overview_v4_metric_response,
    highest_score types.q_reports_overview_v4_metric_response,
    messages_per_session types.q_reports_overview_v4_metric_response,
    persona_response_times types.q_reports_overview_v4_metric_response,
    session_efficiency types.q_reports_overview_v4_metric_response,
    stagnation_rate types.q_reports_overview_v4_metric_response,
    time_spent types.q_reports_overview_v4_metric_response,
    total_attempts types.q_reports_overview_v4_metric_response
);

-- Growth data point
CREATE TYPE types.q_reports_overview_v4_growth_data_point AS (
    date text,
    average_score float,
...
-- Growth metric
CREATE TYPE types.q_reports_overview_v4_growth_metric AS (
    id text,
    name text,
    color text,
    unit text,
...
CREATE TYPE types.q_reports_overview_v4_growth_window_average AS (
    n int,
    last float,
    prev float
);
...
CREATE TYPE types.q_reports_overview_v4_growth_window_averages AS (
    average_score types.q_reports_overview_v4_growth_window_average
);

-- Growth data response
CREATE TYPE types.q_reports_overview_v4_growth_data_response AS (
    chart_data types.q_reports_overview_v4_growth_data_point[],
    available_metrics types.q_reports_overview_v4_growth_metric[],
    window_averages types.q_reports_overview_v4_growth_window_averages,
    status text
);

-- Persona trend data
CREATE TYPE types.q_reports_overview_v4_persona_trend_data AS (
    date text,
    score float,
    timestamp bigint,
    simulation_id text
...
CREATE TYPE types.q_reports_overview_v4_persona_performance_data AS (
    name text,
    score float,
    sessions int,
    color text,
    simulation_ids text[],
    trend_data types.q_reports_overview_v4_persona_trend_data[],
    status text
);

-- Persona color mapping item
CREATE TYPE types.q_reports_overview_v4_persona_color AS (
    persona_name text,
    color text
);

-- Persona performance response
CREATE TYPE types.q_reports_overview_v4_persona_performance_response AS (
    chart_data types.q_reports_overview_v4_persona_performance_data[],
    valid_simulation_ids text[],
    persona_colors_junction types.q_reports_overview_v4_persona_color[]
);

-- Rubric heatmap cell
CREATE TYPE types.q_reports_overview_v4_rubric_heatmap_cell AS (
    rubric_id text,
    correlation float,
    p_value float,
    color text,
...
CREATE TYPE types.q_reports_overview_v4_rubric_heatmap_response AS (
    matrices types.q_reports_overview_v4_rubric_matrix_package[],
    valid_rubric_ids text[],
    status text
);

-- Primary view_metrics_entry
CREATE TYPE types.q_reports_overview_v4_primary_metrics AS (
    growth_data types.q_reports_overview_v4_growth_data_response,
    persona_performance types.q_reports_overview_v4_persona_performance_response,
    rubric_heatmap types.q_reports_overview_v4_rubric_heatmap_response
);

-- Attempt improvement data
CREATE TYPE types.q_reports_overview_v4_attempt_improvement_data AS (
    attempt text,
    average_score float,
    average_time float,
    pass_rate float
...
CREATE TYPE types.q_reports_overview_v4_attempt_improvement_fact AS (
    simulation_id text,
    attempt_no int,
    avg_grade float,
    avg_minutes float,
...
CREATE TYPE types.q_reports_overview_v4_attempt_improvement_response AS (
    chart_data types.q_reports_overview_v4_attempt_improvement_data[],
    facts types.q_reports_overview_v4_attempt_improvement_fact[],
    valid_simulation_ids text[],
    status text
);

-- Cohort data
CREATE TYPE types.q_reports_overview_v4_cohort_data AS (
    id text,
    name text,
    pass_rate float,
...
-- Daily data
CREATE TYPE types.q_reports_overview_v4_daily_data AS (
    date text,
    avg_score float,
    cohort_id text
);
...
-- Cohort fact
CREATE TYPE types.q_reports_overview_v4_cohort_fact AS (
    cohort_id text,
    simulation_id text,
    pass_rate float,
    avg_score float,
...
-- Cohort daily fact
CREATE TYPE types.q_reports_overview_v4_cohort_daily_fact AS (
    date text,
    simulation_id text,
    avg_score float
);
...
CREATE TYPE types.q_reports_overview_v4_cohort_performance_response AS (
    cohort_data types.q_reports_overview_v4_cohort_data[],
    daily_data types.q_reports_overview_v4_daily_data[],
    cohort_facts types.q_reports_overview_v4_cohort_fact[],
    daily_facts types.q_reports_overview_v4_cohort_daily_fact[],
    valid_simulation_ids text[],
    status text
);

-- Skill radar data
CREATE TYPE types.q_reports_overview_v4_skill_radar_data AS (
    metric text,
    description text,
    value float,
    full_mark float
...
-- Skill standard fact
CREATE TYPE types.q_reports_overview_v4_skill_standard_fact AS (
    group_id text,
    group_name text,
...
-- Skill package
CREATE TYPE types.q_reports_overview_v4_skill_package AS (
    rubric_id text,
    radar_data types.q_reports_overview_v4_skill_radar_data[],
    group_facts types.q_reports_overview_v4_skill_standard_fact[]
);

-- Skill performance response
CREATE TYPE types.q_reports_overview_v4_skill_performance_response AS (
    packages types.q_reports_overview_v4_skill_package[],
    valid_rubric_ids text[],
    status text
);

-- Secondary view_metrics_entry
CREATE TYPE types.q_reports_overview_v4_secondary_metrics AS (
    attempt_improvement types.q_reports_overview_v4_attempt_improvement_response,
    cohort_performance types.q_reports_overview_v4_cohort_performance_response,
    skill_performance types.q_reports_overview_v4_skill_performance_response
);

-- Scenario attribute attempt fact
CREATE TYPE types.q_reports_overview_v4_scenario_attribute_attempt_fact AS (
    parameter_id text,
...
CREATE TYPE types.q_reports_overview_v4_scenario_attribute_scenario_fact AS (
    parameter_id text,
    parameter_item_id text,
    scenario_id text
);
...
CREATE TYPE types.q_reports_overview_v4_scenario_performance_response AS (
    valid_parameter_ids text[],
    attribute_attempt_facts types.q_reports_overview_v4_scenario_attribute_attempt_fact[],
    attribute_scenario_facts types.q_reports_overview_v4_scenario_attribute_scenario_fact[],
    status text
);

-- Numeric attempt fact
CREATE TYPE types.q_reports_overview_v4_numeric_attempt_fact AS (
    parameter_id text,
    level_label text,
    level_value float,
    score float,
...
CREATE TYPE types.q_reports_overview_v4_numeric_scenario_fact AS (
    parameter_id text,
    scenario_id text,
    level_label text,
    level_value float
...
CREATE TYPE types.q_reports_overview_v4_scenario_stats_response AS (
    valid_numeric_parameter_ids text[],
    numeric_attempt_facts types.q_reports_overview_v4_numeric_attempt_fact[],
    numeric_scenario_facts types.q_reports_overview_v4_numeric_scenario_fact[],
    status text
);

-- Simulation fact
CREATE TYPE types.q_reports_overview_v4_simulation_fact AS (
    simulation_id text,
    title text,
    avg_score float,
    completion_rate float,
...
CREATE TYPE types.q_reports_overview_v4_simulation_parameter_fact_categorical AS (
    simulation_id text,
    parameter_id text,
    parameter_item_id text,
    scenario_count int
...
CREATE TYPE types.q_reports_overview_v4_simulation_parameter_fact_numeric AS (
    simulation_id text,
    parameter_id text,
    avg_level float,
    level_label text,
...
CREATE TYPE types.q_reports_overview_v4_simulation_composition_response AS (
    valid_simulation_ids text[],
    simulation_facts types.q_reports_overview_v4_simulation_fact[],
    simulation_parameter_facts_categorical types.q_reports_overview_v4_simulation_parameter_fact_categorical[],
    simulation_parameter_facts_numeric types.q_reports_overview_v4_simulation_parameter_fact_numeric[],
    has_data boolean,
    status text
);

-- Scenario fact
CREATE TYPE types.q_reports_overview_v4_scenario_fact AS (
    simulation_id text,
    scenario_id text,
    scenario_name text,
    avg_score float,
...
CREATE TYPE types.q_reports_overview_v4_simulation_performance_response AS (
    valid_simulation_ids text[],
    scenario_facts types.q_reports_overview_v4_scenario_fact[],
    status text
);

-- Footer view_metrics_entry
CREATE TYPE types.q_reports_overview_v4_footer_metrics AS (
    scenario_performance types.q_reports_overview_v4_scenario_performance_response,
    scenario_stats types.q_reports_overview_v4_scenario_stats_response,
    simulation_performance types.q_reports_overview_v4_simulation_performance_response,
    simulation_composition types.q_reports_overview_v4_simulation_composition_response
);

-- Attempt history row (bundle returns empty array, but type needed for RETURNS TABLE)
CREATE TYPE types.q_reports_overview_v4_attempt_history_row AS (
    attempt_id uuid,
    date timestamptz,
    profile_id uuid,
    profile_name text,
...
CREATE TYPE types.q_reports_overview_v4_persona_insight AS (
    persona_name text,
    insight text
);

-- Cohort insight item
CREATE TYPE types.q_reports_overview_v4_cohort_insight AS (
    cohort_id text,
    insight text
);

-- Dashboard insights
CREATE TYPE types.q_reports_overview_v4_insights AS (
    growth text,
    persona types.q_reports_overview_v4_persona_insight[],
    rubric_heatmap text,
    attempt_improvement text,
    cohort types.q_reports_overview_v4_cohort_insight[],
...
-- Thresholds
CREATE TYPE types.q_reports_overview_v4_thresholds AS (
    success int,
    warning int,
    danger int
);
...
-- Simulation
CREATE TYPE types.q_reports_overview_v4_simulation AS (
    simulation_id text,
    name text,
    description text,
    time_limit int,
...
-- Rubric
CREATE TYPE types.q_reports_overview_v4_rubric AS (
    rubric_id text,
    name text,
    description text
);
...
-- Parameter
CREATE TYPE types.q_reports_overview_v4_parameter AS (
    parameter_id text,
    name text,
    description text,
    numerical boolean,
...
-- Field
CREATE TYPE types.q_reports_overview_v4_field AS (
    field_id text,
    name text,
    description text,
    parameter_id text,
...
RETURNS TABLE (
    ...
    footer_metrics types.q_reports_overview_v4_footer_metrics,
    history types.q_reports_overview_v4_attempt_history_row[],
    insights types.q_reports_overview_v4_insights,
    thresholds types.q_reports_overview_v4_thresholds,
    simulations types.q_reports_overview_v4_simulation[],
    rubrics types.q_reports_overview_v4_rubric[],
    parameters types.q_reports_overview_v4_parameter[],
    fields types.q_reports_overview_v4_field[]
)
LANGUAGE sql
STABLE
AS $$
...
profile_data AS (
    SELECT 
        pa.id as profile_id,
        COALESCE(
            (SELECT n.name FROM profile_names_junction pn JOIN names_resource n ON pn.name_id = n.id WHERE pn.profile_id = pa.id LIMIT 1) || ' ' ||
            (SELECT n2.name FROM profile_names_junction pn2 JOIN names_resource n2 ON pn2.name_id = n2.id WHERE pn2.profile_id = pa.id LIMIT 1),
            'System'
        ) as profile_name,
        ARRAY_AGG(e.email ORDER BY pe.is_primary DESC, pe.created_at) FILTER (WHERE pe.active = true AND e.email IS NOT NULL) as profile_emails_junction,
        (SELECT e2.email FROM profile_emails_junction pe2 JOIN emails_resource e2 ON pe2.email_id = e2.id WHERE pe2.profile_id = pa.id AND pe2.is_primary = true AND pe2.active = true LIMIT 1) as profile_primary_email,
    ...
    LEFT JOIN profile_emails_junction pe ON pe.profile_id = pa.id AND pe.active = true
...
settings_thresholds AS (
    SELECT 
        COALESCE((SELECT t.value FROM setting_thresholds_junction st JOIN thresholds_resource t ON st.threshold_id = t.id WHERE st.setting_id = s.id AND st.type = 'success' LIMIT 1), 85) AS success_threshold,
        COALESCE((SELECT t.value FROM setting_thresholds_junction st JOIN thresholds_resource t ON st.threshold_id = t.id WHERE st.setting_id = s.id AND st.type = 'warning' LIMIT 1), 80) AS warning_threshold,
        COALESCE((SELECT t.value FROM setting_thresholds_junction st JOIN thresholds_resource t ON st.threshold_id = t.id WHERE st.setting_id = s.id AND st.type = 'danger' LIMIT 1), 70) AS danger_threshold
    ...
    WHERE f.attempt_created_at >= (SELECT start_date FROM params)
        ...
        AND (cardinality((SELECT department_ids FROM params)::uuid[]) = 0 OR f.department_id = ANY((SELECT department_ids FROM params)::uuid[]))
            ...
            chat_scenario_info_stagnation AS (
                SELECT DISTINCT
                    c.id AS chat_id,
                    acs.scenarios_id AS scenario_id,
                    ssj.simulation_id
                FROM all_chats c
            ...
            persona_agg AS (
                SELECT f.persona_id,
                       ...
                       COALESCE((SELECT c.hex_code FROM persona_colors_junction pc JOIN colors_resource c ON pc.color_id = c.id WHERE pc.persona_id = ppj.persona_id LIMIT 1), '#3b82f6') AS color,
                ...
                JOIN persona_personas_junction ppj ON ppj.personas_id = p.id
                WHERE f.grade_percent IS NOT NULL AND f.persona_id IS NOT NULL
                GROUP BY f.persona_id, (SELECT n.name FROM persona_names_junction pn JOIN names_resource n ON pn.name_id = n.id WHERE pn.persona_id = ppj.persona_id LIMIT 1), (SELECT c.hex_code FROM persona_colors_junction pc JOIN colors_resource c ON pc.color_id = c.id WHERE pc.persona_id = ppj.persona_id LIMIT 1)
            ),
            trend_data_raw AS (
                SELECT
                    f.persona_id,
            ...
            persona_trends_agg_converted AS (
                SELECT 
                    ...
                    COALESCE(
                        ARRAY_AGG(
                            (date, COALESCE(avg_score, 0)::float, timestamp, simulation_id::text)::types.q_reports_overview_v4_persona_trend_data
                            ORDER BY day
                        ),
                        '{}'::types.q_reports_overview_v4_persona_trend_data[]
                    ) AS trends
                FROM trend_data_raw
                GROUP BY persona_id
            ),
            persona_colors_agg_converted AS (
                SELECT ARRAY_AGG(
                    ((SELECT n.name FROM persona_names_junction pn JOIN names_resource n ON pn.name_id = n.id WHERE pn.persona_id = ppj.persona_id LIMIT 1), COALESCE((SELECT c.hex_code FROM persona_colors_junction pc JOIN colors_resource c ON pc.color_id = c.id WHERE pc.persona_id = ppj.persona_id LIMIT 1), '#3b82f6'))::types.q_reports_overview_v4_persona_color
                    ORDER BY (SELECT n.name FROM persona_names_junction pn JOIN names_resource n ON pn.name_id = n.id WHERE pn.persona_id = ppj.persona_id LIMIT 1)
                ) AS colors
            ...
            latest_grade_per_chat AS (
                ...
                LEFT JOIN scenario_rubrics_resource srr ON srr.scenario_id = acs_grade.scenarios_id
            ...
            per_grade_group AS (
                ...
                JOIN view_feedbacks_entry fe ON fe.grade_id = lg.id
            ...
            per_rubric_matrix_converted AS (
                SELECT
                    ...
                    ARRAY_AGG(
                        (g1.rubric_id::text, COALESCE(e.r, 0.0), e.p_value, COALESCE(e.color, '#e5e7eb'), COALESCE(e.strength, 'No Data'), COALESCE(e.n, 0))::types.q_reports_overview_v4_rubric_heatmap_cell
                        ORDER BY g2.name
                    ) AS row_array
            ...
            sg_converted AS (
                SELECT rubric_id,
                    ARRAY_AGG((id::text, name, short_name, rubric_id::text)::types.q_reports_overview_v4_standard_group ORDER BY name) AS standard_groups
                FROM rubric_groups
                GROUP BY rubric_id
            ),
            ...
            rubric_correlations_converted AS (
                SELECT
                    COALESCE(
                        ARRAY_AGG(
                            (pr.rubric_id::text, pr.standard_groups, pr.matrix, pr.insights, pr.has_data)::types.q_reports_overview_v4_rubric_matrix_package
                            ORDER BY pr.rubric_id::text
                        ),
                        '{}'::types.q_reports_overview_v4_rubric_matrix_package[]
                    ) AS matrices,
                    COALESCE(
            ...
            simulations_converted AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (id::text, title, COALESCE(description, ''), time_limit, dept_ids)::types.q_reports_overview_v4_simulation
                        ORDER BY title
                    ),
                    '{}'::types.q_reports_overview_v4_simulation[]
            ...
            rubrics_converted AS (
                SELECT COALESCE(
                    ...
                    '{}'::types.q_reports_overview_v4_rubric[]
                ) AS rubrics_array
                ...
                WHERE EXISTS (SELECT 1 FROM parameter_flags_junction pf JOIN flags_resource f ON pf.flag_id = f.id WHERE pf.parameter_id = p.id AND f.name = 'parameter_active' AND pf.value = true)
                  AND (
                      ...
                      OR EXISTS (
                          ...
                          WHERE (SELECT pf.parameter_id FROM parameter_fields_junction pf WHERE pf.field_id = f.id LIMIT 1) = p.id AND fd.department_id = ANY((SELECT department_ids FROM params)::uuid[])
                      )
                      OR NOT EXISTS (
                          SELECT 1 
                          FROM field_artifact f
                          JOIN field_departments_junction fd2 ON fd2.field_id = f.id AND fd2.active = true
                          WHERE (SELECT pf.parameter_id FROM parameter_fields_junction pf WHERE pf.field_id = f.id LIMIT 1) = p.id
                      )
                  )
            ),
            fields_converted AS (
            ...
            header_avg_score_trend_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG((date, value, count)::types.q_reports_overview_v4_trend_data ORDER BY date),
                    '{}'::types.q_reports_overview_v4_trend_data[]
                ) as trend_data
                FROM header_avg_score_trend
            ),
            header_avg_score_points_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG((COALESCE(profile_id, ''), date, value::float, attempt_id, simulation_id, scenario_id, 0)::types.q_reports_overview_v4_data_point),
                    '{}'::types.q_reports_overview_v4_data_point[]
                ) as data_points
            ...
            header_completion_points_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG((profile_id, date, value::float, attempt_id, simulation_id, scenario_id, 0)::types.q_reports_overview_v4_data_point),
                    '{}'::types.q_reports_overview_v4_data_point[]
                ) as data_points
            ...
            header_first_pass_points_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG((profile_id, date, value::float, attempt_id, simulation_id, COALESCE(scenario_id, ''), 0)::types.q_reports_overview_v4_data_point),
                    '{}'::types.q_reports_overview_v4_data_point[]
                ) as data_points
            ...
            header_stagnation_points_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG((COALESCE(profile_id, ''), date, value::float, COALESCE(attempt_id, ''), COALESCE(simulation_id, ''), COALESCE(scenario_id, ''), 0)::types.q_reports_overview_v4_data_point),
                    '{}'::types.q_reports_overview_v4_data_point[]
                ) as data_points
            ...
            header_metrics_combined AS (
                SELECT (
                    (SELECT (has_data, method, current_value, status, trend_analysis, value_field, key_field, trend_data, data_points)::types.q_reports_overview_v4_metric_response FROM header_avg_score_metric LIMIT 1),
                    (SELECT (has_data, method, current_value, status, trend_analysis, value_field, key_field, trend_data, data_points)::types.q_reports_overview_v4_metric_response FROM header_completion_metric LIMIT 1),
                    (SELECT (has_data, method, current_value, status, trend_analysis, value_field, key_field, trend_data, data_points)::types.q_reports_overview_v4_metric_response FROM header_first_pass_metric LIMIT 1),
                    (SELECT (has_data, method, current_value, status, trend_analysis, value_field, key_field, trend_data, data_points)::types.q_reports_overview_v4_metric_response FROM header_highest_metric LIMIT 1),
                    (SELECT (has_data, method, current_value, status, trend_analysis, value_field, key_field, trend_data, data_points)::types.q_reports_overview_v4_metric_response FROM header_messages_metric LIMIT 1),
                    (SELECT (has_data, method, current_value, status, trend_analysis, value_field, key_field, trend_data, data_points)::types.q_reports_overview_v4_metric_response FROM header_persona_times_metric LIMIT 1),
                    (SELECT (has_data, method, current_value, status, trend_analysis, value_field, key_field, trend_data, data_points)::types.q_reports_overview_v4_metric_response FROM header_efficiency_metric LIMIT 1),
                    (SELECT (has_data, method, current_value, status, trend_analysis, value_field, key_field, trend_data, data_points)::types.q_reports_overview_v4_metric_response FROM header_stagnation_metric LIMIT 1),
                    (SELECT (has_data, method, current_value, status, trend_analysis, value_field, key_field, trend_data, data_points)::types.q_reports_overview_v4_metric_response FROM header_time_metric LIMIT 1),
                    (SELECT (has_data, method, current_value, status, trend_analysis, value_field, key_field, trend_data, data_points)::types.q_reports_overview_v4_metric_response FROM header_attempts_metric LIMIT 1)
                )::types.q_reports_overview_v4_header_metrics as header_metrics
            ),
            -- Primary view_metrics_entry helper CTEs
            growth_chart_data_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (date, average_score::float, completion_rate::float, first_attempt_pass_rate::float, session_efficiency::float, stagnation_rate::float)::types.q_reports_overview_v4_growth_data_point
                        ORDER BY date_val
                    ),
                    '{}'::types.q_reports_overview_v4_growth_data_point[]
                ) as chart_data
                FROM growth_chart_dates
            ),
            growth_available_metrics AS (
                SELECT ARRAY[
                    ('averageScore', 'Average Score', '#3b82f6', '%', 'Average score across all attempts', 'percent')::types.q_reports_overview_v4_growth_metric,
                    ('completionRate', 'Completion Rate', '#8b5cf6', '%', 'Percentage of scenarios completed', 'percent')::types.q_reports_overview_v4_growth_metric,
                    ('firstAttemptPassRate', 'First Attempt Pass Rate', '#06b6d4', '%', 'Pass rate on first attempts', 'percent')::types.q_reports_overview_v4_growth_metric,
                    ('sessionEfficiency', 'Session Efficiency', '#84cc16', '%', 'Efficiency index based on score and time (0-100)', 'percent')::types.q_reports_overview_v4_growth_metric,
                    ('stagnationRate', 'Stagnation Rate', '#ec4899', '%', 'Percentage of attempts with no improvement', 'percent')::types.q_reports_overview_v4_growth_metric
                ] as available_metrics
            ),
            growth_window_averages_combined AS (
                SELECT (
                    ROW((7, (SELECT ROUND(last_avg) FROM growth_window), (SELECT ROUND(prev_avg) FROM growth_window))::types.q_reports_overview_v4_growth_window_average)
                )::types.q_reports_overview_v4_growth_window_averages as window_averages
            ),
            growth_data_combined AS (
                SELECT (
                    ...
                    CASE
                        ...
                        ELSE 'danger'::text
                    END
                )::types.q_reports_overview_v4_growth_data_response as growth_data
            ),
            persona_performance_top5 AS (
                SELECT pa.name, pa.avg_score, pa.sessions, pa.color, pa.simulation_ids, 
                       COALESCE(ptc.trends, ARRAY[]::types.q_reports_overview_v4_persona_trend_data[]) as trends,
                       pa.status
                FROM persona_agg pa
            ...
            persona_performance_chart_data_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (name, COALESCE(avg_score, 0)::float, sessions, color, simulation_ids, trends, status)::types.q_reports_overview_v4_persona_performance_data
                    ),
                    '{}'::types.q_reports_overview_v4_persona_performance_data[]
                ) as chart_data
            ...
            persona_performance_combined AS (
                ...
                )::types.q_reports_overview_v4_persona_performance_response as persona_performance
            ),
            rubric_heatmap_combined AS (
                ...
                )::types.q_reports_overview_v4_rubric_heatmap_response as rubric_heatmap
            ),
            primary_metrics_combined AS (
                ...
                )::types.q_reports_overview_v4_primary_metrics as primary_metrics
            ),
            -- =====================================================
            -- SECONDARY METRICS
            -- =====================================================

            -- Attempt Improvement (single-profile version)
            attempt_first AS (
                SELECT simulation_id, attempt_id,
                       MIN(attempt_created_at) AS first_ts
                FROM filt
                GROUP BY simulation_id, attempt_id
            ),
            attempt_ord AS (
                SELECT af.*,
                       ROW_NUMBER() OVER (PARTITION BY af.simulation_id ORDER BY af.first_ts) AS attempt_no
            ...
            attempt_stats AS (
                ...
                WHERE f.grade_percent IS NOT NULL
                GROUP BY ao.simulation_id, ao.attempt_id, ao.attempt_no
            ),
            attempt_data AS (
                SELECT
                    simulation_id,
            ...
            attempt_improvement_chart_data_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        ('Attempt ' || attempt_no, ROUND(COALESCE(avg_grade, 0))::float, ROUND(COALESCE(avg_time_minutes, 0))::float, ROUND(COALESCE(pass_rate, 0))::float)::types.q_reports_overview_v4_attempt_improvement_data
                        ORDER BY attempt_no
                    ),
                    '{}'::types.q_reports_overview_v4_attempt_improvement_data[]
                ) as chart_data
                FROM attempt_rows
            ),
            attempt_facts AS (
            ...
            attempt_improvement_facts_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (simulation_id, attempt_no, avg_grade::float, avg_minutes::float, pass_rate::float)::types.q_reports_overview_v4_attempt_improvement_fact
                        ORDER BY simulation_id, attempt_no
                    ),
                    '{}'::types.q_reports_overview_v4_attempt_improvement_fact[]
                ) as facts
                FROM attempt_facts
            ),
            ...
            attempt_improvement_combined AS (
                ...
                )::types.q_reports_overview_v4_attempt_improvement_response as attempt_improvement
            ),

            -- Cohort Performance (target profile vs cohort averages)
            ...
            cohort_list AS (
                ...
                JOIN target_profile_cohorts tpc ON tpc.cohort_id = c.id
            ),
            cohort_attempts AS (
                SELECT
                    cad.c_id AS cohort_id,
                    cad.attempt_id,
                    MAX((cad.passed)::int)::int AS passed_any,
                    TRUNC(AVG(cad.grade_percent)::numeric, 2)::float AS avg_grade_attempt
                FROM cohort_all_data cad
                GROUP BY cad.c_id, cad.attempt_id
            ),
            cohort_agg AS (
                SELECT
                    cl.id AS cohort_id,
                    ...
                    (SELECT COUNT(*) FROM (
                        SELECT profile_id
                        FROM cohort_all_data cad2
                        WHERE cad2.c_id = cl.id
                        GROUP BY profile_id
                        HAVING
                            ...
                            AND NOT EXISTS (
                                ...
                                FROM (
                                    ...
                                    FROM cohort_all_data cad3
                                    WHERE cad3.c_id = cl.id
                                        AND cad3.profile_id = cad2.profile_id
                    ...
                    (SELECT COUNT(*) FROM (
                        ...
                        FROM cohort_all_data cad2
                        WHERE cad2.c_id = cl.id
                        GROUP BY cad2.profile_id
                        HAVING MAX((cad2.passed)::int) = 1
                    ...
                    ARRAY_AGG(
                        (cohort_id::text, cohort_name,
                         ...
                         CASE
                             ...
                             ELSE 'danger'::text
                         END)::types.q_reports_overview_v4_cohort_data
                        ORDER BY cohort_name
                    ),
                    '{}'::types.q_reports_overview_v4_cohort_data[]
                ) as cohort_data
                FROM cohort_agg
            ),
            cohort_daily_data AS (
                SELECT
                    to_char(date_trunc('day', cad.attempt_created_at), 'YYYY-MM-DD') AS date,
                    TRUNC(AVG(cad.grade_percent)::numeric, 2)::float AS avg_score,
                    cad.c_id::text AS cohort_id
                FROM cohort_all_data cad
                WHERE cad.grade_percent IS NOT NULL
                GROUP BY cad.c_id, date_trunc('day', cad.attempt_created_at)
            ),
            cohort_performance_daily_data_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (date, ROUND(COALESCE(avg_score, 0))::int, cohort_id)::types.q_reports_overview_v4_daily_data
                        ORDER BY cohort_id, date
                    ),
                    '{}'::types.q_reports_overview_v4_daily_data[]
                ) as daily_data
            ...
            cohort_performance_combined AS (
                SELECT (
                    ...
                    ARRAY[]::types.q_reports_overview_v4_cohort_fact[],
                    ARRAY[]::types.q_reports_overview_v4_cohort_daily_fact[],
                ...
                )::types.q_reports_overview_v4_cohort_performance_response as cohort_performance
            ),

            -- Skill Performance (using view_grade_per_standard_group)
            per_grade_group_skills AS (
                ...
                JOIN filt f ON f.chat_id = vg.chat_id
            ),
            radar_rows AS (
                SELECT
                    pgg.rubric_id,
            ...
            radar_data_per_rubric AS (
                SELECT
                    ...
                    COALESCE(
                        ARRAY_AGG(
                            (group_name, group_description, GREATEST(0, LEAST(1, COALESCE(avg_pct, 0) / 100.0))::float, 1.0::float)::types.q_reports_overview_v4_skill_radar_data
                            ORDER BY group_name
                        ),
                        '{}'::types.q_reports_overview_v4_skill_radar_data[]
                    ) as radar_data
                FROM radar_rows
                GROUP BY rubric_id
            ),
            group_facts_per_rubric AS (
                SELECT
                    ...
                    COALESCE(
                        ARRAY_AGG(
                            (group_id::text, group_name, group_description, simulation_id::text, COALESCE(score_sum, 0)::float, COALESCE(points_sum, 0)::float, COALESCE(avg_pct, 0)::float)::types.q_reports_overview_v4_skill_standard_fact
                            ORDER BY group_name, simulation_id
                        ),
                        '{}'::types.q_reports_overview_v4_skill_standard_fact[]
                    ) as group_facts
            ...
            skill_performance_packages_agg AS (
                SELECT
                    ...
                    COALESCE(rd.radar_data, '{}'::types.q_reports_overview_v4_skill_radar_data[]) AS radar_data,
                    COALESCE(gf.group_facts, '{}'::types.q_reports_overview_v4_skill_standard_fact[]) AS group_facts
            ...
            skill_performance_packages_combined AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (rubric_id::text, radar_data, group_facts)::types.q_reports_overview_v4_skill_package
                        ORDER BY rubric_id::text
                    ),
                    '{}'::types.q_reports_overview_v4_skill_package[]
                ) as packages
            ...
            skill_performance_combined AS (
                ...
                )::types.q_reports_overview_v4_skill_performance_response as skill_performance
            ),
            secondary_metrics_combined AS (
                ...
                )::types.q_reports_overview_v4_secondary_metrics as secondary_metrics
            ),
            ...
            scenario_performance_attribute_attempt_facts_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (parameter_id::text, parameter_item_id::text, date, timestamp, avg_score, attempts, passed_attempts)::types.q_reports_overview_v4_scenario_attribute_attempt_fact
                        ORDER BY parameter_id, parameter_item_id, date
                    ),
                    '{}'::types.q_reports_overview_v4_scenario_attribute_attempt_fact[]
            ...
            scenario_performance_attribute_scenario_facts_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (parameter_id::text, parameter_item_id::text, scenario_id::text)::types.q_reports_overview_v4_scenario_attribute_scenario_fact
                        ORDER BY parameter_id, parameter_item_id, scenario_id
                    ),
                    '{}'::types.q_reports_overview_v4_scenario_attribute_scenario_fact[]
            ...
            scenario_performance_combined AS (
                ...
                )::types.q_reports_overview_v4_scenario_performance_response as scenario_performance
            ),
            ...
            scenario_stats_numeric_attempt_facts_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (parameter_id::text, level_label, level_value, avg_score, attempts)::types.q_reports_overview_v4_numeric_attempt_fact
                        ORDER BY parameter_id, level_value
                    ),
                    '{}'::types.q_reports_overview_v4_numeric_attempt_fact[]
                ...
                SELECT COALESCE(
                    ARRAY_AGG(
                        (nms.parameter_id::text, nms.scenario_id::text,
                         ...
                         nms.level::numeric
                        )::types.q_reports_overview_v4_numeric_scenario_fact
            ...
            scenario_stats_combined AS (
                ...
                )::types.q_reports_overview_v4_scenario_stats_response as scenario_stats
            ),

            -- Simulation Performance (per-scenario breakdown)
            sim_perf AS (
            ...
            simulation_performance_scenario_facts_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (simulation_id::text, scenario_id::text, scenario_name, avg_score, success_rate, total_attempts, completed_attempts)::types.q_reports_overview_v4_scenario_fact
                        ORDER BY simulation_id, scenario_id
                    ),
                    '{}'::types.q_reports_overview_v4_scenario_fact[]
                ) as scenario_facts
                FROM sim_perf
            ),
            ...
            simulation_performance_combined AS (
                ...
                )::types.q_reports_overview_v4_simulation_performance_response as simulation_performance
            ),

            -- Simulation Composition (parameter composition analysis)
            sim_seen AS (
            ...
            simulation_composition_simulation_facts_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (simulation_id::text, simulation_title, avg_score::float, completion_rate::float, total_attempts, scenario_count)::types.q_reports_overview_v4_simulation_fact
                        ORDER BY simulation_id
                    ),
                    '{}'::types.q_reports_overview_v4_simulation_fact[]
                ) as simulation_facts
            ...
            simulation_composition_param_facts_cat_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (simulation_id::text, parameter_id::text, parameter_item_id::text, scenario_count)::types.q_reports_overview_v4_simulation_parameter_fact_categorical
                        ORDER BY simulation_id, parameter_id, parameter_item_id
                    ),
                    '{}'::types.q_reports_overview_v4_simulation_parameter_fact_categorical[]
            ...
            simulation_composition_param_facts_num_agg AS (
                SELECT COALESCE(
                    ARRAY_AGG(
                        (simulation_id::text, parameter_id::text, avg_level, level_label, scenario_count)::types.q_reports_overview_v4_simulation_parameter_fact_numeric
                        ORDER BY simulation_id, parameter_id
                    ),
                    '{}'::types.q_reports_overview_v4_simulation_parameter_fact_numeric[]
            ...
            simulation_composition_combined AS (
                ...
                )::types.q_reports_overview_v4_simulation_composition_response as simulation_composition
            ),
            footer_metrics_combined AS (
                ...
                )::types.q_reports_overview_v4_footer_metrics as footer_metrics
            ),
            -- History - placeholder for now (needs conversion from attempt history CTEs)
            history_combined AS (
                SELECT ARRAY[]::types.q_reports_overview_v4_attempt_history_row[] as history
            ),
            -- Insights - placeholder for now (needs conversion)
            insights_combined AS (
                SELECT (
                    NULL::text,
                    ARRAY[]::types.q_reports_overview_v4_persona_insight[],
                    NULL::text,
                    NULL::text,
                    ARRAY[]::types.q_reports_overview_v4_cohort_insight[],
                    NULL::text,
                    NULL::text,
                    NULL::text,
                    NULL::text,
                    NULL::text
                )::types.q_reports_overview_v4_insights as insights
            ),
            -- Thresholds
            thresholds_combined AS (
                SELECT COALESCE(
                    (SELECT (success_threshold, warning_threshold, danger_threshold)::types.q_reports_overview_v4_thresholds FROM settings_thresholds LIMIT 1),
                    (85, 80, 70)::types.q_reports_overview_v4_thresholds
                ) as thresholds
            )
SELECT
    (SELECT actor_name FROM user_profile)::text as actor_name,
    (SELECT profile_name FROM profile_data LIMIT 1)::text as profile_name,
    (SELECT profile_emails_junction FROM profile_data LIMIT 1)::text[] as profile_emails_junction,
