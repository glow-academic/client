...
BEGIN
    ...
    -- Populate 14 config connection tables from agent config
    -- 1. agents
    ...
    WHERE amj.agent_id = v_agent_id AND amj.active = true
    ...
    FROM agent_temperature_levels_junction atlj WHERE atlj.agent_id = v_agent_id AND atlj.active = true
    ...
    FROM agent_reasoning_levels_junction arlj WHERE arlj.agent_id = v_agent_id AND arlj.active = true
    ...
    FROM agent_prompts_junction apj WHERE apj.agent_id = v_agent_id AND apj.active = true
    ...
    FROM agent_instructions_junction aij WHERE aij.agent_id = v_agent_id AND aij.active = true
    ...
    FROM agent_voices_junction avj WHERE avj.agent_id = v_agent_id AND avj.active = true
