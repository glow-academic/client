...
-- Parameters: name_id, description_id, department_ids, simulation_ids, profile_ids, profile_persona_ids
...
BEGIN
    ...
    LEFT JOIN names_resource n ON n.id = api_create_cohorts_v4.name_id
    LEFT JOIN descriptions_resource d ON d.id = api_create_cohorts_v4.description_id
