...
BEGIN
    ...
    WHERE at.agent_id = api_create_images_v4.agent_id
      AND rt.resource = 'images'::resource_type
      AND at.active = true
    ...
    VALUES (v_run_id, 0, 0, 0, api_create_images_v4.group_id, NOW(), NOW());

    -- Link agent to run
    INSERT INTO agent_runs_junction (agent_id, run_id) VALUES (api_create_images_v4.agent_id, v_run_id);
