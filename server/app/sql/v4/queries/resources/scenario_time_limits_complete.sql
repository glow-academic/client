...
CREATE OR REPLACE FUNCTION api_create_scenario_time_limits_v4(agent_id uuid,
    group_id uuid,
    scenario_id uuid,
...
BEGIN
    ...
    WHERE at.agent_id = api_create_scenario_time_limits_v4.agent_id
    ...
    VALUES (
        v_call_id,
        'scenario_time_limits_' || v_call_id::text,
        v_template_id,
        v_arguments_raw,
        true,
        NOW(),
    ...
    -- INSERT or UPDATE INTO scenario_time_limits_resource
    ...
    VALUES (v_run_id, 0, 0, 0, api_create_scenario_time_limits_v4.group_id, NOW(), NOW());

    -- Link agent to run
    INSERT INTO agent_runs_junction (agent_id, run_id) VALUES (api_create_scenario_time_limits_v4.agent_id, v_run_id);
