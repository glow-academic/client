...
CREATE OR REPLACE FUNCTION api_create_keys_v4(
    key_id uuid,
...
BEGIN
    ...
    IF tool_id IS NOT NULL AND group_id IS NOT NULL THEN
        ...
        VALUES (v_call_id, 'keys_' || v_call_id::text, v_run_id, true, NOW(), NOW());

        -- Link tool to call
        INSERT INTO tools_calls_connection (tools_id, call_id) VALUES (api_create_keys_v4.tool_id, v_call_id);
