...
BEGIN
    ...
    IF tool_id IS NOT NULL AND group_id IS NOT NULL THEN
        ...
        VALUES (v_call_id, 'profiles_' || v_call_id::text, v_run_id, true, NOW(), NOW());
        ...
        VALUES (api_link_profiles_v4.resource_id, v_call_id);
    END IF;

    RETURN QUERY SELECT api_link_profiles_v4.resource_id;
END;
$$;
