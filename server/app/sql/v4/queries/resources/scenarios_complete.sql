...
-- Get or create operation (returns existing ID if scenario_id + group_id already exists)
...
BEGIN
    ...
    VALUES (v_run_id, 0, 0, 0, api_create_scenarios_v4.group_id, NOW(), NOW());

    -- Link agent to run
    INSERT INTO agent_runs_junction (agent_id, run_id) VALUES (api_create_scenarios_v4.agent_id, v_run_id);
