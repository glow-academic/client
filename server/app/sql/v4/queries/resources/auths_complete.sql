...
BEGIN
    ...
    VALUES (v_run_id, 0, 0, 0, api_create_auths_v4.group_id, NOW(), NOW());

    -- Link agent to run
    INSERT INTO agent_runs_junction (agent_id, run_id) VALUES (api_create_auths_v4.agent_id, v_run_id);
