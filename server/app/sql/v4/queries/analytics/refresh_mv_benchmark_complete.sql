...
BEGIN
    ...
    SELECT COALESCE(
        (SELECT n.name FROM profile_names_junction pn JOIN names_resource n ON pn.name_id = n.id WHERE pn.profile_id = api_refresh_mv_benchmark_v4.profile_id LIMIT 1),
        'System'
    ) INTO actor_name_val
