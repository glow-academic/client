...
BEGIN
    ...
    VALUES ('Completed attempt chat ' || api_create_attempt_completion_entry_v4.chat_id || ': ' || api_create_attempt_completion_entry_v4.end_reason, true, api_create_attempt_completion_entry_v4.mcp)
    ...
    VALUES (v_call_id, api_create_attempt_completion_entry_v4.run_id, 'attempt_completion_' || v_call_id::text, true);
