...
BEGIN
    ...
    VALUES ('Completed test invocation ' || api_create_test_completion_entry_v4.invocation_id || ': ' || api_create_test_completion_entry_v4.end_reason, true, api_create_test_completion_entry_v4.mcp)
