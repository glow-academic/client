...
BEGIN
    ...
    VALUES ('Archive test ' || api_create_test_archive_entry_v4.test_id || ': archived=' || api_create_test_archive_entry_v4.archived, true, api_create_test_archive_entry_v4.mcp)
    ...
    VALUES (v_call_id, api_create_test_archive_entry_v4.run_id, 'test_archive_' || v_call_id::text, true);
