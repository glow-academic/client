...
CREATE OR REPLACE FUNCTION public.api_search_test_invocation_entries_v4(
    ...
    suite_department_id uuid DEFAULT NULL,
...
BEGIN
    ...
    FROM (
        SELECT jsonb_build_object(
            ...
            'test_id', m.test_id,
            'group_id', m.group_id,
            'suite_department_id', m.suite_department_id,
        ...
        WHERE true
          ...
          AND (suite_department_id IS NULL OR m.suite_department_id = suite_department_id)
