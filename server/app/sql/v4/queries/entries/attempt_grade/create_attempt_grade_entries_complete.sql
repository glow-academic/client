...
BEGIN
    ...
    VALUES ('Graded attempt: passed=' || api_create_attempt_grade_entry_v4.passed || ', score=' || api_create_attempt_grade_entry_v4.score, true, api_create_attempt_grade_entry_v4.mcp)
    ...
    VALUES (v_call_id, api_create_attempt_grade_entry_v4.run_id, 'attempt_grade_' || v_call_id::text, true);
