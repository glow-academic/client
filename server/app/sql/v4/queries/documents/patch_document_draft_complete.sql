...
BEGIN
    ...
    IF input_draft_id IS NOT NULL THEN
        ...
        FROM document_drafts_entry vde
        ...
        UPDATE document_drafts_entry
        SET version = document_drafts_entry.version + 1,
            updated_at = NOW(),
            group_id = COALESCE(document_drafts_entry.group_id, v_group_id)
    ...
    IF v_draft_id IS NULL THEN
        ...
        INSERT INTO document_drafts_entry (group_id)
        VALUES (v_group_id)
        RETURNING id, version INTO v_draft_id, v_new_version;

        INSERT INTO document_drafts_profiles_connection (draft_id, profiles_id, version)
