...
VALUES (api_insert_scenario_department_link_v4.scenario_id, api_insert_scenario_department_link_v4.department_id, api_insert_scenario_department_link_v4.active, NOW(), NOW())
ON CONFLICT (scenario_id, department_id) DO UPDATE SET
    active = EXCLUDED.active,
    updated_at = NOW()
RETURNING scenario_id, department_id, active, created_at, updated_at
$$;
