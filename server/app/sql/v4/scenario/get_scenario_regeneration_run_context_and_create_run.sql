...
-- Returns: agent, model, provider, persona, documents, parameter items, run_id, group_id, trace_id
...
-- Creates a group (trace_id auto-generated by database default) and links run to it
WITH params AS (
