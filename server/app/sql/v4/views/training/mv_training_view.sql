...
CREATE UNIQUE INDEX mv_training_pk
    ON mv_training (training_entry_id);

CREATE INDEX mv_training_parent_id_idx
    ON mv_training (parent_id);

CREATE INDEX mv_training_scenario_id_idx
    ON mv_training (scenario_id);

CREATE INDEX mv_training_department_ids_gin_idx
    ON mv_training USING GIN (department_ids);

CREATE INDEX mv_training_persona_ids_gin_idx
    ON mv_training USING GIN (persona_ids);
