-- Materialized View: mv_attempt_grades
...
-- ============================================================================
-- Step 1: Drop all indexes on mv_attempt_grades (if it exists)
-- ============================================================================
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'mv_attempt_grades'
    LOOP
...
DROP MATERIALIZED VIEW IF EXISTS mv_attempt_grades CASCADE;

-- ============================================================================
-- Step 3: Create mv_attempt_grades Materialized View
-- ============================================================================

CREATE MATERIALIZED VIEW mv_attempt_grades AS
...
CREATE UNIQUE INDEX mv_attempt_grade_pk
    ON mv_attempt_grades (grade_id);

-- ============================================================================
-- Step 5: Create Filter/Slicing Indexes
-- ============================================================================

CREATE UNIQUE INDEX mv_attempt_grade_chat_id_uniq
    ON mv_attempt_grades (chat_id);

CREATE INDEX mv_attempt_grade_chat_id_idx
    ON mv_attempt_grades (chat_id);
...
REFRESH MATERIALIZED VIEW mv_attempt_grades;
