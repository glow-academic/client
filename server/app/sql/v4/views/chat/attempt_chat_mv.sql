...
CREATE INDEX attempt_chat_mv_user_persona_id_idx
    ON attempt_chat_mv (user_persona_id)
...
CREATE INDEX attempt_chat_mv_training_department_id_idx
    ON attempt_chat_mv (training_department_id)
...
CREATE INDEX attempt_chat_mv_persona_cohort_idx
    ON attempt_chat_mv (user_persona_id, cohort_id)
    WHERE user_persona_id IS NOT NULL;
