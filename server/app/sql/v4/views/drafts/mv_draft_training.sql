...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'mv_draft_training'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS mv_draft_training CASCADE;

CREATE MATERIALIZED VIEW mv_draft_training AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX mv_draft_training_pk ON mv_draft_training (draft_id);

REFRESH MATERIALIZED VIEW mv_draft_training;
