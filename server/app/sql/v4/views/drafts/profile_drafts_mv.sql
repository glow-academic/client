...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'profile_drafts_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS profile_drafts_mv CASCADE;
...
CREATE UNIQUE INDEX profile_drafts_mv_pk ON profile_drafts_mv (draft_id);

REFRESH MATERIALIZED VIEW profile_drafts_mv;
