-- Materialized View: mv_draft_rubric
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'mv_draft_rubric'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS mv_draft_rubric CASCADE;

CREATE MATERIALIZED VIEW mv_draft_rubric AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX mv_draft_rubric_pk ON mv_draft_rubric (draft_id);

REFRESH MATERIALIZED VIEW mv_draft_rubric;
