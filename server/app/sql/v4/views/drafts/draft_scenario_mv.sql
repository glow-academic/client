-- Materialized View: draft_scenario_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_scenario_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_scenario_mv CASCADE;

CREATE MATERIALIZED VIEW draft_scenario_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_scenario_mv_pk ON draft_scenario_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_scenario_mv;
