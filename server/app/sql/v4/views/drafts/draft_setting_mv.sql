-- Materialized View: draft_setting_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_setting_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_setting_mv CASCADE;

CREATE MATERIALIZED VIEW draft_setting_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_setting_mv_pk ON draft_setting_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_setting_mv;
