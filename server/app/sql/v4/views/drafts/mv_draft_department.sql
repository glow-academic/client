-- Materialized View: mv_draft_department
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'mv_draft_department'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS mv_draft_department CASCADE;
...
REFRESH MATERIALIZED VIEW mv_draft_department;
