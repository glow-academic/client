...
SELECT
    ...
    -- Single group_id from drafts_entry.group_id -> groups_groups_connection -> groups_resource
    (
        SELECT ggc.groups_id FROM groups_groups_connection ggc
        WHERE ggc.group_id = d.group_id AND ggc.active = true LIMIT 1
    ) AS group_id,
