-- Materialized View: draft_provider_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_provider_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_provider_mv CASCADE;

CREATE MATERIALIZED VIEW draft_provider_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_provider_mv_pk ON draft_provider_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_provider_mv;
