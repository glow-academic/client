...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'model_drafts_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS model_drafts_mv CASCADE;
...
CREATE UNIQUE INDEX model_drafts_mv_pk ON model_drafts_mv (draft_id);

REFRESH MATERIALIZED VIEW model_drafts_mv;
