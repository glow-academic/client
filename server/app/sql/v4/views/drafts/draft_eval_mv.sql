-- Materialized View: draft_eval_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_eval_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_eval_mv CASCADE;

CREATE MATERIALIZED VIEW draft_eval_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_eval_mv_pk ON draft_eval_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_eval_mv;
