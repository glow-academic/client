-- Materialized View: draft_auth_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_auth_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_auth_mv CASCADE;

CREATE MATERIALIZED VIEW draft_auth_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_auth_mv_pk ON draft_auth_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_auth_mv;
