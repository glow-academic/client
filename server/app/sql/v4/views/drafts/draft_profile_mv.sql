-- Materialized View: draft_profile_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_profile_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_profile_mv CASCADE;

CREATE MATERIALIZED VIEW draft_profile_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_profile_mv_pk ON draft_profile_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_profile_mv;
