-- Materialized View: draft_agent_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_agent_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_agent_mv CASCADE;

CREATE MATERIALIZED VIEW draft_agent_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_agent_mv_pk ON draft_agent_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_agent_mv;
