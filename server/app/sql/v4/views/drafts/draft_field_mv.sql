-- Materialized View: draft_field_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_field_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_field_mv CASCADE;

CREATE MATERIALIZED VIEW draft_field_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_field_mv_pk ON draft_field_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_field_mv;
