-- Materialized View: draft_cohort_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_cohort_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_cohort_mv CASCADE;

CREATE MATERIALIZED VIEW draft_cohort_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_cohort_mv_pk ON draft_cohort_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_cohort_mv;
