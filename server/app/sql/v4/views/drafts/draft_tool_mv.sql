-- Materialized View: draft_tool_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_tool_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_tool_mv CASCADE;

CREATE MATERIALIZED VIEW draft_tool_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_tool_mv_pk ON draft_tool_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_tool_mv;
