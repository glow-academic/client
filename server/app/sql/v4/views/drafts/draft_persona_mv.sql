-- Materialized View: draft_persona_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_persona_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_persona_mv CASCADE;

CREATE MATERIALIZED VIEW draft_persona_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_persona_mv_pk ON draft_persona_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_persona_mv;
