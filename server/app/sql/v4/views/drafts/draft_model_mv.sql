-- Materialized View: draft_model_mv
...
BEGIN
    FOR r IN
        ...
        WHERE schemaname = 'public'
          AND tablename = 'draft_model_mv'
    LOOP
        EXECUTE format('DROP INDEX IF EXISTS %I', r.indexname);
    END LOOP;
END $$;

DROP MATERIALIZED VIEW IF EXISTS draft_model_mv CASCADE;

CREATE MATERIALIZED VIEW draft_model_mv AS
WITH draft_links AS (
...
CREATE UNIQUE INDEX draft_model_mv_pk ON draft_model_mv (draft_id);

REFRESH MATERIALIZED VIEW draft_model_mv;
