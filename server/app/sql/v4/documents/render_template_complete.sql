...
SELECT 
    ...
    COALESCE((SELECT c.hex_code FROM setting_colors sc JOIN colors_resource c ON sc.color_id = c.id WHERE sc.setting_id = ss.settings_id AND sc.type = 'background'::type_setting_colors LIMIT 1), '#ffffff')::text as settings_background,
    COALESCE((SELECT c.hex_code FROM setting_colors sc JOIN colors_resource c ON sc.color_id = c.id WHERE sc.setting_id = ss.settings_id AND sc.type = 'surface'::type_setting_colors LIMIT 1), '#ffffff')::text as settings_surface,
    COALESCE((SELECT c.hex_code FROM setting_colors sc JOIN colors_resource c ON sc.color_id = c.id WHERE sc.setting_id = ss.settings_id AND sc.type = 'success'::type_setting_colors LIMIT 1), '#009e34')::text as settings_success,
    COALESCE((SELECT c.hex_code FROM setting_colors sc JOIN colors_resource c ON sc.color_id = c.id WHERE sc.setting_id = ss.settings_id AND sc.type = 'warning'::type_setting_colors LIMIT 1), '#ff9800')::text as settings_warning,
    COALESCE((SELECT c.hex_code FROM setting_colors sc JOIN colors_resource c ON sc.color_id = c.id WHERE sc.setting_id = ss.settings_id AND sc.type = 'error'::type_setting_colors LIMIT 1), '#d32f2f')::text as settings_error,
    COALESCE((SELECT c.hex_code FROM setting_colors sc JOIN colors_resource c ON sc.color_id = c.id WHERE sc.setting_id = ss.settings_id AND sc.type = 'sidebar_background'::type_setting_colors LIMIT 1), '#171717')::text as settings_sidebar_background,
    COALESCE((SELECT c.hex_code FROM setting_colors sc JOIN colors_resource c ON sc.color_id = c.id WHERE sc.setting_id = ss.settings_id AND sc.type = 'sidebar_primary'::type_setting_colors LIMIT 1), '#f5f5f5')::text as settings_sidebar_primary,
    COALESCE((SELECT c.hex_code FROM setting_colors sc JOIN colors_resource c ON sc.color_id = c.id WHERE sc.setting_id = ss.settings_id AND sc.type = 'chart1'::type_setting_colors LIMIT 1), '#1976d2')::text as settings_chart1,
    COALESCE((SELECT c.hex_code FROM setting_colors sc JOIN colors_resource c ON sc.color_id = c.id WHERE sc.setting_id = ss.settings_id AND sc.type = 'chart2'::type_setting_colors LIMIT 1), '#388e3c')::text as settings_chart2,
    COALESCE((SELECT c.hex_code FROM setting_colors sc JOIN colors_resource c ON sc.color_id = c.id WHERE sc.setting_id = ss.settings_id AND sc.type = 'chart3'::type_setting_colors LIMIT 1), '#f57c00')::text as settings_chart3,
    COALESCE((SELECT c.hex_code FROM setting_colors sc JOIN colors_resource c ON sc.color_id = c.id WHERE sc.setting_id = ss.settings_id AND sc.type = 'chart4'::type_setting_colors LIMIT 1), '#7b1fa2')::text as settings_chart4,
