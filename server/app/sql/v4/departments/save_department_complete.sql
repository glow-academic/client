...
BEGIN
    ...
    -- Create or update department first (outside CTE)
    IF is_create THEN
        ...
        INSERT INTO department (group_id, created_at, updated_at)
    ...
    -- Insert or update department active flag (UPDATE handled above for update case, INSERT here handles both via ON CONFLICT)
