...
BEGIN
    ...
    IF input_draft_id IS NOT NULL THEN
        ...
        IF v_draft_id IS NOT NULL THEN
            ...
            DELETE FROM settings_draft WHERE settings_draft.draft_id = v_draft_id;
            ...
            IF setting_ids IS NOT NULL THEN
                DELETE FROM settings_draft WHERE settings_draft.draft_id = v_draft_id;
                INSERT INTO settings_draft (draft_id, settings_id, version)
    ...
    VALUES ('department'::artifact_type, v_profile_id, v_group_id)
    RETURNING id, version INTO v_draft_id, v_new_version;
