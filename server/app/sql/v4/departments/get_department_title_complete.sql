...
STABLE
AS $$
SELECT (SELECT n.name FROM department_names dn JOIN names n ON dn.name_id = n.id WHERE dn.department_id = department_id LIMIT 1) as title FROM departments WHERE id = department_id
$$;