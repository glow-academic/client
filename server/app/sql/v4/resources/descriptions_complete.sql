...
BEGIN
    ...
    INSERT INTO descriptions(description, active, call_id, mcp)
    ...
    VALUES (
        api_create_descriptions_v4.group_id,
        v_run_id,
        COALESCE((SELECT MAX(gr.idx) FROM group_runs gr WHERE gr.group_id = api_create_descriptions_v4.group_id), -1) + 1,
        NOW(),
        NOW()
    );
