...
BEGIN
    ...
    INSERT INTO models_resource(id, model_id, active, generated, mcp, call_id, group_id, created_at)
    VALUES (uuidv7(), v_artifact_id, true, true, mcp, v_call_id, api_create_models_v4.group_id, NOW())
