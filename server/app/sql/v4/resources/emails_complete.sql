...
BEGIN
    ...
    INSERT INTO emails_resource(active, call_id, mcp)
    ...
    SELECT 
        api_create_emails_v4.group_id,
        v_run_id,
        COALESCE((SELECT MAX(gr.idx) FROM group_runs gr WHERE gr.group_id = api_create_emails_v4.group_id), -1) + 1,
        NOW(),
        NOW();
