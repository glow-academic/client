...
BEGIN
    ...
    WHERE at.agent_id = api_create_endpoints_v4.agent_id
      AND rt.resource = 'endpoints'::resources
      AND at.active = true
    ...
    SELECT 
        api_create_endpoints_v4.group_id,
        v_run_id,
        COALESCE((SELECT MAX(gr.idx) FROM group_runs gr WHERE gr.group_id = api_create_endpoints_v4.group_id), -1) + 1,
        NOW(),
        NOW();
