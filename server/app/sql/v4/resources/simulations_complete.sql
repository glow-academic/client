...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM simulation WHERE id = v_artifact_id) THEN
    ...
    -- INSERT into simulations table (always insert, never update)
    -- INSERT into simulations table (always insert, never update)
    -- Create resource with new unique id and simulation_id FK
    INSERT INTO simulations(id, simulation_id, active, generated, mcp, call_id, group_id, created_at, updated_at)
