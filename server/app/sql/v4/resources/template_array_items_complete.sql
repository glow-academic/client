...
BEGIN
    ...
    INSERT INTO template_array_items(template_id, schema_field_id, item_template_id, "position", active, call_id)
    VALUES (template_id, schema_field_id, item_template_id, position_value, true, v_call_id)
