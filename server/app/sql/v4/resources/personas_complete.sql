...
BEGIN
    ...
    INSERT INTO personas_resource(id, persona_id, active, generated, mcp, call_id, group_id, created_at, updated_at)
    VALUES (uuidv7(), v_artifact_id, true, true, mcp, v_call_id, api_create_personas_v4.group_id, NOW(), NOW())
    ...
    SELECT 
        api_create_personas_v4.group_id,
        v_run_id,
        COALESCE((SELECT MAX(gr.idx) FROM group_runs gr WHERE gr.group_id = api_create_personas_v4.group_id), -1) + 1,
        NOW(),
        NOW();
