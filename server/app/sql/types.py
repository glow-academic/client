...
# Generated from: get_draft_training_bundle_view


class GetDraftTrainingBundleViewSqlParams(BaseModel):
    draft_ids: list[UUID]
...
class QGetDraftTrainingBundleViewV4Item(BaseModel):
    draft_id: UUID | None
    created_at: datetime | None
    updated_at: datetime | None
    version: int | None
...
class GetDraftTrainingBundleViewSqlRow(BaseModel):
    items: list[QGetDraftTrainingBundleViewV4Item] | None = None


class GetDraftTrainingBundleViewApiRequest(BaseModel):
    draft_ids: list[UUID]


class GetDraftTrainingBundleViewApiResponse(BaseModel):
    items: list[QGetDraftTrainingBundleViewV4Item] | None = None
...
_registry: dict[str, tuple[str, str, str, str]] = {
    ...
    "app/sql/v4/queries/views/drafts/get_draft_training_bundle_view_complete.sql": (
        "GetDraftTrainingBundleViewSqlParams",
        "GetDraftTrainingBundleViewSqlRow",
        "GetDraftTrainingBundleViewApiRequest",
        "GetDraftTrainingBundleViewApiResponse",
    ),
