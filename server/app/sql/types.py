...
# Generated from: get_simulation_generation_context

class GetSimulationGenerationContextSqlParams(BaseModel):
...
class GetSimulationGenerationContextSqlRow(BaseModel):

    requests_per_day: int | None = None
    runs_today: int | None = None

class GetSimulationGenerationContextApiRequest(BaseModel):

    p_profile_id: UUID

class GetSimulationGenerationContextApiResponse(BaseModel):
...
_registry: dict[str, tuple[str, str, str, str]] = {
    ...
    "app/sql/v4/queries/generate/simulation/get_simulation_generation_context_complete.sql": (
        ...
        "GetSimulationGenerationContextApiRequest",
        "GetSimulationGenerationContextApiResponse",
    ),
...
if TYPE_CHECKING:
    ...
    @overload
    def load_sql_query(
        file_path: Literal["app/sql/v4/queries/generate/simulation/get_simulation_generation_context_complete.sql"]
    ) -> SqlString: ...
