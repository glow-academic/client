...
class CreateRubricSqlParams(BaseModel):
    ...
    profile_id: UUID
    department_ids: list[UUID] | None = Field(default_factory=list)  # type: ignore[arg-type]
    standard_groups: list[ICreateRubricV3StandardGroup] | None = Field(
...
class UpdateRubricSqlParams(BaseModel):
    ...
    profile_id: UUID
    department_ids: list[UUID] | None = Field(default_factory=list)  # type: ignore[arg-type]
    standard_groups: list[IUpdateRubricV3StandardGroup] | None = Field(
        default_factory=list
    )  # type: ignore[arg-type]
    rubric_agent_id: UUID | None = None
...
class CreateScenarioSqlParams(BaseModel):
    ...
    question_timestamps: list[QCreateScenarioV3QuestionTimestamp] | None = Field(
        default_factory=list
    )  # type: ignore[arg-type]
...
class GetScenarioDetailSqlParams(BaseModel):
    ...
    field_show_selected_by_param: list[QGetScenarioDetailV3FieldParamFilter] | None = (
...
class GetScenarioNewSqlParams(BaseModel):
    ...
    document_show_selected: bool | None = None
    parameter_show_selected: bool | None = None
    field_show_selected_by_param: list[QGetScenarioNewV3FieldParamFilter] | None = (
        Field(default_factory=list)
    )  # type: ignore[arg-type]
...
class UpdateScenarioSqlParams(BaseModel):
    ...
    active_video_id: str | None = None
    question_ids: list[str] | None = None
    question_timestamps: list[QUpdateScenarioV3QuestionTimestamp] | None = Field(
        default_factory=list
    )  # type: ignore[arg-type]
...
class UpdateSettingsSqlParams(BaseModel):
    ...
    profile_id: UUID
    provider_keys: list[IUpdateSettingsV3ProviderKey] | None = Field(
        default_factory=list
    )  # type: ignore[arg-type]
    auth_keys: list[IUpdateSettingsV3AuthKey] | None = Field(default_factory=list)  # type: ignore[arg-type]
    default_admin_profile_id: UUID | None = None
    default_guest_profile_id: UUID | None = None
    provider_enabled: list[IUpdateSettingsV3ProviderEnabled] | None = Field(
        default_factory=list
    )  # type: ignore[arg-type]
    auth_enabled: list[IUpdateSettingsV3AuthEnabled] | None = Field(
        default_factory=list
    )  # type: ignore[arg-type]
