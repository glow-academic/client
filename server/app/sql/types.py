...
# Generated from: get_attempt_overview_view

class GetAttemptOverviewViewSqlParams(BaseModel):
...
class QGetAttemptOverviewViewV4Item(BaseModel):
...
class QGetAttemptOverviewViewV4Standard(BaseModel):
...
class QGetAttemptOverviewViewV4StandardGroup(BaseModel):
...
class GetAttemptOverviewViewSqlRow(BaseModel):

    actor_name: str | None = None
    user_role: str | None = None
    has_data: bool | None = None
    items: list[QGetAttemptOverviewViewV4Item] | None = None
    standard_groups: list[QGetAttemptOverviewViewV4StandardGroup] | None = None
    standards: list[QGetAttemptOverviewViewV4Standard] | None = None

class GetAttemptOverviewViewApiRequest(BaseModel):
...
class GetAttemptOverviewViewApiResponse(BaseModel):
...
_registry: dict[str, tuple[str, str, str, str]] = {
    ...
    "app/sql/v4/queries/views/attempt/overview/get_attempt_overview_view_complete.sql": (
        ...
        "GetAttemptOverviewViewSqlRow",
        "GetAttemptOverviewViewApiRequest",
        "GetAttemptOverviewViewApiResponse",
    ),
...
if TYPE_CHECKING:
    ...
    @overload
    def load_sql_query(
        file_path: Literal["app/sql/v4/queries/views/attempt/overview/get_attempt_overview_view_complete.sql"]
    ) -> SqlString: ...
