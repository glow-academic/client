...
# Generated from: patch_benchmark_bundle_draft
...
class QGetSimulationGradesViewV4Item(BaseModel):
...
class GetSimulationGradesViewSqlRow(BaseModel):
    ...
    items: list[QGetSimulationGradesViewV4Item] | None = None
...
_registry: dict[str, tuple[str, str, str, str]] = {
    ...
    "app/sql/v4/queries/benchmark/patch_benchmark_bundle_draft_complete.sql": (
...
if TYPE_CHECKING:
    ...
    @overload
    def load_sql_query(
        file_path: Literal["app/sql/v4/queries/benchmark/patch_benchmark_bundle_draft_complete.sql"]
    ) -> SqlString: ...
    ...
    @overload
    def load_sql_query(
        file_path: Literal["app/sql/v4/queries/generate/training_bundle/prepare_training_bundle_generation_complete.sql"]
    ) -> SqlString: ...
    ...
    @overload
    def load_sql_query(
        file_path: Literal["app/sql/v4/queries/training/patch_training_bundle_draft_complete.sql"]
    ) -> SqlString: ...
    ...
    @overload
    def load_sql_query(
        file_path: Literal["app/sql/v4/queries/views/benchmark/bundle/get_benchmark_bundle_view_complete.sql"]
    ) -> SqlString: ...
