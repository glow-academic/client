...
SELECT
    ...
    (SELECT n.name FROM persona_names_junction pn JOIN names_resource n ON pn.names_id = n.id WHERE pn.persona_id = api_check_persona_duplicate_access_v4.persona_id LIMIT 1) as original_name;
$$;
