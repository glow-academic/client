...
BEGIN
    ...
    SELECT
        ...
        CASE WHEN resource_type = 'colors' THEN resources_id ELSE NULL::uuid END as color_id,
        CASE WHEN resource_type = 'icons' THEN resources_id ELSE NULL::uuid END as icon_id,
        ...
        CASE WHEN resource_type = 'examples' THEN ARRAY[resources_id] ELSE ARRAY[]::uuid[] END as example_ids;
END;
$$;
