...
BEGIN
    ...
    IF (
        ...
        IF v_name_id IS NOT NULL AND (names).create_tool_id IS NOT NULL THEN
            ...
            VALUES (v_call_id, 'profile_draft_create_names_' || v_call_id::text, v_run_id, NOW());
        ...
        IF v_name_id IS NOT NULL AND (names).link_tool_id IS NOT NULL THEN
            v_call_id := uuidv7();
            INSERT INTO calls_entry (id, external_call_id, run_id, created_at)
            VALUES (v_call_id, 'profile_draft_link_names_' || v_call_id::text, v_run_id, NOW());
        ...
        IF v_active_flag_id IS NOT NULL AND (flags).create_tool_id IS NOT NULL THEN
            v_call_id := uuidv7();
            INSERT INTO calls_entry (id, external_call_id, run_id, created_at)
            VALUES (v_call_id, 'profile_draft_create_flags_' || v_call_id::text, v_run_id, NOW());
        ...
        IF v_active_flag_id IS NOT NULL AND (flags).link_tool_id IS NOT NULL THEN
            v_call_id := uuidv7();
            INSERT INTO calls_entry (id, external_call_id, run_id, created_at)
            VALUES (v_call_id, 'profile_draft_link_flags_' || v_call_id::text, v_run_id, NOW());
        ...
        IF v_request_limit_id IS NOT NULL AND (request_limits).create_tool_id IS NOT NULL THEN
            v_call_id := uuidv7();
            INSERT INTO calls_entry (id, external_call_id, run_id, created_at)
            VALUES (v_call_id, 'profile_draft_create_request_limits_' || v_call_id::text, v_run_id, NOW());
        ...
        IF v_request_limit_id IS NOT NULL AND (request_limits).link_tool_id IS NOT NULL THEN
            v_call_id := uuidv7();
            INSERT INTO calls_entry (id, external_call_id, run_id, created_at)
            VALUES (v_call_id, 'profile_draft_link_request_limits_' || v_call_id::text, v_run_id, NOW());
        ...
        IF COALESCE(array_length(v_department_ids, 1), 0) > 0 AND (departments).create_tool_id IS NOT NULL THEN
            v_call_id := uuidv7();
            INSERT INTO calls_entry (id, external_call_id, run_id, created_at)
            VALUES (v_call_id, 'profile_draft_create_departments_' || v_call_id::text, v_run_id, NOW());
        ...
        IF COALESCE(array_length(v_department_ids, 1), 0) > 0 AND (departments).link_tool_id IS NOT NULL THEN
            v_call_id := uuidv7();
            INSERT INTO calls_entry (id, external_call_id, run_id, created_at)
            VALUES (v_call_id, 'profile_draft_link_departments_' || v_call_id::text, v_run_id, NOW());
        ...
        IF COALESCE(array_length(v_email_ids, 1), 0) > 0 AND (emails).create_tool_id IS NOT NULL THEN
            v_call_id := uuidv7();
            INSERT INTO calls_entry (id, external_call_id, run_id, created_at)
            VALUES (v_call_id, 'profile_draft_create_emails_' || v_call_id::text, v_run_id, NOW());
        ...
        IF COALESCE(array_length(v_email_ids, 1), 0) > 0 AND (emails).link_tool_id IS NOT NULL THEN
            v_call_id := uuidv7();
            INSERT INTO calls_entry (id, external_call_id, run_id, created_at)
            VALUES (v_call_id, 'profile_draft_link_emails_' || v_call_id::text, v_run_id, NOW());
