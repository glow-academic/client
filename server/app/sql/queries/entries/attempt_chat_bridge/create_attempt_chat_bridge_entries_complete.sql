...
BEGIN
    ...
    VALUES (api_create_attempt_chat_bridge_entry_v4.session_id, true, api_create_attempt_chat_bridge_entry_v4.mcp)
    ...
    IF api_create_attempt_chat_bridge_entry_v4.upload_id IS NOT NULL THEN
        ...
        VALUES (v_text_id, api_create_attempt_chat_bridge_entry_v4.upload_id);
    END IF;
