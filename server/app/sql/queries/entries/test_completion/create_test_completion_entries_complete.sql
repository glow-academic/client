...
BEGIN
    ...
    VALUES (api_create_test_completion_entry_v4.session_id, true, api_create_test_completion_entry_v4.mcp)
    ...
    VALUES (api_create_test_completion_entry_v4.run_id, 'assistant', true, api_create_test_completion_entry_v4.mcp)
    ...
    IF api_create_test_completion_entry_v4.upload_id IS NOT NULL THEN
        ...
        VALUES (v_message_id, api_create_test_completion_entry_v4.upload_id);
    END IF;
