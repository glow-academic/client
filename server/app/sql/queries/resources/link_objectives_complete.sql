...
BEGIN
    ...
    IF tool_id IS NOT NULL AND group_id IS NOT NULL THEN
        ...
        VALUES (v_call_id, 'objectives_' || v_call_id::text, v_run_id, NOW());
        ...
        VALUES (api_link_objectives_v4.resources_id, v_call_id);
    END IF;

    RETURN QUERY SELECT api_link_objectives_v4.resources_id;
END;
$$;
