...
-- Simple data fetching from texts_resource + texts_texts_connection
...
-- Create composite type for text item (text_id from connection table)
...
-- Create function — reads from texts_resource + texts_texts_connection
