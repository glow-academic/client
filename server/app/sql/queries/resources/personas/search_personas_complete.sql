...
SELECT COALESCE(
    ARRAY_AGG(
        (q.persona_id, q.name, q.description, q.color, q.icon, q.image_model, q.instructions, q.examples, q.generated, q.parameter_field_ids)::types.q_get_personas_v4_item
        ORDER BY q.name
    ),
