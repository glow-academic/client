...
DO $$ 
BEGIN
    DROP FUNCTION IF EXISTS infra_snapshot_metrics_v3(timestamptz, integer, integer, double precision, double precision, bigint);
EXCEPTION WHEN OTHERS THEN NULL;
END $$;

-- Create function
CREATE OR REPLACE FUNCTION infra_snapshot_metrics_v3(
    ts timestamptz,
...
AS $$
    ...
    VALUES (ts, requests_total, errors_total, avg_latency_ms, cpu_percent, memory_bytes)
