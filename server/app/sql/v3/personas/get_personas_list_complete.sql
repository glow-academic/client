...
DROP FUNCTION IF EXISTS api_list_personas_v3(uuid);

-- 2) Drop types WITHOUT CASCADE
DROP TYPE IF EXISTS types.q_list_personas_v3_persona;
DROP TYPE IF EXISTS types.q_list_personas_v3_scenario;
DROP TYPE IF EXISTS types.q_list_personas_v3_agent;
DROP TYPE IF EXISTS types.q_list_personas_v3_department;
