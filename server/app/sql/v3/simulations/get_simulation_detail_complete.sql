...
DROP FUNCTION IF EXISTS api_get_simulation_detail_v3(uuid, uuid);

-- 2) Drop types WITHOUT CASCADE (drop both old and new names for migration)
DROP TYPE IF EXISTS types.q_get_simulation_detail_v3_scenario CASCADE;
DROP TYPE IF EXISTS types.q_get_simulation_detail_v3_parameter_item CASCADE;
DROP TYPE IF EXISTS types.q_get_simulation_detail_v3_parameter_item_detail CASCADE;
DROP TYPE IF EXISTS types.q_get_simulation_detail_v3_scenario_mapping CASCADE;
DROP TYPE IF EXISTS types.q_get_simulation_detail_v3_scenario_full CASCADE;
