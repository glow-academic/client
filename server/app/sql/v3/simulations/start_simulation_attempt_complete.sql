...
-- Returns: attempt_id, chat_id, chat_title, scenario_id, scenario_name, problem_statement, needs_generation, simulation_data (jsonb), scenario_metadata (jsonb), trace_id (text)
