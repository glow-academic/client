...
DROP FUNCTION IF EXISTS socket_link_system_developer_messages_to_run_v3(uuid, uuid, uuid);

-- 2) Recreate function
CREATE OR REPLACE FUNCTION socket_link_system_developer_messages_to_run_v3(
    run_id uuid,
