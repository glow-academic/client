...
-- Parameters: $1=department_id (uuid), $2=profile_id (uuid, required), $3=rubric_agent_id (uuid, required)
...
WITH params AS (
    ...
    SELECT $1::uuid as department_id, $2::uuid as profile_id, $3::uuid as rubric_agent_id
),
best_agent AS (
