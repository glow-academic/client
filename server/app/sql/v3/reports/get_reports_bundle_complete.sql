...
BEGIN
    FOR r IN 
        ...
        FROM pg_proc 
        WHERE proname = 'api_get_reports_bundle_v3'
          AND pronamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'public')
    LOOP
        EXECUTE format('DROP FUNCTION IF EXISTS api_get_reports_bundle_v3(%s)', r.sig);
    END LOOP;
END $$;
...
DECLARE
    ...
    type_names text[] := ARRAY[
        'q_reports_bundle_v3_profile',  -- Depends on profile_metrics
        'q_reports_bundle_v3_profile_metrics',  -- Depends on metric
        'q_reports_bundle_v3_metric',  -- Depends on data_point and hover
        'q_reports_bundle_v3_data_point',  -- No dependencies
        'q_reports_bundle_v3_hover',  -- No dependencies
        'q_reports_bundle_v3_filter_option',  -- No dependencies
        'q_reports_bundle_v3_scenario',  -- No dependencies
        'q_reports_bundle_v3_simulation'  -- No dependencies
    ];
    type_name text;
BEGIN
    ...
    FOR r IN 
        SELECT typname 
        FROM pg_type 
        WHERE typname LIKE 'q_reports_bundle_v3_%'
...
CREATE TYPE types.q_reports_bundle_v3_data_point AS (
    profile_id text,
    date text,
    value numeric,
    simulation_id text,
...
CREATE TYPE types.q_reports_bundle_v3_hover AS (
    mean int,
    median int,
    mode int,
    count int,
...
-- Metric response
CREATE TYPE types.q_reports_bundle_v3_metric AS (
    has_data boolean,
    method text,
    current_value int,
    data_points types.q_reports_bundle_v3_data_point[],
    hover types.q_reports_bundle_v3_hover,
    status text
);

-- Profile metrics (all 10 metrics)
CREATE TYPE types.q_reports_bundle_v3_profile_metrics AS (
    average_score types.q_reports_bundle_v3_metric,
    completion_percentage types.q_reports_bundle_v3_metric,
    first_attempt_pass_rate types.q_reports_bundle_v3_metric,
    highest_score types.q_reports_bundle_v3_metric,
    messages_per_session types.q_reports_bundle_v3_metric,
    persona_response_times types.q_reports_bundle_v3_metric,
    session_efficiency types.q_reports_bundle_v3_metric,
    stagnation_rate types.q_reports_bundle_v3_metric,
    time_spent types.q_reports_bundle_v3_metric,
    total_attempts types.q_reports_bundle_v3_metric
);

-- Profile data
CREATE TYPE types.q_reports_bundle_v3_profile AS (
    profile_id uuid,
    first_name text,
    last_name text,
    emails text[],
    ...
    simulation_ids text[],
    scenario_ids text[],
    metrics types.q_reports_bundle_v3_profile_metrics
);

-- Filter option
CREATE TYPE types.q_reports_bundle_v3_filter_option AS (
    value text,
    label text,
    count int
);
...
CREATE TYPE types.q_reports_bundle_v3_scenario AS (
    scenario_id uuid,
    name text,
    description text
);
...
CREATE TYPE types.q_reports_bundle_v3_simulation AS (
    simulation_id uuid,
    name text,
    description text,
    rubric_id uuid,
...
-- 4) Recreate function
CREATE OR REPLACE FUNCTION api_get_reports_bundle_v3(
    start_date text,
    end_date text,
    profile_id uuid,
...
RETURNS TABLE (
    actor_name text,
    data types.q_reports_bundle_v3_profile[],
    total_count bigint,
    page int,
    page_size int,
    total_pages bigint,
    profile_options types.q_reports_bundle_v3_filter_option[],
    simulation_options types.q_reports_bundle_v3_filter_option[],
    scenario_options types.q_reports_bundle_v3_filter_option[],
    scenarios types.q_reports_bundle_v3_scenario[],
    simulations types.q_reports_bundle_v3_simulation[]
)
LANGUAGE sql
STABLE
AS $$
        ...
        COALESCE(
            ARRAY_AGG(
                (f.profile_id::text, 
                 ...
                 f.scenario_id::text,
                 NULL::text
                )::types.q_reports_bundle_v3_data_point
                ORDER BY f.attempt_created_at
            ),
            ARRAY[]::types.q_reports_bundle_v3_data_point[]
        ) AS data_points
    FROM filt f
...
all_metrics AS (
    SELECT
        ...
        COALESCE(asdp.data_points, ARRAY[]::types.q_reports_bundle_v3_data_point[]) AS avg_score_points,
        COALESCE(cdp.data_points, ARRAY[]::types.q_reports_bundle_v3_data_point[]) AS completion_points,
        COALESCE(fadp.data_points, ARRAY[]::types.q_reports_bundle_v3_data_point[]) AS first_attempt_points,
        COALESCE(hsdp.data_points, ARRAY[]::types.q_reports_bundle_v3_data_point[]) AS highest_score_points,
        COALESCE(mdp.data_points, ARRAY[]::types.q_reports_bundle_v3_data_point[]) AS messages_points,
        COALESCE(ptdp.data_points, ARRAY[]::types.q_reports_bundle_v3_data_point[]) AS persona_time_points,
        COALESCE(tsdp.data_points, ARRAY[]::types.q_reports_bundle_v3_data_point[]) AS time_spent_points,
        COALESCE(tadp.data_points, ARRAY[]::types.q_reports_bundle_v3_data_point[]) AS total_attempts_points,
        COALESCE(edp.data_points, ARRAY[]::types.q_reports_bundle_v3_data_point[]) AS efficiency_points,
        COALESCE(sdp.data_points, ARRAY[]::types.q_reports_bundle_v3_data_point[]) AS stagnation_points,
...
profiles_with_metrics AS (
    SELECT
        ...
        (
            ...
            )::types.q_reports_bundle_v3_hover,
            CASE
                ...
                ELSE 'danger'
            END
        )::types.q_reports_bundle_v3_metric AS average_score,
        ...
        (
            ...
            CASE
                ...
                ELSE 'danger'
            END
        )::types.q_reports_bundle_v3_metric AS completion_percentage,
        ...
        (
            ...
            CASE
                ...
                ELSE 'danger'
            END
        )::types.q_reports_bundle_v3_metric AS first_attempt_pass_rate,
        ...
        (
            ...
            CASE
                ...
                ELSE 'danger'
            END
        )::types.q_reports_bundle_v3_metric AS highest_score,
        ...
        (
            ...
            CASE
                ...
                ELSE 'danger'
            END
        )::types.q_reports_bundle_v3_metric AS messages_per_session,
        ...
        (
            ...
            CASE
                ...
                ELSE 'success'
            END
        )::types.q_reports_bundle_v3_metric AS persona_response_times,
        ...
        (
            ...
            CASE
                ...
                ELSE 'danger'
            END
        )::types.q_reports_bundle_v3_metric AS session_efficiency,
        ...
        (
            ...
            CASE
                ...
                ELSE 'success'
            END
        )::types.q_reports_bundle_v3_metric AS stagnation_rate,
        ...
        (
            ...
            CASE
                ...
                ELSE 'danger'
            END
        )::types.q_reports_bundle_v3_metric AS time_spent,
        ...
        (
            ...
            CASE
                ...
                ELSE 'danger'
            END
        )::types.q_reports_bundle_v3_metric AS total_attempts
...
profiles_with_profile_metrics AS (
    SELECT
        ...
        (
            ...
            pwm.time_spent,
            pwm.total_attempts
        )::types.q_reports_bundle_v3_profile_metrics AS metrics
    ...
    SELECT
        ARRAY_AGG(
            (pwm.profile_id,
             ...
             pwm.scenario_ids,
             pwm.metrics
            )::types.q_reports_bundle_v3_profile
        ...
        COALESCE(
            ARRAY_AGG(
                (poc.profile_id::text,
                 poc.profile_name,
                 poc.count
                )::types.q_reports_bundle_v3_filter_option
                ORDER BY poc.profile_name
            ),
            ARRAY[]::types.q_reports_bundle_v3_filter_option[]
    ...
    SELECT
        COALESCE(
            ARRAY_AGG(
                ...
                )::types.q_reports_bundle_v3_scenario
                ORDER BY s.name
            ),
            ARRAY[]::types.q_reports_bundle_v3_scenario[]
        ) AS scenarios_array
    FROM scenarios s
...
simulations_final AS (
    SELECT
        COALESCE(
            ...
            ARRAY[]::types.q_reports_bundle_v3_simulation[]
...
SELECT
    ...
    COALESCE((SELECT profiles_array FROM profiles_final), ARRAY[]::types.q_reports_bundle_v3_profile[]) as data,
    ...
    CASE 
        ...
        ELSE 0::bigint
    END as total_pages,
    COALESCE((SELECT profile_options_array FROM profile_options_final), ARRAY[]::types.q_reports_bundle_v3_filter_option[]) as profile_options,
    COALESCE((SELECT simulation_options_array FROM simulation_options_final), ARRAY[]::types.q_reports_bundle_v3_filter_option[]) as simulation_options,
    COALESCE((SELECT scenario_options_array FROM scenario_options_final), ARRAY[]::types.q_reports_bundle_v3_filter_option[]) as scenario_options,
    COALESCE((SELECT scenarios_array FROM scenarios_final), ARRAY[]::types.q_reports_bundle_v3_scenario[]) as scenarios,
    COALESCE((SELECT simulations_array FROM simulations_final), ARRAY[]::types.q_reports_bundle_v3_simulation[]) as simulations
$$;
