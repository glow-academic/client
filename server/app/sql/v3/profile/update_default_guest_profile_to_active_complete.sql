-- Update default guest profile to active and insert activity in a single transaction
-- Parameters: $1=last_active (timestamp with time zone)
...
update_profile AS (
    -- Update default guest profile to active
    UPDATE profiles 
    SET active = true
