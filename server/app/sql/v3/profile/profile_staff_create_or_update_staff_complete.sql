...
DROP FUNCTION IF EXISTS api_upsert_staff_v3(uuid, text, text, text, text, boolean, uuid[], uuid[], uuid, text[], integer);

-- 2) Drop types WITHOUT CASCADE
-- No composite types needed for this function (returns simple types)

-- 3) Recreate function
CREATE OR REPLACE FUNCTION api_upsert_staff_v3(
