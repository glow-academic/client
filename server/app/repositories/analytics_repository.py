...
class AnalyticsRepository:
    ...
    async def get_average_score(self, filters: AnalyticsFilters) -> MetricResponse:
        ...
        return await self.service.get_average_score(filters)

    async def get_completion_percentage(self, filters: AnalyticsFilters) -> MetricResponse:
        """Get completion percentage metric."""
        return await self.service.get_completion_percentage(filters)

    async def get_first_attempt_pass_rate(self, filters: AnalyticsFilters) -> MetricResponse:
        """Get first attempt pass rate metric."""
        return await self.service.get_first_attempt_pass_rate(filters)

    async def get_highest_score(self, filters: AnalyticsFilters) -> MetricResponse:
        """Get highest score metric."""
        return await self.service.get_highest_score(filters)

    async def get_messages_per_session(self, filters: AnalyticsFilters) -> MetricResponse:
        """Get messages per session metric."""
        return await self.service.get_messages_per_session(filters)

    async def get_persona_response_times(self, filters: AnalyticsFilters) -> MetricResponse:
        """Get persona response times metric."""
        return await self.service.get_persona_response_times(filters)

    async def get_session_efficiency(self, filters: AnalyticsFilters) -> MetricResponse:
        """Get session efficiency metric."""
        return await self.service.get_session_efficiency(filters)

    async def get_stagnation_rate(self, filters: AnalyticsFilters) -> MetricResponse:
        """Get stagnation rate metric."""
        return await self.service.get_stagnation_rate(filters)

    async def get_time_spent(self, filters: AnalyticsFilters) -> MetricResponse:
        """Get time spent metric."""
        return await self.service.get_time_spent(filters)

    async def get_total_attempts(self, filters: AnalyticsFilters) -> MetricResponse:
        """Get total attempts metric."""
        return await self.service.get_total_attempts(filters)
    ...
    async def get_rubric_heatmap(
        ...
        return await self.service.get_rubric_heatmap(filters)

    async def get_growth_data(self, filters: AnalyticsFilters) -> GrowthDataResponse:
        """Get growth data."""
        return await self.service.get_growth_data(filters)

    async def get_persona_performance(
        self, filters: AnalyticsFilters
    ) -> PersonaPerformanceResponse:
        """Get persona performance data."""
        return await self.service.get_persona_performance(filters)
    ...
    async def get_attempt_improvement(
        ...
        return await self.service.get_attempt_improvement(filters)

    async def get_cohort_performance(
        self, filters: AnalyticsFilters
    ) -> CohortPerformanceResponse:
        """Get cohort performance data."""
        return await self.service.get_cohort_performance(filters)

    async def get_skill_performance(
        self, filters: AnalyticsFilters
    ) -> SkillPerformanceResponse:
        """Get skill performance data."""
        return await self.service.get_skill_performance(filters)
    ...
    async def get_scenario_performance(
        ...
        return await self.service.get_scenario_performance(filters)

    async def get_scenario_stats(
        self, filters: AnalyticsFilters
    ) -> ScenarioStatsResponse:
        """Get scenario stats data."""
        return await self.service.get_scenario_stats(filters)

    async def get_simulation_composition(
        self, filters: AnalyticsFilters
    ) -> SimulationCompositionResponse:
        """Get simulation composition data."""
        return await self.service.get_simulation_composition(filters)

    async def get_simulation_performance(
        self, filters: AnalyticsFilters
    ) -> SimulationPerformanceResponse:
        """Get simulation performance data."""
        return await self.service.get_simulation_performance(filters)
    ...
    async def get_home_overview(self, filters: AnalyticsFilters) -> HomeOverviewResponse:
        ...
        return await self.service.get_home_overview(filters)

    async def get_attempt_history(
        self, filters: AnalyticsFilters
    ) -> AttemptHistoryResponse:
        """Get attempt history data."""
        return await self.service.get_attempt_history(filters)

    async def get_practice_overview(
        self, filters: AnalyticsFilters
    ) -> PracticeOverviewResponse:
        """Get practice overview data."""
        return await self.service.get_practice_overview(filters)
    ...
    async def get_reports_bundle(
        ...
        return await self.service.get_reports_bundle(filters)

    async def get_leaderboard_bundle(
        self, filters: AnalyticsFilters
    ) -> LeaderboardBundleResponse:
        """Get leaderboard bundle data."""
        return await self.service.get_leaderboard_bundle(filters)
    ...
    async def get_pricing_analytics(
        ...
        return await self.service.get_pricing_analytics(filters)
    ...
    async def get_dashboard_bundle(
        ...
        return await self.service.get_dashboard_bundle(filters)
