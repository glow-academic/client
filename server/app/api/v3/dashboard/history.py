...
SQL_PATH = "app/sql/v3/dashboard/get_dashboard_history_complete.sql"
...
async def get_dashboard_history(
    ...
    try:
        ...
        params = GetDashboardHistorySqlParams(**request.model_dump(), profile_id=profile_id)
        ...
        api_response = GetDashboardHistoryApiResponse.model_validate(result.model_dump())
