...
from app.sql.types import (GetCohortSearchApiRequest,
                           GetCohortSearchApiResponse,
                           GetCohortSearchSqlParams, GetCohortSearchSqlRow,
                           load_sql_query)
...
SQL_PATH = "app/sql/v3/cohorts/get_cohort_search_complete.sql"
