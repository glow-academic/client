...
from app.sql.types import (GetCohortNewApiRequest, GetCohortNewApiResponse,
                           GetCohortNewSqlParams, GetCohortNewSqlRow,
                           load_sql_query)
...
SQL_PATH = "app/sql/v3/cohorts/get_cohort_new_complete.sql"
