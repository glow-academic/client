...
from app.api.v3.cohorts.detail import (CohortDetailResponse, CohortMappingItem,
                                       DepartmentMappingItem,
                                       ProfileMappingItem, SimulationInCohort,
                                       SimulationMappingItem, StaffItem)
...
async def get_cohort_new(
    ...
    try:
        ...
        sql_query = load_sql("app/sql/v3/cohorts/get_cohort_new_complete.sql")
