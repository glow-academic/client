"""Cohort detail default endpoint - v3 API."""
...
async def get_cohort_detail_default(
    request_body: CohortDetailDefaultRequest,
    request: Request,
    response: Response,
    ...
    try:
        ...
        sql = load_sql("sql/v3/cohorts/get_cohort_detail_default_complete.sql")
        row = await conn.fetchrow(sql, request_body.profileId, campus_domain)
