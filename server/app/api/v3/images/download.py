"""Image download endpoint - v3 API following DHH principles."""
...
async def download_image(
    ...
    try:
        sql_query = load_sql("sql/v3/images/get_image_file_info.sql")
        sql_params = (image_id,)
        result = await conn.fetchrow(sql_query, image_id)
