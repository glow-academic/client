...
from app.sql.types import (GetRubricsListApiRequest, GetRubricsListApiResponse,
                           GetRubricsListSqlParams, GetRubricsListSqlRow,
                           load_sql_query)
...
SQL_PATH = "app/sql/v3/rubrics/get_rubrics_list_complete.sql"
