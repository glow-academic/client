...
from app.api.v3.parameters.detail import (FieldConnection,  # noqa: E402
...
async def get_parameter_new(
    ...
    try:
        ...
        sql_query = load_sql("app/sql/v3/parameters/get_parameter_new_complete.sql")
        ...
        # Parse field_connections from JSONB (empty for new)
        ...
        # Parse document_ids from array (empty for new)
