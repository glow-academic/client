...
from app.sql.types import (GetPricingGroupDetailApiRequest,
                           GetPricingGroupDetailApiResponse,
                           GetPricingGroupDetailSqlParams,
                           GetPricingGroupDetailSqlRow, load_sql_query)
...
SQL_PATH = "app/sql/v3/pricing/get_pricing_group_detail_complete.sql"
...
async def get_pricing_run_detail(
    ...
    try:
        ...
        params = GetPricingGroupDetailSqlParams(**request.model_dump(), profile_id=profile_id)
        ...
        api_response = GetPricingGroupDetailApiResponse.model_validate(result.model_dump())
