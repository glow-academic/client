"""Key detail default endpoint - v3 API following DHH principles."""
...
from app.api.v3.keys.detail import KeyDetailResponse
...
class KeyDetailDefaultRequest(BaseModel):
...
@router.post("/detail-default", response_model=KeyDetailResponse)
async def get_key_detail_default(
    request_body: KeyDetailDefaultRequest,
    request: Request,
    response: Response,
    ...
    try:
        sql_query = load_sql("sql/v3/keys/get_key_detail_default_complete.sql")
        ...
        handle_route_error(
            ...
            operation="get_key_detail_default",
            sql_query=sql_query,
