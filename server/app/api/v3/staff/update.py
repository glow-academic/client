...
from app.sql.types import (BulkUpdateStaffApiRequest, BulkUpdateStaffApiResponse,
                           BulkUpdateStaffSqlParams, BulkUpdateStaffSqlRow,
                           load_sql_query)
...
SQL_PATH = "app/sql/v3/staff/bulk_update_staff_complete.sql"
...
async def bulk_update_staff(
    ...
    try:
        ...
        params = BulkUpdateStaffSqlParams(**request.model_dump(), profile_id=uuid.UUID(profile_id))
