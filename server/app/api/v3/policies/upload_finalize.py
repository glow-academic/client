"""Policy upload finalize endpoint - v3 API following DHH principles."""
...
class UploadFinalizeRequest(BaseModel):
    """Request to finalize policy upload."""
...
async def upload_finalize(
    ...
    """Finalize a policy upload and create the policy."""
    ...
    try:
        ...
        final_file_path = f"{policy_id}{ext}"
        ...
        # Insert policy with department links (single query)
        dept_uuids = (
        ...
        sql = load_sql("sql/v3/policies/insert_policy_complete.sql")
        await conn.execute(
            sql,
            policy_id,
            request.name,
