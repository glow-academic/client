"""Video download endpoint - v3 API following DHH principles."""
...
async def download_video(
    ...
    try:
        sql_query = load_sql("sql/v3/videos/get_video_file_info.sql")
        sql_params = (video_id,)
        result = await conn.fetchrow(sql_query, video_id)
