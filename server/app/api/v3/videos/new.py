...
async def get_video_new(
    ...
    try:
        ...
        final_parameter_ids = (
            ...
            else (selected_parameter_ids if selected_parameter_ids else video_parameter_ids)
        )
        final_field_ids = (
        ...
        response_data = VideoDetailResponse(
            ...
            # Personas (empty for new video - will be set below with final values)
            persona_mapping=persona_mapping,
            ...
            video_parameter_ids=final_parameter_ids,
            ...
            selected_field_ids=final_field_ids,  # Apply randomized values
