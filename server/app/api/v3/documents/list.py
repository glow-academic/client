...
from app.sql.types import (GetDocumentsListApiRequest, GetDocumentsListApiResponse,
                           GetDocumentsListSqlParams, GetDocumentsListSqlRow,
                           load_sql_query)
...
SQL_PATH = "app/sql/v3/documents/get_documents_list_complete.sql"
...
async def get_documents_list(
    ...
    try:
        ...
        params = GetDocumentsListSqlParams(**request.model_dump(), profile_id=profile_id)
