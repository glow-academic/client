...
@router.post(
    "/detail",
    response_model=ProfileDetailResponseFull,
    dependencies=[
        audit_activity(
...
async def get_profile_detail(
    ...
    try:
        ...
        # Load SQL query
        sql_query = load_sql("app/sql/v3/profile/staff/get_staff_detail.sql")
        sql_params = (
        ...
        if actor_name:
            audit_set(
                ...
                profile={"name": profile_name, "id": request_body.profileId},
            )
