"""Prompt new endpoint - v3 API following DHH principles."""
...
from app.api.v3.prompts.detail import DepartmentMappingItem, PromptDetailResponse
...
class PromptNewRequest(BaseModel):
...
@router.post("/new", response_model=PromptDetailResponse)
async def get_prompt_new(
    request_body: PromptNewRequest,
    request: Request,
    response: Response,
    ...
    try:
        sql_query = load_sql("sql/v3/prompts/get_prompt_new_complete.sql")
