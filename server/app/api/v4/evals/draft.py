"""Eval draft endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/sql/v4/benchmark/patch_eval_draft_complete.sql"
...
async def patch_eval_draft(
    ...
    """Patch eval draft (creates if not exists)."""
    tags = ["evals", "drafts"]  # From router tags
