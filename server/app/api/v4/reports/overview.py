"""Reports overview v4 API endpoint - requires profileId for individual reports."""
...
SQL_PATH = "app/sql/v4/reports/get_reports_overview_complete.sql"
...
async def get_reports_overview(
    ...
    try:
        ...
        params = GetReportsOverviewSqlParams(
        ...
        api_response = GetReportsOverviewApiResponse.model_validate(result.model_dump())
