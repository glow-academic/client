"""Simulation new endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/sql/v4/simulations/get_simulation_new_complete.sql"
...
async def get_simulation_new(
    ...
    if cached:
        ...
        return GetSimulationNewApiResponse.model_validate(cached["data"])
    ...
    try:
        ...
        params = GetSimulationNewSqlParams(
