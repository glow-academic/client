"""Document draft endpoint - v4 API following DHH principles."""
...
@router.patch(
    ...
    dependencies=[
        audit_activity(
            ...
            "{{ actor.name }} saved document draft",
        )
    ],
)
async def patch_document_draft(
    ...
    """Patch document draft (creates if not exists)."""
    tags = ["documents", "drafts"]  # From router tags
