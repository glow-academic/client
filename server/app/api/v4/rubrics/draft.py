"""Rubric draft endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/sql/v4/rubric/patch_rubric_draft_complete.sql"
...
async def patch_rubric_draft(
    ...
    """Patch rubric draft (creates if not exists)."""
    tags = ["rubrics", "drafts"]  # From router tags
