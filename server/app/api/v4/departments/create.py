"""Department create endpoint - v4 API."""
...
SQL_PATH = "app/sql/v4/departments/create_department_complete.sql"
...
async def create_department(
    ...
    try:
        ...
        async with transaction(conn):
            ...
            params = CreateDepartmentSqlParams(
        ...
        result_response = CreateDepartmentApiResponse.model_validate(
            result.model_dump()
        )
