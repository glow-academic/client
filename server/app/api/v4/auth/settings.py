...
from app.api.v4.auth.types import GetAuthSettingsApiResponse
...
async def get_auth_settings(
    ...
    try:
        ...
        settings_theme: GetSettingsThemeSqlRow | None = None
        if settings_id:
        ...
        return GetAuthSettingsApiResponse(
            ...
            success_threshold=settings_theme.success_threshold,
            warning_threshold=settings_theme.warning_threshold,
            danger_threshold=settings_theme.danger_threshold,
            tokens=derive_theme_tokens(theme_primitives),
