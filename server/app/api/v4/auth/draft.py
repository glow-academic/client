"""Auth draft endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/sql/v4/auth/patch_auth_draft_complete.sql"
...
async def patch_auth_draft(
    ...
    """Patch auth draft (creates if not exists)."""
    tags = ["auth", "drafts"]  # From router tags
    ...
    try:
        ...
        api_response = PatchAuthDraftApiResponse.model_validate(result.model_dump())
