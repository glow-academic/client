"""Benchmark history endpoint - POST /benchmark/history"""
...
SQL_PATH = "app/sql/v4/benchmark/get_benchmark_history_complete.sql"
...
async def get_benchmark_history(
    request: GetBenchmarkHistoryApiRequest,
    http_request: Request,
    response: Response,
    conn: Annotated[asyncpg.Connection, Depends(get_db)],
) -> GetBenchmarkHistoryApiResponse:
    """Get paginated benchmark history with search, filters, sorting, and pagination."""
    tags = ["benchmark", "history"]
    ...
    if not bypass_cache:
        ...
        if cached:
            ...
            return GetBenchmarkHistoryApiResponse.model_validate(cached["data"])
    ...
    try:
        ...
        params = GetBenchmarkHistorySqlParams(
        ...
        profile_specific_tags = tags + [
            f"benchmark:profile:{profile_id}",
