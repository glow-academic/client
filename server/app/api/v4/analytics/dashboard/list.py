...
SQL_PATH = "app/sql/v4/queries/dashboard/get_dashboard_history_complete.sql"
...
async def get_dashboard_history(
    request: GetDashboardHistoryApiRequest,
    ...
    if not bypass_cache:
        ...
        if cached:
            ...
            return GetDashboardHistoryApiResponse.model_validate(cached["data"])
    ...
    try:
        ...
        params = GetDashboardHistorySqlParams(
