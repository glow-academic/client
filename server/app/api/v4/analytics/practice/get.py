...
from app.sql.types import (GetPracticeOverviewApiRequest,
...
SQL_PATH = "app/sql/v4/queries/practice/get_practice_overview_complete.sql"
...
@router.post(
    ...
    dependencies=[
        audit_activity("practice.get", "{{ actor.name }} viewed practice overview")
    ],
)
