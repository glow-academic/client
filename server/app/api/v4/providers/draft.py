"""Provider draft endpoint - v4 API following DHH principles."""
...
@router.patch(
    ...
    dependencies=[
        audit_activity(
            ...
            "{{ actor.name }} saved provider draft",
        )
    ],
)
async def patch_provider_draft(
    ...
    """Patch provider draft (creates if not exists)."""
    tags = ["providers", "drafts"]  # From router tags
