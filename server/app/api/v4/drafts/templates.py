...
from app.sql.types import (CreateDraftTemplatesApiRequest,
                           CreateDraftTemplatesApiResponse,
                           CreateDraftTemplatesSqlParams, CreateDraftTemplatesSqlRow,
                           load_sql_query)
...
async def create_draft_templates(
    ...
    try:
        ...
        api_response = CreateDraftTemplatesApiResponse.model_validate(result.model_dump())
