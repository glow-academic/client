...
from app.sql.types import (CreateDraftObjectivesApiRequest,
                           CreateDraftObjectivesApiResponse,
                           CreateDraftObjectivesSqlParams,
                           CreateDraftObjectivesSqlRow, load_sql_query)
...
async def create_draft_objectives(
    ...
    try:
        ...
        api_response = CreateDraftObjectivesApiResponse.model_validate(result.model_dump())
