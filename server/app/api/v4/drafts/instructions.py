...
from app.sql.types import (CreateDraftInstructionsApiRequest,
                           CreateDraftInstructionsApiResponse,
                           CreateDraftInstructionsSqlParams,
                           CreateDraftInstructionsSqlRow, load_sql_query)
...
async def create_draft_instructions(
    ...
    try:
        ...
        api_response = CreateDraftInstructionsApiResponse.model_validate(result.model_dump())
