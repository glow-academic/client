...
from app.sql.types import (SaveRubricApiRequest, SaveRubricApiResponse,
                           SaveRubricSqlParams, SaveRubricSqlRow,
                           load_sql_query)
...
SQL_PATH = "app/sql/v4/rubrics/save_rubric_complete.sql"
