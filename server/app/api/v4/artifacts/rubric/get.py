...
from app.sql.types import (GetRubricApiRequest, GetRubricApiResponse,
                           GetRubricSqlParams, GetRubricSqlRow, load_sql_query)
...
SQL_PATH = "app/sql/v4/rubrics/get_rubric_complete.sql"
