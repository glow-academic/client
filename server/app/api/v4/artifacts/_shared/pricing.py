...
SQL_PATH_PRICING = "app/sql/v4/queries/resources/pricing/get_pricing_batch_complete.sql"
SQL_PATH_UNITS = "app/sql/v4/queries/resources/units/get_units_batch_complete.sql"
