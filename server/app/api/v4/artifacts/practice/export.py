...
from app.api.v4.artifacts.chat.permissions import compute_pass_pct
from app.api.v4.artifacts.practice.get import _compute_history_aggregates
...
@router.post(
    "/export",
    response_model=ExportPracticeApiResponse,
    dependencies=[
        audit_activity(
            "practice.exported",
            "{{ actor.name }} exported practice data",
        )
    ],
)
