...
from app.api.v4.artifacts.training.types import (
    ...
    PatchTrainingDraftSqlParams,
    PatchTrainingDraftSqlRow,
)
...
@router.patch(
    "/draft",
    response_model=PatchTrainingDraftApiResponse,
)
async def patch_training_draft(
    request: PatchTrainingDraftApiRequest,
    ...
    try:
        ...
        async with conn.transaction():
            params = PatchTrainingDraftSqlParams.from_request(
        ...
        handle_route_error(
            ...
            operation="patch_training_draft",
            sql_query=sql_query,
