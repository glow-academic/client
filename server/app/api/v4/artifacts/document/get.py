...
# SQL paths
QUERY1_SQL_PATH = "app/sql/v4/queries/documents/get_document_access_complete.sql"
QUERY2_SQL_PATH = "app/sql/v4/queries/documents/get_document_ids_complete.sql"
...
async def get_document_internal(
    ...
    resources_needed = list(DOCUMENT_RESOURCES)
    agent_ids = select_agents_for_artifact(
        candidates=candidate_agents,
        artifact_resources=DOCUMENT_RESOURCES,
