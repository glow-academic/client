"""Department list endpoint - v4 API."""
...
from app.sql.types import (GetDepartmentsListApiRequest,
                           GetDepartmentsListApiResponse,
                           GetDepartmentsListSqlParams,
                           GetDepartmentsListSqlRow, load_sql_query)
...
SQL_PATH = "app/sql/v4/departments/get_departments_list_complete.sql"
...
async def get_department_list(
    ...
    if cached:
        ...
        return GetDepartmentsListApiResponse.model_validate(cached["data"])
    ...
    try:
        ...
        api_response = GetDepartmentsListApiResponse.model_validate(result.model_dump())
