...
ACCESS_SQL_PATH = "app/sql/v4/queries/simulations/check_simulation_delete_access_complete.sql"
...
async def delete_simulation(
    ...
    try:
        ...
        if access_result:
            ...
            if not compute_can_delete(user_role, simulation_department_ids, cohort_usage_count):
