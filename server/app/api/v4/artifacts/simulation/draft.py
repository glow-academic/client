...
from app.api.v4.resources.scenario_flags.link import link_scenario_flags_internal
from app.api.v4.resources.scenario_positions.link import (
    link_scenario_positions_internal,
)
from app.api.v4.resources.scenario_rubrics.link import link_scenario_rubrics_internal
