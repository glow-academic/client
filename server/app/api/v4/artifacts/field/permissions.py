...
FIELD_DOMAIN_METADATA: dict[str, dict[str, str | bool]] = {
    "names": {
        "name": "Name",
    ...
    "descriptions": {
        "name": "Description",
        "description": "A brief description of this field's purpose",
        "icon": "file-text",
    },
    "flags": {
        "name": "Status",
...
def build_domain_data(
    ...
    Delegates to shared build_domain_data with field-specific metadata.
    """
    from app.api.v4.types import build_domain_data as _build_domain_data

    return _build_domain_data(
        domain_ids, show_flags, required_flags, FIELD_DOMAIN_METADATA
    )
