"""Agent draft endpoint - v4 API following DHH principles."""
...
async def patch_agent_draft(
    ...
    """Patch agent draft (creates if not exists)."""
    tags = ["agents", "drafts"]  # From router tags
