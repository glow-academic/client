...
MV_SQL_PATH = (
    ...
    / "sql/v4/views/simulation/mv_simulation_strengths.sql"
)
...
async def recreate_strengths_view(
    ...
    """Recreate the mv_simulation_strengths materialized view."""
    ...
    try:
        ...
        return RefreshResponse(
            success=True,
            method="recreate",
            message=f"Recreated mv_simulation_strengths in {duration_ms}ms",
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to recreate mv_simulation_strengths: {str(e)}",
        ) from e
