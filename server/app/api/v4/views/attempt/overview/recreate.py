"""Recreate endpoint for attempt overview view."""
...
MV_SQL_PATH = (
    ...
    / "sql/v4/views/simulation/simulation_overview_view.sql"
)
...
@router.post(
    ...
    dependencies=[
        audit_activity(
            "views.attempt.overview.recreate",
            "{{ actor.name }} recreated attempt overview view",
        )
    ],
)
