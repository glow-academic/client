...
MV_SQL_PATH = (
    ...
    / "sql/v4/views/attempt/mv_attempt_chats.sql"
)
...
async def recreate_chats_view(
    ...
    """Recreate the mv_attempt_chats materialized view."""
    ...
    try:
        ...
        return RefreshResponse(
            success=True,
            method="recreate",
            message=f"Recreated mv_attempt_chats in {duration_ms}ms",
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to recreate mv_attempt_chats: {str(e)}",
        ) from e
