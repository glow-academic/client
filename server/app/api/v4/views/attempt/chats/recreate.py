...
MV_SQL_PATH = (
    ...
    / "sql/v4/views/chat/attempt_chat_mv.sql"
)
...
async def recreate_chats_view(
    ...
    """Recreate the attempt_chat_mv materialized view."""
    ...
    try:
        ...
        return RefreshResponse(
            success=True,
            method="recreate",
            message=f"Recreated attempt_chat_mv in {duration_ms}ms",
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to recreate attempt_chat_mv: {str(e)}",
        ) from e
