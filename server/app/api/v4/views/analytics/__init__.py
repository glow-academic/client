...
router.include_router(
    profile_facts_router, prefix="/profile-facts", tags=["profile_facts"]
)
router.include_router(
    rubric_facts_router, prefix="/rubric-facts", tags=["rubric_facts"]
)
router.include_router(
    simulation_facts_router, prefix="/simulation-facts", tags=["simulation_facts"]
)
router.include_router(
    scenario_facts_router, prefix="/scenario-facts", tags=["scenario_facts"]
)
