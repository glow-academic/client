...
SQL_PATH = "app/sql/v4/queries/entries/texts/search_texts_entries_complete.sql"
...
@router.post(
    "/texts/search",
    response_model=SearchTextsEntriesApiResponse,
)
async def search_texts_entries(
    request: SearchTextsEntriesApiRequest,
    ...
    try:
        items = await search_texts_entries_internal(
            conn,
            request.search,
            request.limit_count,
        ...
        return SearchTextsEntriesApiResponse(items=items)
        ...
        handle_route_error(
            ...
            operation="search_texts_entries",
