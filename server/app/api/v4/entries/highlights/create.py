...
from app.sql.types import (
    ...
    CreateHighlightsEntriesSqlParams,
...
SQL_PATH = (
    "app/sql/v4/queries/entries/highlights/create_highlights_entries_complete.sql"
)
...
@router.post(
    ...
    dependencies=[
        audit_activity(
            "highlights.created",
            "{{ actor.name }} created highlights entry",
        )
    ],
)
async def create_highlights_entry(
    request: CreateHighlightsEntriesApiRequest,
