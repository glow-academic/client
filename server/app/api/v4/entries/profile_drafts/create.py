...
async def create_profile_drafts_entry(
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = CreateProfileDraftsEntriesSqlParams(**request_dict)
            ...
            audit_set(
                http_request,
                actor={"id": profile_id},
                profile_drafts={"id": str(result.id)},
            )

        api_response = CreateProfileDraftsEntriesApiResponse.model_validate(
            result.model_dump()
        )
