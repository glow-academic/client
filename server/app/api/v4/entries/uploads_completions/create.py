...
@router.post(
    ...
    dependencies=[
        audit_activity(
            "uploads_completions.created",
            "{{ actor.name }} created uploads_completions entry",
        )
    ],
)
async def create_uploads_completions_entry(
    request: CreateUploadsCompletionsEntriesApiRequest,
