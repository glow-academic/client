...
from app.sql.types import (
    ...
    SearchProviderDraftsEntriesSqlParams,
    SearchProviderDraftsEntriesSqlRow,
    load_sql_query,
)
...
SQL_PATH = "app/sql/v4/queries/entries/provider_drafts/search_provider_drafts_entries_complete.sql"

router = APIRouter()


async def search_provider_drafts_entries_internal(
    ...
    """Internal function to search provider_drafts entries."""
    ...
    params = SearchProviderDraftsEntriesSqlParams(
        search=search,
        limit_count=limit_count,
        offset_count=offset_count,
        group_id=group_id,
...
async def search_provider_drafts_entries(
    ...
    try:
        items = await search_provider_drafts_entries_internal(
            conn,
            request.search,
            request.limit_count,
