"""Provider Drafts entry GET endpoint."""
...
from app.sql.types import (
    ...
    GetProviderDraftsEntriesSqlRow,
    load_sql_query,
)
...
SQL_PATH = "app/sql/v4/queries/entries/provider_drafts/get_provider_drafts_entries_complete.sql"
