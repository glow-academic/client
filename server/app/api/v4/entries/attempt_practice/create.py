...
from app.api.v4.entries.attempt_practice.types import (
...
SQL_PATH = "app/sql/v4/queries/entries/attempt_practice/create_attempt_practice_entries_complete.sql"
