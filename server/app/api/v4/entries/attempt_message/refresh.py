...
async def refresh_attempt_message_internal(
    ...
    await invalidate_tags(["entries", "attempt_message"])
    return {
        "success": True,
...
async def refresh_attempt_message(
    ...
    try:
        result = await refresh_attempt_message_internal(conn)
