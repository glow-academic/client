...
from app.api.v4.entries.attempt_insights import router as attempt_insights_router
...
from app.api.v4.entries.config import router as config_router
...
from app.api.v4.entries.dashboard_insights import router as dashboard_insights_router
...
from app.api.v4.entries.leaderboard_insights import (
    router as leaderboard_insights_router,
)
...
from app.api.v4.entries.practice_insights import router as practice_insights_router
from app.api.v4.entries.practice_training import router as practice_training_router
from app.api.v4.entries.pricing_insights import router as pricing_insights_router
...
router.include_router(attempt_insights_router)
...
router.include_router(dashboard_insights_router)
...
router.include_router(leaderboard_insights_router)
...
router.include_router(practice_insights_router)
router.include_router(practice_training_router)
router.include_router(pricing_insights_router)
