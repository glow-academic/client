...
from app.sql.types import (
    ...
    GetTestCompletionEntriesSqlParams,
    GetTestCompletionEntriesSqlRow,
    load_sql_query,
)
...
SQL_PATH = "app/sql/v4/queries/entries/test_completion/get_test_completion_entries_complete.sql"
...
async def get_test_completion_entries_internal(
    ...
    """Internal function to fetch test_completion entries by IDs."""
    if not ids:
        return []
    ...
    params = GetTestCompletionEntriesSqlParams(ids=ids)
    result = cast(
        GetTestCompletionEntriesSqlRow,
...
async def get_test_completion_entries(
    ...
    try:
        items = await get_test_completion_entries_internal(
