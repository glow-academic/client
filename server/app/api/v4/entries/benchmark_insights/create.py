"""BenchmarkInsights entry CREATE endpoint."""
...
@router.post(
    ...
    dependencies=[
        audit_activity(
            ...
            "{{ actor.name }} created benchmark_insights entry",
        )
    ],
)
async def create_benchmark_insights_entry(
    ...
    try:
        ...
        api_response = await create_benchmark_insights_entry_internal(
        ...
        audit_set(
            http_request,
            actor={"id": profile_id},
            benchmark_insights={"id": str(api_response.id)},
        )
        ...
        handle_route_error(
            ...
            operation="create_benchmark_insights_entry",
            sql_query=sql_query,
            sql_params=None,
