"""Department Drafts entry GET endpoint."""
...
from app.sql.types import (
    ...
    GetDepartmentDraftsEntriesSqlRow,
    load_sql_query,
)
...
SQL_PATH = "app/sql/v4/queries/entries/department_drafts/get_department_drafts_entries_complete.sql"
...
async def get_department_drafts_entries(
    ...
    try:
        items = await get_department_drafts_entries_internal(
