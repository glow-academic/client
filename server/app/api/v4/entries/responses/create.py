...
SQL_PATH = "app/sql/v4/queries/entries/responses/create_responses_entries_complete.sql"
    ...
    try:
        ...
        async with conn.transaction():
            ...
            audit_set(
                http_request,
                actor={"id": profile_id},
                responses={"id": str(result.id)},
            )

        api_response = CreateResponsesEntriesApiResponse.model_validate(
            result.model_dump()
        )
