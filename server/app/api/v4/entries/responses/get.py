...
SQL_PATH = "app/sql/v4/queries/entries/responses/get_responses_entries_complete.sql"
VIEW_SQL_PATH = "app/sql/v4/queries/views/simulation/responses/get_simulation_responses_view_complete.sql"
