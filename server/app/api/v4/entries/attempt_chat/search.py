"""Attempt Chat entry SEARCH endpoint."""
...
@router.post(
    "/attempt_chat/search",
    response_model=SearchAttemptChatEntriesApiResponse,
)
async def search_attempt_chat_entries(
    request: SearchAttemptChatEntriesApiRequest,
    http_request: Request,
    response: Response,
    conn: Annotated[asyncpg.Connection, Depends(get_db)],
) -> SearchAttemptChatEntriesApiResponse:
    """Search attempt_chat entries."""
    tags = ["entries", "attempt_chat"]
    ...
    try:
        ...
        return SearchAttemptChatEntriesApiResponse(items=items)
        ...
        handle_route_error(
            ...
            operation="search_attempt_chat_entries",
