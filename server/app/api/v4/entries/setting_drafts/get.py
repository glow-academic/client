...
SQL_PATH = (
    "app/sql/v4/queries/entries/setting_drafts/get_setting_drafts_entries_complete.sql"
)

router = APIRouter()


async def get_setting_drafts_entries_internal(
...
async def get_setting_drafts_entries(
    ...
    try:
        items = await get_setting_drafts_entries_internal(
