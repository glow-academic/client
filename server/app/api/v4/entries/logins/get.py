...
SQL_PATH = "app/sql/v4/queries/entries/logins/get_logins_entries_complete.sql"
VIEW_SQL_PATH = "app/sql/v4/queries/views/login/list/get_login_list_view_complete.sql"
