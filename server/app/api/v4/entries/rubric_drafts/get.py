"""Rubric Drafts entry GET endpoint."""
...
SQL_PATH = (
    "app/sql/v4/queries/entries/rubric_drafts/get_rubric_drafts_entries_complete.sql"
)
...
async def get_rubric_drafts_entries(
    ...
    try:
        items = await get_rubric_drafts_entries_internal(
