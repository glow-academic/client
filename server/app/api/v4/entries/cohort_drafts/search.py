...
from app.sql.types import (
    ...
    SearchCohortDraftsEntriesSqlParams,
...
SQL_PATH = (
    "app/sql/v4/queries/entries/cohort_drafts/search_cohort_drafts_entries_complete.sql"
)
...
async def search_cohort_drafts_entries_internal(
    ...
    """Internal function to search cohort_drafts entries."""
    ...
    params = SearchCohortDraftsEntriesSqlParams(
        search=search,
        limit_count=limit_count,
        offset_count=offset_count,
        group_id=group_id,
