...
SQL_PATH = "app/sql/v4/queries/entries/attempt_hint/create_attempt_hint_entries_complete.sql"
...
@router.post(
    "/attempt_hint/create",
    response_model=CreateAttemptHintEntriesApiResponse,
    dependencies=[
        audit_activity(
...
async def create_attempt_hint_entry(
    request: CreateAttemptHintEntriesApiRequest,
    ...
    try:
        ...
        api_response = await create_attempt_hint_entry_internal(
