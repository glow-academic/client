...
SQL_PATH = "app/sql/v4/queries/entries/resolves/create_resolves_entries_complete.sql"
    ...
    try:
        ...
        async with conn.transaction():
            ...
            audit_set(
                http_request,
                actor={"id": profile_id},
                resolves={"id": str(result.id)},
            )

        api_response = CreateResolvesEntriesApiResponse.model_validate(
            result.model_dump()
        )
