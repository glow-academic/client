"""AttemptInsights entry CREATE endpoint."""
...
async def create_attempt_insights_entry_internal(
...
async def create_attempt_insights_entry(
    ...
    try:
        ...
        api_response = await create_attempt_insights_entry_internal(
        ...
        audit_set(
            http_request,
            actor={"id": profile_id},
            attempt_insights={"id": str(api_response.id)},
        )
