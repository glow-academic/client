"""Simulation Drafts entry GET endpoint."""
...
from app.sql.types import (
    ...
    GetSimulationDraftsEntriesSqlRow,
    load_sql_query,
)
...
SQL_PATH = "app/sql/v4/queries/entries/simulation_drafts/get_simulation_drafts_entries_complete.sql"
