...
from app.api.v4.resources.instructions.types import SearchInstructionsParams
...
SQL_PATH = "app/sql/v4/queries/resources/instructions/search_instructions_complete.sql"
...
async def search_instructions_internal(
    ...
    *,
    ...
    params = SearchInstructionsParams(
        search=search,
        limit_count=limit_count,
        offset_count=offset_count,
        draft_id=draft_id,
