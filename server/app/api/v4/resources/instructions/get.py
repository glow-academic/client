...
async def get_instructions_internal(
    ...
    # Execute SQL
    params = GetInstructionsSqlParams(ids=ids, search=search)
    result = cast(
        GetInstructionsSqlRow,
...
async def get_instructions(
    ...
    if not bypass_cache:
        ...
        if cached:
            ...
            return GetInstructionsApiResponse.model_validate(cached)
    ...
    try:
        ...
        # Execute SQL
        params = GetInstructionsSqlParams(ids=request.ids, search=request.search)
        ...
        response_data = GetInstructionsApiResponse(items=items)
