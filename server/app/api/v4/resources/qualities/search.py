...
from app.api.v4.resources.qualities.types import SearchQualitiesParams
...
SQL_PATH = "app/sql/v4/queries/resources/qualities/search_qualities_complete.sql"
