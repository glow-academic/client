...
from app.api.v4.resources.problem_statements.types import SearchProblemStatementsParams
...
SQL_PATH = "app/sql/v4/queries/resources/problem_statements/search_problem_statements_complete.sql"
...
async def search_problem_statements_internal(
    ...
    *,
    ...
    cache_key_val = cache_key(
        "/api/v4/resources/problem_statements/search",
        {
            "search": search,
    ...
    params = SearchProblemStatementsParams(
        search=search,
        limit_count=limit_count,
        offset_count=offset_count,
