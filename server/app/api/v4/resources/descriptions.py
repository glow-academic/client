...
from app.sql.types import (DescriptionsApiRequest,
                           DescriptionsApiResponse,
                           DescriptionsSqlParams,
                           DescriptionsSqlRow, load_sql_query)
from fastapi import APIRouter, Depends, HTTPException, Request, Response
from utils.cache.invalidate_tags import invalidate_tags
from utils.sql_helper import execute_sql_typed

# Load SQL with types at module level - makes it clear what SQL file is used
SQL_PATH = "app/sql/v4/resources/descriptions_complete.sql"
...
async def create_description(
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = DescriptionsSqlParams(**request.model_dump())
