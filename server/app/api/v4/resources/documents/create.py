"""documents endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/sql/v4/queries/resources/documents_complete.sql"
...
@router.post(
    "/documents",
    response_model=DocumentsApiResponse,
    dependencies=[
        audit_activity(
            "documents.created",
            "{{ actor.name }} created documents",
        )
    ],
)
async def create_documents(
    ...
    """Create documents resource (always INSERT)."""
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = DocumentsSqlParams(**request_dict)
        ...
        api_response = DocumentsApiResponse.model_validate(result.model_dump())
