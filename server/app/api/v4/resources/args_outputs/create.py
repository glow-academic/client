...
from app.sql.types import (ArgsOutputsApiRequest, ArgsOutputsApiResponse,
                           ArgsOutputsSqlParams, ArgsOutputsSqlRow,
                           load_sql_query)
...
SQL_PATH = "app/sql/v4/queries/resources/args_outputs_complete.sql"
...
@router.post(
    "/args_outputs",
    response_model=ArgsOutputsApiResponse,
    dependencies=[
        audit_activity(
            "args_outputs.created",
            "{{ actor.name }} created args_outputs",
        )
    ],
)
