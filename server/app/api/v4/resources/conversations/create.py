...
from app.sql.types import (ConversationsApiRequest, ConversationsApiResponse,
                           ConversationsSqlParams, ConversationsSqlRow,
                           load_sql_query)
...
async def create_conversations(
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = ConversationsSqlParams(**request_dict)
        ...
        handle_route_error(
            ...
            operation="create_conversations",
            sql_query=sql_query,
