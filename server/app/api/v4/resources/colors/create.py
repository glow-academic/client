...
from app.sql.types import (ColorsApiRequest, ColorsApiResponse,
                           ColorsSqlParams, ColorsSqlRow, load_sql_query)
...
async def create_colors(
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = ColorsSqlParams(**request_dict)
