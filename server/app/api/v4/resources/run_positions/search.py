...
async def search_run_positions_internal(
    ...
    """Internal function to search run_positions."""
    ...
    params = SearchRunPositionsSqlParams(
        search=search,
        limit_count=limit_count,
        offset_count=offset_count,
...
@router.post(
    "/run_positions/search",
    response_model=SearchRunPositionsApiResponse,
)
async def search_run_positions(
    request: SearchRunPositionsApiRequest,
    ...
    try:
        items = await search_run_positions_internal(
            conn,
            request.search,
            request.limit_count,
        ...
        return SearchRunPositionsApiResponse(items=items)
        ...
        handle_route_error(
            ...
            operation="search_run_positions",
