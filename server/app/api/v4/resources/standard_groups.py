...
from app.sql.types import (StandardGroupsApiRequest,
                           StandardGroupsApiResponse,
                           StandardGroupsSqlParams,
                           StandardGroupsSqlRow, load_sql_query)
from fastapi import APIRouter, Depends, HTTPException, Request, Response
from utils.cache.invalidate_tags import invalidate_tags
from utils.sql_helper import execute_sql_typed

# Load SQL with types at module level - makes it clear what SQL file is used
SQL_PATH = "app/sql/v4/resources/standard_groups_complete.sql"
...
async def create_standard_group(
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = StandardGroupsSqlParams(**request.model_dump())
        ...
        handle_route_error(
            ...
            operation="create_standard_group",
            sql_query=sql_query,
