"""simulation_scenario_flags endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/sql/v4/resources/simulation_scenario_flags_complete.sql"
...
@router.post(
    ...
    response_model=SimulationScenarioFlagsApiResponse,
    dependencies=[
        audit_activity(
            "simulation_scenario_flags.created",
            "{{ actor.name }} created simulation_scenario_flags",
        )
    ],
)
async def create_simulation_scenario_flags(
    ...
    """Create simulation_scenario_flags resource (always INSERT)."""
    tags = ["resources", "simulation_scenario_flags"]
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = SimulationScenarioFlagsSqlParams(**request_dict)
        ...
        api_response = SimulationScenarioFlagsApiResponse.model_validate(
            result.model_dump()
        )
