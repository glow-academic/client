"""departments endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/sql/v4/queries/resources/departments_complete.sql"
...
@router.post(
    "/departments",
    response_model=DepartmentsApiResponse,
    dependencies=[
        audit_activity(
            "departments.created",
            "{{ actor.name }} created departments",
        )
    ],
)
async def create_departments(
    ...
    """Create departments resource (always INSERT)."""
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = DepartmentsSqlParams(**request_dict)
        ...
        api_response = DepartmentsApiResponse.model_validate(result.model_dump())
