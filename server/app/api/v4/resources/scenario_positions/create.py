"""scenario_positions endpoint - v4 API following DHH principles."""
...
from app.sql.types import (ScenarioPositionsApiRequest,
                           ScenarioPositionsApiResponse,
                           ScenarioPositionsSqlParams, ScenarioPositionsSqlRow,
                           load_sql_query)
...
SQL_PATH = "app/sql/v4/resources/scenario_positions_complete.sql"
...
async def create_scenario_positions(
    ...
    """Create scenario_positions resource (always INSERT)."""
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = ScenarioPositionsSqlParams(**request_dict)
        ...
        handle_route_error(
            ...
            operation="create_scenario_positions",
            sql_query=sql_query,
