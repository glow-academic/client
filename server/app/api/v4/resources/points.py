...
from app.sql.types import (PointsApiRequest,
                           PointsApiResponse,
                           PointsSqlParams, PointsSqlRow,
                           load_sql_query)
...
SQL_PATH = "app/sql/v4/resources/points_complete.sql"
...
async def create_point(
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = PointsSqlParams(**request.model_dump())
