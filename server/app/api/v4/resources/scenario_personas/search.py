"""Scenario personas search endpoint - v4 API.

Provides search endpoint for finding available scenario personas for scenarios.
"""
...
SQL_PATH = "app/sql/v4/queries/resources/scenario_personas/search_scenario_personas_complete.sql"
...
@router.post(
    "/scenario_personas/search",
    response_model=SearchScenarioPersonasApiResponse,
)
async def search_scenario_personas(
    request: SearchScenarioPersonasApiRequest,
    ...
    try:
        ...
        handle_route_error(
            ...
            operation="search_scenario_personas",
            sql_query=sql_query,
