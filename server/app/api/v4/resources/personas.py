"""personas endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/sql/v4/resources/personas_complete.sql"
...
async def create_persona(
    ...
    """Create personas resource (always INSERT)."""
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = PersonasSqlParams(**request_dict)
        ...
        api_response = PersonasApiResponse.model_validate(result.model_dump())
