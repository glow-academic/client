...
from app.api.v4.resources.protocols.types import SearchProtocolsParams
...
SQL_PATH = "app/sql/v4/queries/resources/protocols/search_protocols_complete.sql"
