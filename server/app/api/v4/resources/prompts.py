...
from app.sql.types import (PromptsApiRequest,
                           PromptsApiResponse,
                           PromptsSqlParams, PromptsSqlRow,
                           load_sql_query)
...
SQL_PATH = "app/sql/v4/resources/prompts_complete.sql"
...
async def create_prompt(
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = PromptsSqlParams(**request.model_dump())
