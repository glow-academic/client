...
from app.api.v4.resources.slugs.types import SearchSlugsParams
...
SQL_PATH = "app/sql/v4/queries/resources/slugs/search_slugs_complete.sql"

router = APIRouter()


async def search_slugs_internal(
