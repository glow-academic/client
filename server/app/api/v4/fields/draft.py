"""Field draft endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/sql/v4/fields/patch_field_draft_complete.sql"
...
async def patch_field_draft(
    ...
    """Patch field draft (creates if not exists)."""
    tags = ["fields", "drafts"]  # From router tags
