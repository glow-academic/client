...
SQL_PATH = "app/sql/v4/parameters/get_parameter_new_complete.sql"
...
async def get_parameter_new(
    ...
    if cached:
        ...
        return GetParameterNewApiResponse.model_validate(cached["data"])
    ...
    try:
        ...
        params = GetParameterNewSqlParams(**request.model_dump(), profile_id=profile_id)
        ...
        api_response = GetParameterNewApiResponse.model_validate(result.model_dump())
