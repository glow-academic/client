...
def create_classification_function(parameter_item_id: str, parameter_item_name: str, parameter_item_description: str) -> Tool:
    ...
    classify_as_parameter_item.__name__ = f"classify_{parameter_item_id.replace('-', '_')}"
