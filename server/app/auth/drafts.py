...
from app.auth.route_permissions import compute_page_metadata
from app.auth.types import GetDraftsApiResponse, QGetProfileContextV4Draft
from app.v5.api.entries.agent_drafts.get import get_agent_drafts_entries_internal
from app.v5.api.entries.auth_drafts.get import get_auth_drafts_entries_internal
from app.v5.api.entries.cohort_drafts.get import get_cohort_drafts_entries_internal
from app.v5.api.entries.department_drafts.get import (
    get_department_drafts_entries_internal,
)
from app.v5.api.entries.document_drafts.get import get_document_drafts_entries_internal
from app.v5.api.entries.eval_drafts.get import get_eval_drafts_entries_internal
from app.v5.api.entries.field_drafts.get import get_field_drafts_entries_internal
from app.v5.api.entries.model_drafts.get import get_model_drafts_entries_internal
from app.v5.api.entries.parameter_drafts.get import (
    get_parameter_drafts_entries_internal,
)
from app.v5.api.entries.persona_drafts.get import get_persona_drafts_entries_internal
from app.v5.api.entries.profile_drafts.get import get_profile_drafts_entries_internal
...
from app.v5.api.entries.simulation_drafts.get import (
