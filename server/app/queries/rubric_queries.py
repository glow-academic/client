...
class RubricQueries:
    ...
    def get_rubric_detail_default_complete(
        self, profile_id: str
    ) -> tuple[str, list[Any]]:
        """Build optimized query to get default rubric detail in ONE query.

        Combines default rubric lookup with full detail fetch using CTEs.
        Consolidates 2 queries into 1.

        Args:
            profile_id: UUID of the profile for finding default rubric
