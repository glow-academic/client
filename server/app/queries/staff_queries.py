...
class StaffQueries:
    ...
    def get_create_staff_data(
        ...
        """
        return (query, [department_ids, current_profile_id])
    ...
    def search_staff(
        ...
        """Build query to search staff with filters in one query."""
        ...
        cohort_exclusion = ""
        if cohort_ids and len(cohort_ids) > 0:
        ...
        # profile_param is $1 (current_profile_id)
        profile_param = 1
