"""Registry-driven generation event types.

Builds Pydantic models from RESOURCE_SCHEMAS / ENTRY_SCHEMAS via create_model().
...
RESOURCE_EVENTS: dict[str, type[ResourceGenerationBase]] = _build_events(
    RESOURCE_SCHEMAS, ResourceGenerationBase, "resource_type"
)
ENTRY_EVENTS: dict[str, type[EntryGenerationBase]] = _build_events(
    ENTRY_SCHEMAS, EntryGenerationBase, "entry_type"
)
