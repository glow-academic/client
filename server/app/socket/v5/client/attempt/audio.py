"""Client-facing attempt audio handlers.

Validates client payloads and emits to internal events.
All business logic lives in v5/internal/attempt/audio.py.

Events:
- attempt_audio_start: Start a voice session
- attempt_audio_frame: Push audio frame (PCM16)
- attempt_audio_mute: Mute/unmute microphone
