"""Internal attempt_chat lifecycle handler.

Handles: @internal_sio.on("attempt_chat") — create or complete chats within attempts.
...
- Complete mode (has completed_chat_ids): Mark chats completed, emit attempt_chat_ended,
  and optionally auto-proceed via attempt_start
"""
