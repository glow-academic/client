...
async def generate_image_start(sid: str, data: dict[str, Any]) -> None:
    ...
    await handle_client_event(
        sid=sid,
        data=data,
        request_type=GenerateImagePayload,
        handler=_generate_image_impl,  # type: ignore[arg-type]
        error_event_name="image_generation_error",
