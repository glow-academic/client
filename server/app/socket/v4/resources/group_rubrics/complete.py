...
from app.socket.v4.resources.group_rubrics.types import GroupRubricsGenerationEvent
...
async def handle_complete(data: dict[str, Any]) -> None:
    """Handle group_rubrics generation complete - emit typed event from tool result."""
    sid = data.get("sid", "")
