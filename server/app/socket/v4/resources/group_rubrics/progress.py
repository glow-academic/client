...
from app.socket.v4.resources.group_rubrics.types import GroupRubricsGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = GroupRubricsGenerationProgressEvent(
...
async def group_rubrics_generation_progress_api(
    request: GroupRubricsGenerationProgressEvent,
) -> dict[str, bool]:
