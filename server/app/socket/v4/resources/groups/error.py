...
from app.socket.v4.resources.groups.types import GroupsGenerationErrorEvent
...
async def handle_error(data: dict[str, Any]) -> None:
    ...
    event = GroupsGenerationErrorEvent(
...
async def groups_generation_error_api(
    request: GroupsGenerationErrorEvent,
) -> dict[str, bool]:
