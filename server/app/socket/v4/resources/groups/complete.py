"""Groupsroups resource completion handler."""
...
from app.socket.v4.resources.groups.types import GroupsGenerationEvent
...
async def handle_complete(data: dict[str, Any]) -> None:
    """Handle groups generation complete - emit typed event from tool result."""
    sid = data.get("sid", "")
