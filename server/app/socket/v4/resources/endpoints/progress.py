...
from app.socket.v4.resources.endpoints.types import EndpointsGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = EndpointsGenerationProgressEvent(
...
async def endpoints_generation_progress_api(
    request: EndpointsGenerationProgressEvent,
) -> dict[str, bool]:
