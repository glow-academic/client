...
from app.socket.v4.resources.parameter_fields.types import ParameterFieldsGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = ParameterFieldsGenerationProgressEvent(
...
async def parameter_fields_generation_progress_api(
    request: ParameterFieldsGenerationProgressEvent,
) -> dict[str, bool]:
