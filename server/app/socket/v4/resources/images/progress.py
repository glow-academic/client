"""Images resource progress handler."""
...
from app.socket.v4.resources.images.types import ImagesGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = ImagesGenerationProgressEvent(
...
async def images_generation_progress_api(
    request: ImagesGenerationProgressEvent,
) -> dict[str, bool]:
