...
from app.socket.v4.resources.scenario_personas.types import ScenarioPersonasGenerationErrorEvent
...
async def handle_error(data: dict[str, Any]) -> None:
    ...
    event = ScenarioPersonasGenerationErrorEvent(
...
async def scenario_personas_generation_error_api(
    request: ScenarioPersonasGenerationErrorEvent,
) -> dict[str, bool]:
