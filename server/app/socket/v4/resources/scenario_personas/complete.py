...
async def handle_complete(data: dict[str, Any]) -> None:
    """Handle scenario_personas generation complete - emit typed event from tool result."""
    sid = data.get("sid", "")
...
async def scenario_personas_call_complete_listener(data: dict[str, Any]) -> None:
    """Listen for tool_result events targeting scenario_personas."""
