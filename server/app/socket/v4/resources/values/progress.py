...
from app.socket.v4.resources.values.types import ValuesGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = ValuesGenerationProgressEvent(
...
async def values_generation_progress_api(
    request: ValuesGenerationProgressEvent,
) -> dict[str, bool]:
