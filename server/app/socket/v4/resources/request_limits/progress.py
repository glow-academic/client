...
from app.socket.v4.resources.request_limits.types import RequestLimitsGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = RequestLimitsGenerationProgressEvent(
...
async def request_limits_generation_progress_api(
    request: RequestLimitsGenerationProgressEvent,
) -> dict[str, bool]:
