...
from app.socket.v4.resources.request_limits.types import RequestLimitsGenerationEvent
...
async def handle_complete(data: dict[str, Any]) -> None:
    """Handle request_limits generation complete - emit typed event from tool result."""
    sid = data.get("sid", "")
