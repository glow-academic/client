...
from app.socket.v4.resources.texts.types import TextsGenerationErrorEvent
...
async def handle_error(data: dict[str, Any]) -> None:
    ...
    event = TextsGenerationErrorEvent(
...
async def texts_generation_error_api(
    request: TextsGenerationErrorEvent,
) -> dict[str, bool]:
