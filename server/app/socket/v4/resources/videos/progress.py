...
from app.socket.v4.resources.videos.types import VideosGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = VideosGenerationProgressEvent(
...
async def videos_generation_progress_api(
    request: VideosGenerationProgressEvent,
) -> dict[str, bool]:
