...
from app.socket.v4.resources.standards.types import StandardsGenerationErrorEvent
...
async def handle_error(data: dict[str, Any]) -> None:
    ...
    event = StandardsGenerationErrorEvent(
...
async def standards_generation_error_api(
    request: StandardsGenerationErrorEvent,
) -> dict[str, bool]:
