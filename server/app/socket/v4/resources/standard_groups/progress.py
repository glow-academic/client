...
from app.socket.v4.resources.standard_groups.types import StandardGroupsGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = StandardGroupsGenerationProgressEvent(
...
async def standard_groups_generation_progress_api(
    request: StandardGroupsGenerationProgressEvent,
) -> dict[str, bool]:
