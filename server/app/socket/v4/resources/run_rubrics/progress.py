...
from app.socket.v4.resources.run_rubrics.types import RunRubricsGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = RunRubricsGenerationProgressEvent(
...
async def run_rubrics_generation_progress_api(
    request: RunRubricsGenerationProgressEvent,
) -> dict[str, bool]:
