...
from app.socket.v4.resources.scenario_rubrics.types import ScenarioRubricsGenerationStartedEvent
...
async def handle_start(data: dict[str, Any]) -> None:
    ...
    event = ScenarioRubricsGenerationStartedEvent(
...
async def scenario_rubrics_call_start_listener(data: dict[str, Any]) -> None:
    """Listen for tool_call_start events targeting scenario_rubrics."""
...
async def scenario_rubrics_generation_started_api(
    request: ScenarioRubricsGenerationStartedEvent,
) -> dict[str, bool]:
