...
from app.socket.v4.resources.bindings.types import BindingsGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = BindingsGenerationProgressEvent(
...
async def bindings_generation_progress_api(
    request: BindingsGenerationProgressEvent,
) -> dict[str, bool]:
