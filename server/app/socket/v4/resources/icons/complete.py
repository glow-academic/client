"""Iconscons resource completion handler."""
...
from app.socket.v4.resources.icons.types import IconsGenerationEvent
...
async def handle_complete(data: dict[str, Any]) -> None:
    """Handle icons generation complete - emit typed event from tool result."""
    sid = data.get("sid", "")
...
async def icons_call_complete_listener(data: dict[str, Any]) -> None:
    """Listen for tool_result events targeting icons."""
