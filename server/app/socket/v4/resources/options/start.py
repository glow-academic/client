...
from app.socket.v4.resources.options.types import OptionsGenerationStartedEvent
...
async def handle_start(data: dict[str, Any]) -> None:
    ...
    event = OptionsGenerationStartedEvent(
...
async def options_generation_started_api(
    request: OptionsGenerationStartedEvent,
) -> dict[str, bool]:
