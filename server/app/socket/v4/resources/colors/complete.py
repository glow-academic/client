"""Colorsolors resource completion handler."""
...
from app.socket.v4.resources.colors.types import ColorsGenerationEvent
...
async def handle_complete(data: dict[str, Any]) -> None:
    """Handle colors generation complete - emit typed event from tool result."""
    sid = data.get("sid", "")
...
async def colors_call_complete_listener(data: dict[str, Any]) -> None:
    """Listen for tool_result events targeting colors."""
