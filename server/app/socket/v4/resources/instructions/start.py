"""Instructions resource start handler."""
...
from app.socket.v4.resources.instructions.types import InstructionsGenerationStartedEvent
...
async def handle_start(data: dict[str, Any]) -> None:
    """Instructions generation started - emit typed event."""
    sid = data.get("sid", "")
    if not sid:
        return
...
async def instructions_call_start_listener(data: dict[str, Any]) -> None:
    """Listen for tool_call_start events targeting instructions."""
