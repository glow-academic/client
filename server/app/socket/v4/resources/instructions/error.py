...
from app.socket.v4.resources.instructions.types import InstructionsGenerationErrorEvent
...
async def handle_error(data: dict[str, Any]) -> None:
    ...
    event = InstructionsGenerationErrorEvent(
...
async def instructions_generation_error_api(
    request: InstructionsGenerationErrorEvent,
) -> dict[str, bool]:
