...
from app.socket.v4.resources.instructions.types import InstructionsGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = InstructionsGenerationProgressEvent(
...
async def instructions_generation_progress_api(
    request: InstructionsGenerationProgressEvent,
) -> dict[str, bool]:
