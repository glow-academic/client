...
from app.socket.v4.resources.provider_keys.types import ProviderKeysGenerationEvent
...
async def handle_complete(data: dict[str, Any]) -> None:
    """Handle provider_keys generation complete - emit typed event from tool result."""
    sid = data.get("sid", "")
