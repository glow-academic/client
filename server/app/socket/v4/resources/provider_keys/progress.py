...
from app.socket.v4.resources.provider_keys.types import ProviderKeysGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = ProviderKeysGenerationProgressEvent(
...
async def provider_keys_generation_progress_api(
    request: ProviderKeysGenerationProgressEvent,
) -> dict[str, bool]:
