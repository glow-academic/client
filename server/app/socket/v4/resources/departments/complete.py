"""Departmentsepartments resource completion handler."""
...
async def handle_complete(data: dict[str, Any]) -> None:
    """Handle departments generation complete - emit typed event from tool result."""
    sid = data.get("sid", "")
    ...
    await sio.emit(
        "departments_generation_complete",
