...
from app.socket.v4.resources.profiles.types import ProfilesGenerationProgressEvent
...
async def handle_progress(data: dict[str, Any]) -> None:
    ...
    event = ProfilesGenerationProgressEvent(
...
async def profiles_generation_progress_api(
    request: ProfilesGenerationProgressEvent,
) -> dict[str, bool]:
