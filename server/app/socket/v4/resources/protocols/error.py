...
from app.socket.v4.resources.protocols.types import ProtocolsGenerationErrorEvent
...
async def handle_error(data: dict[str, Any]) -> None:
    ...
    event = ProtocolsGenerationErrorEvent(
...
async def protocols_generation_error_api(
    request: ProtocolsGenerationErrorEvent,
) -> dict[str, bool]:
