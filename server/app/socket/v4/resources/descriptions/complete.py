"""Descriptionsescriptions resource completion handler."""
...
from app.socket.v4.resources.descriptions.types import DescriptionsGenerationEvent
...
async def handle_complete(data: dict[str, Any]) -> None:
    """Handle descriptions generation complete - emit typed event from tool result."""
    sid = data.get("sid", "")
