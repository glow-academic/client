...
from app.socket.v4.resources.reasoning_levels.types import ReasoningLevelsGenerationErrorEvent
...
async def handle_error(data: dict[str, Any]) -> None:
    ...
    event = ReasoningLevelsGenerationErrorEvent(
...
async def reasoning_levels_generation_error_api(
    request: ReasoningLevelsGenerationErrorEvent,
) -> dict[str, bool]:
