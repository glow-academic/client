...
async def _create_chat_with_randomization(
    ...
    for dept_row in parent_departments:
        sql = load_sql("app/sql/v4/scenario/insert_scenario_department_link.sql")
    ...
    try:
        ...
        async with get_db_connection() as conn:
            ...
            if data.practice_mode:
                ...
                sql = load_sql(
                    "app/sql/v4/practice/find_practice_simulation_with_persona.sql"
                )
                ...
                if data.practice_department_id:
                    ...
                    if scenario_dept_rows and len(scenario_dept_rows) > 0:
                        ...
                        sql = load_sql(
                            "app/sql/v4/profile/get_departments_for_profile.sql"
                        )
