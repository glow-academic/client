...
SQL_PATH = "app/sql/v4/agents/agents_hint_tools_hint_hint_eval_start_complete.sql"


async def _hint_eval_impl(
    sid: str,
    data: AgentsHintToolsHintHintEvalStartApiRequest,
    ...
    try:
        async with get_db_connection() as conn:
            params = AgentsHintToolsHintHintEvalStartSqlParams(
                **data.model_dump(),
...
async def hint_eval_internal(data: dict[str, Any]) -> None:
    ...
    await handle_internal_event(
        data=data,
        request_type=AgentsHintToolsHintHintEvalStartApiRequest,
