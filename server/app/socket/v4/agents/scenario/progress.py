"""Handler for scenario_progress WebSocket event - ONE EVENT PER FILE."""
...
async def scenario_progress_internal(
    ...
    """Handle scenario_progress event from internal bus (server-to-server)."""
...
register_server_endpoint(
    ...
    "Progress update for scenario generation",
)
