    ...
    try:
        async with get_db_connection() as conn:
            ...
            async with conn.transaction():
                ...
                sql = load_sql("app/sql/v4/questions/create_questions_with_options.sql")
                ...
                link_questions_sql = load_sql(
                    "app/sql/v4/scenario/link_questions_to_scenario.sql"
                )
                ...
                if validated.question_timestamps and video_id_uuid:
                    ...
                    save_timestamps_sql = load_sql(
                        "app/sql/v4/scenario/save_question_timestamps.sql"
                    )
