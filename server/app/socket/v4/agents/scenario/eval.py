...
SQL_PATH = "app/sql/v4/agents/agents_scenario_scenario_eval_start_complete.sql"


async def _scenario_eval_impl(
    sid: str,
    data: AgentsScenarioScenarioEvalStartApiRequest,
    ...
    try:
        async with get_db_connection() as conn:
            params = AgentsScenarioScenarioEvalStartSqlParams(
                **data.model_dump(),
...
async def scenario_eval_internal(data: dict[str, Any]) -> None:
    ...
    await handle_internal_event(
        data=data,
        request_type=AgentsScenarioScenarioEvalStartApiRequest,
