...
SQL_PATH = "app/sql/v4/agents/agents_simulation_tools_speak_speak_eval_start_complete.sql"


async def _speak_eval_impl(
    sid: str,
    data: AgentsSimulationToolsSpeakSpeakEvalStartApiRequest,
    ...
    try:
        async with get_db_connection() as conn:
            params = AgentsSimulationToolsSpeakSpeakEvalStartSqlParams(
                **data.model_dump(),
            ...
            await emit_to_internal(
                "benchmark_eval_complete",
                {
                    ...
                    "success": True,
                    "message": "Speak eval completed successfully",
                },
                sid=sid,
            )
    except RuntimeError:
...
async def speak_eval_internal(data: dict[str, Any]) -> None:
    ...
    await handle_internal_event(
        data=data,
        request_type=AgentsSimulationToolsSpeakSpeakEvalStartApiRequest,
