...
from app.socket.v4.entries.highlights.types import HighlightsGenerationErrorEvent
...
async def handle_error(data: dict[str, Any]) -> None:
    ...
    event = HighlightsGenerationErrorEvent(
...
async def highlights_generation_error_api(
    request: HighlightsGenerationErrorEvent,
) -> dict[str, bool]:
