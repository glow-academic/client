"""Improvements entry completion handler."""
...
async def handle_complete(data: dict[str, Any]) -> None:
    ...
    await sio.emit(
        "improvements_generation_complete",
...
async def improvements_call_complete_listener(data: dict[str, Any]) -> None:
    """Listen for tool_result events targeting improvements."""
