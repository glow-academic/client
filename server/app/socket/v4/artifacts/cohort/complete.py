"""Cohort completion handler - listens to artifact_generation_complete events and emits granular cohort events."""
...
async def handle_cohort_artifact_complete(data: dict[str, Any]) -> None:
    """Handle resource_complete internal event - filter by cohort artifact_type and emit granular event."""
    ...
    if not resource_id_str:
        # Emit resource_error - the cohorts error handler will pick it up and emit cohort_generation_error to client
