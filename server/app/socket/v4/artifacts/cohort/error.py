...
SQL_PATH = "app/sql/v4/queries/cohorts/validate_cohort_resource_error_complete.sql"


@internal_sio.on("generate_call_error")  # type: ignore
async def handle_cohorts_error(data: dict[str, Any]) -> None:
    """Handle generate_*_error event - filter by cohort artifact_type and emit cohort-specific event."""
