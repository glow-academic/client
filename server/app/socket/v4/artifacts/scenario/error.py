"""Scenario error handler - listens to resource_error events and emits scenario-specific events."""
...
async def handle_scenarios_error(data: dict[str, Any]) -> None:
    """Handle resource_error event - filter by scenario artifact_type and emit scenario-specific event."""
