...
# SQL paths
SQL_PATH_CONTEXT = "app/sql/v4/queries/generate/benchmark_bundle/get_benchmark_bundle_generation_context_complete.sql"
...
async def _benchmark_bundle_generate_impl(
    ...
    try:
        ...
        async with get_db_connection() as conn:
            context_params = GetBenchmarkBundleGenerationContextSqlParams(
