"""Agent error handler - listens to resource_error events and emits agent-specific events."""
...
async def handle_agents_error(data: dict[str, Any]) -> None:
    """Handle resource_error event - filter by agent artifact_type and emit agent-specific event."""
