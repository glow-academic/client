"""Suite progress handler - emits percentage-based progress as resources complete.
...
from app.socket.v4.artifacts.suite.types import SuiteGenerationProgressEvent
...
async def handle_suite_resource_progress(data: dict[str, Any]) -> None:
    """Track resource completions and emit suite progress percentage."""
...
async def suite_generation_progress_api(
    ...
    """Server-to-client event: Suite generation progress.

    Emitted as individual resources complete during suite generation.
