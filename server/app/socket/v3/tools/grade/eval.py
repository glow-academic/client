    ...
    try:
        ...
        async with pool.acquire() as conn:
            ...
            await emit_to_internal(
                "grade_eval_complete",
                GradeEvalCompletePayload(test_id=test_id, tool_id=tool_id, success=True, message="Grade eval completed"),
                sid=sid,
            )
        ...
        await emit_to_internal(
            "grade_eval_complete",
            GradeEvalCompletePayload(test_id=data.test_id, tool_id=data.tool_id, success=False, message=str(e)),
            sid=sid,
        )
