    ...
    try:
        ...
        async with pool.acquire() as conn:
            ...
            await emit_to_internal(
                "image_eval_complete",
                ImageEvalCompletePayload(test_id=test_id, tool_id=tool_id, success=True, message="Image eval completed"),
                sid=sid,
            )
        ...
        await emit_to_internal(
            "image_eval_complete",
            ImageEvalCompletePayload(test_id=data.test_id, tool_id=data.tool_id, success=False, message=str(e)),
            sid=sid,
        )
