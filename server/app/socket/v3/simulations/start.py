...
async def _simulation_start_impl(sid: str, data: StartSimulationPayload) -> None:
    ...
    try:
        ...
        async with get_db_connection() as conn:
            ...
            SQL_PATH_START = "app/sql/v3/simulations/start_simulation_attempt_complete.sql"
            start_params = StartSimulationAttemptSqlParams(
                ...
                scenario_id_override=uuid.UUID(scenario_id_override) if scenario_id_override else None,
            )
            result = cast(
                StartSimulationAttemptSqlRow,
