...
from .assistant import client_router as assistant_client_router, server_router as assistant_server_router
from .debug import client_router as debug_client_router, server_router as debug_server_router
...
from .user import client_router as user_client_router, server_router as user_server_router
