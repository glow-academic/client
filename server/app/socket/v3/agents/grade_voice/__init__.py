"""Grade voice WebSocket event handlers."""
...
client_router = APIRouter(prefix="/grade-voice", tags=["socket-client"])
server_router = APIRouter(prefix="/grade-voice", tags=["socket-server"])
