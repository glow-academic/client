    ...
    try:
        ...
        async with pool.acquire() as conn:
            ...
            await emit_to_internal(
                ...
                RubricEvalCompletePayload(test_id=test_id, agent_id=agent_id, success=True, message="Rubric eval completed"),
                sid=sid,
            )
        ...
        await emit_to_internal(
            "rubric_eval_complete",
            RubricEvalCompletePayload(test_id=data.test_id, agent_id=data.agent_id, success=False, message=str(e)),
            sid=sid,
        )
