...
from app.sql.types import (
    StatementEvalStartApiRequest,
    StatementEvalStartSqlParams,
    StatementEvalStartSqlRow,
)
...
async def _statement_eval_impl(
    sid: str,
    data: StatementEvalStartApiRequest,
    ...
    try:
        async with get_db_connection() as conn:
            params = StatementEvalStartSqlParams(
                **data.model_dump(),
...
async def statement_eval_internal(data: dict[str, Any]) -> None:
    ...
    await handle_internal_event(
        data=data,
        request_type=StatementEvalStartApiRequest,
