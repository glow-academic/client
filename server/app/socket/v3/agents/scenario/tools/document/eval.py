...
SQL_PATH = "app/sql/v3/agents/agents_scenario_tools_document_document_eval_start_complete.sql"


async def _document_eval_impl(
    sid: str,
    data: AgentsScenarioToolsDocumentDocumentEvalStartApiRequest,
    ...
    try:
        async with get_db_connection() as conn:
            params = AgentsScenarioToolsDocumentDocumentEvalStartSqlParams(
                **data.model_dump(),
...
async def document_eval_internal(data: dict[str, Any]) -> None:
    ...
    await handle_internal_event(
        data=data,
        request_type=AgentsScenarioToolsDocumentDocumentEvalStartApiRequest,
...
register_client_endpoint(
    ...
    "/eval",
    AgentsScenarioToolsDocumentDocumentEvalStartApiRequest,
    "Execute document tool for eval",
)
