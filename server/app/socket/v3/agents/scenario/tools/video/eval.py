...
SQL_PATH = "app/sql/v3/agents/agents_scenario_tools_video_video_eval_start_complete.sql"


async def _video_eval_impl(
    sid: str,
    data: AgentsScenarioToolsVideoVideoEvalStartApiRequest,
    ...
    try:
        async with get_db_connection() as conn:
            params = AgentsScenarioToolsVideoVideoEvalStartSqlParams(
                **data.model_dump(),
...
async def video_eval_internal(data: dict[str, Any]) -> None:
    ...
    await handle_internal_event(
        data=data,
        request_type=AgentsScenarioToolsVideoVideoEvalStartApiRequest,
