...
from app.socket.v3.agents.simulation.generate import (
...
SQL_PATH_CONTEXT = "app/sql/v3/member/get_member_regeneration_run_context_and_create_run_complete.sql"
