...
from .document import client_router as document_client_router, server_router as document_server_router
from .image import client_router as image_client_router, server_router as image_server_router
from .objectives import client_router as objectives_client_router, server_router as objectives_server_router
from .questions import client_router as questions_client_router, server_router as questions_server_router
from .statement import client_router as statement_client_router, server_router as statement_server_router
from .video import client_router as video_client_router, server_router as video_server_router
