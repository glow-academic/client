...
async def generate_video_start(sid: str, data: dict[str, Any]) -> None:
    ...
    await handle_client_event(
        sid=sid,
        data=data,
        request_type=GenerateVideoPayload,
        handler=_generate_video_impl,  # type: ignore[arg-type]
        error_event_name="video_generation_error",
