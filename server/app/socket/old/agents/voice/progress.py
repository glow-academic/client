            ...
            async with get_db_connection() as conn:
                ...
                if call_id not in tool_calls_dict[chat_id_str]:
                    ...
                    sql_get_latest_message = load_sql(
                        "app/sql/v4/simulations/get_latest_message.sql"
                    )
    ...
    try:
        ...
        async with get_db_connection() as conn:
            ...
            sql_validate_message = load_sql(
                "app/sql/v4/simulations/validate_message_belongs_to_chat.sql"
            )
            message_row = await conn.fetchrow(
            ...
            sql_get_upload = load_sql("app/sql/v4/uploads/get_upload_id.sql")
