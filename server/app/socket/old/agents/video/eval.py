"""Handler for video_eval_start WebSocket event - eval-specific logic for video agent."""
...
SQL_PATH = "app/sql/v4/agents/agents_video_video_eval_start_complete.sql"
        ...
        async with get_db_connection() as conn:
            ...
            await internal_sio.emit(
                "benchmark_eval_complete",
                {
                    ...
                    "tool_id": None,
                    "success": True,
                    "message": "Video eval completed successfully",
                    "sid": sid,
                },
            )
    except RuntimeError:
