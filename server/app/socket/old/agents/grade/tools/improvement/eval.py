...
SQL_PATH = "app/sql/v4/agents/agents_grade_tools_improvement_improvement_eval_start_complete.sql"


async def _improvement_eval_impl(
    sid: str,
    data: AgentsGradeToolsImprovementImprovementEvalStartApiRequest,
    ...
    try:
        async with get_db_connection() as conn:
            params = AgentsGradeToolsImprovementImprovementEvalStartSqlParams(
                **data.model_dump(),
...
async def improvement_eval_internal(data: dict[str, Any]) -> None:
    ...
    await handle_internal_event(
        data=data,
        request_type=AgentsGradeToolsImprovementImprovementEvalStartApiRequest,
