...
class Rubrics(_Base, table=True):
    ...
    active_listening: int = Field(sa_column=Column('active_listening', Integer))
    empathy: int = Field(sa_column=Column('empathy', Integer))
    communication: int = Field(sa_column=Column('communication', Integer))
    nonverbal: int = Field(sa_column=Column('nonverbal', Integer))
    problem_solving: int = Field(sa_column=Column('problem_solving', Integer))
    resource_utilization: int = Field(sa_column=Column('resource_utilization', Integer))
