...
t_models = Table(
    'models', ,
    Column('id', Uuid, nullable=False, default_factory=uuid.uuid4),
    Column('created_at', DateTime(True), nullable=False, default_factory=lambda: datetime.now(timezone.utc)),
    Column('updated_at', DateTime(True), nullable=False, default_factory=lambda: datetime.now(timezone.utc)),
    Column('name', Text, nullable=False),
    Column('description', Text, nullable=False),
    Column('provider_id', Uuid, nullable=False),
    Column('active', Boolean, nullable=False, default=True),
    Column('input_ppm', Double(53), nullable=False, default=0.0),
    Column('output_ppm', Double(53), nullable=False, default=0.0),
    Column('custom_model', Boolean, nullable=False, default=False)
)
...
class Personas(_Base, table=True):
    __table_args__ = (
        ...
        Index('idx_personas_model_id', 'model_id')
    )
...
class ModelRuns(_Base, table=True):
    ...
    __table_args__ = (
        ...
        Index('idx_model_runs_model_id', 'model_id'),
        Index('idx_model_runs_profile_id', 'profile_id')
    )
...
class Scenarios(_Base, table=True):
    __table_args__ = (
        ...
        Index('idx_scenarios_persona_id', 'persona_id')
    )
...
class StandardGroups(_Base, table=True):
    ...
    __table_args__ = (
        ...
        Index('idx_standard_groups_rubric_id', 'rubric_id')
    )
...
class SimulationAttempts(_Base, table=True):
    ...
    __table_args__ = (
        ...
        Index('idx_simulation_attempts_profile_created', 'profile_id', 'created_at'),
        Index('idx_simulation_attempts_profile_id', 'profile_id'),
        Index('idx_simulation_attempts_simulation_id', 'simulation_id')
    )
...
class Standards(_Base, table=True):
    __table_args__ = (
        ...
        Index('idx_standards_standard_group_id', 'standard_group_id')
    )
...
class SimulationChats(_Base, table=True):
    ...
    __table_args__ = (
        ...
        Index('idx_simulation_chats_attempt_id', 'attempt_id'),
        Index('idx_simulation_chats_scenario_id', 'scenario_id')
    )
...
class SimulationChatGrades(_Base, table=True):
    ...
    __table_args__ = (
        ...
        Index('idx_simulation_chat_grades_rubric_id', 'rubric_id'),
        Index('idx_simulation_chat_grades_simulation_chat_id', 'simulation_chat_id')
    )
...
class SimulationMessages(_Base, table=True):
    ...
    __table_args__ = (
        ...
        Index('idx_simulation_messages_chat_created', 'chat_id', 'created_at'),
        Index('idx_simulation_messages_chat_id', 'chat_id'),
        Index('idx_simulation_messages_created_at', 'created_at')
    )
...
class SimulationChatFeedbacks(_Base, table=True):
    ...
    __table_args__ = (
        ...
        Index('idx_simulation_chat_feedbacks_simulation_chat_grade_id', 'simulation_chat_grade_id'),
        Index('idx_simulation_chat_feedbacks_standard_id', 'standard_id')
    )
