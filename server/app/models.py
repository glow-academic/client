...
class Cohorts(_Base, table=True):
    ...
    default_cohort: bool = Field(
        sa_column=Column("default_cohort", Boolean, default=False)
    )
...
class ScenarioDeadlines(_Base, table=True):
    ...
    __table_args__ = (PrimaryKeyConstraint("id", name="scenario_deadlines_pkey"),)
...
class ScenarioTimes(_Base, table=True):
    ...
    __table_args__ = (PrimaryKeyConstraint("id", name="scenario_times_pkey"),)
...
class Classes(_Base, table=True):
    ...
    department_id: Mapped[uuid.UUID] = Field(
        sa_column=Column("department_id", Uuid(as_uuid=True))
    )
    name: str = Field(sa_column=Column("name", Text))
...
class Scenarios(_Base, table=True):
    ...
    practice_scenario: bool = Field(
        sa_column=Column("practice_scenario", Boolean, default=False)
    )
    ...
    location_id: Optional[uuid.UUID] = Field(
        default=None, sa_column=Column("location_id", Uuid(as_uuid=True))
    )
    deadline_id: Optional[uuid.UUID] = Field(
        default=None, sa_column=Column("deadline_id", Uuid(as_uuid=True))
    )
    time_id: Optional[uuid.UUID] = Field(
        default=None, sa_column=Column("time_id", Uuid(as_uuid=True))
    )
    document_ids: Optional[List[uuid.UUID]] = Field(
        default=None, sa_column=Column("document_ids", ARRAY(Uuid(as_uuid=True)))
    )
