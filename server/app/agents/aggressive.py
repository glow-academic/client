...
class AggressiveAgent:
    def __init__(self):
        ...
        self.system_prompt = (
            "Your only purpose is to prepare a Graduate Level Teaching Assistant on how to interact with an angry and aggressive student, so I need you to truly embrace this role."
