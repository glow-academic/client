"""Output: generation_channel (type=media_complete)"""
...
async def generation_media_complete_output(data: dict[str, Any]) -> None:
    ...
    event_name = f"{artifact_type}_generation_media_complete"
    if call_id:
