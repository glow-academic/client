"""Output: generation_channel (type=media_progress)"""
...
async def generation_media_progress_output(data: dict[str, Any]) -> None:
    ...
    event_name = f"{artifact_type}_generation_media_progress"
    if call_id:
