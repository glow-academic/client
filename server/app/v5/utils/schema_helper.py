...
async def get_schema_with_fields(
    ...
    rows = cast(
        ...
        await execute_sql_typed(
            conn,
            "app/v5/sql/queries/schemas/get_schema_with_fields_complete.sql",
            params=params,
            multi_row=True,
        ),
    )
...
async def get_template_schema(
    ...
    row_result = cast(
        ...
        await execute_sql_typed(
            conn,
            "app/v5/sql/templates/get_template_schema_complete.sql",
            params=params,
        ),
    )
...
async def get_template_values(
    ...
    values_rows_typed = cast(
        ...
        await execute_sql_typed(
            conn,
            "app/v5/sql/queries/utils/get_template_values_v4_complete.sql",
    ...
    array_items_rows_typed = cast(
        ...
        await execute_sql_typed(
            conn,
            "app/v5/sql/queries/utils/get_template_array_items_v4_complete.sql",
            params=array_params,
            multi_row=True,
        ),
    )
...
async def create_template_with_values(
    ...
    await execute_sql_typed(
        conn,
        "app/v5/sql/queries/utils/create_template_v4_complete.sql",
    ...
    for field in schema_fields_list:
        ...
        if field_type == "array":
                ...
                for position, item_value in enumerate(value):
                    if isinstance(item_value, dict):
                        ...
                        if item_schema_id:
                            ...
                            await execute_sql_typed(
                                conn,
                                "app/v5/sql/queries/utils/create_template_array_item_v4_complete.sql",
            ...
            if field_type == "string":
                ...
                await execute_sql_typed(
                    conn,
                    "app/v5/sql/queries/utils/create_template_value_v4_complete.sql",
                    params=value_params,
                )
            elif field_type == "number":
                value_params = CreateTemplateValueV4SqlParams(
...
async def link_template_to_schema(
    ...
    await execute_sql_typed(
        conn,
        "app/v5/sql/queries/utils/link_schema_template_v4_complete.sql",
        params=link_params,
    )
...
async def create_schema_from_dict(
    ...
    await execute_sql_typed(
        conn,
        "app/v5/sql/queries/utils/create_schema_v4_complete.sql",
    ...
    for position, field in enumerate(fields):
        ...
        await execute_sql_typed(
            conn,
            "app/v5/sql/queries/utils/create_schema_field_v4_complete.sql",
            params=field_params,
        )
        ...
        if field_type == "array" and "item" in field:
            ...
            await execute_sql_typed(
                conn,
                "app/v5/sql/queries/utils/create_schema_field_item_v4_complete.sql",
                params=item_params,
            )
