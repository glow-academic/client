...
COLUMNS_SQL = "app/v5/sql/queries/docs/get_docs_columns_complete.sql"
JUNCTIONS_SQL = "app/v5/sql/queries/docs/get_docs_junctions_complete.sql"
FK_SQL = "app/v5/sql/queries/docs/get_docs_foreign_keys_complete.sql"
