...
from app.v5.api.main.activity import router as activity_artifact_router

# ============================================================================
# Artifacts (19 total)
# ============================================================================
from app.v5.api.main.agent import router as agents_router
from app.v5.api.main.attempt import router as attempt_artifact_router
from app.v5.api.main.auth import router as auth_artifact_router
from app.v5.api.main.benchmark import router as benchmark_artifact_router
from app.v5.api.main.chat import router as chat_artifact_router
from app.v5.api.main.cohort import router as cohorts_router

# View-based artifact handlers (aggregated data for UI sections)
from app.v5.api.main.dashboard import router as dashboard_artifact_router
from app.v5.api.main.department import router as departments_router
from app.v5.api.main.document import router as documents_router
from app.v5.api.main.eval import router as evals_router
from app.v5.api.main.field import router as fields_router
from app.v5.api.main.group import router as group_router
from app.v5.api.main.health import router as health_artifact_router
from app.v5.api.main.home import router as home_artifact_router
from app.v5.api.main.leaderboard import router as leaderboard_artifact_router
from app.v5.api.main.model import router as models_router
from app.v5.api.main.parameter import router as parameters_router
from app.v5.api.main.persona import router as personas_router
from app.v5.api.main.practice import router as practice_artifact_router
from app.v5.api.main.pricing import router as pricing_artifact_router
from app.v5.api.main.profile import router as profile_router
from app.v5.api.main.provider import router as providers_router
from app.v5.api.main.reports import router as reports_artifact_router
from app.v5.api.main.rubric import router as rubrics_router
from app.v5.api.main.scenario import router as scenarios_router
from app.v5.api.main.session import router as session_router
from app.v5.api.main.setting import router as settings_router
from app.v5.api.main.simulation import router as simulations_router
...
# Docs
# ============================================================================
from app.v5.api.docs import router as docs_router

# ============================================================================
# Entries (CRUD layer on entry tables via MVs)
# ============================================================================
from app.v5.api.entries import router as entries_router
