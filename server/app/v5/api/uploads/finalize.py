...
from app.v5.infra.globals import AUDIO_FOLDER, TUS_UPLOADS_DIR, UPLOAD_FOLDER, VIDEO_FOLDER, get_db
...
SQL_PATH = "app/v5/sql/queries/uploads/finalize_upload_complete.sql"
