...
SQL_PATH = "app/v5/sql/queries/entries/attempt_analysis/get_attempt_analysis_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/simulation/analyses/get_simulation_analyses_view_complete.sql"
...
async def get_attempt_analysis_internal(
    ...
    from app.v5.sql.types import GetSimulationAnalysesViewSqlParams
