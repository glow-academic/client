...
from app.v5.api.entries.attempt_analysis.types import (
...
SQL_PATH = "app/v5/sql/queries/entries/attempt_analysis/create_attempt_analysis_entries_complete.sql"
...
async def create_attempt_analysis_entry_internal(
    ...
    async with conn.transaction():
        ...
        request_dict["upload_id"] = await write_text_file(
            conn, None, "Created attempt analysis entry"
        )
...
@router.post(
    "/attempt-analysis/create", response_model=CreateAttemptAnalysisEntryResponse
)
