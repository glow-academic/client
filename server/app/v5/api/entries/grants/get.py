...
SQL_PATH = "app/v5/sql/queries/entries/grants/get_grants_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/grant/list/get_grant_list_view_complete.sql"
...
async def get_grant_list_view_internal(
    ...
    from app.v5.sql.types import GetGrantListViewSqlParams
