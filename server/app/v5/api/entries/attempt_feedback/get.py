...
SQL_PATH = "app/v5/sql/queries/entries/attempt_feedback/get_attempt_feedback_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/simulation/feedbacks/get_simulation_feedbacks_view_complete.sql"
...
async def get_attempt_feedback_internal(
    ...
    from app.v5.sql.types import GetSimulationFeedbacksViewSqlParams
