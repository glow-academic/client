"""AttemptFeedback entry CREATE endpoint."""
...
from app.v5.api.entries.attempt_feedback.types import (
...
SQL_PATH = "app/v5/sql/queries/entries/attempt_feedback/create_attempt_feedback_entries_complete.sql"
...
async def create_attempt_feedback_entry(
    ...
    try:
        ...
        handle_route_error(
            ...
            operation="create_attempt_feedback_entry",
            sql_query=sql_query,
            sql_params=None,
