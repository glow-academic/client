...
SQL_PATH = "app/v5/sql/queries/entries/attempt_message/get_attempt_message_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/simulation/messages/get_simulation_messages_view_complete.sql"
...
async def get_attempt_message_internal(
    ...
    from app.v5.sql.types import GetSimulationMessagesViewSqlParams
