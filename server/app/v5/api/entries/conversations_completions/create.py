...
from app.v5.api.entries.conversations_completions.types import (
...
SQL_PATH = "app/v5/sql/queries/entries/conversations_completions/create_conversations_completions_entries_complete.sql"
