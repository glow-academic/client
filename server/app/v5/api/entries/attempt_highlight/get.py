...
SQL_PATH = "app/v5/sql/queries/entries/attempt_highlight/get_attempt_highlight_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/simulation/highlights/get_simulation_highlights_view_complete.sql"
...
async def get_attempt_highlight_internal(
    ...
    from app.v5.sql.types import GetSimulationHighlightsViewSqlParams
