...
from app.v5.api.entries.attempt_highlight.types import (
...
SQL_PATH = "app/v5/sql/queries/entries/attempt_highlight/create_attempt_highlight_entries_complete.sql"
