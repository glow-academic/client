...
SQL_PATH = "app/v5/sql/queries/entries/calls/get_calls_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/call/list/get_call_list_view_complete.sql"
...
async def get_call_list_view_internal(
    ...
    from app.v5.sql.types import GetCallListViewSqlParams
