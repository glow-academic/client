...
from app.v5.api.entries.attempt_strength.types import (
...
SQL_PATH = "app/v5/sql/queries/entries/attempt_strength/create_attempt_strength_entries_complete.sql"
