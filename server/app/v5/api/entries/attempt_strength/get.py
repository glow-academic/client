...
SQL_PATH = "app/v5/sql/queries/entries/attempt_strength/get_attempt_strength_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/simulation/strengths/get_simulation_strengths_view_complete.sql"
...
async def get_attempt_strength_internal(
    ...
    from app.v5.sql.types import GetSimulationStrengthsViewSqlParams
