...
SQL_PATH = "app/v5/sql/queries/entries/attempt_content/get_attempt_content_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/simulation/contents/get_simulation_contents_view_complete.sql"
...
async def get_attempt_content_internal(
    ...
    from app.v5.sql.types import GetSimulationContentsViewSqlParams
...
async def get_attempt_content_entries(
    ...
    try:
        items = await get_attempt_content_entries_internal(
