...
SQL_PATH = "app/v5/sql/queries/entries/activity/get_activity_entries_complete.sql"
VIEW_SQL_PATH = (
    "app/v5/sql/queries/views/activity/list/get_activity_list_view_complete.sql"
)
...
async def get_activity_list_view_internal(
    ...
    from app.v5.sql.types import GetActivityListViewSqlParams
