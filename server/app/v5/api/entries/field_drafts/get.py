...
SQL_PATH = (
    "app/v5/sql/queries/entries/field_drafts/get_field_drafts_entries_complete.sql"
)
...
async def get_field_drafts_entries(
    ...
    try:
        items = await get_field_drafts_entries_internal(conn, request.ids, bypass_cache)
