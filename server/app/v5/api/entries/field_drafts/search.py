...
from app.v5.sql.types import (
    ...
    SearchFieldDraftsEntriesSqlParams,
    SearchFieldDraftsEntriesSqlRow,
    load_sql_query,
)
...
SQL_PATH = (
    "app/v5/sql/queries/entries/field_drafts/search_field_drafts_entries_complete.sql"
)
...
async def search_field_drafts_entries_internal(
    ...
    """Internal function to search field_drafts entries."""
    ...
    params = SearchFieldDraftsEntriesSqlParams(
        search=search,
        limit_count=limit_count,
        offset_count=offset_count,
        group_id=group_id,
...
async def search_field_drafts_entries(
    ...
    try:
        items = await search_field_drafts_entries_internal(
            conn,
            request.search,
            request.limit_count,
