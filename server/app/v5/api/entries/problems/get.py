...
SQL_PATH = "app/v5/sql/queries/entries/problems/get_problems_entries_complete.sql"
VIEW_SQL_PATH = (
    "app/v5/sql/queries/views/problem/list/get_problem_list_view_complete.sql"
)
...
async def get_problem_list_view_internal(
    ...
    from app.v5.sql.types import GetProblemListViewSqlParams
