...
SQL_PATH = (
    "app/v5/sql/queries/entries/attempt_grade/get_attempt_grade_entries_complete.sql"
)
VIEW_SQL_PATH = (
    "app/v5/sql/queries/views/simulation/grades/get_simulation_grades_view_complete.sql"
)
...
async def get_attempt_grade_internal(
    ...
    from app.v5.sql.types import GetSimulationGradesViewSqlParams
