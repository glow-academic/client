...
from app.v5.api.entries.certificates.types import (
...
SQL_PATH = (
    "app/v5/sql/queries/entries/certificates/create_certificates_entries_complete.sql"
)
...
async def create_certificates_entry_internal(
    ...
    async with conn.transaction():
        ...
        request_dict["text_upload_id"] = await write_text_file(
            conn, None, "Created certificates entry"
        )
...
async def create_certificates_entry(
    ...
    try:
        ...
        handle_route_error(
            ...
            operation="create_certificates_entry",
            sql_query=sql_query,
            sql_params=None,
