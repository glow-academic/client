...
from app.v5.api.entries.attempt_practice.types import (
...
SQL_PATH = "app/v5/sql/queries/entries/attempt_practice/create_attempt_practice_entries_complete.sql"
...
async def create_attempt_practice_entry(
    ...
    try:
        ...
        api_response = await create_attempt_practice_entry_internal(
