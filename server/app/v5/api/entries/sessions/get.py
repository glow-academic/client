...
SQL_PATH = "app/v5/sql/queries/entries/sessions/get_sessions_entries_complete.sql"
VIEW_SQL_PATH = (
    "app/v5/sql/queries/views/session/list/get_session_list_view_complete.sql"
)
COUNTS_SQL_PATH = (
    "app/v5/sql/queries/views/session/counts/get_session_counts_view_complete.sql"
)
...
async def get_session_list_view_internal(
    ...
    from app.v5.sql.types import GetSessionListViewSqlParams
