...
SQL_PATH = "app/v5/sql/queries/entries/attempt_improvement/get_attempt_improvement_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/simulation/improvements/get_simulation_improvements_view_complete.sql"
...
async def get_attempt_improvement_internal(
    ...
    from app.v5.sql.types import GetSimulationImprovementsViewSqlParams
