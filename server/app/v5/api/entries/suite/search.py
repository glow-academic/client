...
SQL_PATH = "app/v5/sql/queries/entries/suite/search_suite_entries_complete.sql"
...
@router.post(
    "/suite/search",
    response_model=SearchSuiteEntriesApiResponse,
)
async def search_suite_entries(
    request: SearchSuiteEntriesApiRequest,
    ...
    try:
        items = await search_suite_entries_internal(
            conn,
            request.search,
            request.limit_count,
        ...
        return SearchSuiteEntriesApiResponse(items=items)
        ...
        handle_route_error(
            ...
            operation="search_suite_entries",
