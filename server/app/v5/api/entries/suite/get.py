...
SQL_PATH = "app/v5/sql/queries/entries/suite/get_suite_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/benchmark/bundle/get_suite_view_complete.sql"
...
async def get_suite_view_internal(
    ...
    from app.v5.sql.types import GetSuiteViewSqlParams
