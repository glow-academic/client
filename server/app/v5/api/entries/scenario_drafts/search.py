...
from app.v5.sql.types import (
    ...
    SearchScenarioDraftsEntriesSqlParams,
...
SQL_PATH = "app/v5/sql/queries/entries/scenario_drafts/search_scenario_drafts_entries_complete.sql"

router = APIRouter()


async def search_scenario_drafts_entries_internal(
    ...
    """Internal function to search scenario_drafts entries."""
    ...
    params = SearchScenarioDraftsEntriesSqlParams(
        search=search,
        limit_count=limit_count,
        offset_count=offset_count,
        group_id=group_id,
