...
SQL_PATH = (
    "app/v5/sql/queries/entries/attempt_hint/get_attempt_hint_entries_complete.sql"
)
VIEW_SQL_PATH = (
    "app/v5/sql/queries/views/simulation/hints/get_simulation_hints_view_complete.sql"
)
...
async def get_attempt_hint_internal(
    ...
    from app.v5.sql.types import GetSimulationHintsViewSqlParams
