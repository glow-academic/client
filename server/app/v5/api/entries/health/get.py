...
SQL_PATH = "app/v5/sql/queries/entries/health/get_health_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/health/list/get_health_list_view_complete.sql"
...
async def get_health_list_view_internal(
    ...
    from app.v5.sql.types import GetHealthListViewSqlParams
