...
from app.v5.api.entries.attempt_replacement.types import (
...
SQL_PATH = "app/v5/sql/queries/entries/attempt_replacement/create_attempt_replacement_entries_complete.sql"
