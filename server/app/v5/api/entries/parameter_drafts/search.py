...
from app.v5.sql.types import (
    ...
    SearchParameterDraftsEntriesSqlParams,
    SearchParameterDraftsEntriesSqlRow,
    load_sql_query,
)
...
SQL_PATH = "app/v5/sql/queries/entries/parameter_drafts/search_parameter_drafts_entries_complete.sql"

router = APIRouter()


async def search_parameter_drafts_entries_internal(
    ...
    """Internal function to search parameter_drafts entries."""
    ...
    params = SearchParameterDraftsEntriesSqlParams(
        search=search,
        limit_count=limit_count,
        offset_count=offset_count,
        group_id=group_id,
...
async def search_parameter_drafts_entries(
    ...
    try:
        items = await search_parameter_drafts_entries_internal(
            conn,
            request.search,
            request.limit_count,
