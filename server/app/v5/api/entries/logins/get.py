...
SQL_PATH = "app/v5/sql/queries/entries/logins/get_logins_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/login/list/get_login_list_view_complete.sql"
...
async def get_login_list_view_internal(
    ...
    from app.v5.sql.types import GetLoginListViewSqlParams
