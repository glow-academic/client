...
from app.v5.api.entries.attempt_message_tree.types import (
...
SQL_PATH = "app/v5/sql/queries/entries/attempt_message_tree/create_attempt_message_tree_entries_complete.sql"
