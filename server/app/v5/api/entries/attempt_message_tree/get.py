...
SQL_PATH = "app/v5/sql/queries/entries/attempt_message_tree/get_attempt_message_tree_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/simulation/message_tree/get_simulation_message_tree_view_complete.sql"
...
async def get_attempt_message_tree_internal(
    ...
    from app.v5.sql.types import GetSimulationMessageTreeViewSqlParams
