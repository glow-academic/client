...
from app.v5.sql.types import (
    ...
    SearchDepartmentDraftsEntriesSqlParams,
    SearchDepartmentDraftsEntriesSqlRow,
    load_sql_query,
)
...
SQL_PATH = "app/v5/sql/queries/entries/department_drafts/search_department_drafts_entries_complete.sql"

router = APIRouter()


async def search_department_drafts_entries_internal(
    ...
    """Internal function to search department_drafts entries."""
    ...
    params = SearchDepartmentDraftsEntriesSqlParams(
        search=search,
        limit_count=limit_count,
        offset_count=offset_count,
        group_id=group_id,
