...
SQL_PATH = "app/v5/sql/queries/entries/test/search_test_entries_complete.sql"
LIST_SQL_PATH = "app/v5/sql/queries/views/test/list/get_test_list_view_complete.sql"
