...
from app.v5.api.entries.test.types import (
...
SQL_PATH = "app/v5/sql/queries/entries/test/create_test_entries_complete.sql"
...
@router.post("/test/create", response_model=CreateTestEntryResponse)
