...
from app.v5.api.entries.messages_completions.types import (
...
SQL_PATH = "app/v5/sql/queries/entries/messages_completions/create_messages_completions_entries_complete.sql"
