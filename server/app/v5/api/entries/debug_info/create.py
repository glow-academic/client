...
from app.v5.api.entries.debug_info.types import (
...
SQL_PATH = (
    "app/v5/sql/queries/entries/debug_info/create_debug_info_entries_complete.sql"
)
...
async def create_debug_info_entry_internal(
    ...
    async with conn.transaction():
        ...
        request_dict["upload_id"] = await write_text_file(
            conn, None, "Created debug info entry"
        )
