...
SQL_PATH = "app/v5/sql/queries/entries/test_invocation/get_test_invocation_entries_complete.sql"
VIEW_SQL_PATH = "app/v5/sql/queries/views/benchmark/invocations/get_test_invocation_view_complete.sql"
...
async def get_test_invocation_internal(
    ...
    from app.v5.sql.types import GetTestInvocationViewSqlParams
