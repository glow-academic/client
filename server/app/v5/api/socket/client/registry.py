...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/agent/prepare_agent_generation_complete.sql",
        draft_view_key="draft_agent",
        fetcher_id_kwarg="agent_id",
        fetcher_module="app.v5.api.main.agent.get",
        fetcher_func="get_agent_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.agent.get",
            "get_agent_websocket",
            "agent_id",
        ),
    )
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/auth/prepare_auth_generation_complete.sql",
        draft_view_key="draft_auth",
        fetcher_id_kwarg="auth_id",
        fetcher_module="app.v5.api.main.auth.get",
        fetcher_func="get_auth_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.auth.get",
            "get_auth_websocket",
            "auth_id",
        ),
    )
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/persona/prepare_persona_generation_complete.sql",
        draft_view_key="draft_persona",
        requires_draft=False,
        fetcher_id_kwarg="persona_id",
        fetcher_module="app.v5.api.main.persona.get",
        fetcher_func="get_persona_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.persona.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/scenario/prepare_scenario_generation_complete.sql",
        draft_view_key="draft_scenario",
        requires_draft=False,
        fetcher_id_kwarg="scenario_id",
        fetcher_module="app.v5.api.main.scenario.get",
        fetcher_func="get_scenario_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.scenario.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/simulation/prepare_simulation_generation_complete.sql",
        draft_view_key="draft_simulation",
        requires_draft=False,
        fetcher_id_kwarg="simulation_id",
        fetcher_module="app.v5.api.main.simulation.get",
        fetcher_func="get_simulation_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.simulation.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/cohort/prepare_cohort_generation_complete.sql",
        draft_view_key="draft_cohort",
        requires_draft=False,
        fetcher_id_kwarg="cohort_id",
        fetcher_module="app.v5.api.main.cohort.get",
        fetcher_func="get_cohort_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.cohort.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/document/prepare_document_generation_complete.sql",
        draft_view_key="draft_document",
        requires_draft=False,
        fetcher_id_kwarg="document_id",
        fetcher_module="app.v5.api.main.document.get",
        fetcher_func="get_document_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.document.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/profile/prepare_profile_generation_complete.sql",
        draft_view_key="draft_profile",
        fetcher_id_kwarg="target_profile_id",
        fetcher_module="app.v5.api.main.profile.get",
        fetcher_func="get_profile_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.profile.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/parameter/prepare_parameter_generation_complete.sql",
        draft_view_key="draft_parameter",
        fetcher_id_kwarg="parameter_id",
        fetcher_module="app.v5.api.main.parameter.get",
        fetcher_func="get_parameter_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.parameter.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/field/prepare_field_generation_complete.sql",
        draft_view_key="draft_field",
        fetcher_id_kwarg="field_id",
        fetcher_module="app.v5.api.main.field.get",
        fetcher_func="get_field_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.field.get",
            "get_field_websocket",
            "field_id",
        ),
    )
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/model/prepare_model_generation_complete.sql",
        draft_view_key="draft_model",
        fetcher_id_kwarg="model_id",
        fetcher_module="app.v5.api.main.model.get",
        fetcher_func="get_model_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.model.get",
            "get_model_websocket",
            "model_id",
        ),
    )
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/tool/prepare_tool_generation_complete.sql",
        draft_view_key="draft_tool",
        fetcher_id_kwarg="tool_id",
        fetcher_module="app.v5.api.main.tool.get",
        fetcher_func="get_tool_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.tool.get",
            "get_tool_websocket",
            "tool_id",
        ),
    )
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/department/prepare_department_generation_complete.sql",
        draft_view_key="draft_department",
        fetcher_id_kwarg="department_id",
        fetcher_module="app.v5.api.main.department.get",
        fetcher_func="get_department_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.department.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/provider/prepare_provider_generation_complete.sql",
        draft_view_key="draft_provider",
        fetcher_id_kwarg="provider_id",
        fetcher_module="app.v5.api.main.provider.get",
        fetcher_func="get_provider_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.provider.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/rubric/prepare_rubric_generation_complete.sql",
        draft_view_key="draft_rubric",
        fetcher_id_kwarg="rubric_id",
        fetcher_module="app.v5.api.main.rubric.get",
        fetcher_func="get_rubric_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.rubric.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/eval/prepare_eval_generation_complete.sql",
        draft_view_key="draft_eval",
        fetcher_id_kwarg="eval_id",
        fetcher_module="app.v5.api.main.eval.get",
        fetcher_func="get_eval_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.eval.get",
            "get_eval_websocket",
            "eval_id",
        ),
    )
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/setting/prepare_setting_generation_complete.sql",
        draft_view_key="draft_setting",
        fetcher_id_kwarg="setting_id",
        fetcher_module="app.v5.api.main.setting.get",
        fetcher_func="get_setting_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.setting.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/training/prepare_training_generation_complete.sql",
        draft_view_key="draft_chat",
        requires_pool=True,
        fetcher_id_kwarg="chat_entry_id",
        fetcher_module="app.v5.api.main.chat.get",
        fetcher_func="get_chat_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.chat.get",
            "get_chat_websocket",
            "chat_entry_id",
            needs_pool=True,
        ),
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/benchmark/prepare_benchmark_generation_complete.sql",
        draft_view_key="draft_invocation",
        has_artifact_id=False,
        requires_pool=True,
        fetcher_module="app.v5.api.main.benchmark.get",
        fetcher_func="get_invocation_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.benchmark.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/suite/prepare_suite_generation_complete.sql",
        draft_view_key="draft_invocation",
        entry_types=[],
        requires_draft=False,
        requires_pool=True,
        fetcher_id_kwarg="benchmark_entry_id",
        fetcher_module="app.v5.api.main.invocation.get",
        fetcher_func="get_invocation_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.invocation.get",
            "get_invocation_websocket",
            "benchmark_entry_id",
            needs_pool=True,
        ),
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/activity/prepare_activity_generation_complete.sql",
        draft_view_key="draft_activity",
        entry_types=["debug_info", "messages"],
        requires_draft=False,
        has_artifact_id=False,
        requires_pool=True,
        fetcher_module="app.v5.api.main.activity.get",
        fetcher_func="get_activity_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.activity.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/session/prepare_session_generation_complete.sql",
        draft_view_key="draft_session",
        entry_types=["debug_info", "messages"],
        requires_draft=False,
        requires_pool=True,
        fetcher_id_kwarg="session_id",
        fetcher_module="app.v5.api.main.session.get",
        fetcher_func="get_session_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.session.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/pricing/prepare_pricing_generation_complete.sql",
        draft_view_key="draft_pricing",
        entry_types=["debug_info", "messages"],
        requires_draft=False,
        has_artifact_id=False,
        requires_pool=True,
        fetcher_module="app.v5.api.main.pricing.get",
        fetcher_func="get_pricing_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.pricing.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/reports/prepare_reports_generation_complete.sql",
        draft_view_key="draft_reports",
        entry_types=["debug_info", "messages"],
        requires_draft=False,
        has_artifact_id=False,
        requires_pool=True,
        fetcher_module="app.v5.api.main.reports.get",
        fetcher_func="get_reports_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.reports.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/group/prepare_group_generation_complete.sql",
        draft_view_key="draft_group",
        entry_types=["debug_info", "messages"],
        requires_draft=False,
        requires_pool=True,
        fetcher_id_kwarg="group_id",
        fetcher_module="app.v5.api.main.group.get",
        fetcher_func="get_group_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.group.get",
            "get_group_websocket",
            "group_id",
            needs_pool=True,
        ),
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/health/prepare_health_generation_complete.sql",
        draft_view_key="draft_health",
        entry_types=["debug_info", "messages"],
        requires_draft=False,
        has_artifact_id=False,
        requires_pool=True,
        fetcher_module="app.v5.api.main.health.get",
        fetcher_func="get_health_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.health.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/leaderboard/prepare_leaderboard_generation_complete.sql",
        draft_view_key="draft_leaderboard",
        entry_types=["debug_info", "messages"],
        requires_draft=False,
        has_artifact_id=False,
        requires_pool=True,
        fetcher_module="app.v5.api.main.leaderboard.get",
        fetcher_func="get_leaderboard_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.leaderboard.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/record/prepare_record_generation_complete.sql",
        draft_view_key="draft_record",
        entry_types=["debug_info", "messages"],
        requires_draft=False,
        requires_pool=True,
        fetcher_id_kwarg="record_id",
        fetcher_module="app.v5.api.main.record.get",
        fetcher_func="get_record_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.record.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        prepare_sql_path="app/v5/sql/queries/generate/dashboard/prepare_dashboard_generation_complete.sql",
        draft_view_key="draft_dashboard",
        entry_types=["debug_info", "messages"],
        requires_draft=False,
        has_artifact_id=False,
        requires_pool=True,
        fetcher_module="app.v5.api.main.dashboard.get",
        fetcher_func="get_dashboard_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.dashboard.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        has_artifact_id=False,
        requires_pool=True,
        fetcher_module="app.v5.api.main.home.get",
        fetcher_func="get_home_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.home.get",
            "get_home_websocket",
            "",
            needs_pool=True,
        ),
...
_register(
    ArtifactGenerateConfig(
        ...
        has_artifact_id=False,
        requires_pool=True,
        fetcher_module="app.v5.api.main.practice.get",
        fetcher_func="get_practice_websocket",
        fetcher=_make_fetcher(
            "app.v5.api.main.practice.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        fetcher_module="app.v5.api.main.attempt.get",
        fetcher_func="get_attempt_websocket",
        needs_conn=True,
        fetcher=_make_fetcher(
            "app.v5.api.main.attempt.get",
...
_register(
    ArtifactGenerateConfig(
        ...
        fetcher_module="app.v5.api.main.test.get",
        fetcher_func="get_test_websocket",
        needs_conn=True,
        fetcher=_make_fetcher(
            "app.v5.api.main.test.get",
            "get_test_websocket",
            "test_id",
            needs_conn=True,
        ),
