...
ARTIFACT_REGISTRY: dict[str, dict[str, tuple[str, str]]] = {
    "activity": {
        "get": ("app.v5.api.main.activity.get", "get_activity"),
        "docs": ("app.v5.api.main.activity.docs", "get_activity_docs_static"),
        "refresh": ("app.v5.api.main.activity.refresh", "activity_refresh"),
    },
    # "agent": {
    #     "get": ("app.v5.api.main.agent.get", "get_agent"),
    #     "list": ("app.v5.api.main.agent.list", "get_agent_list"),
    #     "save": ("app.v5.api.main.agent.save", "save_agent"),
    #     "delete": ("app.v5.api.main.agent.delete", "delete_agent"),
    #     "duplicate": ("app.v5.api.main.agent.duplicate", "duplicate_agent"),
    #     "draft": ("app.v5.api.main.agent.draft", "patch_agent_draft"),
    #     "docs": ("app.v5.api.main.agent.docs", "get_agents_docs"),
    # },
    "attempt": {
        "get": ("app.v5.api.main.attempt.get", "attempt_get"),
        "docs": ("app.v5.api.main.attempt.docs", "get_attempts_docs"),
    },
    # "auth": {
    #     "get": ("app.v5.api.main.auth.get", "get_auth"),
    #     "list": ("app.v5.api.main.auth.list", "get_auth_list"),
    #     "save": ("app.v5.api.main.auth.save", "save_auth"),
    #     "delete": ("app.v5.api.main.auth.delete", "delete_auth"),
    #     "duplicate": ("app.v5.api.main.auth.duplicate", "duplicate_auth"),
    #     "draft": ("app.v5.api.main.auth.draft", "patch_auth_draft"),
    #     "docs": ("app.v5.api.main.auth.docs", "get_auths_docs"),
    # },
    "benchmark": {
        "get": ("app.v5.api.main.benchmark.get", "benchmark_bundle_get"),
        "refresh": ("app.v5.api.main.benchmark.refresh", "benchmark_refresh"),
        "docs": ("app.v5.api.main.benchmark.docs", "get_benchmarks_docs"),
    },
    "cohort": {
        "get": ("app.v5.api.main.cohort.get", "get_cohort"),
        "list": ("app.v5.api.main.cohort.list", "get_cohort_list"),
        "save": ("app.v5.api.main.cohort.save", "save_cohort"),
        "delete": ("app.v5.api.main.cohort.delete", "delete_cohort"),
        "duplicate": ("app.v5.api.main.cohort.duplicate", "duplicate_cohort"),
        "draft": ("app.v5.api.main.cohort.draft", "patch_cohort_draft"),
        "docs": ("app.v5.api.main.cohort.docs", "get_cohorts_docs"),
    },
    "dashboard": {
        "get": ("app.v5.api.main.dashboard.get", "get_dashboard"),
        "header": ("app.v5.api.main.dashboard.header", "get_dashboard_header"),
        "footer": ("app.v5.api.main.dashboard.footer", "get_dashboard_footer"),
        "primary": ("app.v5.api.main.dashboard.primary", "get_dashboard_primary"),
        "secondary": (
            "app.v5.api.main.dashboard.secondary",
            "get_dashboard_secondary",
        ),
        "refresh": ("app.v5.api.main.dashboard.refresh", "dashboard_refresh"),
        "docs": ("app.v5.api.main.dashboard.docs", "get_dashboard_docs_static"),
    },
    # "department": {
    #     "get": ("app.v5.api.main.department.get", "get_department"),
    #     "list": ("app.v5.api.main.department.list", "get_department_list"),
    #     "save": ("app.v5.api.main.department.save", "save_department"),
    #     "delete": ("app.v5.api.main.department.delete", "delete_department"),
    #     "duplicate": (
    #         "app.v5.api.main.department.duplicate",
    #         "duplicate_department",
    #     ),
    #     "draft": ("app.v5.api.main.department.draft", "patch_department_draft"),
    #     "docs": ("app.v5.api.main.department.docs", "get_departments_docs"),
    # },
    # "document": {
    #     "get": ("app.v5.api.main.document.get", "get_document"),
    #     "list": ("app.v5.api.main.document.list", "get_document_list"),
    #     "save": ("app.v5.api.main.document.save", "save_document"),
    #     "delete": ("app.v5.api.main.document.delete", "delete_document"),
    #     "duplicate": ("app.v5.api.main.document.duplicate", "duplicate_document"),
    #     "draft": ("app.v5.api.main.document.draft", "patch_document_draft"),
    #     "docs": ("app.v5.api.main.document.docs", "get_documents_docs"),
    # },
    # "eval": {
    #     "get": ("app.v5.api.main.eval.get", "get_eval"),
    #     "list": ("app.v5.api.main.eval.list", "get_eval_list"),
    #     "save": ("app.v5.api.main.eval.save", "save_eval"),
    #     "delete": ("app.v5.api.main.eval.delete", "delete_eval"),
    #     "duplicate": ("app.v5.api.main.eval.duplicate", "duplicate_eval"),
    #     "draft": ("app.v5.api.main.eval.draft", "patch_eval_draft"),
    #     "docs": ("app.v5.api.main.eval.docs", "get_evals_docs"),
    # },
    # "field": {
    #     "get": ("app.v5.api.main.field.get", "get_field"),
    #     "list": ("app.v5.api.main.field.list", "get_field_list"),
    #     "save": ("app.v5.api.main.field.save", "save_field"),
    #     "delete": ("app.v5.api.main.field.delete", "delete_field"),
    #     "duplicate": ("app.v5.api.main.field.duplicate", "duplicate_field"),
    #     "draft": ("app.v5.api.main.field.draft", "patch_field_draft"),
    #     "docs": ("app.v5.api.main.field.docs", "get_fields_docs"),
    # },
    "group": {
        "get": ("app.v5.api.main.group.get", "get_group"),
        "docs": ("app.v5.api.main.group.docs", "get_groups_docs"),
    },
    # "health": {
    #     "get": ("app.v5.api.main.health.get", "get_health"),
    #     "refresh": ("app.v5.api.main.health.refresh", "health_refresh"),
    #     "docs": ("app.v5.api.main.health.docs", "get_health_docs_static"),
    # },
    "leaderboard": {
        "get": ("app.v5.api.main.leaderboard.get", "get_leaderboard"),
        "refresh": (
            "app.v5.api.main.leaderboard.refresh",
            "leaderboard_refresh",
        ),
        "docs": (
            "app.v5.api.main.leaderboard.docs",
            "get_leaderboard_docs_static",
        ),
    },
    # "model": {
    #     "get": ("app.v5.api.main.model.get", "get_model"),
    #     "list": ("app.v5.api.main.model.list", "get_model_list"),
    #     "save": ("app.v5.api.main.model.save", "save_model"),
    #     "delete": ("app.v5.api.main.model.delete", "delete_model"),
    #     "duplicate": ("app.v5.api.main.model.duplicate", "duplicate_model"),
    #     "draft": ("app.v5.api.main.model.draft", "patch_model_draft"),
    #     "docs": ("app.v5.api.main.model.docs", "get_models_docs"),
    # },
    # "parameter": {
    #     "get": ("app.v5.api.main.parameter.get", "get_parameter"),
    #     "list": ("app.v5.api.main.parameter.list", "get_parameter_list"),
    #     "save": ("app.v5.api.main.parameter.save", "save_parameter"),
    #     "delete": ("app.v5.api.main.parameter.delete", "delete_parameter"),
    #     "duplicate": (
    #         "app.v5.api.main.parameter.duplicate",
    #         "duplicate_parameter",
    #     ),
    #     "draft": ("app.v5.api.main.parameter.draft", "patch_parameter_draft"),
    #     "docs": ("app.v5.api.main.parameter.docs", "get_parameters_docs"),
    # },
    "persona": {
        "get": ("app.v5.api.main.persona.get", "get_persona"),
        "list": ("app.v5.api.main.persona.list", "get_persona_list"),
        "save": ("app.v5.api.main.persona.save", "save_persona"),
        "delete": ("app.v5.api.main.persona.delete", "delete_persona"),
        "duplicate": ("app.v5.api.main.persona.duplicate", "duplicate_persona"),
        "draft": ("app.v5.api.main.persona.draft", "patch_persona_draft"),
        "docs": ("app.v5.api.main.persona.docs", "get_personas_docs"),
    },
    "pricing": {
        "get": ("app.v5.api.main.pricing.get", "get_pricing"),
        "refresh": ("app.v5.api.main.pricing.refresh", "pricing_refresh"),
        "docs": ("app.v5.api.main.pricing.docs", "get_pricing_docs_static"),
    },
    # "profile": {
    #     "get": ("app.v5.api.main.profile.get", "get_profile"),
    #     "list": ("app.v5.api.main.profile.list", "get_profile_list"),
    #     "save": ("app.v5.api.main.profile.save", "save_profile"),
    #     "delete": ("app.v5.api.main.profile.delete", "delete_profile"),
    #     "duplicate": ("app.v5.api.main.profile.duplicate", "duplicate_profile"),
    #     "draft": ("app.v5.api.main.profile.draft", "patch_profile_draft"),
    #     "docs": ("app.v5.api.main.profile.docs", "get_profiles_docs"),
    # },
    # "provider": {
    #     "get": ("app.v5.api.main.provider.get", "get_provider"),
    #     "list": ("app.v5.api.main.provider.list", "get_provider_list"),
    #     "save": ("app.v5.api.main.provider.save", "save_provider"),
    #     "delete": ("app.v5.api.main.provider.delete", "delete_provider"),
    #     "duplicate": ("app.v5.api.main.provider.duplicate", "duplicate_provider"),
    #     "draft": ("app.v5.api.main.provider.draft", "patch_provider_draft"),
    #     "docs": ("app.v5.api.main.provider.docs", "get_providers_docs"),
    # },
    "reports": {
        "get": ("app.v5.api.main.reports.get", "get_reports"),
        "refresh": ("app.v5.api.main.reports.refresh", "reports_refresh"),
        "docs": ("app.v5.api.main.reports.docs", "get_reports_docs_static"),
    },
    # "rubric": {
    #     "get": ("app.v5.api.main.rubric.get", "get_rubric"),
    #     "list": ("app.v5.api.main.rubric.list", "get_rubric_list"),
    #     "save": ("app.v5.api.main.rubric.save", "save_rubric"),
    #     "delete": ("app.v5.api.main.rubric.delete", "delete_rubric"),
    #     "duplicate": ("app.v5.api.main.rubric.duplicate", "duplicate_rubric"),
    #     "draft": ("app.v5.api.main.rubric.draft", "patch_rubric_draft"),
    #     "docs": ("app.v5.api.main.rubric.docs", "get_rubrics_docs"),
    # },
    "scenario": {
        "get": ("app.v5.api.main.scenario.get", "get_scenario"),
        "list": ("app.v5.api.main.scenario.list", "get_scenario_list"),
        "save": ("app.v5.api.main.scenario.save", "save_scenario"),
        "delete": ("app.v5.api.main.scenario.delete", "delete_scenario"),
        "duplicate": ("app.v5.api.main.scenario.duplicate", "duplicate_scenario"),
        "draft": ("app.v5.api.main.scenario.draft", "patch_scenario_draft"),
        "docs": ("app.v5.api.main.scenario.docs", "get_scenarios_docs"),
    },
    "session": {
        "get": ("app.v5.api.main.session.get", "get_session"),
        "docs": ("app.v5.api.main.session.docs", "get_sessions_docs"),
    },
    # "setting": {
    #     "get": ("app.v5.api.main.setting.get", "get_setting"),
    #     "list": ("app.v5.api.main.setting.list", "get_setting_list"),
    #     "save": ("app.v5.api.main.setting.save", "save_setting"),
    #     "delete": ("app.v5.api.main.setting.delete", "delete_setting"),
    #     "duplicate": ("app.v5.api.main.setting.duplicate", "duplicate_setting"),
    #     "draft": ("app.v5.api.main.setting.draft", "patch_setting_draft"),
    #     "docs": ("app.v5.api.main.setting.docs", "get_settings_docs"),
    # },
    "simulation": {
        "get": ("app.v5.api.main.simulation.get", "get_simulation"),
        "list": ("app.v5.api.main.simulation.list", "get_simulation_list"),
        "save": ("app.v5.api.main.simulation.save", "save_simulation"),
        "delete": ("app.v5.api.main.simulation.delete", "delete_simulation"),
        "duplicate": (
            "app.v5.api.main.simulation.duplicate",
            "duplicate_simulation",
        ),
        "draft": ("app.v5.api.main.simulation.draft", "patch_simulation_draft"),
        "docs": ("app.v5.api.main.simulation.docs", "get_simulations_docs"),
    },
    # "test": {
    #     "get": ("app.v5.api.main.test.get", "get_test_artifact"),
    #     "docs": ("app.v5.api.main.test.docs", "get_tests_docs"),
    # },
    # "tool": {
    #     "get": ("app.v5.api.main.tool.get", "get_tool"),
    #     "list": ("app.v5.api.main.tool.list", "get_tool_list"),
    #     "save": ("app.v5.api.main.tool.save", "save_tool"),
    #     "delete": ("app.v5.api.main.tool.delete", "delete_tool"),
    #     "duplicate": ("app.v5.api.main.tool.duplicate", "duplicate_tool"),
    #     "draft": ("app.v5.api.main.tool.draft", "patch_tool_draft"),
    #     "docs": ("app.v5.api.main.tool.docs", "get_tools_docs"),
    # },
    "chat": {
        "get": ("app.v5.api.main.chat.get", "chat_bundle_get"),
        "list": ("app.v5.api.main.chat.list", "chat_get"),
        "draft": ("app.v5.api.main.chat.draft", "patch_chat_draft"),
        "refresh": ("app.v5.api.main.chat.refresh", "chat_refresh"),
        "docs": ("app.v5.api.main.chat.docs", "get_chat_docs_static"),
    },
}
...
for _name in _ALL_RESOURCES:
    _entry: dict[str, tuple[str, str]] = {
        "get": (f"app.v5.api.resources.{_name}.get", f"get_{_name}"),
        "search": (f"app.v5.api.resources.{_name}.search", f"search_{_name}"),
        "docs": (f"app.v5.api.resources.{_name}.docs", f"get_{_name}_docs"),
    }
    if _name in _RESOURCES_WITH_CREATE:
        _entry["create"] = (
            f"app.v5.api.resources.{_name}.create",
            f"create_{_name}",
        )
...
for _name in _ALL_ENTRIES:
    _entry: dict[str, tuple[str, str]] = {
        "get": (f"app.v5.api.entries.{_name}.get", f"get_{_name}_entries"),
        "search": (f"app.v5.api.entries.{_name}.search", f"search_{_name}_entries"),
    }
    if _name in _ENTRIES_WITH_CREATE_ROUTE:
        _entry["create"] = (
            f"app.v5.api.entries.{_name}.create",
...
async def call_handler(
    ...
    """
    from app.v5.utils.mcp.get_mcp_profile_id import get_mcp_profile_id
...
def register_endpoints(server: FastMCP) -> None:
    ...
    def docs(name: str) -> dict[str, Any]:
        ...
        if name == "glow":
            try:
                handler = _get_handler("app.v5.api.docs", "get_glow_docs")
                return handler()
            except Exception:
    ...
    async def upload(
        ...
        from app.v5.infra.globals import AUDIO_FOLDER, UPLOAD_FOLDER, VIDEO_FOLDER, get_db
        from app.v5.sql.types import FinalizeUploadSqlParams, FinalizeUploadSqlRow
        ...
        profile_id = get_mcp_profile_id()
        finalize_sql = "app/v5/sql/queries/uploads/finalize_upload_complete.sql"
    ...
    async def download(
        ...
        from app.v5.sql.types import GetUploadFileInfoSqlParams, GetUploadFileInfoSqlRow
        from app.v5.utils.mcp.get_mcp_profile_id import get_mcp_profile_id
        from app.v5.utils.mime.get_content_type import get_content_type
        from app.v5.utils.sql_helper import execute_sql_typed

        profile_id = get_mcp_profile_id()
        download_sql = "app/v5/sql/queries/uploads/get_upload_file_info_complete.sql"
