...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/documents/check_document_duplicate_access_complete.sql"
)
DUPLICATE_SQL_PATH = "app/v5/sql/queries/documents/duplicate_document_complete.sql"
