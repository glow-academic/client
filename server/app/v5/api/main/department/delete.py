...
from app.v5.api.main.department.permissions import compute_can_delete
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/departments/check_department_delete_access_complete.sql"
)
DELETE_SQL_PATH = "app/v5/sql/queries/departments/delete_department_complete.sql"
