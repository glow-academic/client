...
# SQL paths
QUERY1_SQL_PATH = "app/v5/sql/queries/departments/get_department_access_complete.sql"
QUERY2_SQL_PATH = "app/v5/sql/queries/departments/get_department_ids_complete.sql"
