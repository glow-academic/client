...
from app.v5.api.main.department.permissions import compute_can_duplicate
...
DUPLICATE_SQL_PATH = "app/v5/sql/queries/departments/duplicate_department_complete.sql"
