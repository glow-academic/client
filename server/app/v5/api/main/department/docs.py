...
from app.v5.sql.types import GetDepartmentDocsSqlParams, GetDepartmentDocsSqlRow
...
SQL_PATH = "app/v5/sql/queries/departments/get_department_docs_complete.sql"
