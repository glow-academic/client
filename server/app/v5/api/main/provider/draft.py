...
from app.v5.api.main.provider.permissions import compute_can_draft
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/providers/check_provider_duplicate_access_complete.sql"
)
SQL_PATH = "app/v5/sql/queries/providers/patch_provider_draft_complete.sql"
