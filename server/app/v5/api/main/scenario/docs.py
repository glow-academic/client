...
from app.v5.api.main.scenario import permissions
from app.v5.api.resources.names.get import get_names_internal
from app.v5.infra.globals import get_db
from app.v5.sql.types import GetScenarioDocsSqlParams, GetScenarioDocsSqlRow
...
SQL_PATH = "app/v5/sql/queries/scenarios/get_scenario_docs_complete.sql"
