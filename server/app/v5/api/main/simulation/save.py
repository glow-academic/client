...
from app.v5.api.resources.simulations.create import create_simulations_internal
...
# SQL paths
SQL_PATH = "app/v5/sql/queries/simulations/save_simulation_complete.sql"
ACCESS_SQL_PATH = (
    "app/v5/sql/queries/simulations/check_simulation_save_access_complete.sql"
)
...
async def _resolve_simulation_values(
    ...
    if item.scenarios is not None and item.scenario_ids is None:
        from app.v5.api.resources.scenarios.search import (
