...
from app.v5.api.main.rubric.permissions import compute_can_duplicate
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/rubrics/check_rubric_duplicate_access_complete.sql"
)
DUPLICATE_SQL_PATH = "app/v5/sql/queries/rubric/duplicate_rubric_complete.sql"
