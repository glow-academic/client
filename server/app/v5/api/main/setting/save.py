...
from app.v5.api.main.setting.permissions import compute_can_edit
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/settings/check_setting_save_access_complete.sql"
)
SQL_PATH = "app/v5/sql/queries/settings/save_setting_complete.sql"
