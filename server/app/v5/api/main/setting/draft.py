...
from app.v5.api.main.setting.permissions import compute_can_draft
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/settings/check_setting_duplicate_access_complete.sql"
)
SQL_PATH = "app/v5/sql/queries/settings/patch_setting_draft_complete.sql"
