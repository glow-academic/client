...
from app.v5.api.main.profile.permissions import (
    compute_can_delete,
...
SQL_PATH = "app/v5/sql/queries/profiles/get_profiles_list_complete.sql"

router = APIRouter()


@router.post("/list", response_model=ListProfilesApiResponse)
