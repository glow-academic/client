...
from app.v5.api.main.chat.get import get_chat_internal
...
from app.v5.api.main.chat.types import (
    ChatSimulationOperational,
    RubricMapping,
    StandardGroupMapping,
    StandardMapping,
)
from app.v5.api.main.home.types import (
    GetHomeRequest,
    GetHomeResponse,
...
from app.v5.api.entries.home.get import get_home_context_view_internal
...
from app.v5.sql.types import GetHomeContextViewSqlRow
...
async def _fetch_home_history_data(
    pool: asyncpg.Pool,
...
async def get_home_internal(
    ...
    async def fetch_history() -> HistoryResponse | None:
        return await _fetch_home_history_data(
            pool=pool,
            request=request,
...
async def get_home_websocket(
    ...
    """Independent websocket wrapper for home generation — config chain + bundle resources."""
