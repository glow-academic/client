...
from app.v5.api.main.parameter.permissions import compute_can_delete
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/parameters/check_parameter_delete_access_complete.sql"
)
DELETE_SQL_PATH = "app/v5/sql/queries/parameters/delete_parameter_complete.sql"
