...
# SQL paths
QUERY1_SQL_PATH = "app/v5/sql/queries/parameters/get_parameter_access_complete.sql"
QUERY2_SQL_PATH = "app/v5/sql/queries/parameters/get_parameter_ids_complete.sql"
