...
from app.v5.api.main.parameter.permissions import compute_can_duplicate
...
DUPLICATE_SQL_PATH = "app/v5/sql/queries/parameters/duplicate_parameter_complete.sql"
