...
from app.v5.api.main.parameter.permissions import compute_can_draft
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/parameters/check_parameter_duplicate_access_complete.sql"
)
SQL_PATH = "app/v5/sql/queries/parameters/patch_parameter_draft_complete.sql"
...
async def patch_parameter_draft(
    ...
    try:
        ...
        async with conn.transaction():
            params = PatchParameterDraftSqlParams.from_request(
                request,
                profile_id=profile_id,
            )
