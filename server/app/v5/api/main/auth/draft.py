...
from app.v5.api.main.auth.permissions import compute_can_draft
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/auth/check_auth_duplicate_access_complete.sql"
)
SQL_PATH = "app/v5/sql/queries/auth/patch_auth_draft_complete.sql"
