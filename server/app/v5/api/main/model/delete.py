...
from app.v5.api.main.model.permissions import compute_can_delete
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/models/check_model_delete_access_complete.sql"
)
DELETE_SQL_PATH = "app/v5/sql/queries/models/delete_model_complete.sql"
