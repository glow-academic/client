...
# SQL paths
ACCESS_CHECK_SQL_PATH = "app/v5/sql/queries/models/check_model_save_access_complete.sql"
SQL_PATH = "app/v5/sql/queries/models/save_model_complete.sql"
GET_NAME_SQL_PATH = "app/v5/sql/queries/simulations/get_name_by_id_complete.sql"
