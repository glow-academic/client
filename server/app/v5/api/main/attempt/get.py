...
from app.v5.api.main.attempt.permissions import (
...
from app.v5.api.main.attempt.types import (
    AggregatedResults,
    AnalysisEntry,
    AttemptData,
    AttemptEntries,
...
from app.v5.api.entries.attempt_analysis.get import get_attempt_analysis_internal
from app.v5.api.entries.attempt_content.get import get_attempt_content_internal
from app.v5.api.entries.attempt_feedback.get import get_attempt_feedback_internal
from app.v5.api.entries.attempt_grade.get import get_attempt_grade_internal
from app.v5.api.entries.attempt_highlight.get import (
    get_attempt_highlight_internal,
)
from app.v5.api.entries.attempt_hint.get import get_attempt_hint_internal
from app.v5.api.entries.attempt_improvement.get import (
    get_attempt_improvement_internal,
)
from app.v5.api.entries.attempt_replacement.get import (
    get_attempt_replacement_internal,
)
from app.v5.api.entries.attempt_strength.get import (
    get_attempt_strength_internal,
)
from app.v5.api.entries.responses.get import (
    get_simulation_responses_internal,
)
from app.v5.api.entries.uploads.get import get_upload_list_view_internal
