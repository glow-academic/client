...
from app.v5.api.main.persona.permissions import compute_can_delete
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/personas/check_persona_delete_access_complete.sql"
)
DELETE_SQL_PATH = "app/v5/sql/queries/personas/delete_persona_complete.sql"
