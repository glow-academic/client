...
from app.v5.api.resources.examples.create import create_examples_internal
from app.v5.api.resources.flags.search import search_flags_internal
from app.v5.api.resources.icons.search import search_icons_internal
from app.v5.api.resources.instructions.create import create_instructions_internal
...
from app.v5.api.resources.personas.create import create_personas_internal
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/personas/check_persona_save_access_complete.sql"
)
SQL_PATH = "app/v5/sql/queries/personas/save_persona_complete.sql"
