...
from app.v5.api.main.eval.permissions import compute_can_duplicate
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/evals/check_eval_duplicate_access_complete.sql"
)
DUPLICATE_SQL_PATH = "app/v5/sql/queries/evals/duplicate_eval_complete.sql"
