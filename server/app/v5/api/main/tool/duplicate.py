...
from app.v5.api.main.tool.permissions import compute_can_duplicate
...
ACCESS_CHECK_SQL_PATH = (
    "app/v5/sql/queries/tools/check_tool_duplicate_access_complete.sql"
)
DUPLICATE_SQL_PATH = "app/v5/sql/queries/tools/duplicate_tool_complete.sql"

router = APIRouter()


@router.post("/duplicate", response_model=DuplicateToolApiResponse)
