...
from app.v5.api.main.tool.permissions import compute_can_delete
...
# SQL paths
ACCESS_CHECK_SQL_PATH = "app/v5/sql/queries/tools/check_tool_delete_access_complete.sql"
DELETE_SQL_PATH = "app/v5/sql/queries/tools/delete_tool_complete.sql"
