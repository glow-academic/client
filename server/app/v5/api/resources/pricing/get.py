"""Pricing GET endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/v5/sql/queries/resources/pricing/get_pricing_complete.sql"
...
@router.post(
    "/pricing/get",
    response_model=GetPricingApiResponse,
)
async def get_pricing(
    request: GetPricingApiRequest,
