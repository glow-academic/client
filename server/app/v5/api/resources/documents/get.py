...
SQL_PATH = "app/v5/sql/queries/documents/get_document_resource_data_complete.sql"
BATCH_SQL_PATH = "app/v5/sql/queries/resources/documents/get_documents_complete.sql"
