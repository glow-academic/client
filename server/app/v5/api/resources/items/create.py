"""items endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/v5/sql/queries/resources/items_complete.sql"
...
async def create_items(
    ...
    """Create items resource (always INSERT)."""
    ...
    try:
        ...
        async with conn.transaction():
            ...
            # Frontend sends snake_case (items) - auto-generated types match SQL function signature
            # Add mcp from header (not in request body)
            request_dict = request.model_dump()
            request_dict["mcp"] = mcp
            params = ItemsSqlParams(**request_dict)
