...
SQL_PATH = "app/v5/sql/queries/resources/rubrics/get_rubrics_complete.sql"
BATCH_SQL_PATH = "app/v5/sql/queries/resources/rubrics/get_rubrics_batch_complete.sql"
