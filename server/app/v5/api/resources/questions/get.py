...
from app.v5.api.resources.questions.types import (
...
SQL_PATH = "app/v5/sql/queries/resources/questions/get_question_complete.sql"
BATCH_SQL_PATH = "app/v5/sql/queries/resources/questions/get_questions_complete.sql"
...
async def get_questions_internal(
    ...
    cache_key_val = cache_key(
        "/api/v5/resources/questions/get-batch",
