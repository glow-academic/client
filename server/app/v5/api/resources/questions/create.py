...
SQL_PATH = "app/v5/sql/queries/resources/questions_complete.sql"

router = APIRouter()


@router.post("/questions", response_model=QuestionsApiResponse)
async def create_questions(
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = QuestionsSqlParams(**request_dict)
