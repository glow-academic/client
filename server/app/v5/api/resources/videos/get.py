...
from app.v5.api.resources.videos.types import (
    GetVideoApiRequest,
    GetVideoApiResponse,
    GetVideoSqlParams,
    GetVideoSqlRow,
...
SQL_PATH = "app/v5/sql/queries/resources/videos/get_video_complete.sql"
BATCH_SQL_PATH = "app/v5/sql/queries/resources/videos/get_videos_complete.sql"
