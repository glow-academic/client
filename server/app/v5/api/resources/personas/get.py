...
SQL_PATH = "app/v5/sql/queries/personas/get_persona_resource_data_complete.sql"
BATCH_SQL_PATH = "app/v5/sql/queries/resources/personas/get_personas_complete.sql"
