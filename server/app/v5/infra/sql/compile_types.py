...
def write_consolidated_types_file(
    ...
    lines.append("    from app.v5.utils.sql_helper import load_sql")
    lines.append("")
...
async def generate_types_for_sql_file(
    ...
    try:
        ...
        from app.v5.infra.sql.sql_introspect import introspect_sql_file
        from app.v5.infra.sql.sql_typegen import generate_types_file
...
async def compile_sql_types(
    ...
    if server_root is None:
        ...
        # compile_types.py is at: server/app/v5/infra/sql/compile_types.py
