"""Field refresh logic — composable infra architecture.
...
_TAGS = ["fields", "artifacts"]

# Views refreshed by this endpoint
_VIEWS = ["field_drafts_mv"]


async def refresh_field_impl(
    pool: asyncpg.Pool,
    redis: Redis | None,
    *,
    profile_id: UUID,
) -> RefreshResponse:
    """Field refresh using composable infra functions.
