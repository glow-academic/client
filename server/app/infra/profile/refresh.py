"""Profile refresh logic — composable infra architecture.
...
from app.tools.v5.entries.profile_drafts.refresh import (
    refresh_profile_drafts,
)

# Tags to invalidate — artifact cache + resource caches
_TAGS = ["profiles", "artifacts"]
...
async def refresh_profile_impl(
    ...
    *,
    ...
    """Profile refresh using composable infra functions.
