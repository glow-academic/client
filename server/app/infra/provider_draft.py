...
from app.infra.provider_permissions import compute_can_draft
...
# ---------------------------------------------------------------------------
# patch_provider_draft_client — composable infra architecture
# ---------------------------------------------------------------------------


async def patch_provider_draft_client(
    pool: asyncpg.Pool,
    redis: Redis,
    *,
    profile_id: UUID,
