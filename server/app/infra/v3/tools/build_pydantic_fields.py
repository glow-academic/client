...
def build_pydantic_fields(tool_config: dict[str, Any]) -> dict[str, Any]:
    ...
    for field_name, field_spec in arguments.items():
        ...
        if field_type == "string":
            ...
            logger.warning(f"Unknown field type {field_type} for {field_name}, defaulting to str")
            python_type = str
...
def build_function_signature_string(tool_config: dict[str, Any]) -> tuple[str, list[str]]:
