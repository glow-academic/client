...
- **One SQL file per infra function**: Each database operation has exactly one SQL file in `server/app/sql/v3/infrastructure/[category]/[operation]_complete.sql`
...
server/app/sql/v3/infrastructure/activity/
...
See `server/app/infra/v3/activity/profile_exists.py` and `server/app/sql/v3/infrastructure/activity/profile_exists_complete.sql` as the reference implementation for database operations.
