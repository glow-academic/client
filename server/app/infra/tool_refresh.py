...
from app.routes.v5.tools.entries.tool_drafts.refresh import (
    refresh_tool_drafts,
)
...
_VIEWS = ["tool_drafts_mv"]


async def refresh_tool_client(
    pool: asyncpg.Pool,
    redis: Redis | None,
    *,
    profile_id: UUID,
) -> RefreshResponse:
    """Tool refresh using composable infra functions.
