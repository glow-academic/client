...
from app.infra.setting_permissions import compute_can_draft
...
# ---------------------------------------------------------------------------
# patch_setting_draft_client — composable infra architecture
# ---------------------------------------------------------------------------


async def patch_setting_draft_client(
    pool: asyncpg.Pool,
    redis: Redis,
    *,
    profile_id: UUID,
