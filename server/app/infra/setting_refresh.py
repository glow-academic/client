"""Setting refresh logic — composable infra architecture.
...
_TAGS = ["settings", "artifacts"]

# Views refreshed by this endpoint
_VIEWS = ["setting_drafts_mv"]


async def refresh_setting_client(
    conn: asyncpg.Connection,
    redis: Redis | None,
    *,
    profile_id: UUID,
) -> RefreshResponse:
    """Setting refresh using composable infra functions.
