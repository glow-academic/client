...
from app.routes.v5.api.main.parameter.permissions import compute_can_draft
...
# ---------------------------------------------------------------------------
# patch_parameter_draft_client — composable infra architecture
# ---------------------------------------------------------------------------


async def patch_parameter_draft_client(
    conn: asyncpg.Connection,
    redis: Redis,
    *,
    profile_id: UUID,
