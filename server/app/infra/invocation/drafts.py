"""Invocation drafts list logic — composable infra architecture.

Composes existing black-box tools:
  1. resolve_profile_identity_context — profile (profiles_id)
  2. search_invocation_drafts — declarative filter by profile ownership
"""
...
async def list_invocation_drafts_impl(
    ...
    *,
    ...
    Flow:
      ...
      2. search_invocation_drafts(profile_ids=[profiles_id]) → entries
