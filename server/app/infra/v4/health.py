...
async def check_tus_workflow() -> ServiceCheckResult:
    ...
    - POST /api/v4/uploads/save (creation-with-upload)
    - HEAD /api/v4/uploads/save/{id} to verify
    ...
    url = f"{base_url}/api/v4/uploads/save"
        ...
        async with httpx.AsyncClient(timeout=3.0) as client:
            ...
            if r.status_code != status.HTTP_201_CREATED:
                ...
                return ServiceCheckResult(
                    False,
                    latency,
                    f"POST /api/v4/uploads/save -> {r.status_code}",
                )
