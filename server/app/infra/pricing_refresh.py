"""Pricing refresh logic — composable infra architecture.
...
from app.routes.v5.tools.entries.run_pricing.refresh import (
...
async def refresh_pricing_client(
    ...
    *,
    ...
    """Pricing refresh using composable infra functions.
