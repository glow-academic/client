"""Names SEARCH — reusable data-access layer."""
...
async def search_names(
    ...
    *,
    ...
    """Search names with optional artifact/draft filters."""
    if limit_count <= 0:
        return []
    ...
    items = await get_names(conn, ids, redis, bypass_cache=True)
