"""Descriptions Resource GET — reusable data-access layer."""
...
async def get_descriptions(
    ...
    """Fetch descriptions_resource entries by IDs."""
    if not ids:
        return []

    tags = ["resources", "descriptions"]
    key = cache_key(
        "/v5/resources/descriptions/get", {"ids": [str(id) for id in ids]}
    )
