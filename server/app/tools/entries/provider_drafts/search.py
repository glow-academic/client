"""Provider drafts SEARCH — declarative filters on base table + connections."""
...
async def search_provider_drafts(
    ...
    """Search provider_drafts with declarative filters and connection data."""
