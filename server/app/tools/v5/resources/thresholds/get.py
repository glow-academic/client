"""Thresholds Resource GET — reusable data-access layer."""
...
from app.tools.v5.resources.thresholds.types import GetThresholdResponse
...
async def get_thresholds(
    ...
    """Fetch thresholds_resource entries by IDs."""
    if not ids:
        return []
