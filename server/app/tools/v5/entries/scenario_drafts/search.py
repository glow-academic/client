"""Scenario drafts SEARCH — declarative filters on base table + connections."""
...
async def search_scenario_drafts(
    ...
    """Search scenario_drafts with declarative filters and connection data."""
