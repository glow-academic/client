"""Eval create endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.eval.create.
"""
...
@router.post("/create", response_model=CreateEvalApiResponse)
async def create_eval(
    ...
    try:
        ...
        async def _runner() -> CreateEvalApiResponse:
            return await create_eval_impl(
                pool,
                redis,
