"""Images Resource GET — reusable data-access layer."""
...
async def get_images(
    ...
    """Fetch images_resource entries by IDs."""
    if not ids:
        return []

    tags = ["resources", "images"]
    key = cache_key("/api/v5/resources/images/get", {"ids": [str(id) for id in ids]})
