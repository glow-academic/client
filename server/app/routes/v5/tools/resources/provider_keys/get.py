"""provider_keys/get internal — reusable data-access layer."""
...
SQL_PATH = "app/sql/queries/resources/provider_keys/get_provider_keys_complete.sql"

async def get_provider_keys_internal(
    conn: asyncpg.Connection,
    ids: list[UUID],
    bypass_cache: bool = False,
) -> list[QGetProviderKeysV4Item]:
    """Internal function to fetch provider_keys by IDs."""
    if not ids:
        return []
    ...
    params = GetProviderKeysSqlParams(ids=ids)
    result = cast(
        GetProviderKeysSqlRow,
