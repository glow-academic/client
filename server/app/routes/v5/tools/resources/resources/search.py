"""Resources SEARCH — reusable data-access layer."""
...
async def search_resources(
    ...
    *,
    ...
    """Search resources with optional artifact filters."""
    if limit_count <= 0:
        return []
    ...
    if resource is not None:
        extra_conditions.append(("{alias}.resource::text = ${idx}", resource))
    ...
    items = await get_resources(conn, ids, redis, bypass_cache=True)
