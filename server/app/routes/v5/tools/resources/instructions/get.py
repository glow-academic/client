"""Instructions Resource GET — reusable data-access layer."""
...
async def get_instructions(
    ...
    """Fetch instructions_resource entries by IDs."""
    if not ids:
        return []

    tags = ["resources", "instructions"]
    key = cache_key("/api/v5/resources/instructions/get", {"ids": [str(id) for id in ids]})
