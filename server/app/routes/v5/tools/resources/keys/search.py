"""keys/search internal — reusable data-access layer."""
...
SQL_PATH = "app/sql/queries/resources/keys/search_keys_complete.sql"
...
async def search_keys_internal(
    ...
    *,
    ...
    """Internal function to search keys."""
