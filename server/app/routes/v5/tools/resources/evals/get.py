"""evals/get internal — reusable data-access layer."""
...
SQL_PATH = "app/sql/queries/resources/evals/get_evals_complete.sql"

async def get_evals_internal(
    conn: asyncpg.Connection,
    ids: list[UUID],
    bypass_cache: bool = False,
) -> list[QGetEvalsV4Item]:
    """Internal function to fetch evals by IDs.
    ...
    # Execute SQL
    params = GetEvalsSqlParams(ids=ids)
    result = cast(
        GetEvalsSqlRow,
