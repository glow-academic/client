"""attempt_strength/search internal — reusable data-access layer."""
...
SQL_PATH = "app/sql/queries/entries/attempt_strength/search_attempt_strength_entries_complete.sql"
