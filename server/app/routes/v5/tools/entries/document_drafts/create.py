"""document_drafts CREATE — thin wrapper around shared drafts CRUD."""
...
TABLE = "document_drafts_entry"


async def create_document_drafts(
    ...
    """Create a document_drafts entry."""
