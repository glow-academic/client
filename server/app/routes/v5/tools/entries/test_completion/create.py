"""test_completion/create internal — reusable data-access layer."""
...
SQL_PATH = "app/sql/queries/entries/test_completion/create_test_completion_entries_complete.sql"
...
async def create_test_completion_entry_internal(
    ...
    async with conn.transaction():
        ...
        request_dict["upload_id"] = await write_text_file(
            conn, None, "Created test completion entry"
        )
