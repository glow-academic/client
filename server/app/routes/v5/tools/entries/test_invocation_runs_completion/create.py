...
from app.routes.v5.tools.entries.test_invocation_runs_completion.types import (
...
async def create_test_invocation_runs_completion(
    ...
    entry_id = await conn.fetchval(
        """
        INSERT INTO test_invocation_runs_completion_entry (test_invocation_runs_id, call_id, stop, error, message, active, mcp, generated)
