...
from app.routes.v5.tools.entries.scenario_drafts.types import CreateScenarioDraftResponse
...
async def create_scenario_draft(
    ...
    connections: list[tuple[str, str, list[UUID]]] = [
        ("scenario_drafts_departments_connection", "departments_id", department_ids or []),
        ("scenario_drafts_descriptions_connection", "descriptions_id", description_ids or []),
        ...
        ("scenario_drafts_parameter_fields_connection", "parameter_fields_id", parameter_field_ids or []),
        ("scenario_drafts_personas_connection", "personas_id", persona_ids or []),
        ("scenario_drafts_problem_statements_connection", "problem_statements_id", problem_statement_ids or []),
