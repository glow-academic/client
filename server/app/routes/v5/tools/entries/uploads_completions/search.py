"""uploads_completions/search internal — reusable data-access layer."""
...
SQL_PATH = "app/sql/queries/entries/uploads_completions/search_uploads_completions_entries_complete.sql"
