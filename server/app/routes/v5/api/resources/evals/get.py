...
from app.routes.v5.tools.resources.evals.get import get_evals as get_evals_resource
...
async def get_evals(
    ...
    try:
        items = await get_evals_resource(conn, request.ids, get_redis_client(), bypass_cache)
