...
from app.routes.v5.tools.resources.points.get import get_points as get_points_resource
...
async def get_points(
    ...
    try:
        items = await get_points_resource(conn, request.ids, get_redis_client(), bypass_cache)
