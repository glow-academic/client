...
from app.routes.v5.tools.resources.scenario_rubrics.get import (
    get_scenario_rubrics as get_scenario_rubrics_resource,
)
...
async def get_scenario_rubrics(
    request: GetScenarioRubricsApiRequest,
    ...
    try:
        ...
        items = await get_scenario_rubrics_resource(
            conn=conn,
            ids=request.ids or [],
        ...
        api_response = GetScenarioRubricsApiResponse(items=items)
        ...
        handle_route_error(
            ...
            operation="get_scenario_rubrics",
            sql_query=None,
