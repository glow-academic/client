...
from app.routes.v5.tools.resources.voices.get import get_voices as get_voices_resource
...
async def get_voices(
    ...
    try:
        items = await get_voices_resource(conn, request.ids, get_redis_client(), bypass_cache)
