...
from app.routes.v5.tools.resources.endpoints.get import get_endpoints as get_endpoints_resource
...
async def get_endpoints(
    ...
    try:
        items = await get_endpoints_resource(conn, request.ids, get_redis_client(), bypass_cache)
