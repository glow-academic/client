"""simulation_positions endpoint - v4 API following DHH principles."""
...
SQL_PATH = "app/sql/queries/resources/simulation_positions_complete.sql"
...
async def create_simulation_positions(
    ...
    """Create simulation_positions resource (always INSERT)."""
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = SimulationPositionsSqlParams(**request_dict)
        ...
        handle_route_error(
            ...
            operation="create_simulation_positions",
            sql_query=sql_query,
