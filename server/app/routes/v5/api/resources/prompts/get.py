...
from app.routes.v5.tools.resources.prompts.get import get_prompts as get_prompts_resource
...
async def get_prompts(
    ...
    try:
        items = await get_prompts_resource(conn, request.ids, get_redis_client(), bypass_cache)
