...
SQL_PATH = "app/sql/queries/resources/videos_complete.sql"

router = APIRouter()


@router.post("/videos", response_model=VideosApiResponse)
async def create_videos(
    ...
    try:
        ...
        async with conn.transaction():
            ...
            params = VideosSqlParams(**request_dict)
