...
from app.sql.types import (
    ...
    SearchAgentDraftsEntriesSqlParams,
    SearchAgentDraftsEntriesSqlRow,
    load_sql_query,
)
...
SQL_PATH = (
    "app/sql/queries/entries/agent_drafts/search_agent_drafts_entries_complete.sql"
)

router = APIRouter()


async def search_agent_drafts_entries_internal(
    ...
    """Internal function to search agent_drafts entries."""
    ...
    params = SearchAgentDraftsEntriesSqlParams(
        search=search,
        limit_count=limit_count,
        offset_count=offset_count,
        group_id=group_id,
...
async def search_agent_drafts_entries(
    ...
    try:
        items = await search_agent_drafts_entries_internal(
            conn,
            request.search,
            request.limit_count,
