...
SQL_PATH = "app/sql/queries/entries/resolves/create_resolves_entries_complete.sql"
...
async def create_resolves_entry_internal(
    ...
    async with conn.transaction():
        ...
        request_dict["upload_id"] = await write_text_file(
            conn, None, "Created resolves entry"
        )
