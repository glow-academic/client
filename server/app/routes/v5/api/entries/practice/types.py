"""Canonical practice entry type — single source of truth for entry fields."""

from pydantic import BaseModel


class PracticeEntryData(BaseModel):
    """Canonical practice entry fields. All optional for streaming support."""
