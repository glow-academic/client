...
from app.routes.v5.tools.entries.runs.get import SQL_PATH, get_runs_entries_internal
...
async def get_runs_entries(
    ...
    try:
        items = await get_runs_entries_internal(conn, request.ids, bypass_cache)
