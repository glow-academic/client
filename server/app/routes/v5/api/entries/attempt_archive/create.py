...
from app.routes.v5.api.entries.attempt_archive.types import (
    CreateAttemptArchiveEntryRequest,
    CreateAttemptArchiveEntryResponse,
)
from app.routes.v5.tools.entries.attempt_archive.create import (
...
async def create_attempt_archive_entry(
    ...
    try:
        ...
        api_response = await create_attempt_archive(
