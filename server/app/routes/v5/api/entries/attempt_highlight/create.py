"""AttemptHighlight entry CREATE endpoint."""
...
from app.routes.v5.tools.entries.attempt_highlight.create import (
    SQL_PATH,
    create_attempt_highlight_entry_internal,
)
...
@router.post(
    "/attempt-highlight/create", response_model=CreateAttemptHighlightEntryResponse
)
async def create_attempt_highlight_entry(
    ...
    try:
        ...
        api_response = await create_attempt_highlight_entry_internal(
        ...
        handle_route_error(
            ...
            operation="create_attempt_highlight_entry",
            sql_query=sql_query,
            sql_params=None,
