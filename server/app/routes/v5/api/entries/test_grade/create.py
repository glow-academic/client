...
from app.routes.v5.api.entries.test_grade.types import (
...
SQL_PATH = (
    "app/sql/queries/entries/test_grade/create_test_grade_entries_complete.sql"
)

ENTRY_TYPE = "test_grades"
...
async def create_test_grade_entry_internal(
    ...
    async with conn.transaction():
        ...
        request_dict["upload_id"] = await write_text_file(
            conn, None, "Created test grade entry"
        )
...
@router.post("/test-grade/create", response_model=CreateTestGradeEntryResponse)
