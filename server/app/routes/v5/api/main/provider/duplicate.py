...
from app.routes.v5.api.main.provider.permissions import compute_can_duplicate
...
DUPLICATE_SQL_PATH = "app/sql/queries/providers/duplicate_provider_complete.sql"

router = APIRouter()


@router.post("/duplicate", response_model=DuplicateProviderApiResponse)
