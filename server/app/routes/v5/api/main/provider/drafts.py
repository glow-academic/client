"""Provider drafts list endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.provider_drafts.
"""
...
from app.infra.provider_drafts import list_provider_drafts_client
...
async def get_provider_drafts(
    ...
    try:
        ...
        context = await list_provider_drafts_client(
            pool,
            redis,
        ...
        return GetProviderDraftsApiResponse(
