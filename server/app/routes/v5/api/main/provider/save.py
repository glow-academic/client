"""Provider save endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.provider_save.
"""
...
from app.infra.provider_save import save_provider_client
...
async def save_provider(
    ...
    """Save providers using composable infra architecture."""
    try:
        ...
        response_data = await save_provider_client(
            pool,
            redis,
