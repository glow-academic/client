...
from app.routes.v5.api.main.provider.permissions import compute_can_delete
...
ACCESS_CHECK_SQL_PATH = (
    "app/sql/queries/providers/check_provider_delete_access_complete.sql"
)
DELETE_SQL_PATH = "app/sql/queries/providers/delete_provider_complete.sql"
