...
Thin route handler. Core logic lives in app.infra.rubric_update.
"""
...
from app.infra.rubric_update import update_rubric_client
...
async def update_rubric(
    ...
    try:
        ...
        response_data = await update_rubric_client(
            conn,
            redis,
