...
Thin route handler. Core logic lives in app.infra.rubric_draft.
"""
...
from app.infra.rubric_draft import patch_rubric_draft_client
...
async def patch_rubric_draft(
    ...
    try:
        ...
        result = await patch_rubric_draft_client(
            conn,
            redis,
