...
RUBRIC_EVENT_CONFIGS: dict[str, OperationEventConfig] = {
    ...
    "create": OperationEventConfig(
        operation="create",
        domain_events=("artifacts.rubric.created",),
        scope="collection",
        entity_key=None,
        can_subscribe=require_authenticated_profile,
    ...
    "update": OperationEventConfig(
        operation="update",
        domain_events=("artifacts.rubric.updated",),
        scope="entity",
        entity_key="rubric_id",
        can_subscribe=require_authenticated_profile,
        resolve_entity_ids=_rubric_result_entity_ids,
    ...
    "delete": OperationEventConfig(
        operation="delete",
        domain_events=("artifacts.rubric.deleted",),
        scope="entity",
        entity_key="rubric_id",
        can_subscribe=require_authenticated_profile,
        resolve_entity_ids=_rubric_result_entity_ids,
    ...
    "duplicate": OperationEventConfig(
        operation="duplicate",
        domain_events=("artifacts.rubric.duplicated",),
        scope="entity",
        entity_key="rubric_id",
        can_subscribe=require_authenticated_profile,
    ...
    "draft": OperationEventConfig(
        operation="draft",
        domain_events=("artifacts.rubric.draft.saved",),
        scope="entity",
        entity_key="draft_id",
        can_subscribe=require_authenticated_profile,
    ...
    "drafts": OperationEventConfig(
        operation="drafts",
        domain_events=("artifacts.rubric.drafts.viewed",),
        scope="collection",
        entity_key=None,
        can_subscribe=require_authenticated_profile,
    ...
    "search": OperationEventConfig(
        operation="search",
        domain_events=("artifacts.rubric.search.performed",),
        scope="collection",
        entity_key=None,
        can_subscribe=require_authenticated_profile,
        include_call_lifecycle=False,
    ...
    "docs": OperationEventConfig(
        operation="docs",
        domain_events=("artifacts.rubric.docs.viewed",),
        scope="entity",
    ...
    "export": OperationEventConfig(
        operation="export",
        domain_events=("artifacts.rubric.exported",),
        scope="collection",
        entity_key="rubric_id",
        can_subscribe=require_authenticated_profile,
        resolve_entity_ids=lambda arguments, output: _rubric_request_entity_ids(
