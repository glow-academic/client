"""Department save endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.department_save.
"""
...
from app.infra.department_save import save_department_client
...
async def save_department(
    ...
    """Save departments using composable infra architecture."""
    try:
        ...
        response_data = await save_department_client(
            pool,
            redis,
