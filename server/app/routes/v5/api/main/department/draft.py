...
Thin route handler. Core logic lives in app.infra.department.draft.
"""
...
async def patch_department_draft(
    ...
    try:
        ...
        async def _runner() -> PatchDepartmentDraftApiResponse:
            return await patch_department_draft_impl(
                pool,
                redis,
