...
Thin route handler. Core logic lives in app.infra.profile_drafts.
"""
...
from app.infra.profile_drafts import list_profile_drafts_client
...
async def get_profile_drafts(
    ...
    try:
        ...
        context = await list_profile_drafts_client(
            pool,
            redis,
