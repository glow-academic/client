...
async def get_profile_context(
    ...
    try:
        ...
        # Derive available_sections and scoped_roles
        available_sections = compute_available_sections(identity.role_artifacts or [])
        scoped_roles = sorted(SIMULATABLE_ROLES.get(identity.role, set()))

        # Parallel: fetch all roles + resolve theme
        ...
        # Emulation state from middleware
