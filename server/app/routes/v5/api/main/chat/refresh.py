"""Chat refresh endpoint - POST /training/refresh.
...
SQL_PATH = "app/sql/queries/analytics/refresh_mv_training_complete.sql"
...
async def chat_refresh(
    ...
    """Refresh all chat section materialized views."""
    tags = ["training", "home"]
