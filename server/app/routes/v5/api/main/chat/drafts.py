...
Thin route handler. Core logic lives in app.infra.chat_drafts.
"""
...
from app.infra.chat_drafts import list_chat_drafts_client
...
async def get_chat_drafts(
    ...
    try:
        ...
        context = await list_chat_drafts_client(
            pool,
            redis,
