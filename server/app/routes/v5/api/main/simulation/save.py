"""Simulation save endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.simulation_save.
"""
...
from app.infra.simulation_save import save_simulation_client
...
async def save_simulation(
    ...
    """Save simulations using composable infra architecture."""
    try:
        ...
        response_data = await save_simulation_client(
            pool,
            redis,
