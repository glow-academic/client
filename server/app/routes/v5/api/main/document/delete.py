...
from app.routes.v5.api.main.document.permissions import compute_can_delete
...
ACCESS_CHECK_SQL_PATH = (
    "app/sql/queries/documents/check_document_delete_access_complete.sql"
)
DELETE_SQL_PATH = "app/sql/queries/documents/delete_document_complete.sql"
