"""Document CSV parse endpoint — accepts a CSV file and returns mapped items for preview."""
    ...
    try:
        ...
        if not field_map:
            raise HTTPException(
                ...
                f"Expected: {', '.join(f['label'] for f in DOCUMENT_IMPORT_FIELDS)}",
            )
        ...
        return ParseDocumentCsvApiResponse(
