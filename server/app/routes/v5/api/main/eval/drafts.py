...
Thin route handler. Core logic lives in app.infra.eval_drafts.
"""
...
from app.infra.eval_drafts import list_eval_drafts_client
...
async def get_eval_drafts(
    ...
    try:
        ...
        context = await list_eval_drafts_client(
            pool,
            redis,
        ...
        return GetEvalDraftsApiResponse(
