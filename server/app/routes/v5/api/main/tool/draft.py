"""Tool draft endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.tool_draft.
"""
...
from app.infra.tool_draft import patch_tool_draft_client
...
async def patch_tool_draft(
    ...
    try:
        ...
        result = await patch_tool_draft_client(
            pool,
            redis,
