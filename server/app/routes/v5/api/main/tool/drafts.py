...
Thin route handler. Core logic lives in app.infra.tool_drafts.
"""
...
from app.infra.tool_drafts import list_tool_drafts_client
...
async def get_tool_drafts(
    ...
    try:
        ...
        context = await list_tool_drafts_client(
            pool,
            redis,
