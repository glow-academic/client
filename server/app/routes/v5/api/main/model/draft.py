...
Thin route handler. Core logic lives in app.infra.model_draft.
"""
...
from app.infra.model_draft import patch_model_draft_client
...
async def patch_model_draft(
    ...
    try:
        ...
        result = await patch_model_draft_client(
            pool,
            redis,
