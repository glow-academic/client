...
Thin route handler. Core logic lives in app.infra.model_drafts.
"""
...
from app.infra.model_drafts import list_model_drafts_client
...
async def get_model_drafts(
    ...
    try:
        ...
        context = await list_model_drafts_client(
            pool,
            redis,
