...
Thin route handler. Core logic lives in app.infra.scenario_drafts.
"""
...
from app.infra.scenario_drafts import list_scenario_drafts_client
...
async def get_scenario_drafts(
    ...
    try:
        ...
        context = await list_scenario_drafts_client(
            pool,
            redis,
