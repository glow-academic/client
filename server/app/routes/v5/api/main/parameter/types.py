...
class SaveParameterLegacyApiRequest(BaseModel):
    """Legacy request model for save parameter endpoint - flat resource IDs."""
...
class SaveParameterLegacyApiResponse(BaseModel):
    success: bool
    parameter_id: UUID
    message: str
