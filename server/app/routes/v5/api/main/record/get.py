"""Record artifact — get endpoint (profile report + websocket config).

Composable pattern: resolve_common_context → resolve_dashboard_context → Python assembly.
Record is dashboard scoped to a single profile (target_profile_id required).
"""
...
# ---------------------------------------------------------------------------
# Layer 2a: HTTP client endpoint (profile report — dashboard for one profile)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Layer 2b: WebSocket config chain (for AI generation)
# ---------------------------------------------------------------------------
