...
from app.routes.v5.api.main.setting.drafts import router as drafts_router
from app.routes.v5.api.main.setting.duplicate import router as duplicate_router
from app.routes.v5.api.main.setting.export import router as export_router
from app.routes.v5.api.main.setting.get import router as get_router
from app.routes.v5.api.main.setting.refresh import router as refresh_router
