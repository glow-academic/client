...
Thin route handler. Core logic lives in app.infra.setting_draft.
"""
...
from app.infra.setting_draft import patch_setting_draft_client
...
async def patch_setting_draft(
    ...
    try:
        ...
        result = await patch_setting_draft_client(
            pool,
            redis,
