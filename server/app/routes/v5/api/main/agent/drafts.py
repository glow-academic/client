...
Thin route handler. Core logic lives in app.infra.agent_drafts.
"""
...
from app.infra.agent_drafts import list_agent_drafts_client
...
async def get_agent_drafts(
    ...
    try:
        ...
        context = await list_agent_drafts_client(
            pool,
            redis,
