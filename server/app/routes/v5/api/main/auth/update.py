...
Thin route handler. Core logic lives in app.infra.auth_update.
"""
...
from app.infra.auth_update import update_auth_client
...
@router.post("/update", response_model=UpdateAuthApiResponse)
async def update_auth(
    ...
    try:
        ...
        response_data = await update_auth_client(
            conn,
            redis,
