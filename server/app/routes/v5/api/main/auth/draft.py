...
Thin route handler. Core logic lives in app.infra.auth_draft.
"""
...
from app.infra.auth_draft import patch_auth_draft_client
...
async def patch_auth_draft(
    ...
    try:
        ...
        result = await patch_auth_draft_client(
            conn,
            redis,
