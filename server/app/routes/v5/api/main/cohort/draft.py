"""Cohort draft endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.cohort_draft.
"""
...
async def patch_cohort_draft(
    ...
    try:
        ...
        async def _runner() -> PatchCohortDraftApiResponse:
            return await patch_cohort_draft_impl(
                pool,
                redis,
