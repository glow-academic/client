"""Cohort save endpoint — composable infra architecture.

Thin route handler. Core logic lives in app.infra.cohort_save.
"""
...
from app.infra.cohort_save import save_cohort_client
...
async def save_cohort(
    ...
    """Save cohorts using composable infra architecture."""
    try:
        ...
        response_data = await save_cohort_client(
            pool,
            redis,
