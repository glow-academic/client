...
Thin route handler. Core logic lives in app.infra.invocation_drafts.
"""
...
from app.infra.invocation_drafts import list_invocation_drafts_client
from app.routes.v5.api.main.invocation.types import GetInvocationDraftsApiResponse
...
async def get_invocation_drafts(
    ...
    try:
        ...
        context = await list_invocation_drafts_client(
            pool,
            redis,
