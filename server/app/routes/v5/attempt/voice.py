"""Attempt voice endpoints — HTTP adapters for voice session management.
...
For /voice/frame, the caller passes an upload_id pointing to an already-uploaded
...
@router.post("/voice/start", response_model=AudioStartInternalResult)
...
@router.post("/voice/frame", response_model=AudioFrameResponse)
...
@router.post("/voice/stop", response_model=AudioStopInternalResult)
