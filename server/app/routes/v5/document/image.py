"""Document image uploads — upload and download for image files."""
...
router = APIRouter(prefix="/image", tags=["documents-image"])
...
async def upload_image(
    ...
    try:
        ...
        handle_route_error(
            ...
            operation="upload_document_image",
...
async def download_image(
    ...
    try:
        ...
        handle_route_error(
            error=e,
            route_path=http_request.url.path,
            operation="download_document_image",
            request=http_request,
        )
        raise
