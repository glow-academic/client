...
ARTIFACT_REGISTRY: dict[str, dict[str, tuple[str, str]]] = {
    ...
    # "agent": {
    #     "get": ("app.routes.v5.agent.get", "get_agent"),
    #     "search": ("app.routes.v5.agent.search", "search_agent"),
    #     "save": ("app.routes.v5.agent.save", "save_agent"),
    #     "delete": ("app.routes.v5.agent.delete", "delete_agent"),
    #     "duplicate": ("app.routes.v5.agent.duplicate", "duplicate_agent"),
    #     "draft": ("app.routes.v5.agent.draft", "patch_agent_draft"),
    #     "docs": ("app.infra.agent_docs", "docs_agent_client"),
    # },
    "attempt": {
    ...
    #     "search": ("app.routes.v5.auth.search", "search_auth"),
    #     "save": ("app.routes.v5.auth.save", "save_auth"),
    #     "delete": ("app.routes.v5.auth.delete", "delete_auth"),
    #     "duplicate": ("app.routes.v5.auth.duplicate", "duplicate_auth"),
    #     "draft": ("app.routes.v5.auth.draft", "patch_auth_draft"),
    ...
    "cohort": {
        ...
        "search": ("app.routes.v5.cohort.search", "search_cohort"),
    ...
    #     "search": ("app.routes.v5.department.search", "search_department"),
    #     "save": ("app.routes.v5.department.save", "save_department"),
    #     "delete": ("app.routes.v5.department.delete", "delete_department"),
    #     "duplicate": (
    #         "app.routes.v5.department.duplicate",
    #         "duplicate_department",
    #     ),
    #     "draft": ("app.routes.v5.department.draft", "patch_department_draft"),
    #     "docs": ("app.infra.department_docs", "docs_department_client"),
    # },
    # "document": {
    #     "get": ("app.routes.v5.document.get", "get_document"),
    #     "search": ("app.routes.v5.document.search", "search_document"),
    #     "save": ("app.routes.v5.document.save", "save_document"),
    #     "delete": ("app.routes.v5.document.delete", "delete_document"),
    #     "duplicate": ("app.routes.v5.document.duplicate", "duplicate_document"),
    #     "draft": ("app.routes.v5.document.draft", "patch_document_draft"),
    #     "docs": ("app.infra.document_docs", "docs_document_client"),
    # },
    # "eval": {
    #     "get": ("app.routes.v5.eval.get", "get_eval"),
    #     "search": ("app.routes.v5.eval.search", "search_eval"),
    #     "save": ("app.routes.v5.eval.save", "save_eval"),
    #     "delete": ("app.routes.v5.eval.delete", "delete_eval"),
    #     "duplicate": ("app.routes.v5.eval.duplicate", "duplicate_eval"),
    #     "draft": ("app.routes.v5.eval.draft", "patch_eval_draft"),
    #     "docs": ("app.infra.eval_docs", "docs_eval_client"),
    # },
    # "field": {
    #     "get": ("app.routes.v5.field.get", "get_field"),
    #     "search": ("app.routes.v5.field.search", "search_field"),
    #     "save": ("app.routes.v5.field.save", "save_field"),
    #     "delete": ("app.routes.v5.field.delete", "delete_field"),
    #     "duplicate": ("app.routes.v5.field.duplicate", "duplicate_field"),
    #     "draft": ("app.routes.v5.field.draft", "patch_field_draft"),
    ...
    #     "refresh": ("app.routes.v5.health.refresh", "health_refresh"),
    #     "docs": ("app.infra.health_docs", "docs_health_client"),
    # },
    "leaderboard": {
        "get": ("app.routes.v5.leaderboard.get", "get_leaderboard"),
        "refresh": (
    ...
    #     "search": ("app.routes.v5.model.search", "search_model"),
    #     "save": ("app.routes.v5.model.save", "save_model"),
    #     "delete": ("app.routes.v5.model.delete", "delete_model"),
    #     "duplicate": ("app.routes.v5.model.duplicate", "duplicate_model"),
    #     "draft": ("app.routes.v5.model.draft", "patch_model_draft"),
    #     "docs": ("app.infra.model_docs", "docs_model_client"),
    # },
    # "parameter": {
    #     "get": ("app.routes.v5.parameter.get", "get_parameter"),
    #     "search": ("app.routes.v5.parameter.search", "search_parameter"),
    #     "save": ("app.routes.v5.parameter.save", "save_parameter"),
    #     "delete": ("app.routes.v5.parameter.delete", "delete_parameter"),
    #     "duplicate": (
    #         "app.routes.v5.parameter.duplicate",
    #         "duplicate_parameter",
    #     ),
    #     "draft": ("app.routes.v5.parameter.draft", "patch_parameter_draft"),
    #     "docs": ("app.infra.parameter_docs", "docs_parameter_client"),
    # },
    "persona": {
        "get": ("app.routes.v5.persona.get", "get_persona"),
        "search": ("app.routes.v5.persona.search", "search_persona"),
    ...
    #     "search": ("app.routes.v5.profile.search", "search_profile"),
    #     "save": ("app.routes.v5.profile.save", "save_profile"),
    #     "delete": ("app.routes.v5.profile.delete", "delete_profile"),
    #     "duplicate": ("app.routes.v5.profile.duplicate", "duplicate_profile"),
    #     "draft": ("app.routes.v5.profile.draft", "patch_profile_draft"),
    #     "docs": ("app.infra.profile_docs", "docs_profile_client"),
    # },
    # "provider": {
    #     "get": ("app.routes.v5.provider.get", "get_provider"),
    #     "search": ("app.routes.v5.provider.search", "search_provider"),
    #     "save": ("app.routes.v5.provider.save", "save_provider"),
    #     "delete": ("app.routes.v5.provider.delete", "delete_provider"),
    #     "duplicate": ("app.routes.v5.provider.duplicate", "duplicate_provider"),
    #     "draft": ("app.routes.v5.provider.draft", "patch_provider_draft"),
    ...
    #     "search": ("app.routes.v5.rubric.search", "search_rubric"),
    #     "save": ("app.routes.v5.rubric.save", "save_rubric"),
    #     "delete": ("app.routes.v5.rubric.delete", "delete_rubric"),
    #     "duplicate": ("app.routes.v5.rubric.duplicate", "duplicate_rubric"),
    #     "draft": ("app.routes.v5.rubric.draft", "patch_rubric_draft"),
    #     "docs": ("app.infra.rubric_docs", "docs_rubric_client"),
    # },
    "scenario": {
        "get": ("app.routes.v5.scenario.get", "get_scenario"),
        "search": ("app.routes.v5.scenario.search", "search_scenario"),
        "delete": ("app.routes.v5.scenario.delete", "delete_scenario"),
        "duplicate": (
            "app.routes.v5.scenario.duplicate",
            "duplicate_scenario",
        ),
    ...
    #     "search": ("app.routes.v5.setting.search", "search_setting"),
    #     "save": ("app.routes.v5.setting.save", "save_setting"),
    #     "delete": ("app.routes.v5.setting.delete", "delete_setting"),
    #     "duplicate": ("app.routes.v5.setting.duplicate", "duplicate_setting"),
    #     "draft": ("app.routes.v5.setting.draft", "patch_setting_draft"),
    #     "docs": ("app.infra.setting_docs", "docs_setting_client"),
    # },
    "simulation": {
        "get": ("app.routes.v5.simulation.get", "get_simulation"),
        "search": ("app.routes.v5.simulation.search", "search_simulation"),
        "delete": ("app.routes.v5.simulation.delete", "delete_simulation"),
        "duplicate": (
            "app.routes.v5.simulation.duplicate",
    ...
    # },
    # "tool": {
    #     "get": ("app.routes.v5.tool.get", "get_tool"),
    #     "search": ("app.routes.v5.tool.search", "search_tool"),
    #     "save": ("app.routes.v5.tool.save", "save_tool"),
    #     "delete": ("app.routes.v5.tool.delete", "delete_tool"),
    #     "duplicate": ("app.routes.v5.tool.duplicate", "duplicate_tool"),
    #     "draft": ("app.routes.v5.tool.draft", "patch_tool_draft"),
    #     "docs": ("app.infra.tool_docs", "docs_tool_client"),
    # },
    "chat": {
        "get": ("app.routes.v5.chat.get", "chat_bundle_get"),
...
for _name in _ALL_ENTRIES:
    _entry: dict[str, tuple[str, str]] = {
        "get": (f"app.routes.v5.tools.entries.{_name}.get", f"get_{_name}_entries"),
        "search": (
            f"app.routes.v5.tools.entries.{_name}.search",
            f"search_{_name}_entries",
        ),
    }
    if _name in _ENTRIES_WITH_CREATE_ROUTE:
        _entry["create"] = (
            f"app.routes.v5.tools.entries.{_name}.create",
...
def register_endpoints(server: FastMCP) -> None:
    ...
    def docs(name: str) -> dict[str, Any]:
        ...
        if name == "glow":
            try:
                handler = _get_handler("app.routes.v5.docs", "get_glow_docs")
                return handler()
            except Exception:
    ...
    # ==================================================================
    # Category 6: Upload/Download — use /uploads/* HTTP routes instead
    # (TUS, multipart POST, raw binary PUT, GET download)
    # ==================================================================
