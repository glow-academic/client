"""Uploads workflow router — TUS, multipart, raw binary, download, preview, template."""
...
from app.routes.uploads.multipart import router as multipart_router
from app.routes.uploads.preview import router as preview_router
from app.routes.uploads.raw import router as raw_router
...
router.include_router(multipart_router)
