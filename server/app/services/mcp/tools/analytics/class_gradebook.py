...
from app.models import (Classes, Cohorts, Profiles, SimulationAttempts,
    ...
    try:
            ...
            for attempt in attempts:
                ...
                if chats:
                    ...
                    if grade:
                        ...
                        if sim_id not in simulation_grades or grade.score > simulation_grades[sim_id]["score"]:
        ...
        for sim in simulations:
            ...
            has_class_attempts = any(
                ...
                for student in class_students 
                for attempt in session.exec(select(SimulationAttempts).where(
                    SimulationAttempts.profile_id == student.id,
